...
public class dinterpret {
    private static class VarWalker extends StoppableVisitor
    {
        ...
        public VarWalker copy() {
            VarWalker that = new VarWalker();
            that.ccf = this.ccf;
            that.this = this.this;
            that.stop = this.stop;
            return that;
    ...
    private static class RecursiveBlock
    {
        ...
        private boolean refCopy;
        private boolean needsPostblit;
        private boolean needsDtor;
    ...
    public static class Interpreter extends Visitor
    {
            ...
            if (this.goal == CtfeGoal.ctfeNeedLvalue)
            {
                if ((this.istate != null && (this.istate).fd.vthis != null))
                {
                    ...
                    if ((this.istate).fd.isThis2)
                    {
                        ...
                        this.result = new IndexExp(e.loc, this.result, literal());
                    }
        ...
        public  void visit(SymOffExp e) {
            ...
            if (((val.type.ty & 0xFF) == ENUMTY.Tarray || (val.type.ty & 0xFF) == ENUMTY.Tsarray))
            {
                ...
                {
                    emplaceExp(this.pue, e.loc, val, e.type);
                ...
                if ((((val.type.ty & 0xFF) == ENUMTY.Tsarray && (pointee.ty & 0xFF) == ENUMTY.Tsarray) && elemsize == pointee.nextOf().size()))
                {
                    ...
                    se.type = pointee;
                    emplaceExp(this.pue, e.loc, se, e.type);
                    this.result = (this.pue).exp();
                    return ;
                }
                if (!(isSafePointerCast(elemtype, pointee)))
                {
                    if ((e.offset == 0L && isSafePointerCast(e.var.type, pointee)))
                    {
                        ...
                        ve.type = elemtype;
                        emplaceExp(this.pue, e.loc, ve, e.type);
                        this.result = (this.pue).exp();
                        return ;
                    }
                ...
                if (aggregate != null)
                {
                    ...
                    ei.type = elemtype;
                    emplaceExp(this.pue, e.loc, ei, e.type);
                    this.result = (this.pue).exp();
                    return ;
                }
            }
        ...
        public  void visit(AddrExp e) {
            {
                ...
                if (ve != null)
                {
                    ...
                    if (decl.isDataseg())
                    {
                        emplaceExp(this.pue, e.loc, ((VarExp)e.e1).var, 0);
                        this.result = (this.pue).exp();
                        this.result.type = e.type;
                        return ;
                    }
            ...
            if (this.exceptionOrCant(er))
                return ;
            emplaceExp(this.pue, e.loc, er, e.type);
            this.result = (this.pue).exp();
        }
        ...
        public  void visit(DelegateExp e) {
            ...
            else
            {
                ...
                emplaceExp(this.pue, e.loc, er, e.func, false);
                this.result = (this.pue).exp();
                this.result.type = e.type;
            }
        }
        ...
        public  void visit(TypeidExp e) {
            ...
            }
            {
                ...
                if (ex != null)
                {
                    ...
                    assert(cd != null);
                    emplaceExp(this.pue, e.loc, cd.type);
                    this.result = (this.pue).exp();
                    this.result.type = e.type;
                    return ;
                }
        ...
        public  void visit(TupleExp e) {
            ...
            {
                expandTuples(expsx);
                emplaceExp(this.pue, e.loc, expsx);
                this.result = (this.pue).exp();
        ...
        public  void visit(ArrayLiteralExp e) {
            ...
            if (expsx != e.elements)
            {
                ...
                emplaceExp(this.pue, e.loc, e.type, basis, expsx);
        ...
        public  void visit(StructLiteralExp e) {
            ...
            if (expsx != e.elements)
            {
                ...
                emplaceExp(this.pue, e.loc, e.sd, expsx);
        ...
        public static Expression recursivelyCreateArrayLiteral(UnionExp pue, Loc loc, Type newtype, InterState istate, DArray<Expression> arguments, int argnum) {
            ...
            if (((elemType.ty & 0xFF) == ENUMTY.Tarray && argnum < (arguments).length - 1))
            {
                ...
                emplaceExp(pue, loc, newtype, elements);
        ...
        public  void visit(NewExp e) {
            ...
            }
            {
                ...
                if (ts != null)
                {
                    ...
                    emplaceExp(this.pue, e.loc, ev, e.type);
                    this.result = (this.pue).exp();
                    return ;
                }
            }
        ...
        public  void interpretCompareCommon(BinExp e, Function4<Loc,Byte,Expression,Expression,Integer> fp) {
            ...
            if (((e.e1.type.ty & 0xFF) == ENUMTY.Tpointer && (e.e2.type.ty & 0xFF) == ENUMTY.Tpointer))
            {
                ...
                emplaceExp(this.pue, e.loc, cmp, e.type);
                this.result = (this.pue).exp();
                return ;
            }
            Expression e1 = interpret(ue1, e.e1, this.istate, CtfeGoal.ctfeNeedRvalue);
        ...
        public  void interpretFourPointerRelation(UnionExp pue, BinExp e) {
            ...
            if (((!(pointToSameMemoryBlock(agg1, agg2)) && (agg1.op & 0xFF) != 13) && (agg2.op & 0xFF) != 13))
            {
                ...
                {
                    emplaceExp(pue, e.loc, (e.op & 0xFF) == 101 ? 0 : 1, e.type);
                    this.result = (pue).exp();
                    return ;
                }
        ...
        public  void visit(LogicalExp e) {
            ...
            if (this.goal != CtfeGoal.ctfeNeedNothing)
            {
                emplaceExp(this.pue, e.loc, res, e.type);
                this.result = (this.pue).exp();
            }
        }
        ...
        public  void visit(CondExp e) {
            ...
            if (isPointer(e.econd.type))
            {
                if ((econd.op & 0xFF) != 13)
                {
                    emplaceExp(uecond, e.loc, 1, Type.tbool);
                    econd = uecond.exp();
                }
            }
            if (isTrueBool(econd))
        ...
        public  void visit(ArrayLengthExp e) {
            ...
            emplaceExp(this.pue, e.loc, resolveArrayLength(e1), e.type);
            this.result = (this.pue).exp();
        }
        ...
        public static Expression interpretVectorToArray(UnionExp pue, VectorExp e) {
            ...
            if (((e.e1.op & 0xFF) == 135 || (e.e1.op & 0xFF) == 140))
            {
                ...
                assert(type != null);
                emplaceExp(pue, e.loc, type, elements);
        ...
        public  void visit(VectorExp e) {
            ...
            if (pequals(e1, (this.pue).exp()))
                e1 = (this.pue).copy();
            emplaceExp(this.pue, e.loc, e1, e.to);
        ...
        public  void visit(IndexExp e) {
            if ((e.e1.type.toBasetype().ty & 0xFF) == ENUMTY.Tpointer)
            {
                ...
                if (((agg.value.op & 0xFF) == 47 || (agg.value.op & 0xFF) == 121))
                {
                    if (this.goal == CtfeGoal.ctfeNeedLvalue)
                    {
                        emplaceExp(this.pue, e.loc, agg.value, new IntegerExp(e.e2.loc, indexToAccess.value, e.e2.type));
                        this.result = (this.pue).exp();
                        this.result.type = e.type;
                        return ;
                    }
            ...
            if ((e.e1.type.toBasetype().ty & 0xFF) == ENUMTY.Taarray)
            {
                ...
                if (this.goal == CtfeGoal.ctfeNeedLvalue)
                {
                    ...
                    {
                        emplaceExp(this.pue, e.loc, e1, e2);
                        this.result = (this.pue).exp();
                        this.result.type = e.type;
                    }
                    return ;
            ...
            if (this.goal == CtfeGoal.ctfeNeedLvalue)
            {
                ...
                emplaceExp(this.pue, e.loc, agg.value, e2);
                this.result = (this.pue).exp();
                this.result.type = e.type;
                return ;
            }
        ...
        public  void visit(SliceExp e) {
            if ((e.e1.type.toBasetype().ty & 0xFF) == ENUMTY.Tpointer)
            {
                ...
                emplaceExp(this.pue, e.loc, agg, lwr, upr);
                this.result = (this.pue).exp();
                this.result.type = e.type;
                return ;
            }
            ...
            }
            {
                ...
                if (se != null)
                {
                    ...
                    ilwr += lo1;
                    iupr += lo1;
                    emplaceExp(this.pue, e.loc, se.e1, new IntegerExp(e.loc, ilwr, lwr.type), new IntegerExp(e.loc, iupr, upr.type));
                    this.result = (this.pue).exp();
                    this.result.type = e.type;
                    return ;
                }
            ...
            emplaceExp(this.pue, e.loc, e1, lwr, upr);
            this.result = (this.pue).exp();
            this.result.type = e.type;
        }
        ...
        public  void visit(InExp e) {
            ...
            if ((e2.op & 0xFF) == 13)
            {
                emplaceExp(this.pue, e.loc, e.type);
                this.result = (this.pue).exp();
                return ;
            }
            if ((e2.op & 0xFF) != 48)
            ...
            else
            {
                ...
                emplaceExp(this.pue, e.loc, this.result, e.type);
                this.result = (this.pue).exp();
            }
        }
        ...
        public  void visit(CastExp e) {
            ...
            if (((e.to.ty & 0xFF) == ENUMTY.Tpointer && (e1.op & 0xFF) != 13))
            {
                ...
                if (((e1.op & 0xFF) == 62 && !(((IndexExp)e1).e1.type.equals(e1.type))))
                {
                    ...
                    emplaceExp(this.pue, e1.loc, ie.e1, ie.e2);
                    this.result = (this.pue).exp();
                    this.result.type = e.type;
                    return ;
                }
                {
                    ...
                    if (ae != null)
                    {
                        ...
                        if (isSafePointerCast(origType, pointee))
                        {
                            emplaceExp(this.pue, e.loc, ae.e1, e.type);
                            this.result = (this.pue).exp();
                            return ;
                        }
                ...
                if (((e1.op & 0xFF) == 26 || (e1.op & 0xFF) == 25))
                {
                    ...
                    }
                    {
                        VarExp ve = e1.isVarExp();
                        if (ve != null)
                            emplaceExp(this.pue, e.loc, ve.var);
                        else
                            emplaceExp(this.pue, e.loc, ((SymOffExp)e1).var, ((SymOffExp)e1).offset);
                    }
                    this.result = (this.pue).exp();
            ...
            if (((e.to.ty & 0xFF) == ENUMTY.Tarray && (e1.op & 0xFF) == 31))
            {
                ...
                emplaceExp(this.pue, e1.loc, se.e1, se.lwr, se.upr);
                this.result = (this.pue).exp();
                this.result.type = e.to;
                return ;
            }
            ...
            {
                emplaceExp(this.pue, e.loc, (e1.op & 0xFF) != 13, e.to);
                this.result = (this.pue).exp();
                return ;
            }
        ...
        public  void visit(DotVarExp e) {
                ...
                return ;
            {
                ...
                if (f != null)
                {
                    ...
                    {
                        emplaceExp(this.pue, e.loc, ex, f, false);
                        this.result = (this.pue).exp();
                        this.result.type = e.type;
                    }
                    return ;
            ...
            if (this.goal == CtfeGoal.ctfeNeedLvalue)
            {
                ...
                {
                    emplaceExp(this.pue, e.loc, ex, v);
                    this.result = (this.pue).exp();
                    this.result.type = e.type;
                }
                return ;
        ...
        public  void visit(RemoveExp e) {
            ...
            emplaceExp(this.pue, e.loc, (removed) != 0 ? 1 : 0, Type.tbool);
            this.result = (this.pue).exp();
        }
    ...
    public static Expression interpret_length(UnionExp pue, InterState istate, Expression earg) {
        ...
        emplaceExp(pue, earg.loc, len, Type.tsize_t);
        return (pue).exp();
    }
    ...
    public static Expression interpret_keys(UnionExp pue, InterState istate, Expression earg, Type returnType) {
        ...
        if ((earg.op & 0xFF) == 13)
        {
            emplaceExp(pue, earg.loc, earg.type);
            return (pue).exp();
        }
    ...
    public static Expression interpret_aaApply(UnionExp pue, InterState istate, Expression aa, Expression deleg) {
        ...
        if ((aa.op & 0xFF) != 48)
        {
            emplaceExp(pue, deleg.loc, 0, Type.tsize_t);
            return (pue).exp();
        }
        FuncDeclaration fd = null;
        Expression pthis = null;
    ...
    public static Expression foreachApplyUtf(UnionExp pue, InterState istate, Expression str, Expression deleg, boolean rvs) {
        ...
        if (len == 0)
        {
            emplaceExp(pue, deleg.loc, 0, indexType);
            return (pue).exp();
        }
