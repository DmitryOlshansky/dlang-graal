...
public class tokens {
    ...
    public static class Token
    {
        ...
        static {
            Identifier.initTable();
            {
                ...
                for (; (__key131 < __r130.getLength());__key131 += 1) {
                    ...
                    Identifier.idPool(tochars.get((kw & 0xFF)).getPtr(0), tochars.get((kw & 0xFF)).getLength(), (kw & 0xFF));
                }
            }
        }
        // Erasure: isKeyword<>
        ...
        public  BytePtr toChars() {
            BytePtr p = pcopy(tokens.toCharsbuffer.ptr());
            {
                ...
                do {
                    ...
                    {
                        case 105:
                            sprintf(tokens.toCharsbuffer.ptr(), new BytePtr("%d"), (int)this.intvalue);
                            break;
                        case 106:
                        case 117:
                        case 118:
                        case 119:
                            sprintf(tokens.toCharsbuffer.ptr(), new BytePtr("%uU"), (int)this.intvalue);
                            break;
                        case 107:
                            sprintf(tokens.toCharsbuffer.ptr(), new BytePtr("%lldL"), this.intvalue);
                            break;
                        case 108:
                            sprintf(tokens.toCharsbuffer.ptr(), new BytePtr("%lluUL"), this.intvalue);
                            break;
                        case 111:
                            CTFloat.sprint(tokens.toCharsbuffer.ptr(), (byte)103, this.floatvalue);
                            strcat(tokens.toCharsbuffer.ptr(), new BytePtr("f"));
                            break;
                        case 112:
                            CTFloat.sprint(tokens.toCharsbuffer.ptr(), (byte)103, this.floatvalue);
                            break;
                        case 113:
                            CTFloat.sprint(tokens.toCharsbuffer.ptr(), (byte)103, this.floatvalue);
                            strcat(tokens.toCharsbuffer.ptr(), new BytePtr("L"));
                            break;
                        case 114:
                            CTFloat.sprint(tokens.toCharsbuffer.ptr(), (byte)103, this.floatvalue);
                            strcat(tokens.toCharsbuffer.ptr(), new BytePtr("fi"));
                            break;
                        case 115:
                            CTFloat.sprint(tokens.toCharsbuffer.ptr(), (byte)103, this.floatvalue);
                            strcat(tokens.toCharsbuffer.ptr(), new BytePtr("i"));
                            break;
                        case 116:
                            CTFloat.sprint(tokens.toCharsbuffer.ptr(), (byte)103, this.floatvalue);
                            strcat(tokens.toCharsbuffer.ptr(), new BytePtr("Li"));
                            break;
                        case 121:
                            {
        ...
        public static BytePtr toChars(byte value) {
            return asString(value).getPtr(0);
        }
        ...
        public Token copy(){
            ...
            r.ptr = ptr;
            r.value = value;
            r.blockComment = blockComment.copy();
            r.lineComment = lineComment.copy();
            r.intvalue = intvalue;
