...
public class astbase {
    ...
    static SCstring stcToCharstable = slice(initializer_1);
    ...
    public static class ASTBase
    {
        ...
        public static class VarDeclaration extends Declaration
        {
            ...
            public  VarDeclaration(Loc loc, Type type, Identifier id, Initializer _init, long st) {
                ...
                this._init = _init;
                this.loc = loc.copy();
                this.storage_class = this.storage_class;
        ...
        public static class FuncDeclaration extends Declaration
        {
            ...
            public  Ptr<FuncLiteralDeclaration> isFuncLiteralDeclaration() {
                return null;
            }
        ...
        {
            public boolean mangleOnly;
            public Expression identExp;
            public  Nspace(Loc loc, Identifier ident, Expression identExp, DArray<Dsymbol> members, boolean mangleOnly) {
                super(ident);
                this.loc = loc.copy();
            ...
            public Nspace copy() {
                ...
                that.mangleOnly = this.mangleOnly;
        ...
        public static class IntegerExp extends Expression
        {
            ...
            public  void normalize() {
                switch ((this.type.toBasetype().ty & 0xFF))
                {
                    case 30:
                        this.value = (long)(this.value != 0L);
                        break;
                    case 13:
        ...
        public static class StringExp extends Expression
        {
            ...
            public  void writeTo(Object dest, boolean zero, int tyto) {
                ...
                {
                    memcpy(dest, this.string, this.len * (this.sz & 0xFF));
                    if (zero)
                        memset(dest.plus((this.len * (this.sz & 0xFF)) * 1), 0, (this.sz & 0xFF));
                }
                else
                    throw new AssertionError("Unreachable code!");
            }
