...
public class expression {
    ...
    private static class DtorVisitor extends StoppableVisitor
    {
        ...
        public DtorVisitor copy() {
            DtorVisitor that = new DtorVisitor();
            that.sc = this.sc;
            that.ce = this.ce;
            that.vcond = this.vcond;
            that.isThen = this.isThen;
            that.this = this.this;
            that.stop = this.stop;
            return that;
        }
    ...
    // from template emplaceExp!(StringExpLocObjectInteger)
    // removed duplicate function, [["Expression eval_yl2xp1Loc, FuncDeclaration, DArray<Expression>", "int skipPastIdentWithDotsOutBuffer, int", "boolean emitAnchorNameOutBuffer, Dsymbol, Scope, boolean", "TemplateParameter isTemplateParameterDArray<Dsymbol>, BytePtr, int", "TypeAArray toBuiltinAATypeType", "Expression eval_isinfinityLoc, FuncDeclaration, DArray<Expression>", "boolean mergeCallSuperRef<Short>, short", "Expression eval_floorLoc, FuncDeclaration, DArray<Expression>", "UnionExp changeArrayLiteralLengthLoc, TypeArray, Expression, int, int", "ArrayLiteralExp createBlockDuplicatedArrayLiteralUnionExp, Loc, Type, Expression, int", "BytePtr stripLeadingNewlinesBytePtr", "void createMatchNodes", "UnionExp ArrayLengthType, Expression", "boolean checkAccessAggregateDeclaration, Loc, Scope, Dsymbol", "Expression resolveSliceExpression, UnionExp", "Expression getValueVarDeclaration", "boolean hasPackageAccessScope, Dsymbol", "boolean isFloatIntPaintType, Type", "int mainSlice<ByteSlice>", "void vmessageLoc, BytePtr, Slice<Object>", "boolean isValidManglingint", "int getAlignmentAlignDeclaration, Scope", "int arrayObjectHashDArray<RootObject>", "boolean numCmpbyte, int, intInteger", "boolean exceptionOrCantInterpretExpression", "ByteSlice lookForSourceFileByteSlice", "void showCtfeExprExpression, int", "void removeBlankLineMacroOutBuffer, IntRef, IntRef", "boolean isErrorRootObject", "void emitMemberCommentsScopeDsymbol, OutBuffer, Scope", "UnionExp ctfeCatLoc, Type, Expression, Expression", "void escapeDdocStringOutBuffer, int", "void deprecationLoc, BytePtr", "void messageLoc, BytePtr", "Parameter isFunctionParameterDArray<Dsymbol>, BytePtr, int", "short parseModulePatternDepthBytePtr", "void MODtoDecoBufferOutBuffer, byte", "UnionExp ModLoc, Type, Expression, Expression", "void emplaceExpObject, Loc _param_1, Object _param_2, int _param_3StringExpLocObjectInteger", "void emplaceExpObject, Loc _param_1, StructLiteralExp _param_2, Type _param_3ClassReferenceExpLocStructLiteralExpType", "Expression eval_tanLoc, FuncDeclaration, DArray<Expression>", "int skippastURLOutBuffer, int", "boolean isZeroSecondbyte", "Expression eval_copysignLoc, FuncDeclaration, DArray<Expression>", "Expression eval_log2Loc, FuncDeclaration, DArray<Expression>", "double creallcomplex_t", "void warningSupplementalLoc, BytePtr", "int deduceTypeRootObject, Scope, Type, DArray<TemplateParameter>, DArray<RootObject>, IntPtr, int, boolean", "Tuple isTupleRootObject", "Expression eval_truncLoc, FuncDeclaration, DArray<Expression>", "UnionExp DivLoc, Type, Expression, Expression", "void expandTemplateMixinCommentsTemplateMixin, OutBuffer, Scope", "Expression eval_sqrtLoc, FuncDeclaration, DArray<Expression>", "boolean lambdaCheckForNestedRefExpression, Scope", "void dsymbolSemanticDsymbol, Scope", "void cantExpUnionExp", "boolean pointToSameMemoryBlockExpression, Expression", "long getStorageClassPrefixAttributesASTBaseASTBase", "UnionExp ComType, Expression", "ByteSlice initializerMsgtable", "int specificCmpbyte, int", "void builtinDeinitialize", "boolean isDigitSecondbyte", "Scope skipNonQualScopesScope", "UnionExp MulLoc, Type, Expression, Expression", "int utfStrideBytePtr", "void verrorPrintLoc, int, BytePtr, BytePtr, Slice<Object>, BytePtr, BytePtr", "int ctfeCmpLoc, byte, Expression, Expression", "boolean isTrueBoolExpression", "void builtin_init", "Parameter isParameterRootObject", "void errorSupplementalLoc, BytePtr", "long resolveArrayLengthExpression", "Expression evaluateDtorInterState, Expression", "int foreachDsymbolDArray<Dsymbol>, Function1<Dsymbol,Integer>", "Expression interpret_lengthUnionExp, InterState, Expression", "Parameter isFunctionParameterDsymbol, BytePtr, int", "void emitProtectionOutBuffer, Import", "TemplateParameter isTemplateParameterRootObject", "boolean arrayObjectMatchDArray<RootObject>, DArray<RootObject>", "boolean reliesOnTemplateParametersExpression, Slice<TemplateParameter>", "int endAllMarkdownQuotesOutBuffer, int, IntRef", "boolean definitelyValueParameterExpression", "boolean reliesOnTidentType, DArray<TemplateParameter>, int", "Expression eval_yl2xLoc, FuncDeclaration, DArray<Expression>", "void errorLoc, BytePtr", "boolean utf_isValidDcharint", "void fatal", "Expression evaluateIfBuiltinUnionExp, InterState, Loc, FuncDeclaration, DArray<Expression>, Expression", "UnionExp pointerDifferenceLoc, Type, Expression, Expression", "UnionExp NegType, Expression", "boolean isidcharbyte", "int utf_codeLengthWcharint", "Expression getValueRef<Dsymbol>", "Function3<Loc,FuncDeclaration,DArray<Expression>,Expression> builtin_lookupBytePtr", "BytePtr linkToCharsint", "Expression interpretStatement, InterState", "int isConstExpression", "Expression getExpressionRootObject", "void emitProtectionOutBuffer, Prot", "Expression ctfeIndexLoc, Type, Expression, long", "int utf_codeLengthint, int", "UnionExp SliceType, Expression, Expression, Expression", "void functionResolveMatchAccumulator, Dsymbol, Loc, Scope, DArray<RootObject>, Type, DArray<Expression>, Ptr<BytePtr>", "int intSignedCmpbyte, long, long", "int ctfeIdentityLoc, byte, Expression, Expression", "Expression ctfeInterpretForPragmaMsgExpression", "boolean isUniAlphaint", "BytePtr skipwhitespaceBytePtr", "UnionExp Cmpbyte, Loc, Type, Expression, Expression", "Dsymbol mostVisibleOverloadDsymbol, Module", "UnionExp OrLoc, Type, Expression, Expression", "int sliceCmpStringWithArrayStringExp, ArrayLiteralExp, int, int, int", "boolean hasPackageAccessModule, Dsymbol", "CtorDeclaration generateCopyCtorDeclarationStructDeclaration, long, long", "void errorBytePtr, int, int, BytePtr", "void add_builtinBytePtr, Function3<Loc,FuncDeclaration,DArray<Expression>,Expression>", "UnionExp PtrType, Expression", "void utf_encodeWcharCharPtr, int", "boolean findConditionDArray<Identifier>, Identifier", "int ctfeRawCmpLoc, Expression, Expression, boolean", "UnionExp ShlLoc, Type, Expression, Expression", "void highlightTextScope, DArray<Dsymbol>, Loc, OutBuffer, int", "UnionExp voidInitLiteralType, VarDeclaration", "void gendocfileModule", "boolean isIdTailBytePtr", "UnionExp ShrLoc, Type, Expression, Expression", "int setMangleOverrideDsymbol, ByteSlice", "Dsymbol getDsymbolRootObject", "Expression eval_log10Loc, FuncDeclaration, DArray<Expression>", "Expression eval_expLoc, FuncDeclaration, DArray<Expression>", "Expression getAggregateFromPointerExpression, Ptr<Long>", "Expression eval_fmaxLoc, FuncDeclaration, DArray<Expression>", "boolean isArrayExpression", "UnionExp CastLoc, Type, Type, Expression", "UnionExp IndexType, Expression, Expression", "void emitAnchorOutBuffer, Dsymbol, Scope, boolean", "void removeAnyAtxHeadingSuffixOutBuffer, int", "DArray<Expression> copyElementsExpression, Expression", "void assignInPlaceExpression, Expression", "TemplateDeclaration getEponymousParentDsymbol", "void utf_encodeint, Object, int", "boolean issinglecharbyte", "ByteSlice replaceCharByteSlice, byte, ByteSlice", "int getCodeIndentBytePtr", "boolean isIdentifierDArray<Dsymbol>, BytePtr, int", "BytePtr utf_decodeCharBytePtr, int, IntRef, IntRef", "void vwarningLoc, BytePtr, Slice<Object>", "boolean needToCopyLiteralExpression", "int sliceCmpStringWithStringStringExp, StringExp, int, int, int", "boolean isCtfeComparableExpression", "ByteSlice memdupByteSlice", "void mangleToBufferTemplateInstance, OutBuffer", "ByteSlice lexBytePtr, ByteSlice", "boolean isPointerType", "Expression findKeyInAALoc, AssocArrayLiteralExp, Expression", "int endTableOutBuffer, int, Ref<IntSlice>", "Expression scrubReturnValueLoc, Expression", "Type rawTypeMergeType, Type", "boolean buildCopyCtorStructDeclaration, Scope", "boolean reliesOnTemplateParametersType, Slice<TemplateParameter>", "int utf_codeLengthCharint", "void highlightCode3Scope, OutBuffer, BytePtr, BytePtr", "BytePtr getMessageDeprecatedDeclaration", "int endAllListsAndQuotesOutBuffer, IntRef, Ref<Slice<MarkdownList>>, IntRef, IntRef", "ByteSlice toLowercaseByteSlice", "Expression interpretFunctionUnionExp, FuncDeclaration, InterState, DArray<Expression>, Expression", "Expression interpret_valuesUnionExp, InterState, Expression, Type", "Expression eval_roundLoc, FuncDeclaration, DArray<Expression>", "boolean modifyFieldVarLoc, Scope, VarDeclaration, Expression", "void deprecationSupplementalLoc, BytePtr", "Expression eval_ldexpLoc, FuncDeclaration, DArray<Expression>", "int extractArgNByteSlice, Ref<ByteSlice>, int", "UnionExp UshrLoc, Type, Expression, Expression", "Expression interpret_keysUnionExp, InterState, Expression, Type", "UnionExp Identitybyte, Loc, Type, Expression, Expression", "void vwarningSupplementalLoc, BytePtr, Slice<Object>", "BytePtr modToCharsint", "boolean checkSymbolAccessScope, Dsymbol", "Expression toDelegateExpression, Type, Scope", "UnionExp PowLoc, Type, Expression, Expression", "int isattyint", "Expression scrubCacheValueExpression", "int findFieldIndexByNameStructDeclaration, VarDeclaration", "boolean replaceMarkdownThematicBreakOutBuffer, IntRef, int, Loc", "RootObject objectSyntaxCopyRootObject", "int ctfeEqualLoc, byte, Expression, Expression", "void emplaceExpObject, Loc _param_1, Declaration _param_2, long _param_3SymOffExpLocDeclarationLong", "FuncDeclaration buildPostBlitStructDeclaration, Scope", "int skipCharsOutBuffer, int, ByteSlice", "Statement generateCopyCtorBodyStructDeclaration", "void sliceAssignStringFromArrayLiteralStringExp, ArrayLiteralExp, int", "int expressionHashExpression", "boolean ensureStaticLinkToDsymbol, Dsymbol", "DArray<Expression> copyLiteralArrayDArray<Expression>, Expression", "int templateParameterLookupType, DArray<TemplateParameter>", "boolean symbolIsVisibleDsymbol, Dsymbol", "boolean c_isalnumint", "void tyToDecoBufferOutBuffer, int", "void ObjectNotFoundIdentifier", "boolean isCVariadicParameterDArray<Dsymbol>, ByteSlice", "void mangleToFuncSignatureOutBuffer, FuncDeclaration", "void colorHighlightCodeOutBuffer", "boolean symbolIsVisibleScope, Dsymbol", "void warningLoc, BytePtr", "UnionExp BoolType, Expression", "StringExp createBlockDuplicatedStringLiteralUnionExp, Loc, Type, int, int, byte", "void colorSyntaxHighlightOutBuffer", "Expression paintTypeOntoLiteralType, Expression", "void endMarkdownHeadingOutBuffer, int, IntRef, Loc, IntRef", "int endRowAndTableOutBuffer, int, int, Loc, Ref<Slice<MarkdownDelimiter>>, Ref<IntSlice>", "boolean isoctalbyte", "void unSpeculativeScope, RootObject", "Expression eval_fminLoc, FuncDeclaration, DArray<Expression>", "boolean arrayObjectIsErrorDArray<RootObject>", "long getStorageClassPrefixAttributesASTCodegenASTCodegen", "boolean isSpecialEnumIdentIdentifier", "int skiptoidentOutBuffer, int", "int deduceTypeHelperType, Ptr<Type>, Type", "boolean mergeFieldInitRef<Short>, short", "void foreachDsymbolDArray<Dsymbol>, Function1<Dsymbol,Void>", "Expression interpretUnionExp, Expression, InterState, int", "UnionExp AddLoc, Type, Expression, Expression", "Expression isExpressionRootObject", "int parseTableDelimiterRowOutBuffer, int, boolean, Ref<IntSlice>", "int skippastidentOutBuffer, int", "UnionExp XorLoc, Type, Expression, Expression", "int realCmpbyte, double, double", "boolean isCVariadicArgByteSlice", "boolean isCtfeValueValidExpression", "UnionExp MinLoc, Type, Expression, Expression", "Expression eval_bsrLoc, FuncDeclaration, DArray<Expression>", "void semanticTypeInfoScope, Type", "void highlightCodeScope, Dsymbol, OutBuffer, int", "Expression eval_logLoc, FuncDeclaration, DArray<Expression>", "Expression eval_cosLoc, FuncDeclaration, DArray<Expression>", "boolean allowsContractWithoutBodyFuncDeclaration", "double cimaglcomplex_t", "int replaceTableRowOutBuffer, int, int, Loc, Ref<Slice<MarkdownDelimiter>>, IntSlice, boolean", "void verrorLoc, BytePtr, Slice<Object>, BytePtr, BytePtr, BytePtr", "UnionExp AndLoc, Type, Expression, Expression", "boolean _isZeroInitExpression", "boolean checkAccessLoc, Scope, Package", "Expression eval_ceilLoc, FuncDeclaration, DArray<Expression>", "boolean isCtfeReferenceValidExpression", "boolean checkFrameAccessLoc, Scope, AggregateDeclaration, int", "Expression ctfeInterpretExpression", "int ctfeCmpArraysLoc, Expression, Expression, long", "boolean isTypeInfo_ClassType", "byte deduceWildHelperType, Ptr<Type>, Type", "boolean isIndentWSBytePtr", "Expression evaluatePostblitInterState, Expression", "void verrorSupplementalLoc, BytePtr, Slice<Object>", "boolean checkAccessLoc, Scope, Expression, Declaration", "FuncDeclaration search_toStringStructDeclaration", "Expression eval_sinLoc, FuncDeclaration, DArray<Expression>", "UnionExp Equalbyte, Loc, Type, Expression, Expression", "int replaceMarkdownEmphasisOutBuffer, Loc, Ref<Slice<MarkdownDelimiter>>, int", "ByteSlice generateSlice<Msgtable>, Function1<Msgtable,ByteSlice>", "void processFileByteSlice, ByteSlice, BytePtr_lispy", "Expression eval_popcntLoc, FuncDeclaration, DArray<Expression>", "Expression eval_bsfLoc, FuncDeclaration, DArray<Expression>", "void setValueWithoutCheckingVarDeclaration, Expression", "void mangleToBufferType, OutBuffer", "int isBuiltinFuncDeclaration", "Expression paintFloatIntUnionExp, Expression, Type", "void sliceAssignStringFromStringStringExp, StringExp, int", "Expression paintTypeOntoLiteralUnionExp, Type, Expression", "boolean symbolIsVisibleModule, Dsymbol", "void ctfeCompileFuncDeclaration", "Expression eval_fabsLoc, FuncDeclaration, DArray<Expression>", "void printCtfePerformanceStats", "void highlightCodeScope, DArray<Dsymbol>, OutBuffer, int", "ByteSlice getFilenameDArray<Identifier>, Identifier", "Expression interpretExpression, InterState, int", "Expression getValueExpression", "void messageBytePtr", "Expression eval_isnanLoc, FuncDeclaration, DArray<Expression>", "Expression ctfeCastUnionExp, Loc, Type, Type, Expression", "UnionExp NotType, Expression", "void escapeStrayParenthesisLoc, OutBuffer, int, boolean", "void lambdaSetParentExpression, FuncDeclaration", "boolean isIdStartBytePtr", "int intUnsignedCmpbyte, long, long", "UnionExp pointerArithmeticLoc, byte, Type, Expression, Expression", "void emitProtectionOutBuffer, Declaration", "int templateIdentifierLookupIdentifier, DArray<TemplateParameter>", "ByteSlice lispyBytePtr, ByteSlice", "boolean walkPostorderExpression, StoppableVisitor", "TypeFunction isTypeFunctionDsymbol", "void printDepsConditionalScope, DVCondition, ByteSlice", "Expression expTypeType, Expression", "Expression resolveAliasThisScope, Expression, boolean", "int detectAtxHeadingLevelOutBuffer, int", "Type isTypeRootObject", "Expression eval_builtinLoc, FuncDeclaration, DArray<Expression>", "boolean c_isxdigitint", "BytePtr utf_decodeWcharCharPtr, int, IntRef, IntRef", "Expression interpretUnionExp, Statement, InterState", "ByteSlice deinitializerMsgtable", "Expression eval_unimpLoc, FuncDeclaration, DArray<Expression>", "void utf_encodeCharBytePtr, int", "void semantic3OnDependenciesModule", "UnionExp copyLiteralExpression", "UnionExp paintTypeOntoLiteralCopyType, Expression", "Expression interpret_aaApplyUnionExp, InterState, Expression, Expression", "void emitCommentDsymbol, OutBuffer, Scope", "ByteSlice skipwhitespaceByteSlice", "void vdeprecationSupplementalLoc, BytePtr, Slice<Object>", "void highlightCode2Scope, DArray<Dsymbol>, OutBuffer, int", "FuncDeclaration funcptrOfExpression", "void parseModulePatternBytePtr, MatcherNode, short", "void mangleToBufferExpression, OutBuffer", "boolean matchRootObject, RootObject", "Expression eval_exp2Loc, FuncDeclaration, DArray<Expression>", "int getMarkdownIndentOutBuffer, int, int", "int startTableOutBuffer, int, int, Loc, boolean, Ref<Slice<MarkdownDelimiter>>, Ref<IntSlice>", "boolean isKeywordBytePtr, int", "UnionExp CatType, Expression, Expression", "Expression eval_isfiniteLoc, FuncDeclaration, DArray<Expression>", "int comparePointersbyte, Expression, long, Expression, long", "boolean isDittoBytePtr", "boolean isAssocArrayType", "boolean isSafePointerCastType, Type", "boolean numCmpbyte, double, doubleDouble", "void mangleToBufferDsymbol, OutBuffer", "void aliasSemanticAliasDeclaration, Scope", "Parameter isEponymousFunctionParameterDArray<Dsymbol>, BytePtr, int", "Expression assignAssocArrayElementLoc, AssocArrayLiteralExp, Expression, Expression", "ByteSlice identifierMsgtable", "boolean ishexbyte", "void processFileByteSlice, ByteSlice, BytePtr_lex", "Expression eval_bswapLoc, FuncDeclaration, DArray<Expression>", "void vdeprecationLoc, BytePtr, Slice<Object>, BytePtr, BytePtr", "void setValueVarDeclaration, Expression", "void halt", "BytePtr mangleExactFuncDeclaration", "void emplaceExpObject, int _param_1IntegerExpInteger", "Expression eval_expm1Loc, FuncDeclaration, DArray<Expression>", "Dsymbol isDsymbolRootObject", "boolean isReservedNameByteSlice", "boolean hasProtectedAccessScope, Dsymbol", "void writeHighlightsConsole, OutBuffer", "boolean numCmpbyte, long, longLong", "Expression interpret_dupUnionExp, InterState, Expression", "Dsymbol getEponymousMemberTemplateDeclaration", "Expression eval_powLoc, FuncDeclaration, DArray<Expression>", "boolean hasValueVarDeclaration", "void templateInstanceSemanticTemplateInstance, Scope, DArray<Expression>", "Type getTypeRootObject", "Expression foreachApplyUtfUnionExp, InterState, Expression, Expression, boolean", "boolean includeImportedModuleCheckModuleComponentRange", "Expression eval_fmaLoc, FuncDeclaration, DArray<Expression>", "void sliceAssignArrayLiteralFromStringArrayLiteralExp, StringExp, int", "boolean writeMixinByteSlice, Loc", "void toDocBufferDsymbol, OutBuffer, Scope"]] signature: void emplaceExpObject, Loc _param_1, Object _param_2, int _param_3StringExpLocObjectInteger
    ...
    // from template emplaceExp!(IntegerExpLocLongType)
    // removed duplicate function, [["Expression eval_yl2xp1Loc, FuncDeclaration, DArray<Expression>", "int skipPastIdentWithDotsOutBuffer, int", "boolean emitAnchorNameOutBuffer, Dsymbol, Scope, boolean", "TemplateParameter isTemplateParameterDArray<Dsymbol>, BytePtr, int", "TypeAArray toBuiltinAATypeType", "Expression eval_isinfinityLoc, FuncDeclaration, DArray<Expression>", "boolean mergeCallSuperRef<Short>, short", "Expression eval_floorLoc, FuncDeclaration, DArray<Expression>", "UnionExp changeArrayLiteralLengthLoc, TypeArray, Expression, int, int", "ArrayLiteralExp createBlockDuplicatedArrayLiteralUnionExp, Loc, Type, Expression, int", "BytePtr stripLeadingNewlinesBytePtr", "void createMatchNodes", "UnionExp ArrayLengthType, Expression", "boolean checkAccessAggregateDeclaration, Loc, Scope, Dsymbol", "Expression resolveSliceExpression, UnionExp", "Expression getValueVarDeclaration", "boolean hasPackageAccessScope, Dsymbol", "boolean isFloatIntPaintType, Type", "int mainSlice<ByteSlice>", "void vmessageLoc, BytePtr, Slice<Object>", "boolean isValidManglingint", "int getAlignmentAlignDeclaration, Scope", "int arrayObjectHashDArray<RootObject>", "boolean numCmpbyte, int, intInteger", "boolean exceptionOrCantInterpretExpression", "ByteSlice lookForSourceFileByteSlice", "void showCtfeExprExpression, int", "void removeBlankLineMacroOutBuffer, IntRef, IntRef", "boolean isErrorRootObject", "void emitMemberCommentsScopeDsymbol, OutBuffer, Scope", "UnionExp ctfeCatLoc, Type, Expression, Expression", "void escapeDdocStringOutBuffer, int", "void deprecationLoc, BytePtr", "void messageLoc, BytePtr", "Parameter isFunctionParameterDArray<Dsymbol>, BytePtr, int", "short parseModulePatternDepthBytePtr", "void MODtoDecoBufferOutBuffer, byte", "UnionExp ModLoc, Type, Expression, Expression", "void emplaceExpObject, Loc _param_1, Object _param_2, int _param_3StringExpLocObjectInteger", "void emplaceExpObject, Loc _param_1, StructLiteralExp _param_2, Type _param_3ClassReferenceExpLocStructLiteralExpType", "Expression eval_tanLoc, FuncDeclaration, DArray<Expression>", "int skippastURLOutBuffer, int", "boolean isZeroSecondbyte", "Expression eval_copysignLoc, FuncDeclaration, DArray<Expression>", "Expression eval_log2Loc, FuncDeclaration, DArray<Expression>", "double creallcomplex_t", "void warningSupplementalLoc, BytePtr", "int deduceTypeRootObject, Scope, Type, DArray<TemplateParameter>, DArray<RootObject>, IntPtr, int, boolean", "Tuple isTupleRootObject", "Expression eval_truncLoc, FuncDeclaration, DArray<Expression>", "UnionExp DivLoc, Type, Expression, Expression", "void expandTemplateMixinCommentsTemplateMixin, OutBuffer, Scope", "Expression eval_sqrtLoc, FuncDeclaration, DArray<Expression>", "boolean lambdaCheckForNestedRefExpression, Scope", "void emplaceExpObject, Loc _param_1, complex_t _param_2, Type _param_3ComplexExpLoccomplex_tType", "void dsymbolSemanticDsymbol, Scope", "void cantExpUnionExp", "boolean pointToSameMemoryBlockExpression, Expression", "long getStorageClassPrefixAttributesASTBaseASTBase", "UnionExp ComType, Expression", "ByteSlice initializerMsgtable", "int specificCmpbyte, int", "void builtinDeinitialize", "boolean isDigitSecondbyte", "Scope skipNonQualScopesScope", "UnionExp MulLoc, Type, Expression, Expression", "int utfStrideBytePtr", "void verrorPrintLoc, int, BytePtr, BytePtr, Slice<Object>, BytePtr, BytePtr", "int ctfeCmpLoc, byte, Expression, Expression", "boolean isTrueBoolExpression", "void builtin_init", "Parameter isParameterRootObject", "void errorSupplementalLoc, BytePtr", "long resolveArrayLengthExpression", "Expression evaluateDtorInterState, Expression", "int foreachDsymbolDArray<Dsymbol>, Function1<Dsymbol,Integer>", "Expression interpret_lengthUnionExp, InterState, Expression", "Parameter isFunctionParameterDsymbol, BytePtr, int", "void emitProtectionOutBuffer, Import", "TemplateParameter isTemplateParameterRootObject", "boolean arrayObjectMatchDArray<RootObject>, DArray<RootObject>", "boolean reliesOnTemplateParametersExpression, Slice<TemplateParameter>", "int endAllMarkdownQuotesOutBuffer, int, IntRef", "boolean definitelyValueParameterExpression", "void emplaceExpObject, Loc _param_1, boolean _param_2, Type _param_3IntegerExpLocBooleanType", "boolean reliesOnTidentType, DArray<TemplateParameter>, int", "Expression eval_yl2xLoc, FuncDeclaration, DArray<Expression>", "void errorLoc, BytePtr", "boolean utf_isValidDcharint", "void fatal", "Expression evaluateIfBuiltinUnionExp, InterState, Loc, FuncDeclaration, DArray<Expression>, Expression", "UnionExp pointerDifferenceLoc, Type, Expression, Expression", "UnionExp NegType, Expression", "boolean isidcharbyte", "int utf_codeLengthWcharint", "Expression getValueRef<Dsymbol>", "Function3<Loc,FuncDeclaration,DArray<Expression>,Expression> builtin_lookupBytePtr", "BytePtr linkToCharsint", "Expression interpretStatement, InterState", "int isConstExpression", "Expression getExpressionRootObject", "void emitProtectionOutBuffer, Prot", "Expression ctfeIndexLoc, Type, Expression, long", "int utf_codeLengthint, int", "UnionExp SliceType, Expression, Expression, Expression", "void functionResolveMatchAccumulator, Dsymbol, Loc, Scope, DArray<RootObject>, Type, DArray<Expression>, Ptr<BytePtr>", "int intSignedCmpbyte, long, long", "int ctfeIdentityLoc, byte, Expression, Expression", "Expression ctfeInterpretForPragmaMsgExpression", "void emplaceExpObject, Loc _param_1, long _param_2, Type _param_3IntegerExpLocLongType", "boolean isUniAlphaint", "BytePtr skipwhitespaceBytePtr", "UnionExp Cmpbyte, Loc, Type, Expression, Expression", "Dsymbol mostVisibleOverloadDsymbol, Module", "UnionExp OrLoc, Type, Expression, Expression", "int sliceCmpStringWithArrayStringExp, ArrayLiteralExp, int, int, int", "boolean hasPackageAccessModule, Dsymbol", "CtorDeclaration generateCopyCtorDeclarationStructDeclaration, long, long", "void errorBytePtr, int, int, BytePtr", "void add_builtinBytePtr, Function3<Loc,FuncDeclaration,DArray<Expression>,Expression>", "UnionExp PtrType, Expression", "void utf_encodeWcharCharPtr, int", "boolean findConditionDArray<Identifier>, Identifier", "int ctfeRawCmpLoc, Expression, Expression, boolean", "UnionExp ShlLoc, Type, Expression, Expression", "void highlightTextScope, DArray<Dsymbol>, Loc, OutBuffer, int", "UnionExp voidInitLiteralType, VarDeclaration", "void gendocfileModule", "boolean isIdTailBytePtr", "UnionExp ShrLoc, Type, Expression, Expression", "int setMangleOverrideDsymbol, ByteSlice", "Dsymbol getDsymbolRootObject", "Expression eval_log10Loc, FuncDeclaration, DArray<Expression>", "Expression eval_expLoc, FuncDeclaration, DArray<Expression>", "Expression getAggregateFromPointerExpression, Ptr<Long>", "Expression eval_fmaxLoc, FuncDeclaration, DArray<Expression>", "boolean isArrayExpression", "UnionExp CastLoc, Type, Type, Expression", "UnionExp IndexType, Expression, Expression", "void emitAnchorOutBuffer, Dsymbol, Scope, boolean", "void removeAnyAtxHeadingSuffixOutBuffer, int", "DArray<Expression> copyElementsExpression, Expression", "void assignInPlaceExpression, Expression", "TemplateDeclaration getEponymousParentDsymbol", "void utf_encodeint, Object, int", "boolean issinglecharbyte", "ByteSlice replaceCharByteSlice, byte, ByteSlice", "int getCodeIndentBytePtr", "boolean isIdentifierDArray<Dsymbol>, BytePtr, int", "BytePtr utf_decodeCharBytePtr, int, IntRef, IntRef", "void vwarningLoc, BytePtr, Slice<Object>", "boolean needToCopyLiteralExpression", "int sliceCmpStringWithStringStringExp, StringExp, int, int, int", "boolean isCtfeComparableExpression", "ByteSlice memdupByteSlice", "void mangleToBufferTemplateInstance, OutBuffer", "ByteSlice lexBytePtr, ByteSlice", "boolean isPointerType", "Expression findKeyInAALoc, AssocArrayLiteralExp, Expression", "int endTableOutBuffer, int, Ref<IntSlice>", "Expression scrubReturnValueLoc, Expression", "Type rawTypeMergeType, Type", "void emplaceExpObject, Loc _param_1, Expression _param_2, Type _param_3VectorExpLocExpressionType", "boolean buildCopyCtorStructDeclaration, Scope", "boolean reliesOnTemplateParametersType, Slice<TemplateParameter>", "int utf_codeLengthCharint", "void highlightCode3Scope, OutBuffer, BytePtr, BytePtr", "BytePtr getMessageDeprecatedDeclaration", "int endAllListsAndQuotesOutBuffer, IntRef, Ref<Slice<MarkdownList>>, IntRef, IntRef", "ByteSlice toLowercaseByteSlice", "Expression interpretFunctionUnionExp, FuncDeclaration, InterState, DArray<Expression>, Expression", "Expression interpret_valuesUnionExp, InterState, Expression, Type", "Expression eval_roundLoc, FuncDeclaration, DArray<Expression>", "boolean modifyFieldVarLoc, Scope, VarDeclaration, Expression", "void deprecationSupplementalLoc, BytePtr", "Expression eval_ldexpLoc, FuncDeclaration, DArray<Expression>", "int extractArgNByteSlice, Ref<ByteSlice>, int", "UnionExp UshrLoc, Type, Expression, Expression", "Expression interpret_keysUnionExp, InterState, Expression, Type", "UnionExp Identitybyte, Loc, Type, Expression, Expression", "void vwarningSupplementalLoc, BytePtr, Slice<Object>", "BytePtr modToCharsint", "boolean checkSymbolAccessScope, Dsymbol", "Expression toDelegateExpression, Type, Scope", "UnionExp PowLoc, Type, Expression, Expression", "int isattyint", "Expression scrubCacheValueExpression", "int findFieldIndexByNameStructDeclaration, VarDeclaration", "boolean replaceMarkdownThematicBreakOutBuffer, IntRef, int, Loc", "RootObject objectSyntaxCopyRootObject", "int ctfeEqualLoc, byte, Expression, Expression", "void emplaceExpObject, Loc _param_1, Declaration _param_2, long _param_3SymOffExpLocDeclarationLong", "FuncDeclaration buildPostBlitStructDeclaration, Scope", "int skipCharsOutBuffer, int, ByteSlice", "Statement generateCopyCtorBodyStructDeclaration", "void sliceAssignStringFromArrayLiteralStringExp, ArrayLiteralExp, int", "int expressionHashExpression", "boolean ensureStaticLinkToDsymbol, Dsymbol", "DArray<Expression> copyLiteralArrayDArray<Expression>, Expression", "int templateParameterLookupType, DArray<TemplateParameter>", "boolean symbolIsVisibleDsymbol, Dsymbol", "boolean c_isalnumint", "void tyToDecoBufferOutBuffer, int", "void emplaceExpObject, Loc _param_1, StructDeclaration _param_2, DArray<Expression> _param_3StructLiteralExpLocStructDeclarationDArray<Expression>", "void ObjectNotFoundIdentifier", "boolean isCVariadicParameterDArray<Dsymbol>, ByteSlice", "void mangleToFuncSignatureOutBuffer, FuncDeclaration", "void colorHighlightCodeOutBuffer", "boolean symbolIsVisibleScope, Dsymbol", "void emplaceExpObject, Loc _param_1, TypeSArray _param_2, DArray<Expression> _param_3ArrayLiteralExpLocTypeSArrayDArray<Expression>", "void warningLoc, BytePtr", "UnionExp BoolType, Expression", "StringExp createBlockDuplicatedStringLiteralUnionExp, Loc, Type, int, int, byte", "void colorSyntaxHighlightOutBuffer", "Expression paintTypeOntoLiteralType, Expression", "void endMarkdownHeadingOutBuffer, int, IntRef, Loc, IntRef", "int endRowAndTableOutBuffer, int, int, Loc, Ref<Slice<MarkdownDelimiter>>, Ref<IntSlice>", "boolean isoctalbyte", "void unSpeculativeScope, RootObject", "Expression eval_fminLoc, FuncDeclaration, DArray<Expression>", "boolean arrayObjectIsErrorDArray<RootObject>", "long getStorageClassPrefixAttributesASTCodegenASTCodegen", "boolean isSpecialEnumIdentIdentifier", "int skiptoidentOutBuffer, int", "int deduceTypeHelperType, Ptr<Type>, Type", "boolean mergeFieldInitRef<Short>, short", "void foreachDsymbolDArray<Dsymbol>, Function1<Dsymbol,Void>", "Expression interpretUnionExp, Expression, InterState, int", "UnionExp AddLoc, Type, Expression, Expression", "Expression isExpressionRootObject", "void emplaceExpObject, Loc _param_1, Expression _param_2, IntegerExp _param_3, Expression _param_4SliceExpLocExpressionIntegerExpExpression", "int parseTableDelimiterRowOutBuffer, int, boolean, Ref<IntSlice>", "int skippastidentOutBuffer, int", "UnionExp XorLoc, Type, Expression, Expression", "int realCmpbyte, double, double", "boolean isCVariadicArgByteSlice", "boolean isCtfeValueValidExpression", "UnionExp MinLoc, Type, Expression, Expression", "Expression eval_bsrLoc, FuncDeclaration, DArray<Expression>", "void semanticTypeInfoScope, Type", "void highlightCodeScope, Dsymbol, OutBuffer, int", "Expression eval_logLoc, FuncDeclaration, DArray<Expression>", "Expression eval_cosLoc, FuncDeclaration, DArray<Expression>", "boolean allowsContractWithoutBodyFuncDeclaration", "double cimaglcomplex_t", "int replaceTableRowOutBuffer, int, int, Loc, Ref<Slice<MarkdownDelimiter>>, IntSlice, boolean", "void verrorLoc, BytePtr, Slice<Object>, BytePtr, BytePtr, BytePtr", "UnionExp AndLoc, Type, Expression, Expression", "boolean _isZeroInitExpression", "boolean checkAccessLoc, Scope, Package", "Expression eval_ceilLoc, FuncDeclaration, DArray<Expression>", "boolean isCtfeReferenceValidExpression", "boolean checkFrameAccessLoc, Scope, AggregateDeclaration, int", "Expression ctfeInterpretExpression", "int ctfeCmpArraysLoc, Expression, Expression, long", "boolean isTypeInfo_ClassType", "byte deduceWildHelperType, Ptr<Type>, Type", "boolean isIndentWSBytePtr", "Expression evaluatePostblitInterState, Expression", "void verrorSupplementalLoc, BytePtr, Slice<Object>", "boolean checkAccessLoc, Scope, Expression, Declaration", "FuncDeclaration search_toStringStructDeclaration", "Expression eval_sinLoc, FuncDeclaration, DArray<Expression>", "UnionExp Equalbyte, Loc, Type, Expression, Expression", "void emplaceExpObject, Loc _param_1, Expression _param_2, TypeVector _param_3VectorExpLocExpressionTypeVector", "int replaceMarkdownEmphasisOutBuffer, Loc, Ref<Slice<MarkdownDelimiter>>, int", "void emplaceExpObject, Loc _param_1, Object _param_2, int _param_3, byte _param_4StringExpLocObjectIntegerByte", "ByteSlice generateSlice<Msgtable>, Function1<Msgtable,ByteSlice>", "void processFileByteSlice, ByteSlice, BytePtr_lispy", "Expression eval_popcntLoc, FuncDeclaration, DArray<Expression>", "Expression eval_bsfLoc, FuncDeclaration, DArray<Expression>", "void setValueWithoutCheckingVarDeclaration, Expression", "void mangleToBufferType, OutBuffer", "int isBuiltinFuncDeclaration", "Expression paintFloatIntUnionExp, Expression, Type", "void sliceAssignStringFromStringStringExp, StringExp, int", "Expression paintTypeOntoLiteralUnionExp, Type, Expression", "boolean symbolIsVisibleModule, Dsymbol", "void ctfeCompileFuncDeclaration", "Expression eval_fabsLoc, FuncDeclaration, DArray<Expression>", "void printCtfePerformanceStats", "void highlightCodeScope, DArray<Dsymbol>, OutBuffer, int", "ByteSlice getFilenameDArray<Identifier>, Identifier", "Expression interpretExpression, InterState, int", "Expression getValueExpression", "void messageBytePtr", "Expression eval_isnanLoc, FuncDeclaration, DArray<Expression>", "Expression ctfeCastUnionExp, Loc, Type, Type, Expression", "UnionExp NotType, Expression", "void escapeStrayParenthesisLoc, OutBuffer, int, boolean", "void lambdaSetParentExpression, FuncDeclaration", "boolean isIdStartBytePtr", "int intUnsignedCmpbyte, long, long", "void emplaceExpObject, Loc _param_1, int _param_2, Type _param_3IntegerExpLocIntegerType", "UnionExp pointerArithmeticLoc, byte, Type, Expression, Expression", "void emitProtectionOutBuffer, Declaration", "int templateIdentifierLookupIdentifier, DArray<TemplateParameter>", "ByteSlice lispyBytePtr, ByteSlice", "boolean walkPostorderExpression, StoppableVisitor", "TypeFunction isTypeFunctionDsymbol", "void printDepsConditionalScope, DVCondition, ByteSlice", "Expression expTypeType, Expression", "Expression resolveAliasThisScope, Expression, boolean", "int detectAtxHeadingLevelOutBuffer, int", "Type isTypeRootObject", "Expression eval_builtinLoc, FuncDeclaration, DArray<Expression>", "boolean c_isxdigitint", "BytePtr utf_decodeWcharCharPtr, int, IntRef, IntRef", "Expression interpretUnionExp, Statement, InterState", "ByteSlice deinitializerMsgtable", "Expression eval_unimpLoc, FuncDeclaration, DArray<Expression>", "void utf_encodeCharBytePtr, int", "void semantic3OnDependenciesModule", "UnionExp copyLiteralExpression", "UnionExp paintTypeOntoLiteralCopyType, Expression", "Expression interpret_aaApplyUnionExp, InterState, Expression, Expression", "void emitCommentDsymbol, OutBuffer, Scope", "ByteSlice skipwhitespaceByteSlice", "void vdeprecationSupplementalLoc, BytePtr, Slice<Object>", "void highlightCode2Scope, DArray<Dsymbol>, OutBuffer, int", "FuncDeclaration funcptrOfExpression", "void parseModulePatternBytePtr, MatcherNode, short", "void mangleToBufferExpression, OutBuffer", "boolean matchRootObject, RootObject", "Expression eval_exp2Loc, FuncDeclaration, DArray<Expression>", "int getMarkdownIndentOutBuffer, int, int", "int startTableOutBuffer, int, int, Loc, boolean, Ref<Slice<MarkdownDelimiter>>, Ref<IntSlice>", "boolean isKeywordBytePtr, int", "UnionExp CatType, Expression, Expression", "Expression eval_isfiniteLoc, FuncDeclaration, DArray<Expression>", "int comparePointersbyte, Expression, long, Expression, long", "boolean isDittoBytePtr", "void emplaceExpObject, Loc _param_1, Type _param_2NullExpLocType", "boolean isAssocArrayType", "boolean isSafePointerCastType, Type", "boolean numCmpbyte, double, doubleDouble", "void mangleToBufferDsymbol, OutBuffer", "void aliasSemanticAliasDeclaration, Scope", "Parameter isEponymousFunctionParameterDArray<Dsymbol>, BytePtr, int", "void emplaceExpObject, Loc _param_1, Type _param_2, DArray<Expression> _param_3ArrayLiteralExpLocTypeDArray<Expression>", "Expression assignAssocArrayElementLoc, AssocArrayLiteralExp, Expression, Expression", "void emplaceExpObject, Loc _param_1, IndexExp _param_2, Type _param_3AddrExpLocIndexExpType", "ByteSlice identifierMsgtable", "boolean ishexbyte", "void processFileByteSlice, ByteSlice, BytePtr_lex", "Expression eval_bswapLoc, FuncDeclaration, DArray<Expression>", "void vdeprecationLoc, BytePtr, Slice<Object>, BytePtr, BytePtr", "void setValueVarDeclaration, Expression", "void halt", "BytePtr mangleExactFuncDeclaration", "void emplaceExpObject, int _param_1IntegerExpInteger", "Expression eval_expm1Loc, FuncDeclaration, DArray<Expression>", "Dsymbol isDsymbolRootObject", "boolean isReservedNameByteSlice", "boolean hasProtectedAccessScope, Dsymbol", "void writeHighlightsConsole, OutBuffer", "boolean numCmpbyte, long, longLong", "Expression interpret_dupUnionExp, InterState, Expression", "Dsymbol getEponymousMemberTemplateDeclaration", "Expression eval_powLoc, FuncDeclaration, DArray<Expression>", "boolean hasValueVarDeclaration", "void templateInstanceSemanticTemplateInstance, Scope, DArray<Expression>", "Type getTypeRootObject", "Expression foreachApplyUtfUnionExp, InterState, Expression, Expression, boolean", "boolean includeImportedModuleCheckModuleComponentRange", "Expression eval_fmaLoc, FuncDeclaration, DArray<Expression>", "void sliceAssignArrayLiteralFromStringArrayLiteralExp, StringExp, int", "boolean writeMixinByteSlice, Loc", "void toDocBufferDsymbol, OutBuffer, Scope"]] signature: void emplaceExpObject, Loc _param_1, long _param_2, Type _param_3IntegerExpLocLongType
    ...
    // from template emplaceExp!(SymOffExpLocDeclarationLong)
    // removed duplicate function, [["Expression eval_yl2xp1Loc, FuncDeclaration, DArray<Expression>", "int skipPastIdentWithDotsOutBuffer, int", "boolean emitAnchorNameOutBuffer, Dsymbol, Scope, boolean", "TemplateParameter isTemplateParameterDArray<Dsymbol>, BytePtr, int", "TypeAArray toBuiltinAATypeType", "Expression eval_isinfinityLoc, FuncDeclaration, DArray<Expression>", "boolean mergeCallSuperRef<Short>, short", "Expression eval_floorLoc, FuncDeclaration, DArray<Expression>", "UnionExp changeArrayLiteralLengthLoc, TypeArray, Expression, int, int", "ArrayLiteralExp createBlockDuplicatedArrayLiteralUnionExp, Loc, Type, Expression, int", "BytePtr stripLeadingNewlinesBytePtr", "void createMatchNodes", "UnionExp ArrayLengthType, Expression", "boolean checkAccessAggregateDeclaration, Loc, Scope, Dsymbol", "Expression resolveSliceExpression, UnionExp", "Expression getValueVarDeclaration", "boolean hasPackageAccessScope, Dsymbol", "boolean isFloatIntPaintType, Type", "int mainSlice<ByteSlice>", "void vmessageLoc, BytePtr, Slice<Object>", "boolean isValidManglingint", "int getAlignmentAlignDeclaration, Scope", "int arrayObjectHashDArray<RootObject>", "boolean numCmpbyte, int, intInteger", "boolean exceptionOrCantInterpretExpression", "ByteSlice lookForSourceFileByteSlice", "void showCtfeExprExpression, int", "void removeBlankLineMacroOutBuffer, IntRef, IntRef", "boolean isErrorRootObject", "void emitMemberCommentsScopeDsymbol, OutBuffer, Scope", "UnionExp ctfeCatLoc, Type, Expression, Expression", "void escapeDdocStringOutBuffer, int", "void deprecationLoc, BytePtr", "void messageLoc, BytePtr", "Parameter isFunctionParameterDArray<Dsymbol>, BytePtr, int", "short parseModulePatternDepthBytePtr", "void MODtoDecoBufferOutBuffer, byte", "UnionExp ModLoc, Type, Expression, Expression", "void emplaceExpObject, Loc _param_1, Object _param_2, int _param_3StringExpLocObjectInteger", "void emplaceExpObject, Loc _param_1, StructLiteralExp _param_2, Type _param_3ClassReferenceExpLocStructLiteralExpType", "Expression eval_tanLoc, FuncDeclaration, DArray<Expression>", "int skippastURLOutBuffer, int", "boolean isZeroSecondbyte", "Expression eval_copysignLoc, FuncDeclaration, DArray<Expression>", "Expression eval_log2Loc, FuncDeclaration, DArray<Expression>", "double creallcomplex_t", "void warningSupplementalLoc, BytePtr", "int deduceTypeRootObject, Scope, Type, DArray<TemplateParameter>, DArray<RootObject>, IntPtr, int, boolean", "Tuple isTupleRootObject", "Expression eval_truncLoc, FuncDeclaration, DArray<Expression>", "UnionExp DivLoc, Type, Expression, Expression", "void expandTemplateMixinCommentsTemplateMixin, OutBuffer, Scope", "Expression eval_sqrtLoc, FuncDeclaration, DArray<Expression>", "boolean lambdaCheckForNestedRefExpression, Scope", "void emplaceExpObject, Loc _param_1, complex_t _param_2, Type _param_3ComplexExpLoccomplex_tType", "void dsymbolSemanticDsymbol, Scope", "void cantExpUnionExp", "boolean pointToSameMemoryBlockExpression, Expression", "long getStorageClassPrefixAttributesASTBaseASTBase", "UnionExp ComType, Expression", "ByteSlice initializerMsgtable", "int specificCmpbyte, int", "void builtinDeinitialize", "boolean isDigitSecondbyte", "Scope skipNonQualScopesScope", "UnionExp MulLoc, Type, Expression, Expression", "int utfStrideBytePtr", "void verrorPrintLoc, int, BytePtr, BytePtr, Slice<Object>, BytePtr, BytePtr", "int ctfeCmpLoc, byte, Expression, Expression", "boolean isTrueBoolExpression", "void builtin_init", "Parameter isParameterRootObject", "void errorSupplementalLoc, BytePtr", "long resolveArrayLengthExpression", "Expression evaluateDtorInterState, Expression", "int foreachDsymbolDArray<Dsymbol>, Function1<Dsymbol,Integer>", "Expression interpret_lengthUnionExp, InterState, Expression", "Parameter isFunctionParameterDsymbol, BytePtr, int", "void emitProtectionOutBuffer, Import", "TemplateParameter isTemplateParameterRootObject", "boolean arrayObjectMatchDArray<RootObject>, DArray<RootObject>", "void emplaceExpObject, Loc _param_1, Type _param_2, Expression _param_3, DArray<Expression> _param_4ArrayLiteralExpLocTypeExpressionDArray<Expression>", "boolean reliesOnTemplateParametersExpression, Slice<TemplateParameter>", "int endAllMarkdownQuotesOutBuffer, int, IntRef", "boolean definitelyValueParameterExpression", "void emplaceExpObject, Loc _param_1, boolean _param_2, Type _param_3IntegerExpLocBooleanType", "boolean reliesOnTidentType, DArray<TemplateParameter>, int", "Expression eval_yl2xLoc, FuncDeclaration, DArray<Expression>", "void errorLoc, BytePtr", "boolean utf_isValidDcharint", "void fatal", "Expression evaluateIfBuiltinUnionExp, InterState, Loc, FuncDeclaration, DArray<Expression>, Expression", "UnionExp pointerDifferenceLoc, Type, Expression, Expression", "UnionExp NegType, Expression", "boolean isidcharbyte", "int utf_codeLengthWcharint", "Expression getValueRef<Dsymbol>", "Function3<Loc,FuncDeclaration,DArray<Expression>,Expression> builtin_lookupBytePtr", "BytePtr linkToCharsint", "Expression interpretStatement, InterState", "int isConstExpression", "Expression getExpressionRootObject", "void emitProtectionOutBuffer, Prot", "Expression ctfeIndexLoc, Type, Expression, long", "int utf_codeLengthint, int", "UnionExp SliceType, Expression, Expression, Expression", "void functionResolveMatchAccumulator, Dsymbol, Loc, Scope, DArray<RootObject>, Type, DArray<Expression>, Ptr<BytePtr>", "int intSignedCmpbyte, long, long", "int ctfeIdentityLoc, byte, Expression, Expression", "Expression ctfeInterpretForPragmaMsgExpression", "void emplaceExpObject, Loc _param_1, long _param_2, Type _param_3IntegerExpLocLongType", "boolean isUniAlphaint", "BytePtr skipwhitespaceBytePtr", "UnionExp Cmpbyte, Loc, Type, Expression, Expression", "Dsymbol mostVisibleOverloadDsymbol, Module", "UnionExp OrLoc, Type, Expression, Expression", "int sliceCmpStringWithArrayStringExp, ArrayLiteralExp, int, int, int", "boolean hasPackageAccessModule, Dsymbol", "CtorDeclaration generateCopyCtorDeclarationStructDeclaration, long, long", "void errorBytePtr, int, int, BytePtr", "void add_builtinBytePtr, Function3<Loc,FuncDeclaration,DArray<Expression>,Expression>", "UnionExp PtrType, Expression", "void utf_encodeWcharCharPtr, int", "boolean findConditionDArray<Identifier>, Identifier", "int ctfeRawCmpLoc, Expression, Expression, boolean", "UnionExp ShlLoc, Type, Expression, Expression", "void highlightTextScope, DArray<Dsymbol>, Loc, OutBuffer, int", "UnionExp voidInitLiteralType, VarDeclaration", "void gendocfileModule", "boolean isIdTailBytePtr", "UnionExp ShrLoc, Type, Expression, Expression", "int setMangleOverrideDsymbol, ByteSlice", "Dsymbol getDsymbolRootObject", "Expression eval_log10Loc, FuncDeclaration, DArray<Expression>", "Expression eval_expLoc, FuncDeclaration, DArray<Expression>", "Expression getAggregateFromPointerExpression, Ptr<Long>", "Expression eval_fmaxLoc, FuncDeclaration, DArray<Expression>", "boolean isArrayExpression", "UnionExp CastLoc, Type, Type, Expression", "UnionExp IndexType, Expression, Expression", "void emitAnchorOutBuffer, Dsymbol, Scope, boolean", "void removeAnyAtxHeadingSuffixOutBuffer, int", "DArray<Expression> copyElementsExpression, Expression", "void assignInPlaceExpression, Expression", "TemplateDeclaration getEponymousParentDsymbol", "void utf_encodeint, Object, int", "boolean issinglecharbyte", "ByteSlice replaceCharByteSlice, byte, ByteSlice", "int getCodeIndentBytePtr", "boolean isIdentifierDArray<Dsymbol>, BytePtr, int", "BytePtr utf_decodeCharBytePtr, int, IntRef, IntRef", "void vwarningLoc, BytePtr, Slice<Object>", "boolean needToCopyLiteralExpression", "int sliceCmpStringWithStringStringExp, StringExp, int, int, int", "boolean isCtfeComparableExpression", "ByteSlice memdupByteSlice", "void mangleToBufferTemplateInstance, OutBuffer", "ByteSlice lexBytePtr, ByteSlice", "boolean isPointerType", "Expression findKeyInAALoc, AssocArrayLiteralExp, Expression", "int endTableOutBuffer, int, Ref<IntSlice>", "Expression scrubReturnValueLoc, Expression", "Type rawTypeMergeType, Type", "void emplaceExpObject, Loc _param_1, Expression _param_2, Type _param_3VectorExpLocExpressionType", "boolean buildCopyCtorStructDeclaration, Scope", "boolean reliesOnTemplateParametersType, Slice<TemplateParameter>", "int utf_codeLengthCharint", "void highlightCode3Scope, OutBuffer, BytePtr, BytePtr", "BytePtr getMessageDeprecatedDeclaration", "int endAllListsAndQuotesOutBuffer, IntRef, Ref<Slice<MarkdownList>>, IntRef, IntRef", "ByteSlice toLowercaseByteSlice", "Expression interpretFunctionUnionExp, FuncDeclaration, InterState, DArray<Expression>, Expression", "Expression interpret_valuesUnionExp, InterState, Expression, Type", "Expression eval_roundLoc, FuncDeclaration, DArray<Expression>", "boolean modifyFieldVarLoc, Scope, VarDeclaration, Expression", "void deprecationSupplementalLoc, BytePtr", "Expression eval_ldexpLoc, FuncDeclaration, DArray<Expression>", "int extractArgNByteSlice, Ref<ByteSlice>, int", "UnionExp UshrLoc, Type, Expression, Expression", "Expression interpret_keysUnionExp, InterState, Expression, Type", "UnionExp Identitybyte, Loc, Type, Expression, Expression", "void vwarningSupplementalLoc, BytePtr, Slice<Object>", "BytePtr modToCharsint", "boolean checkSymbolAccessScope, Dsymbol", "Expression toDelegateExpression, Type, Scope", "UnionExp PowLoc, Type, Expression, Expression", "int isattyint", "Expression scrubCacheValueExpression", "int findFieldIndexByNameStructDeclaration, VarDeclaration", "boolean replaceMarkdownThematicBreakOutBuffer, IntRef, int, Loc", "RootObject objectSyntaxCopyRootObject", "int ctfeEqualLoc, byte, Expression, Expression", "void emplaceExpObject, Loc _param_1, Declaration _param_2, long _param_3SymOffExpLocDeclarationLong", "FuncDeclaration buildPostBlitStructDeclaration, Scope", "int skipCharsOutBuffer, int, ByteSlice", "Statement generateCopyCtorBodyStructDeclaration", "void sliceAssignStringFromArrayLiteralStringExp, ArrayLiteralExp, int", "int expressionHashExpression", "boolean ensureStaticLinkToDsymbol, Dsymbol", "DArray<Expression> copyLiteralArrayDArray<Expression>, Expression", "int templateParameterLookupType, DArray<TemplateParameter>", "boolean symbolIsVisibleDsymbol, Dsymbol", "boolean c_isalnumint", "void tyToDecoBufferOutBuffer, int", "void emplaceExpObject, Loc _param_1, StructDeclaration _param_2, DArray<Expression> _param_3StructLiteralExpLocStructDeclarationDArray<Expression>", "void ObjectNotFoundIdentifier", "boolean isCVariadicParameterDArray<Dsymbol>, ByteSlice", "void mangleToFuncSignatureOutBuffer, FuncDeclaration", "void colorHighlightCodeOutBuffer", "boolean symbolIsVisibleScope, Dsymbol", "void emplaceExpObject, Loc _param_1, TypeSArray _param_2, DArray<Expression> _param_3ArrayLiteralExpLocTypeSArrayDArray<Expression>", "void warningLoc, BytePtr", "UnionExp BoolType, Expression", "StringExp createBlockDuplicatedStringLiteralUnionExp, Loc, Type, int, int, byte", "void colorSyntaxHighlightOutBuffer", "Expression paintTypeOntoLiteralType, Expression", "void endMarkdownHeadingOutBuffer, int, IntRef, Loc, IntRef", "int endRowAndTableOutBuffer, int, int, Loc, Ref<Slice<MarkdownDelimiter>>, Ref<IntSlice>", "boolean isoctalbyte", "void unSpeculativeScope, RootObject", "Expression eval_fminLoc, FuncDeclaration, DArray<Expression>", "boolean arrayObjectIsErrorDArray<RootObject>", "long getStorageClassPrefixAttributesASTCodegenASTCodegen", "boolean isSpecialEnumIdentIdentifier", "int skiptoidentOutBuffer, int", "int deduceTypeHelperType, Ptr<Type>, Type", "boolean mergeFieldInitRef<Short>, short", "void foreachDsymbolDArray<Dsymbol>, Function1<Dsymbol,Void>", "Expression interpretUnionExp, Expression, InterState, int", "UnionExp AddLoc, Type, Expression, Expression", "Expression isExpressionRootObject", "void emplaceExpObject, Loc _param_1, Expression _param_2, IntegerExp _param_3, Expression _param_4SliceExpLocExpressionIntegerExpExpression", "int parseTableDelimiterRowOutBuffer, int, boolean, Ref<IntSlice>", "int skippastidentOutBuffer, int", "UnionExp XorLoc, Type, Expression, Expression", "int realCmpbyte, double, double", "boolean isCVariadicArgByteSlice", "boolean isCtfeValueValidExpression", "UnionExp MinLoc, Type, Expression, Expression", "Expression eval_bsrLoc, FuncDeclaration, DArray<Expression>", "void semanticTypeInfoScope, Type", "void highlightCodeScope, Dsymbol, OutBuffer, int", "Expression eval_logLoc, FuncDeclaration, DArray<Expression>", "Expression eval_cosLoc, FuncDeclaration, DArray<Expression>", "boolean allowsContractWithoutBodyFuncDeclaration", "double cimaglcomplex_t", "int replaceTableRowOutBuffer, int, int, Loc, Ref<Slice<MarkdownDelimiter>>, IntSlice, boolean", "void verrorLoc, BytePtr, Slice<Object>, BytePtr, BytePtr, BytePtr", "UnionExp AndLoc, Type, Expression, Expression", "boolean _isZeroInitExpression", "boolean checkAccessLoc, Scope, Package", "Expression eval_ceilLoc, FuncDeclaration, DArray<Expression>", "boolean isCtfeReferenceValidExpression", "boolean checkFrameAccessLoc, Scope, AggregateDeclaration, int", "Expression ctfeInterpretExpression", "int ctfeCmpArraysLoc, Expression, Expression, long", "boolean isTypeInfo_ClassType", "byte deduceWildHelperType, Ptr<Type>, Type", "boolean isIndentWSBytePtr", "Expression evaluatePostblitInterState, Expression", "void verrorSupplementalLoc, BytePtr, Slice<Object>", "boolean checkAccessLoc, Scope, Expression, Declaration", "FuncDeclaration search_toStringStructDeclaration", "Expression eval_sinLoc, FuncDeclaration, DArray<Expression>", "UnionExp Equalbyte, Loc, Type, Expression, Expression", "void emplaceExpObject, Loc _param_1, Expression _param_2, TypeVector _param_3VectorExpLocExpressionTypeVector", "int replaceMarkdownEmphasisOutBuffer, Loc, Ref<Slice<MarkdownDelimiter>>, int", "void emplaceExpObject, Loc _param_1, Object _param_2, int _param_3, byte _param_4StringExpLocObjectIntegerByte", "ByteSlice generateSlice<Msgtable>, Function1<Msgtable,ByteSlice>", "void processFileByteSlice, ByteSlice, BytePtr_lispy", "Expression eval_popcntLoc, FuncDeclaration, DArray<Expression>", "Expression eval_bsfLoc, FuncDeclaration, DArray<Expression>", "void setValueWithoutCheckingVarDeclaration, Expression", "void mangleToBufferType, OutBuffer", "int isBuiltinFuncDeclaration", "Expression paintFloatIntUnionExp, Expression, Type", "void sliceAssignStringFromStringStringExp, StringExp, int", "Expression paintTypeOntoLiteralUnionExp, Type, Expression", "boolean symbolIsVisibleModule, Dsymbol", "void ctfeCompileFuncDeclaration", "Expression eval_fabsLoc, FuncDeclaration, DArray<Expression>", "void printCtfePerformanceStats", "void highlightCodeScope, DArray<Dsymbol>, OutBuffer, int", "ByteSlice getFilenameDArray<Identifier>, Identifier", "Expression interpretExpression, InterState, int", "Expression getValueExpression", "void messageBytePtr", "Expression eval_isnanLoc, FuncDeclaration, DArray<Expression>", "Expression ctfeCastUnionExp, Loc, Type, Type, Expression", "UnionExp NotType, Expression", "void escapeStrayParenthesisLoc, OutBuffer, int, boolean", "void lambdaSetParentExpression, FuncDeclaration", "boolean isIdStartBytePtr", "int intUnsignedCmpbyte, long, long", "void emplaceExpObject, Loc _param_1, int _param_2, Type _param_3IntegerExpLocIntegerType", "UnionExp pointerArithmeticLoc, byte, Type, Expression, Expression", "void emitProtectionOutBuffer, Declaration", "int templateIdentifierLookupIdentifier, DArray<TemplateParameter>", "ByteSlice lispyBytePtr, ByteSlice", "boolean walkPostorderExpression, StoppableVisitor", "TypeFunction isTypeFunctionDsymbol", "void printDepsConditionalScope, DVCondition, ByteSlice", "Expression expTypeType, Expression", "Expression resolveAliasThisScope, Expression, boolean", "int detectAtxHeadingLevelOutBuffer, int", "Type isTypeRootObject", "Expression eval_builtinLoc, FuncDeclaration, DArray<Expression>", "boolean c_isxdigitint", "BytePtr utf_decodeWcharCharPtr, int, IntRef, IntRef", "Expression interpretUnionExp, Statement, InterState", "ByteSlice deinitializerMsgtable", "Expression eval_unimpLoc, FuncDeclaration, DArray<Expression>", "void utf_encodeCharBytePtr, int", "void semantic3OnDependenciesModule", "UnionExp copyLiteralExpression", "UnionExp paintTypeOntoLiteralCopyType, Expression", "Expression interpret_aaApplyUnionExp, InterState, Expression, Expression", "void emitCommentDsymbol, OutBuffer, Scope", "ByteSlice skipwhitespaceByteSlice", "void vdeprecationSupplementalLoc, BytePtr, Slice<Object>", "void highlightCode2Scope, DArray<Dsymbol>, OutBuffer, int", "FuncDeclaration funcptrOfExpression", "void parseModulePatternBytePtr, MatcherNode, short", "void mangleToBufferExpression, OutBuffer", "boolean matchRootObject, RootObject", "Expression eval_exp2Loc, FuncDeclaration, DArray<Expression>", "int getMarkdownIndentOutBuffer, int, int", "int startTableOutBuffer, int, int, Loc, boolean, Ref<Slice<MarkdownDelimiter>>, Ref<IntSlice>", "boolean isKeywordBytePtr, int", "UnionExp CatType, Expression, Expression", "Expression eval_isfiniteLoc, FuncDeclaration, DArray<Expression>", "int comparePointersbyte, Expression, long, Expression, long", "boolean isDittoBytePtr", "void emplaceExpObject, Loc _param_1, Type _param_2NullExpLocType", "boolean isAssocArrayType", "boolean isSafePointerCastType, Type", "boolean numCmpbyte, double, doubleDouble", "void mangleToBufferDsymbol, OutBuffer", "void aliasSemanticAliasDeclaration, Scope", "Parameter isEponymousFunctionParameterDArray<Dsymbol>, BytePtr, int", "void emplaceExpObject, Loc _param_1, Type _param_2, DArray<Expression> _param_3ArrayLiteralExpLocTypeDArray<Expression>", "Expression assignAssocArrayElementLoc, AssocArrayLiteralExp, Expression, Expression", "void emplaceExpObject, Loc _param_1, IndexExp _param_2, Type _param_3AddrExpLocIndexExpType", "ByteSlice identifierMsgtable", "boolean ishexbyte", "void processFileByteSlice, ByteSlice, BytePtr_lex", "Expression eval_bswapLoc, FuncDeclaration, DArray<Expression>", "void vdeprecationLoc, BytePtr, Slice<Object>, BytePtr, BytePtr", "void setValueVarDeclaration, Expression", "void halt", "BytePtr mangleExactFuncDeclaration", "void emplaceExpObject, int _param_1IntegerExpInteger", "Expression eval_expm1Loc, FuncDeclaration, DArray<Expression>", "Dsymbol isDsymbolRootObject", "boolean isReservedNameByteSlice", "boolean hasProtectedAccessScope, Dsymbol", "void writeHighlightsConsole, OutBuffer", "boolean numCmpbyte, long, longLong", "Expression interpret_dupUnionExp, InterState, Expression", "Dsymbol getEponymousMemberTemplateDeclaration", "Expression eval_powLoc, FuncDeclaration, DArray<Expression>", "boolean hasValueVarDeclaration", "void templateInstanceSemanticTemplateInstance, Scope, DArray<Expression>", "Type getTypeRootObject", "Expression foreachApplyUtfUnionExp, InterState, Expression, Expression, boolean", "boolean includeImportedModuleCheckModuleComponentRange", "Expression eval_fmaLoc, FuncDeclaration, DArray<Expression>", "void sliceAssignArrayLiteralFromStringArrayLiteralExp, StringExp, int", "boolean writeMixinByteSlice, Loc", "void toDocBufferDsymbol, OutBuffer, Scope"]] signature: void emplaceExpObject, Loc _param_1, Declaration _param_2, long _param_3SymOffExpLocDeclarationLong
    ...
    // from template emplaceExp!(NullExpLocType)
    // removed duplicate function, [["Expression eval_yl2xp1Loc, FuncDeclaration, DArray<Expression>", "int skipPastIdentWithDotsOutBuffer, int", "boolean emitAnchorNameOutBuffer, Dsymbol, Scope, boolean", "TemplateParameter isTemplateParameterDArray<Dsymbol>, BytePtr, int", "void emplaceExpObject, Loc _param_1, double _param_2, Type _param_3RealExpLocDoubleType", "TypeAArray toBuiltinAATypeType", "Expression eval_isinfinityLoc, FuncDeclaration, DArray<Expression>", "boolean mergeCallSuperRef<Short>, short", "Expression eval_floorLoc, FuncDeclaration, DArray<Expression>", "UnionExp changeArrayLiteralLengthLoc, TypeArray, Expression, int, int", "ArrayLiteralExp createBlockDuplicatedArrayLiteralUnionExp, Loc, Type, Expression, int", "BytePtr stripLeadingNewlinesBytePtr", "void emplaceExpObject, byte _param_1CTFEExpByte", "void createMatchNodes", "UnionExp ArrayLengthType, Expression", "boolean checkAccessAggregateDeclaration, Loc, Scope, Dsymbol", "Expression resolveSliceExpression, UnionExp", "Expression getValueVarDeclaration", "boolean hasPackageAccessScope, Dsymbol", "boolean isFloatIntPaintType, Type", "int mainSlice<ByteSlice>", "void vmessageLoc, BytePtr, Slice<Object>", "boolean isValidManglingint", "int getAlignmentAlignDeclaration, Scope", "int arrayObjectHashDArray<RootObject>", "boolean numCmpbyte, int, intInteger", "boolean exceptionOrCantInterpretExpression", "ByteSlice lookForSourceFileByteSlice", "void showCtfeExprExpression, int", "void removeBlankLineMacroOutBuffer, IntRef, IntRef", "boolean isErrorRootObject", "void emitMemberCommentsScopeDsymbol, OutBuffer, Scope", "UnionExp ctfeCatLoc, Type, Expression, Expression", "void escapeDdocStringOutBuffer, int", "void deprecationLoc, BytePtr", "void messageLoc, BytePtr", "Parameter isFunctionParameterDArray<Dsymbol>, BytePtr, int", "short parseModulePatternDepthBytePtr", "void MODtoDecoBufferOutBuffer, byte", "UnionExp ModLoc, Type, Expression, Expression", "void emplaceExpObject, Loc _param_1, Object _param_2, int _param_3StringExpLocObjectInteger", "void emplaceExpObject, Loc _param_1, StructLiteralExp _param_2, Type _param_3ClassReferenceExpLocStructLiteralExpType", "Expression eval_tanLoc, FuncDeclaration, DArray<Expression>", "int skippastURLOutBuffer, int", "boolean isZeroSecondbyte", "Expression eval_copysignLoc, FuncDeclaration, DArray<Expression>", "Expression eval_log2Loc, FuncDeclaration, DArray<Expression>", "double creallcomplex_t", "void warningSupplementalLoc, BytePtr", "int deduceTypeRootObject, Scope, Type, DArray<TemplateParameter>, DArray<RootObject>, IntPtr, int, boolean", "Tuple isTupleRootObject", "Expression eval_truncLoc, FuncDeclaration, DArray<Expression>", "UnionExp DivLoc, Type, Expression, Expression", "void expandTemplateMixinCommentsTemplateMixin, OutBuffer, Scope", "Expression eval_sqrtLoc, FuncDeclaration, DArray<Expression>", "boolean lambdaCheckForNestedRefExpression, Scope", "void emplaceExpObject, Loc _param_1, complex_t _param_2, Type _param_3ComplexExpLoccomplex_tType", "void dsymbolSemanticDsymbol, Scope", "void cantExpUnionExp", "boolean pointToSameMemoryBlockExpression, Expression", "long getStorageClassPrefixAttributesASTBaseASTBase", "UnionExp ComType, Expression", "ByteSlice initializerMsgtable", "int specificCmpbyte, int", "void builtinDeinitialize", "boolean isDigitSecondbyte", "Scope skipNonQualScopesScope", "UnionExp MulLoc, Type, Expression, Expression", "int utfStrideBytePtr", "void verrorPrintLoc, int, BytePtr, BytePtr, Slice<Object>, BytePtr, BytePtr", "int ctfeCmpLoc, byte, Expression, Expression", "boolean isTrueBoolExpression", "void builtin_init", "Parameter isParameterRootObject", "void errorSupplementalLoc, BytePtr", "long resolveArrayLengthExpression", "Expression evaluateDtorInterState, Expression", "int foreachDsymbolDArray<Dsymbol>, Function1<Dsymbol,Integer>", "Expression interpret_lengthUnionExp, InterState, Expression", "Parameter isFunctionParameterDsymbol, BytePtr, int", "void emitProtectionOutBuffer, Import", "TemplateParameter isTemplateParameterRootObject", "boolean arrayObjectMatchDArray<RootObject>, DArray<RootObject>", "void emplaceExpObject, Loc _param_1, Type _param_2, Expression _param_3, DArray<Expression> _param_4ArrayLiteralExpLocTypeExpressionDArray<Expression>", "boolean reliesOnTemplateParametersExpression, Slice<TemplateParameter>", "int endAllMarkdownQuotesOutBuffer, int, IntRef", "boolean definitelyValueParameterExpression", "void emplaceExpObject, Loc _param_1, boolean _param_2, Type _param_3IntegerExpLocBooleanType", "boolean reliesOnTidentType, DArray<TemplateParameter>, int", "Expression eval_yl2xLoc, FuncDeclaration, DArray<Expression>", "void errorLoc, BytePtr", "boolean utf_isValidDcharint", "void fatal", "Expression evaluateIfBuiltinUnionExp, InterState, Loc, FuncDeclaration, DArray<Expression>, Expression", "UnionExp pointerDifferenceLoc, Type, Expression, Expression", "UnionExp NegType, Expression", "boolean isidcharbyte", "int utf_codeLengthWcharint", "Expression getValueRef<Dsymbol>", "Function3<Loc,FuncDeclaration,DArray<Expression>,Expression> builtin_lookupBytePtr", "BytePtr linkToCharsint", "Expression interpretStatement, InterState", "int isConstExpression", "Expression getExpressionRootObject", "void emitProtectionOutBuffer, Prot", "Expression ctfeIndexLoc, Type, Expression, long", "int utf_codeLengthint, int", "UnionExp SliceType, Expression, Expression, Expression", "void functionResolveMatchAccumulator, Dsymbol, Loc, Scope, DArray<RootObject>, Type, DArray<Expression>, Ptr<BytePtr>", "int intSignedCmpbyte, long, long", "int ctfeIdentityLoc, byte, Expression, Expression", "Expression ctfeInterpretForPragmaMsgExpression", "void emplaceExpObject, Loc _param_1, long _param_2, Type _param_3IntegerExpLocLongType", "boolean isUniAlphaint", "BytePtr skipwhitespaceBytePtr", "UnionExp Cmpbyte, Loc, Type, Expression, Expression", "Dsymbol mostVisibleOverloadDsymbol, Module", "UnionExp OrLoc, Type, Expression, Expression", "int sliceCmpStringWithArrayStringExp, ArrayLiteralExp, int, int, int", "boolean hasPackageAccessModule, Dsymbol", "CtorDeclaration generateCopyCtorDeclarationStructDeclaration, long, long", "void errorBytePtr, int, int, BytePtr", "void add_builtinBytePtr, Function3<Loc,FuncDeclaration,DArray<Expression>,Expression>", "UnionExp PtrType, Expression", "void utf_encodeWcharCharPtr, int", "boolean findConditionDArray<Identifier>, Identifier", "int ctfeRawCmpLoc, Expression, Expression, boolean", "UnionExp ShlLoc, Type, Expression, Expression", "void highlightTextScope, DArray<Dsymbol>, Loc, OutBuffer, int", "UnionExp voidInitLiteralType, VarDeclaration", "void gendocfileModule", "boolean isIdTailBytePtr", "UnionExp ShrLoc, Type, Expression, Expression", "int setMangleOverrideDsymbol, ByteSlice", "Dsymbol getDsymbolRootObject", "Expression eval_log10Loc, FuncDeclaration, DArray<Expression>", "Expression eval_expLoc, FuncDeclaration, DArray<Expression>", "Expression getAggregateFromPointerExpression, Ptr<Long>", "void emplaceExpObject, Loc _param_1, Expression _param_2, Expression _param_3IndexExpLocExpressionExpression", "Expression eval_fmaxLoc, FuncDeclaration, DArray<Expression>", "boolean isArrayExpression", "UnionExp CastLoc, Type, Type, Expression", "UnionExp IndexType, Expression, Expression", "void emitAnchorOutBuffer, Dsymbol, Scope, boolean", "void removeAnyAtxHeadingSuffixOutBuffer, int", "DArray<Expression> copyElementsExpression, Expression", "void assignInPlaceExpression, Expression", "TemplateDeclaration getEponymousParentDsymbol", "void utf_encodeint, Object, int", "boolean issinglecharbyte", "ByteSlice replaceCharByteSlice, byte, ByteSlice", "int getCodeIndentBytePtr", "boolean isIdentifierDArray<Dsymbol>, BytePtr, int", "BytePtr utf_decodeCharBytePtr, int, IntRef, IntRef", "void vwarningLoc, BytePtr, Slice<Object>", "boolean needToCopyLiteralExpression", "int sliceCmpStringWithStringStringExp, StringExp, int, int, int", "boolean isCtfeComparableExpression", "ByteSlice memdupByteSlice", "void mangleToBufferTemplateInstance, OutBuffer", "ByteSlice lexBytePtr, ByteSlice", "boolean isPointerType", "Expression findKeyInAALoc, AssocArrayLiteralExp, Expression", "int endTableOutBuffer, int, Ref<IntSlice>", "Expression scrubReturnValueLoc, Expression", "Type rawTypeMergeType, Type", "void emplaceExpObject, Loc _param_1, Expression _param_2, Type _param_3VectorExpLocExpressionType", "boolean buildCopyCtorStructDeclaration, Scope", "boolean reliesOnTemplateParametersType, Slice<TemplateParameter>", "int utf_codeLengthCharint", "void highlightCode3Scope, OutBuffer, BytePtr, BytePtr", "BytePtr getMessageDeprecatedDeclaration", "int endAllListsAndQuotesOutBuffer, IntRef, Ref<Slice<MarkdownList>>, IntRef, IntRef", "ByteSlice toLowercaseByteSlice", "Expression interpretFunctionUnionExp, FuncDeclaration, InterState, DArray<Expression>, Expression", "Expression interpret_valuesUnionExp, InterState, Expression, Type", "Expression eval_roundLoc, FuncDeclaration, DArray<Expression>", "boolean modifyFieldVarLoc, Scope, VarDeclaration, Expression", "void deprecationSupplementalLoc, BytePtr", "Expression eval_ldexpLoc, FuncDeclaration, DArray<Expression>", "int extractArgNByteSlice, Ref<ByteSlice>, int", "UnionExp UshrLoc, Type, Expression, Expression", "Expression interpret_keysUnionExp, InterState, Expression, Type", "UnionExp Identitybyte, Loc, Type, Expression, Expression", "void vwarningSupplementalLoc, BytePtr, Slice<Object>", "BytePtr modToCharsint", "boolean checkSymbolAccessScope, Dsymbol", "Expression toDelegateExpression, Type, Scope", "UnionExp PowLoc, Type, Expression, Expression", "int isattyint", "Expression scrubCacheValueExpression", "int findFieldIndexByNameStructDeclaration, VarDeclaration", "boolean replaceMarkdownThematicBreakOutBuffer, IntRef, int, Loc", "RootObject objectSyntaxCopyRootObject", "int ctfeEqualLoc, byte, Expression, Expression", "void emplaceExpObject, Loc _param_1, Declaration _param_2, long _param_3SymOffExpLocDeclarationLong", "FuncDeclaration buildPostBlitStructDeclaration, Scope", "int skipCharsOutBuffer, int, ByteSlice", "Statement generateCopyCtorBodyStructDeclaration", "void sliceAssignStringFromArrayLiteralStringExp, ArrayLiteralExp, int", "int expressionHashExpression", "boolean ensureStaticLinkToDsymbol, Dsymbol", "DArray<Expression> copyLiteralArrayDArray<Expression>, Expression", "int templateParameterLookupType, DArray<TemplateParameter>", "boolean symbolIsVisibleDsymbol, Dsymbol", "boolean c_isalnumint", "void tyToDecoBufferOutBuffer, int", "void emplaceExpObject, Loc _param_1, StructDeclaration _param_2, DArray<Expression> _param_3StructLiteralExpLocStructDeclarationDArray<Expression>", "void ObjectNotFoundIdentifier", "boolean isCVariadicParameterDArray<Dsymbol>, ByteSlice", "void mangleToFuncSignatureOutBuffer, FuncDeclaration", "void colorHighlightCodeOutBuffer", "boolean symbolIsVisibleScope, Dsymbol", "void emplaceExpObject, Loc _param_1, TypeSArray _param_2, DArray<Expression> _param_3ArrayLiteralExpLocTypeSArrayDArray<Expression>", "void warningLoc, BytePtr", "UnionExp BoolType, Expression", "StringExp createBlockDuplicatedStringLiteralUnionExp, Loc, Type, int, int, byte", "void colorSyntaxHighlightOutBuffer", "Expression paintTypeOntoLiteralType, Expression", "void endMarkdownHeadingOutBuffer, int, IntRef, Loc, IntRef", "int endRowAndTableOutBuffer, int, int, Loc, Ref<Slice<MarkdownDelimiter>>, Ref<IntSlice>", "boolean isoctalbyte", "void unSpeculativeScope, RootObject", "Expression eval_fminLoc, FuncDeclaration, DArray<Expression>", "boolean arrayObjectIsErrorDArray<RootObject>", "long getStorageClassPrefixAttributesASTCodegenASTCodegen", "boolean isSpecialEnumIdentIdentifier", "int skiptoidentOutBuffer, int", "int deduceTypeHelperType, Ptr<Type>, Type", "boolean mergeFieldInitRef<Short>, short", "void foreachDsymbolDArray<Dsymbol>, Function1<Dsymbol,Void>", "Expression interpretUnionExp, Expression, InterState, int", "UnionExp AddLoc, Type, Expression, Expression", "Expression isExpressionRootObject", "void emplaceExpObject, Loc _param_1, Expression _param_2, IntegerExp _param_3, Expression _param_4SliceExpLocExpressionIntegerExpExpression", "int parseTableDelimiterRowOutBuffer, int, boolean, Ref<IntSlice>", "int skippastidentOutBuffer, int", "UnionExp XorLoc, Type, Expression, Expression", "int realCmpbyte, double, double", "boolean isCVariadicArgByteSlice", "boolean isCtfeValueValidExpression", "UnionExp MinLoc, Type, Expression, Expression", "Expression eval_bsrLoc, FuncDeclaration, DArray<Expression>", "void semanticTypeInfoScope, Type", "void highlightCodeScope, Dsymbol, OutBuffer, int", "Expression eval_logLoc, FuncDeclaration, DArray<Expression>", "Expression eval_cosLoc, FuncDeclaration, DArray<Expression>", "boolean allowsContractWithoutBodyFuncDeclaration", "double cimaglcomplex_t", "int replaceTableRowOutBuffer, int, int, Loc, Ref<Slice<MarkdownDelimiter>>, IntSlice, boolean", "void verrorLoc, BytePtr, Slice<Object>, BytePtr, BytePtr, BytePtr", "UnionExp AndLoc, Type, Expression, Expression", "boolean _isZeroInitExpression", "boolean checkAccessLoc, Scope, Package", "Expression eval_ceilLoc, FuncDeclaration, DArray<Expression>", "boolean isCtfeReferenceValidExpression", "boolean checkFrameAccessLoc, Scope, AggregateDeclaration, int", "Expression ctfeInterpretExpression", "int ctfeCmpArraysLoc, Expression, Expression, long", "boolean isTypeInfo_ClassType", "byte deduceWildHelperType, Ptr<Type>, Type", "boolean isIndentWSBytePtr", "Expression evaluatePostblitInterState, Expression", "void verrorSupplementalLoc, BytePtr, Slice<Object>", "boolean checkAccessLoc, Scope, Expression, Declaration", "FuncDeclaration search_toStringStructDeclaration", "Expression eval_sinLoc, FuncDeclaration, DArray<Expression>", "UnionExp Equalbyte, Loc, Type, Expression, Expression", "void emplaceExpObject, Loc _param_1, Expression _param_2, TypeVector _param_3VectorExpLocExpressionTypeVector", "int replaceMarkdownEmphasisOutBuffer, Loc, Ref<Slice<MarkdownDelimiter>>, int", "void emplaceExpObject, Loc _param_1, Object _param_2, int _param_3, byte _param_4StringExpLocObjectIntegerByte", "ByteSlice generateSlice<Msgtable>, Function1<Msgtable,ByteSlice>", "void processFileByteSlice, ByteSlice, BytePtr_lispy", "Expression eval_popcntLoc, FuncDeclaration, DArray<Expression>", "Expression eval_bsfLoc, FuncDeclaration, DArray<Expression>", "void setValueWithoutCheckingVarDeclaration, Expression", "void mangleToBufferType, OutBuffer", "int isBuiltinFuncDeclaration", "Expression paintFloatIntUnionExp, Expression, Type", "void sliceAssignStringFromStringStringExp, StringExp, int", "Expression paintTypeOntoLiteralUnionExp, Type, Expression", "boolean symbolIsVisibleModule, Dsymbol", "void ctfeCompileFuncDeclaration", "Expression eval_fabsLoc, FuncDeclaration, DArray<Expression>", "void printCtfePerformanceStats", "void highlightCodeScope, DArray<Dsymbol>, OutBuffer, int", "ByteSlice getFilenameDArray<Identifier>, Identifier", "Expression interpretExpression, InterState, int", "Expression getValueExpression", "void messageBytePtr", "Expression eval_isnanLoc, FuncDeclaration, DArray<Expression>", "Expression ctfeCastUnionExp, Loc, Type, Type, Expression", "UnionExp NotType, Expression", "void escapeStrayParenthesisLoc, OutBuffer, int, boolean", "void lambdaSetParentExpression, FuncDeclaration", "boolean isIdStartBytePtr", "int intUnsignedCmpbyte, long, long", "void emplaceExpObject, Loc _param_1, int _param_2, Type _param_3IntegerExpLocIntegerType", "UnionExp pointerArithmeticLoc, byte, Type, Expression, Expression", "void emitProtectionOutBuffer, Declaration", "int templateIdentifierLookupIdentifier, DArray<TemplateParameter>", "ByteSlice lispyBytePtr, ByteSlice", "boolean walkPostorderExpression, StoppableVisitor", "TypeFunction isTypeFunctionDsymbol", "void printDepsConditionalScope, DVCondition, ByteSlice", "Expression expTypeType, Expression", "Expression resolveAliasThisScope, Expression, boolean", "int detectAtxHeadingLevelOutBuffer, int", "Type isTypeRootObject", "Expression eval_builtinLoc, FuncDeclaration, DArray<Expression>", "boolean c_isxdigitint", "BytePtr utf_decodeWcharCharPtr, int, IntRef, IntRef", "Expression interpretUnionExp, Statement, InterState", "ByteSlice deinitializerMsgtable", "Expression eval_unimpLoc, FuncDeclaration, DArray<Expression>", "void utf_encodeCharBytePtr, int", "void semantic3OnDependenciesModule", "UnionExp copyLiteralExpression", "UnionExp paintTypeOntoLiteralCopyType, Expression", "Expression interpret_aaApplyUnionExp, InterState, Expression, Expression", "void emitCommentDsymbol, OutBuffer, Scope", "ByteSlice skipwhitespaceByteSlice", "void vdeprecationSupplementalLoc, BytePtr, Slice<Object>", "void highlightCode2Scope, DArray<Dsymbol>, OutBuffer, int", "FuncDeclaration funcptrOfExpression", "void parseModulePatternBytePtr, MatcherNode, short", "void mangleToBufferExpression, OutBuffer", "boolean matchRootObject, RootObject", "Expression eval_exp2Loc, FuncDeclaration, DArray<Expression>", "int getMarkdownIndentOutBuffer, int, int", "int startTableOutBuffer, int, int, Loc, boolean, Ref<Slice<MarkdownDelimiter>>, Ref<IntSlice>", "boolean isKeywordBytePtr, int", "UnionExp CatType, Expression, Expression", "Expression eval_isfiniteLoc, FuncDeclaration, DArray<Expression>", "int comparePointersbyte, Expression, long, Expression, long", "boolean isDittoBytePtr", "void emplaceExpObject, Loc _param_1, Type _param_2NullExpLocType", "boolean isAssocArrayType", "boolean isSafePointerCastType, Type", "boolean numCmpbyte, double, doubleDouble", "void mangleToBufferDsymbol, OutBuffer", "void aliasSemanticAliasDeclaration, Scope", "Parameter isEponymousFunctionParameterDArray<Dsymbol>, BytePtr, int", "void emplaceExpObject, Loc _param_1, Type _param_2, DArray<Expression> _param_3ArrayLiteralExpLocTypeDArray<Expression>", "Expression assignAssocArrayElementLoc, AssocArrayLiteralExp, Expression, Expression", "void emplaceExpObject, Loc _param_1, IndexExp _param_2, Type _param_3AddrExpLocIndexExpType", "ByteSlice identifierMsgtable", "boolean ishexbyte", "void processFileByteSlice, ByteSlice, BytePtr_lex", "Expression eval_bswapLoc, FuncDeclaration, DArray<Expression>", "void vdeprecationLoc, BytePtr, Slice<Object>, BytePtr, BytePtr", "void setValueVarDeclaration, Expression", "void halt", "BytePtr mangleExactFuncDeclaration", "void emplaceExpObject, int _param_1IntegerExpInteger", "Expression eval_expm1Loc, FuncDeclaration, DArray<Expression>", "Dsymbol isDsymbolRootObject", "boolean isReservedNameByteSlice", "boolean hasProtectedAccessScope, Dsymbol", "void writeHighlightsConsole, OutBuffer", "boolean numCmpbyte, long, longLong", "Expression interpret_dupUnionExp, InterState, Expression", "Dsymbol getEponymousMemberTemplateDeclaration", "Expression eval_powLoc, FuncDeclaration, DArray<Expression>", "boolean hasValueVarDeclaration", "void templateInstanceSemanticTemplateInstance, Scope, DArray<Expression>", "Type getTypeRootObject", "Expression foreachApplyUtfUnionExp, InterState, Expression, Expression, boolean", "boolean includeImportedModuleCheckModuleComponentRange", "Expression eval_fmaLoc, FuncDeclaration, DArray<Expression>", "void sliceAssignArrayLiteralFromStringArrayLiteralExp, StringExp, int", "boolean writeMixinByteSlice, Loc", "void toDocBufferDsymbol, OutBuffer, Scope"]] signature: void emplaceExpObject, Loc _param_1, Type _param_2NullExpLocType
    ...
    // from template emplaceExp!(IntegerExpLocBooleanType)
    // removed duplicate function, [["Expression eval_yl2xp1Loc, FuncDeclaration, DArray<Expression>", "int skipPastIdentWithDotsOutBuffer, int", "boolean emitAnchorNameOutBuffer, Dsymbol, Scope, boolean", "TemplateParameter isTemplateParameterDArray<Dsymbol>, BytePtr, int", "void emplaceExpObject, Loc _param_1, double _param_2, Type _param_3RealExpLocDoubleType", "TypeAArray toBuiltinAATypeType", "Expression eval_isinfinityLoc, FuncDeclaration, DArray<Expression>", "boolean mergeCallSuperRef<Short>, short", "Expression eval_floorLoc, FuncDeclaration, DArray<Expression>", "UnionExp changeArrayLiteralLengthLoc, TypeArray, Expression, int, int", "ArrayLiteralExp createBlockDuplicatedArrayLiteralUnionExp, Loc, Type, Expression, int", "BytePtr stripLeadingNewlinesBytePtr", "void emplaceExpObject, byte _param_1CTFEExpByte", "void createMatchNodes", "UnionExp ArrayLengthType, Expression", "boolean checkAccessAggregateDeclaration, Loc, Scope, Dsymbol", "Expression resolveSliceExpression, UnionExp", "Expression getValueVarDeclaration", "boolean hasPackageAccessScope, Dsymbol", "boolean isFloatIntPaintType, Type", "int mainSlice<ByteSlice>", "void vmessageLoc, BytePtr, Slice<Object>", "boolean isValidManglingint", "int getAlignmentAlignDeclaration, Scope", "int arrayObjectHashDArray<RootObject>", "boolean numCmpbyte, int, intInteger", "boolean exceptionOrCantInterpretExpression", "ByteSlice lookForSourceFileByteSlice", "void showCtfeExprExpression, int", "void removeBlankLineMacroOutBuffer, IntRef, IntRef", "boolean isErrorRootObject", "void emitMemberCommentsScopeDsymbol, OutBuffer, Scope", "UnionExp ctfeCatLoc, Type, Expression, Expression", "void escapeDdocStringOutBuffer, int", "void deprecationLoc, BytePtr", "void messageLoc, BytePtr", "Parameter isFunctionParameterDArray<Dsymbol>, BytePtr, int", "short parseModulePatternDepthBytePtr", "void MODtoDecoBufferOutBuffer, byte", "UnionExp ModLoc, Type, Expression, Expression", "void emplaceExpObject, Loc _param_1, Object _param_2, int _param_3StringExpLocObjectInteger", "void emplaceExpObject, Loc _param_1, StructLiteralExp _param_2, Type _param_3ClassReferenceExpLocStructLiteralExpType", "Expression eval_tanLoc, FuncDeclaration, DArray<Expression>", "int skippastURLOutBuffer, int", "boolean isZeroSecondbyte", "Expression eval_copysignLoc, FuncDeclaration, DArray<Expression>", "Expression eval_log2Loc, FuncDeclaration, DArray<Expression>", "double creallcomplex_t", "void warningSupplementalLoc, BytePtr", "int deduceTypeRootObject, Scope, Type, DArray<TemplateParameter>, DArray<RootObject>, IntPtr, int, boolean", "Tuple isTupleRootObject", "Expression eval_truncLoc, FuncDeclaration, DArray<Expression>", "UnionExp DivLoc, Type, Expression, Expression", "void expandTemplateMixinCommentsTemplateMixin, OutBuffer, Scope", "Expression eval_sqrtLoc, FuncDeclaration, DArray<Expression>", "boolean lambdaCheckForNestedRefExpression, Scope", "void emplaceExpObject, Loc _param_1, complex_t _param_2, Type _param_3ComplexExpLoccomplex_tType", "void dsymbolSemanticDsymbol, Scope", "void cantExpUnionExp", "boolean pointToSameMemoryBlockExpression, Expression", "long getStorageClassPrefixAttributesASTBaseASTBase", "UnionExp ComType, Expression", "ByteSlice initializerMsgtable", "int specificCmpbyte, int", "void builtinDeinitialize", "boolean isDigitSecondbyte", "Scope skipNonQualScopesScope", "UnionExp MulLoc, Type, Expression, Expression", "int utfStrideBytePtr", "void verrorPrintLoc, int, BytePtr, BytePtr, Slice<Object>, BytePtr, BytePtr", "int ctfeCmpLoc, byte, Expression, Expression", "boolean isTrueBoolExpression", "void builtin_init", "Parameter isParameterRootObject", "void errorSupplementalLoc, BytePtr", "long resolveArrayLengthExpression", "Expression evaluateDtorInterState, Expression", "int foreachDsymbolDArray<Dsymbol>, Function1<Dsymbol,Integer>", "Expression interpret_lengthUnionExp, InterState, Expression", "Parameter isFunctionParameterDsymbol, BytePtr, int", "void emitProtectionOutBuffer, Import", "TemplateParameter isTemplateParameterRootObject", "boolean arrayObjectMatchDArray<RootObject>, DArray<RootObject>", "void emplaceExpObject, Loc _param_1, Type _param_2, Expression _param_3, DArray<Expression> _param_4ArrayLiteralExpLocTypeExpressionDArray<Expression>", "boolean reliesOnTemplateParametersExpression, Slice<TemplateParameter>", "int endAllMarkdownQuotesOutBuffer, int, IntRef", "boolean definitelyValueParameterExpression", "void emplaceExpObject, Loc _param_1, boolean _param_2, Type _param_3IntegerExpLocBooleanType", "boolean reliesOnTidentType, DArray<TemplateParameter>, int", "Expression eval_yl2xLoc, FuncDeclaration, DArray<Expression>", "void errorLoc, BytePtr", "boolean utf_isValidDcharint", "void fatal", "Expression evaluateIfBuiltinUnionExp, InterState, Loc, FuncDeclaration, DArray<Expression>, Expression", "UnionExp pointerDifferenceLoc, Type, Expression, Expression", "UnionExp NegType, Expression", "boolean isidcharbyte", "int utf_codeLengthWcharint", "Expression getValueRef<Dsymbol>", "Function3<Loc,FuncDeclaration,DArray<Expression>,Expression> builtin_lookupBytePtr", "BytePtr linkToCharsint", "Expression interpretStatement, InterState", "int isConstExpression", "Expression getExpressionRootObject", "void emitProtectionOutBuffer, Prot", "Expression ctfeIndexLoc, Type, Expression, long", "int utf_codeLengthint, int", "UnionExp SliceType, Expression, Expression, Expression", "void functionResolveMatchAccumulator, Dsymbol, Loc, Scope, DArray<RootObject>, Type, DArray<Expression>, Ptr<BytePtr>", "int intSignedCmpbyte, long, long", "int ctfeIdentityLoc, byte, Expression, Expression", "Expression ctfeInterpretForPragmaMsgExpression", "void emplaceExpObject, Loc _param_1, long _param_2, Type _param_3IntegerExpLocLongType", "boolean isUniAlphaint", "BytePtr skipwhitespaceBytePtr", "UnionExp Cmpbyte, Loc, Type, Expression, Expression", "Dsymbol mostVisibleOverloadDsymbol, Module", "UnionExp OrLoc, Type, Expression, Expression", "int sliceCmpStringWithArrayStringExp, ArrayLiteralExp, int, int, int", "boolean hasPackageAccessModule, Dsymbol", "CtorDeclaration generateCopyCtorDeclarationStructDeclaration, long, long", "void errorBytePtr, int, int, BytePtr", "void add_builtinBytePtr, Function3<Loc,FuncDeclaration,DArray<Expression>,Expression>", "UnionExp PtrType, Expression", "void utf_encodeWcharCharPtr, int", "boolean findConditionDArray<Identifier>, Identifier", "int ctfeRawCmpLoc, Expression, Expression, boolean", "UnionExp ShlLoc, Type, Expression, Expression", "void highlightTextScope, DArray<Dsymbol>, Loc, OutBuffer, int", "UnionExp voidInitLiteralType, VarDeclaration", "void gendocfileModule", "boolean isIdTailBytePtr", "UnionExp ShrLoc, Type, Expression, Expression", "int setMangleOverrideDsymbol, ByteSlice", "Dsymbol getDsymbolRootObject", "Expression eval_log10Loc, FuncDeclaration, DArray<Expression>", "Expression eval_expLoc, FuncDeclaration, DArray<Expression>", "Expression getAggregateFromPointerExpression, Ptr<Long>", "void emplaceExpObject, Loc _param_1, Expression _param_2, Expression _param_3IndexExpLocExpressionExpression", "Expression eval_fmaxLoc, FuncDeclaration, DArray<Expression>", "boolean isArrayExpression", "UnionExp CastLoc, Type, Type, Expression", "UnionExp IndexType, Expression, Expression", "void emitAnchorOutBuffer, Dsymbol, Scope, boolean", "void removeAnyAtxHeadingSuffixOutBuffer, int", "DArray<Expression> copyElementsExpression, Expression", "void assignInPlaceExpression, Expression", "TemplateDeclaration getEponymousParentDsymbol", "void utf_encodeint, Object, int", "boolean issinglecharbyte", "ByteSlice replaceCharByteSlice, byte, ByteSlice", "int getCodeIndentBytePtr", "boolean isIdentifierDArray<Dsymbol>, BytePtr, int", "BytePtr utf_decodeCharBytePtr, int, IntRef, IntRef", "void vwarningLoc, BytePtr, Slice<Object>", "boolean needToCopyLiteralExpression", "int sliceCmpStringWithStringStringExp, StringExp, int, int, int", "boolean isCtfeComparableExpression", "ByteSlice memdupByteSlice", "void mangleToBufferTemplateInstance, OutBuffer", "ByteSlice lexBytePtr, ByteSlice", "boolean isPointerType", "Expression findKeyInAALoc, AssocArrayLiteralExp, Expression", "int endTableOutBuffer, int, Ref<IntSlice>", "Expression scrubReturnValueLoc, Expression", "Type rawTypeMergeType, Type", "void emplaceExpObject, Loc _param_1, Expression _param_2, Type _param_3VectorExpLocExpressionType", "boolean buildCopyCtorStructDeclaration, Scope", "boolean reliesOnTemplateParametersType, Slice<TemplateParameter>", "int utf_codeLengthCharint", "void highlightCode3Scope, OutBuffer, BytePtr, BytePtr", "BytePtr getMessageDeprecatedDeclaration", "int endAllListsAndQuotesOutBuffer, IntRef, Ref<Slice<MarkdownList>>, IntRef, IntRef", "ByteSlice toLowercaseByteSlice", "Expression interpretFunctionUnionExp, FuncDeclaration, InterState, DArray<Expression>, Expression", "Expression interpret_valuesUnionExp, InterState, Expression, Type", "Expression eval_roundLoc, FuncDeclaration, DArray<Expression>", "void emplaceExpObject, Loc _param_1, Expression _param_2, Expression _param_3, Expression _param_4SliceExpLocExpressionExpressionExpression", "boolean modifyFieldVarLoc, Scope, VarDeclaration, Expression", "void deprecationSupplementalLoc, BytePtr", "Expression eval_ldexpLoc, FuncDeclaration, DArray<Expression>", "int extractArgNByteSlice, Ref<ByteSlice>, int", "UnionExp UshrLoc, Type, Expression, Expression", "Expression interpret_keysUnionExp, InterState, Expression, Type", "UnionExp Identitybyte, Loc, Type, Expression, Expression", "void vwarningSupplementalLoc, BytePtr, Slice<Object>", "BytePtr modToCharsint", "boolean checkSymbolAccessScope, Dsymbol", "Expression toDelegateExpression, Type, Scope", "UnionExp PowLoc, Type, Expression, Expression", "int isattyint", "Expression scrubCacheValueExpression", "int findFieldIndexByNameStructDeclaration, VarDeclaration", "boolean replaceMarkdownThematicBreakOutBuffer, IntRef, int, Loc", "RootObject objectSyntaxCopyRootObject", "int ctfeEqualLoc, byte, Expression, Expression", "void emplaceExpObject, Loc _param_1, Object _param_2, DArray<Expression> _param_3ArrayLiteralExpLocObjectDArray<Expression>", "void emplaceExpObject, Loc _param_1, Declaration _param_2, long _param_3SymOffExpLocDeclarationLong", "FuncDeclaration buildPostBlitStructDeclaration, Scope", "int skipCharsOutBuffer, int, ByteSlice", "Statement generateCopyCtorBodyStructDeclaration", "void sliceAssignStringFromArrayLiteralStringExp, ArrayLiteralExp, int", "int expressionHashExpression", "boolean ensureStaticLinkToDsymbol, Dsymbol", "DArray<Expression> copyLiteralArrayDArray<Expression>, Expression", "int templateParameterLookupType, DArray<TemplateParameter>", "boolean symbolIsVisibleDsymbol, Dsymbol", "boolean c_isalnumint", "void tyToDecoBufferOutBuffer, int", "void emplaceExpObject, Loc _param_1, StructDeclaration _param_2, DArray<Expression> _param_3StructLiteralExpLocStructDeclarationDArray<Expression>", "void ObjectNotFoundIdentifier", "boolean isCVariadicParameterDArray<Dsymbol>, ByteSlice", "void mangleToFuncSignatureOutBuffer, FuncDeclaration", "void colorHighlightCodeOutBuffer", "boolean symbolIsVisibleScope, Dsymbol", "void emplaceExpObject, Loc _param_1, TypeSArray _param_2, DArray<Expression> _param_3ArrayLiteralExpLocTypeSArrayDArray<Expression>", "void warningLoc, BytePtr", "UnionExp BoolType, Expression", "StringExp createBlockDuplicatedStringLiteralUnionExp, Loc, Type, int, int, byte", "void colorSyntaxHighlightOutBuffer", "Expression paintTypeOntoLiteralType, Expression", "void endMarkdownHeadingOutBuffer, int, IntRef, Loc, IntRef", "int endRowAndTableOutBuffer, int, int, Loc, Ref<Slice<MarkdownDelimiter>>, Ref<IntSlice>", "boolean isoctalbyte", "void unSpeculativeScope, RootObject", "Expression eval_fminLoc, FuncDeclaration, DArray<Expression>", "boolean arrayObjectIsErrorDArray<RootObject>", "long getStorageClassPrefixAttributesASTCodegenASTCodegen", "boolean isSpecialEnumIdentIdentifier", "int skiptoidentOutBuffer, int", "int deduceTypeHelperType, Ptr<Type>, Type", "boolean mergeFieldInitRef<Short>, short", "void foreachDsymbolDArray<Dsymbol>, Function1<Dsymbol,Void>", "Expression interpretUnionExp, Expression, InterState, int", "UnionExp AddLoc, Type, Expression, Expression", "Expression isExpressionRootObject", "void emplaceExpObject, Loc _param_1, Expression _param_2, IntegerExp _param_3, Expression _param_4SliceExpLocExpressionIntegerExpExpression", "int parseTableDelimiterRowOutBuffer, int, boolean, Ref<IntSlice>", "int skippastidentOutBuffer, int", "UnionExp XorLoc, Type, Expression, Expression", "int realCmpbyte, double, double", "boolean isCVariadicArgByteSlice", "boolean isCtfeValueValidExpression", "UnionExp MinLoc, Type, Expression, Expression", "Expression eval_bsrLoc, FuncDeclaration, DArray<Expression>", "void semanticTypeInfoScope, Type", "void highlightCodeScope, Dsymbol, OutBuffer, int", "Expression eval_logLoc, FuncDeclaration, DArray<Expression>", "Expression eval_cosLoc, FuncDeclaration, DArray<Expression>", "boolean allowsContractWithoutBodyFuncDeclaration", "double cimaglcomplex_t", "int replaceTableRowOutBuffer, int, int, Loc, Ref<Slice<MarkdownDelimiter>>, IntSlice, boolean", "void verrorLoc, BytePtr, Slice<Object>, BytePtr, BytePtr, BytePtr", "UnionExp AndLoc, Type, Expression, Expression", "boolean _isZeroInitExpression", "boolean checkAccessLoc, Scope, Package", "Expression eval_ceilLoc, FuncDeclaration, DArray<Expression>", "boolean isCtfeReferenceValidExpression", "boolean checkFrameAccessLoc, Scope, AggregateDeclaration, int", "Expression ctfeInterpretExpression", "int ctfeCmpArraysLoc, Expression, Expression, long", "boolean isTypeInfo_ClassType", "byte deduceWildHelperType, Ptr<Type>, Type", "boolean isIndentWSBytePtr", "Expression evaluatePostblitInterState, Expression", "void verrorSupplementalLoc, BytePtr, Slice<Object>", "boolean checkAccessLoc, Scope, Expression, Declaration", "FuncDeclaration search_toStringStructDeclaration", "Expression eval_sinLoc, FuncDeclaration, DArray<Expression>", "UnionExp Equalbyte, Loc, Type, Expression, Expression", "void emplaceExpObject, Loc _param_1, Expression _param_2, TypeVector _param_3VectorExpLocExpressionTypeVector", "int replaceMarkdownEmphasisOutBuffer, Loc, Ref<Slice<MarkdownDelimiter>>, int", "void emplaceExpObject, Loc _param_1, Object _param_2, int _param_3, byte _param_4StringExpLocObjectIntegerByte", "ByteSlice generateSlice<Msgtable>, Function1<Msgtable,ByteSlice>", "void emplaceExpObject, Loc _param_1, DArray<Expression> _param_2TupleExpLocDArray<Expression>", "void processFileByteSlice, ByteSlice, BytePtr_lispy", "Expression eval_popcntLoc, FuncDeclaration, DArray<Expression>", "Expression eval_bsfLoc, FuncDeclaration, DArray<Expression>", "void setValueWithoutCheckingVarDeclaration, Expression", "void mangleToBufferType, OutBuffer", "int isBuiltinFuncDeclaration", "Expression paintFloatIntUnionExp, Expression, Type", "void sliceAssignStringFromStringStringExp, StringExp, int", "Expression paintTypeOntoLiteralUnionExp, Type, Expression", "boolean symbolIsVisibleModule, Dsymbol", "void ctfeCompileFuncDeclaration", "Expression eval_fabsLoc, FuncDeclaration, DArray<Expression>", "void printCtfePerformanceStats", "void highlightCodeScope, DArray<Dsymbol>, OutBuffer, int", "ByteSlice getFilenameDArray<Identifier>, Identifier", "Expression interpretExpression, InterState, int", "Expression getValueExpression", "void messageBytePtr", "Expression eval_isnanLoc, FuncDeclaration, DArray<Expression>", "Expression ctfeCastUnionExp, Loc, Type, Type, Expression", "UnionExp NotType, Expression", "void escapeStrayParenthesisLoc, OutBuffer, int, boolean", "void lambdaSetParentExpression, FuncDeclaration", "boolean isIdStartBytePtr", "int intUnsignedCmpbyte, long, long", "void emplaceExpObject, Loc _param_1, int _param_2, Type _param_3IntegerExpLocIntegerType", "UnionExp pointerArithmeticLoc, byte, Type, Expression, Expression", "void emitProtectionOutBuffer, Declaration", "int templateIdentifierLookupIdentifier, DArray<TemplateParameter>", "ByteSlice lispyBytePtr, ByteSlice", "boolean walkPostorderExpression, StoppableVisitor", "TypeFunction isTypeFunctionDsymbol", "void printDepsConditionalScope, DVCondition, ByteSlice", "Expression expTypeType, Expression", "Expression resolveAliasThisScope, Expression, boolean", "int detectAtxHeadingLevelOutBuffer, int", "Type isTypeRootObject", "Expression eval_builtinLoc, FuncDeclaration, DArray<Expression>", "boolean c_isxdigitint", "BytePtr utf_decodeWcharCharPtr, int, IntRef, IntRef", "Expression interpretUnionExp, Statement, InterState", "ByteSlice deinitializerMsgtable", "Expression eval_unimpLoc, FuncDeclaration, DArray<Expression>", "void utf_encodeCharBytePtr, int", "void semantic3OnDependenciesModule", "UnionExp copyLiteralExpression", "UnionExp paintTypeOntoLiteralCopyType, Expression", "Expression interpret_aaApplyUnionExp, InterState, Expression, Expression", "void emitCommentDsymbol, OutBuffer, Scope", "void emplaceExpObject, Loc _param_1, VarExp _param_2, Type _param_3AddrExpLocVarExpType", "ByteSlice skipwhitespaceByteSlice", "void vdeprecationSupplementalLoc, BytePtr, Slice<Object>", "void highlightCode2Scope, DArray<Dsymbol>, OutBuffer, int", "FuncDeclaration funcptrOfExpression", "void emplaceExpObject, Loc _param_1, DArray<Expression> _param_2, DArray<Expression> _param_3AssocArrayLiteralExpLocDArray<Expression>DArray<Expression>", "void parseModulePatternBytePtr, MatcherNode, short", "void mangleToBufferExpression, OutBuffer", "boolean matchRootObject, RootObject", "Expression eval_exp2Loc, FuncDeclaration, DArray<Expression>", "int getMarkdownIndentOutBuffer, int, int", "int startTableOutBuffer, int, int, Loc, boolean, Ref<Slice<MarkdownDelimiter>>, Ref<IntSlice>", "boolean isKeywordBytePtr, int", "UnionExp CatType, Expression, Expression", "Expression eval_isfiniteLoc, FuncDeclaration, DArray<Expression>", "int comparePointersbyte, Expression, long, Expression, long", "boolean isDittoBytePtr", "void emplaceExpObject, Loc _param_1, Type _param_2NullExpLocType", "boolean isAssocArrayType", "boolean isSafePointerCastType, Type", "boolean numCmpbyte, double, doubleDouble", "void mangleToBufferDsymbol, OutBuffer", "void aliasSemanticAliasDeclaration, Scope", "Parameter isEponymousFunctionParameterDArray<Dsymbol>, BytePtr, int", "void emplaceExpObject, Loc _param_1, Type _param_2, DArray<Expression> _param_3ArrayLiteralExpLocTypeDArray<Expression>", "Expression assignAssocArrayElementLoc, AssocArrayLiteralExp, Expression, Expression", "void emplaceExpObject, Loc _param_1, IndexExp _param_2, Type _param_3AddrExpLocIndexExpType", "ByteSlice identifierMsgtable", "boolean ishexbyte", "void processFileByteSlice, ByteSlice, BytePtr_lex", "Expression eval_bswapLoc, FuncDeclaration, DArray<Expression>", "void vdeprecationLoc, BytePtr, Slice<Object>, BytePtr, BytePtr", "void setValueVarDeclaration, Expression", "void halt", "BytePtr mangleExactFuncDeclaration", "void emplaceExpObject, int _param_1IntegerExpInteger", "Expression eval_expm1Loc, FuncDeclaration, DArray<Expression>", "Dsymbol isDsymbolRootObject", "boolean isReservedNameByteSlice", "boolean hasProtectedAccessScope, Dsymbol", "void writeHighlightsConsole, OutBuffer", "boolean numCmpbyte, long, longLong", "Expression interpret_dupUnionExp, InterState, Expression", "Dsymbol getEponymousMemberTemplateDeclaration", "Expression eval_powLoc, FuncDeclaration, DArray<Expression>", "boolean hasValueVarDeclaration", "void templateInstanceSemanticTemplateInstance, Scope, DArray<Expression>", "Type getTypeRootObject", "Expression foreachApplyUtfUnionExp, InterState, Expression, Expression, boolean", "boolean includeImportedModuleCheckModuleComponentRange", "Expression eval_fmaLoc, FuncDeclaration, DArray<Expression>", "void sliceAssignArrayLiteralFromStringArrayLiteralExp, StringExp, int", "boolean writeMixinByteSlice, Loc", "void toDocBufferDsymbol, OutBuffer, Scope"]] signature: void emplaceExpObject, Loc _param_1, boolean _param_2, Type _param_3IntegerExpLocBooleanType
    ...
    // from template emplaceExp!(IntegerExpLocLongType)
    // removed duplicate function, [["Expression eval_yl2xp1Loc, FuncDeclaration, DArray<Expression>", "int skipPastIdentWithDotsOutBuffer, int", "boolean emitAnchorNameOutBuffer, Dsymbol, Scope, boolean", "TemplateParameter isTemplateParameterDArray<Dsymbol>, BytePtr, int", "void emplaceExpObject, Loc _param_1, double _param_2, Type _param_3RealExpLocDoubleType", "TypeAArray toBuiltinAATypeType", "Expression eval_isinfinityLoc, FuncDeclaration, DArray<Expression>", "boolean mergeCallSuperRef<Short>, short", "Expression eval_floorLoc, FuncDeclaration, DArray<Expression>", "UnionExp changeArrayLiteralLengthLoc, TypeArray, Expression, int, int", "ArrayLiteralExp createBlockDuplicatedArrayLiteralUnionExp, Loc, Type, Expression, int", "BytePtr stripLeadingNewlinesBytePtr", "void emplaceExpObject, byte _param_1CTFEExpByte", "void createMatchNodes", "UnionExp ArrayLengthType, Expression", "boolean checkAccessAggregateDeclaration, Loc, Scope, Dsymbol", "Expression resolveSliceExpression, UnionExp", "Expression getValueVarDeclaration", "boolean hasPackageAccessScope, Dsymbol", "void emplaceExpObject, Loc _param_1, Expression _param_2, Type _param_3AddrExpLocExpressionType", "boolean isFloatIntPaintType, Type", "int mainSlice<ByteSlice>", "void vmessageLoc, BytePtr, Slice<Object>", "boolean isValidManglingint", "int getAlignmentAlignDeclaration, Scope", "int arrayObjectHashDArray<RootObject>", "boolean numCmpbyte, int, intInteger", "boolean exceptionOrCantInterpretExpression", "ByteSlice lookForSourceFileByteSlice", "void showCtfeExprExpression, int", "void removeBlankLineMacroOutBuffer, IntRef, IntRef", "boolean isErrorRootObject", "void emitMemberCommentsScopeDsymbol, OutBuffer, Scope", "UnionExp ctfeCatLoc, Type, Expression, Expression", "void escapeDdocStringOutBuffer, int", "void deprecationLoc, BytePtr", "void messageLoc, BytePtr", "Parameter isFunctionParameterDArray<Dsymbol>, BytePtr, int", "short parseModulePatternDepthBytePtr", "void MODtoDecoBufferOutBuffer, byte", "UnionExp ModLoc, Type, Expression, Expression", "void emplaceExpObject, Loc _param_1, Object _param_2, int _param_3StringExpLocObjectInteger", "void emplaceExpObject, Loc _param_1, StructLiteralExp _param_2, Type _param_3ClassReferenceExpLocStructLiteralExpType", "Expression eval_tanLoc, FuncDeclaration, DArray<Expression>", "int skippastURLOutBuffer, int", "boolean isZeroSecondbyte", "Expression eval_copysignLoc, FuncDeclaration, DArray<Expression>", "Expression eval_log2Loc, FuncDeclaration, DArray<Expression>", "double creallcomplex_t", "void warningSupplementalLoc, BytePtr", "int deduceTypeRootObject, Scope, Type, DArray<TemplateParameter>, DArray<RootObject>, IntPtr, int, boolean", "Tuple isTupleRootObject", "Expression eval_truncLoc, FuncDeclaration, DArray<Expression>", "UnionExp DivLoc, Type, Expression, Expression", "void expandTemplateMixinCommentsTemplateMixin, OutBuffer, Scope", "Expression eval_sqrtLoc, FuncDeclaration, DArray<Expression>", "boolean lambdaCheckForNestedRefExpression, Scope", "void emplaceExpObject, Loc _param_1, complex_t _param_2, Type _param_3ComplexExpLoccomplex_tType", "void dsymbolSemanticDsymbol, Scope", "void cantExpUnionExp", "boolean pointToSameMemoryBlockExpression, Expression", "long getStorageClassPrefixAttributesASTBaseASTBase", "UnionExp ComType, Expression", "ByteSlice initializerMsgtable", "int specificCmpbyte, int", "void builtinDeinitialize", "boolean isDigitSecondbyte", "Scope skipNonQualScopesScope", "UnionExp MulLoc, Type, Expression, Expression", "int utfStrideBytePtr", "void verrorPrintLoc, int, BytePtr, BytePtr, Slice<Object>, BytePtr, BytePtr", "int ctfeCmpLoc, byte, Expression, Expression", "boolean isTrueBoolExpression", "void builtin_init", "Parameter isParameterRootObject", "void errorSupplementalLoc, BytePtr", "long resolveArrayLengthExpression", "Expression evaluateDtorInterState, Expression", "int foreachDsymbolDArray<Dsymbol>, Function1<Dsymbol,Integer>", "Expression interpret_lengthUnionExp, InterState, Expression", "Parameter isFunctionParameterDsymbol, BytePtr, int", "void emitProtectionOutBuffer, Import", "TemplateParameter isTemplateParameterRootObject", "boolean arrayObjectMatchDArray<RootObject>, DArray<RootObject>", "void emplaceExpObject, Loc _param_1, Type _param_2, Expression _param_3, DArray<Expression> _param_4ArrayLiteralExpLocTypeExpressionDArray<Expression>", "boolean reliesOnTemplateParametersExpression, Slice<TemplateParameter>", "int endAllMarkdownQuotesOutBuffer, int, IntRef", "boolean definitelyValueParameterExpression", "void emplaceExpObject, Loc _param_1, boolean _param_2, Type _param_3IntegerExpLocBooleanType", "boolean reliesOnTidentType, DArray<TemplateParameter>, int", "Expression eval_yl2xLoc, FuncDeclaration, DArray<Expression>", "void errorLoc, BytePtr", "boolean utf_isValidDcharint", "void fatal", "Expression evaluateIfBuiltinUnionExp, InterState, Loc, FuncDeclaration, DArray<Expression>, Expression", "UnionExp pointerDifferenceLoc, Type, Expression, Expression", "UnionExp NegType, Expression", "boolean isidcharbyte", "int utf_codeLengthWcharint", "Expression getValueRef<Dsymbol>", "Function3<Loc,FuncDeclaration,DArray<Expression>,Expression> builtin_lookupBytePtr", "BytePtr linkToCharsint", "Expression interpretStatement, InterState", "int isConstExpression", "Expression getExpressionRootObject", "void emitProtectionOutBuffer, Prot", "Expression ctfeIndexLoc, Type, Expression, long", "int utf_codeLengthint, int", "UnionExp SliceType, Expression, Expression, Expression", "void functionResolveMatchAccumulator, Dsymbol, Loc, Scope, DArray<RootObject>, Type, DArray<Expression>, Ptr<BytePtr>", "int intSignedCmpbyte, long, long", "int ctfeIdentityLoc, byte, Expression, Expression", "Expression ctfeInterpretForPragmaMsgExpression", "void emplaceExpObject, Loc _param_1, long _param_2, Type _param_3IntegerExpLocLongType", "boolean isUniAlphaint", "BytePtr skipwhitespaceBytePtr", "UnionExp Cmpbyte, Loc, Type, Expression, Expression", "Dsymbol mostVisibleOverloadDsymbol, Module", "UnionExp OrLoc, Type, Expression, Expression", "void emplaceExpObject, Loc _param_1, Declaration _param_2, int _param_3SymOffExpLocDeclarationInteger", "int sliceCmpStringWithArrayStringExp, ArrayLiteralExp, int, int, int", "boolean hasPackageAccessModule, Dsymbol", "CtorDeclaration generateCopyCtorDeclarationStructDeclaration, long, long", "void errorBytePtr, int, int, BytePtr", "void add_builtinBytePtr, Function3<Loc,FuncDeclaration,DArray<Expression>,Expression>", "UnionExp PtrType, Expression", "void utf_encodeWcharCharPtr, int", "boolean findConditionDArray<Identifier>, Identifier", "int ctfeRawCmpLoc, Expression, Expression, boolean", "UnionExp ShlLoc, Type, Expression, Expression", "void highlightTextScope, DArray<Dsymbol>, Loc, OutBuffer, int", "UnionExp voidInitLiteralType, VarDeclaration", "void gendocfileModule", "boolean isIdTailBytePtr", "UnionExp ShrLoc, Type, Expression, Expression", "int setMangleOverrideDsymbol, ByteSlice", "Dsymbol getDsymbolRootObject", "Expression eval_log10Loc, FuncDeclaration, DArray<Expression>", "Expression eval_expLoc, FuncDeclaration, DArray<Expression>", "Expression getAggregateFromPointerExpression, Ptr<Long>", "void emplaceExpObject, Loc _param_1, Expression _param_2, Expression _param_3IndexExpLocExpressionExpression", "Expression eval_fmaxLoc, FuncDeclaration, DArray<Expression>", "boolean isArrayExpression", "UnionExp CastLoc, Type, Type, Expression", "UnionExp IndexType, Expression, Expression", "void emitAnchorOutBuffer, Dsymbol, Scope, boolean", "void removeAnyAtxHeadingSuffixOutBuffer, int", "DArray<Expression> copyElementsExpression, Expression", "void assignInPlaceExpression, Expression", "TemplateDeclaration getEponymousParentDsymbol", "void utf_encodeint, Object, int", "boolean issinglecharbyte", "ByteSlice replaceCharByteSlice, byte, ByteSlice", "int getCodeIndentBytePtr", "boolean isIdentifierDArray<Dsymbol>, BytePtr, int", "BytePtr utf_decodeCharBytePtr, int, IntRef, IntRef", "void vwarningLoc, BytePtr, Slice<Object>", "boolean needToCopyLiteralExpression", "int sliceCmpStringWithStringStringExp, StringExp, int, int, int", "boolean isCtfeComparableExpression", "ByteSlice memdupByteSlice", "void mangleToBufferTemplateInstance, OutBuffer", "ByteSlice lexBytePtr, ByteSlice", "boolean isPointerType", "Expression findKeyInAALoc, AssocArrayLiteralExp, Expression", "int endTableOutBuffer, int, Ref<IntSlice>", "Expression scrubReturnValueLoc, Expression", "Type rawTypeMergeType, Type", "void emplaceExpObject, Loc _param_1, Expression _param_2, Type _param_3VectorExpLocExpressionType", "boolean buildCopyCtorStructDeclaration, Scope", "boolean reliesOnTemplateParametersType, Slice<TemplateParameter>", "int utf_codeLengthCharint", "void highlightCode3Scope, OutBuffer, BytePtr, BytePtr", "BytePtr getMessageDeprecatedDeclaration", "int endAllListsAndQuotesOutBuffer, IntRef, Ref<Slice<MarkdownList>>, IntRef, IntRef", "ByteSlice toLowercaseByteSlice", "Expression interpretFunctionUnionExp, FuncDeclaration, InterState, DArray<Expression>, Expression", "Expression interpret_valuesUnionExp, InterState, Expression, Type", "Expression eval_roundLoc, FuncDeclaration, DArray<Expression>", "void emplaceExpObject, Loc _param_1, Expression _param_2, Expression _param_3, Expression _param_4SliceExpLocExpressionExpressionExpression", "boolean modifyFieldVarLoc, Scope, VarDeclaration, Expression", "void deprecationSupplementalLoc, BytePtr", "Expression eval_ldexpLoc, FuncDeclaration, DArray<Expression>", "int extractArgNByteSlice, Ref<ByteSlice>, int", "UnionExp UshrLoc, Type, Expression, Expression", "Expression interpret_keysUnionExp, InterState, Expression, Type", "UnionExp Identitybyte, Loc, Type, Expression, Expression", "void vwarningSupplementalLoc, BytePtr, Slice<Object>", "BytePtr modToCharsint", "boolean checkSymbolAccessScope, Dsymbol", "Expression toDelegateExpression, Type, Scope", "UnionExp PowLoc, Type, Expression, Expression", "int isattyint", "Expression scrubCacheValueExpression", "int findFieldIndexByNameStructDeclaration, VarDeclaration", "boolean replaceMarkdownThematicBreakOutBuffer, IntRef, int, Loc", "RootObject objectSyntaxCopyRootObject", "int ctfeEqualLoc, byte, Expression, Expression", "void emplaceExpObject, Loc _param_1, Object _param_2, DArray<Expression> _param_3ArrayLiteralExpLocObjectDArray<Expression>", "void emplaceExpObject, Loc _param_1, Declaration _param_2, long _param_3SymOffExpLocDeclarationLong", "FuncDeclaration buildPostBlitStructDeclaration, Scope", "int skipCharsOutBuffer, int, ByteSlice", "Statement generateCopyCtorBodyStructDeclaration", "void sliceAssignStringFromArrayLiteralStringExp, ArrayLiteralExp, int", "int expressionHashExpression", "boolean ensureStaticLinkToDsymbol, Dsymbol", "DArray<Expression> copyLiteralArrayDArray<Expression>, Expression", "int templateParameterLookupType, DArray<TemplateParameter>", "boolean symbolIsVisibleDsymbol, Dsymbol", "boolean c_isalnumint", "void tyToDecoBufferOutBuffer, int", "void emplaceExpObject, Loc _param_1, StructDeclaration _param_2, DArray<Expression> _param_3StructLiteralExpLocStructDeclarationDArray<Expression>", "void ObjectNotFoundIdentifier", "boolean isCVariadicParameterDArray<Dsymbol>, ByteSlice", "void mangleToFuncSignatureOutBuffer, FuncDeclaration", "void colorHighlightCodeOutBuffer", "boolean symbolIsVisibleScope, Dsymbol", "void emplaceExpObject, Loc _param_1, TypeSArray _param_2, DArray<Expression> _param_3ArrayLiteralExpLocTypeSArrayDArray<Expression>", "void warningLoc, BytePtr", "UnionExp BoolType, Expression", "StringExp createBlockDuplicatedStringLiteralUnionExp, Loc, Type, int, int, byte", "void colorSyntaxHighlightOutBuffer", "Expression paintTypeOntoLiteralType, Expression", "void endMarkdownHeadingOutBuffer, int, IntRef, Loc, IntRef", "int endRowAndTableOutBuffer, int, int, Loc, Ref<Slice<MarkdownDelimiter>>, Ref<IntSlice>", "boolean isoctalbyte", "void unSpeculativeScope, RootObject", "Expression eval_fminLoc, FuncDeclaration, DArray<Expression>", "boolean arrayObjectIsErrorDArray<RootObject>", "long getStorageClassPrefixAttributesASTCodegenASTCodegen", "boolean isSpecialEnumIdentIdentifier", "int skiptoidentOutBuffer, int", "int deduceTypeHelperType, Ptr<Type>, Type", "boolean mergeFieldInitRef<Short>, short", "void foreachDsymbolDArray<Dsymbol>, Function1<Dsymbol,Void>", "Expression interpretUnionExp, Expression, InterState, int", "UnionExp AddLoc, Type, Expression, Expression", "Expression isExpressionRootObject", "void emplaceExpObject, Loc _param_1, Expression _param_2, IntegerExp _param_3, Expression _param_4SliceExpLocExpressionIntegerExpExpression", "int parseTableDelimiterRowOutBuffer, int, boolean, Ref<IntSlice>", "int skippastidentOutBuffer, int", "UnionExp XorLoc, Type, Expression, Expression", "int realCmpbyte, double, double", "boolean isCVariadicArgByteSlice", "boolean isCtfeValueValidExpression", "UnionExp MinLoc, Type, Expression, Expression", "Expression eval_bsrLoc, FuncDeclaration, DArray<Expression>", "void semanticTypeInfoScope, Type", "void highlightCodeScope, Dsymbol, OutBuffer, int", "Expression eval_logLoc, FuncDeclaration, DArray<Expression>", "Expression eval_cosLoc, FuncDeclaration, DArray<Expression>", "boolean allowsContractWithoutBodyFuncDeclaration", "double cimaglcomplex_t", "int replaceTableRowOutBuffer, int, int, Loc, Ref<Slice<MarkdownDelimiter>>, IntSlice, boolean", "void verrorLoc, BytePtr, Slice<Object>, BytePtr, BytePtr, BytePtr", "UnionExp AndLoc, Type, Expression, Expression", "boolean _isZeroInitExpression", "boolean checkAccessLoc, Scope, Package", "Expression eval_ceilLoc, FuncDeclaration, DArray<Expression>", "boolean isCtfeReferenceValidExpression", "boolean checkFrameAccessLoc, Scope, AggregateDeclaration, int", "Expression ctfeInterpretExpression", "int ctfeCmpArraysLoc, Expression, Expression, long", "boolean isTypeInfo_ClassType", "byte deduceWildHelperType, Ptr<Type>, Type", "boolean isIndentWSBytePtr", "Expression evaluatePostblitInterState, Expression", "void verrorSupplementalLoc, BytePtr, Slice<Object>", "boolean checkAccessLoc, Scope, Expression, Declaration", "FuncDeclaration search_toStringStructDeclaration", "Expression eval_sinLoc, FuncDeclaration, DArray<Expression>", "UnionExp Equalbyte, Loc, Type, Expression, Expression", "void emplaceExpObject, Loc _param_1, Expression _param_2, TypeVector _param_3VectorExpLocExpressionTypeVector", "int replaceMarkdownEmphasisOutBuffer, Loc, Ref<Slice<MarkdownDelimiter>>, int", "void emplaceExpObject, Loc _param_1, Object _param_2, int _param_3, byte _param_4StringExpLocObjectIntegerByte", "ByteSlice generateSlice<Msgtable>, Function1<Msgtable,ByteSlice>", "void emplaceExpObject, Loc _param_1, DArray<Expression> _param_2TupleExpLocDArray<Expression>", "void processFileByteSlice, ByteSlice, BytePtr_lispy", "Expression eval_popcntLoc, FuncDeclaration, DArray<Expression>", "Expression eval_bsfLoc, FuncDeclaration, DArray<Expression>", "void setValueWithoutCheckingVarDeclaration, Expression", "void mangleToBufferType, OutBuffer", "int isBuiltinFuncDeclaration", "Expression paintFloatIntUnionExp, Expression, Type", "void sliceAssignStringFromStringStringExp, StringExp, int", "Expression paintTypeOntoLiteralUnionExp, Type, Expression", "boolean symbolIsVisibleModule, Dsymbol", "void ctfeCompileFuncDeclaration", "Expression eval_fabsLoc, FuncDeclaration, DArray<Expression>", "void printCtfePerformanceStats", "void highlightCodeScope, DArray<Dsymbol>, OutBuffer, int", "ByteSlice getFilenameDArray<Identifier>, Identifier", "Expression interpretExpression, InterState, int", "Expression getValueExpression", "void messageBytePtr", "Expression eval_isnanLoc, FuncDeclaration, DArray<Expression>", "Expression ctfeCastUnionExp, Loc, Type, Type, Expression", "UnionExp NotType, Expression", "void escapeStrayParenthesisLoc, OutBuffer, int, boolean", "void lambdaSetParentExpression, FuncDeclaration", "boolean isIdStartBytePtr", "int intUnsignedCmpbyte, long, long", "void emplaceExpObject, Loc _param_1, int _param_2, Type _param_3IntegerExpLocIntegerType", "UnionExp pointerArithmeticLoc, byte, Type, Expression, Expression", "void emitProtectionOutBuffer, Declaration", "int templateIdentifierLookupIdentifier, DArray<TemplateParameter>", "ByteSlice lispyBytePtr, ByteSlice", "boolean walkPostorderExpression, StoppableVisitor", "TypeFunction isTypeFunctionDsymbol", "void printDepsConditionalScope, DVCondition, ByteSlice", "Expression expTypeType, Expression", "Expression resolveAliasThisScope, Expression, boolean", "int detectAtxHeadingLevelOutBuffer, int", "Type isTypeRootObject", "Expression eval_builtinLoc, FuncDeclaration, DArray<Expression>", "boolean c_isxdigitint", "BytePtr utf_decodeWcharCharPtr, int, IntRef, IntRef", "Expression interpretUnionExp, Statement, InterState", "ByteSlice deinitializerMsgtable", "Expression eval_unimpLoc, FuncDeclaration, DArray<Expression>", "void utf_encodeCharBytePtr, int", "void semantic3OnDependenciesModule", "UnionExp copyLiteralExpression", "UnionExp paintTypeOntoLiteralCopyType, Expression", "Expression interpret_aaApplyUnionExp, InterState, Expression, Expression", "void emitCommentDsymbol, OutBuffer, Scope", "void emplaceExpObject, Loc _param_1, VarExp _param_2, Type _param_3AddrExpLocVarExpType", "ByteSlice skipwhitespaceByteSlice", "void vdeprecationSupplementalLoc, BytePtr, Slice<Object>", "void highlightCode2Scope, DArray<Dsymbol>, OutBuffer, int", "FuncDeclaration funcptrOfExpression", "void emplaceExpObject, Loc _param_1, DArray<Expression> _param_2, DArray<Expression> _param_3AssocArrayLiteralExpLocDArray<Expression>DArray<Expression>", "void parseModulePatternBytePtr, MatcherNode, short", "void mangleToBufferExpression, OutBuffer", "boolean matchRootObject, RootObject", "Expression eval_exp2Loc, FuncDeclaration, DArray<Expression>", "int getMarkdownIndentOutBuffer, int, int", "int startTableOutBuffer, int, int, Loc, boolean, Ref<Slice<MarkdownDelimiter>>, Ref<IntSlice>", "boolean isKeywordBytePtr, int", "UnionExp CatType, Expression, Expression", "Expression eval_isfiniteLoc, FuncDeclaration, DArray<Expression>", "int comparePointersbyte, Expression, long, Expression, long", "boolean isDittoBytePtr", "void emplaceExpObject, Loc _param_1, Type _param_2NullExpLocType", "boolean isAssocArrayType", "boolean isSafePointerCastType, Type", "boolean numCmpbyte, double, doubleDouble", "void mangleToBufferDsymbol, OutBuffer", "void aliasSemanticAliasDeclaration, Scope", "Parameter isEponymousFunctionParameterDArray<Dsymbol>, BytePtr, int", "void emplaceExpObject, Loc _param_1, Type _param_2, DArray<Expression> _param_3ArrayLiteralExpLocTypeDArray<Expression>", "Expression assignAssocArrayElementLoc, AssocArrayLiteralExp, Expression, Expression", "void emplaceExpObject, Loc _param_1, IndexExp _param_2, Type _param_3AddrExpLocIndexExpType", "ByteSlice identifierMsgtable", "boolean ishexbyte", "void processFileByteSlice, ByteSlice, BytePtr_lex", "Expression eval_bswapLoc, FuncDeclaration, DArray<Expression>", "void vdeprecationLoc, BytePtr, Slice<Object>, BytePtr, BytePtr", "void setValueVarDeclaration, Expression", "void halt", "BytePtr mangleExactFuncDeclaration", "void emplaceExpObject, int _param_1IntegerExpInteger", "Expression eval_expm1Loc, FuncDeclaration, DArray<Expression>", "Dsymbol isDsymbolRootObject", "boolean isReservedNameByteSlice", "boolean hasProtectedAccessScope, Dsymbol", "void writeHighlightsConsole, OutBuffer", "boolean numCmpbyte, long, longLong", "Expression interpret_dupUnionExp, InterState, Expression", "Dsymbol getEponymousMemberTemplateDeclaration", "Expression eval_powLoc, FuncDeclaration, DArray<Expression>", "boolean hasValueVarDeclaration", "void templateInstanceSemanticTemplateInstance, Scope, DArray<Expression>", "Type getTypeRootObject", "Expression foreachApplyUtfUnionExp, InterState, Expression, Expression, boolean", "boolean includeImportedModuleCheckModuleComponentRange", "Expression eval_fmaLoc, FuncDeclaration, DArray<Expression>", "void sliceAssignArrayLiteralFromStringArrayLiteralExp, StringExp, int", "boolean writeMixinByteSlice, Loc", "void toDocBufferDsymbol, OutBuffer, Scope"]] signature: void emplaceExpObject, Loc _param_1, long _param_2, Type _param_3IntegerExpLocLongType
    ...
    // from template emplaceExp!(AddrExpLocExpression)
    // removed duplicate function, [["Expression eval_yl2xp1Loc, FuncDeclaration, DArray<Expression>", "int skipPastIdentWithDotsOutBuffer, int", "boolean emitAnchorNameOutBuffer, Dsymbol, Scope, boolean", "TemplateParameter isTemplateParameterDArray<Dsymbol>, BytePtr, int", "void emplaceExpObject, Loc _param_1, double _param_2, Type _param_3RealExpLocDoubleType", "TypeAArray toBuiltinAATypeType", "Expression eval_isinfinityLoc, FuncDeclaration, DArray<Expression>", "boolean mergeCallSuperRef<Short>, short", "Expression eval_floorLoc, FuncDeclaration, DArray<Expression>", "UnionExp changeArrayLiteralLengthLoc, TypeArray, Expression, int, int", "ArrayLiteralExp createBlockDuplicatedArrayLiteralUnionExp, Loc, Type, Expression, int", "BytePtr stripLeadingNewlinesBytePtr", "void emplaceExpObject, byte _param_1CTFEExpByte", "void createMatchNodes", "UnionExp ArrayLengthType, Expression", "boolean checkAccessAggregateDeclaration, Loc, Scope, Dsymbol", "Expression resolveSliceExpression, UnionExp", "Expression getValueVarDeclaration", "boolean hasPackageAccessScope, Dsymbol", "void emplaceExpObject, Loc _param_1, Expression _param_2, Type _param_3AddrExpLocExpressionType", "boolean isFloatIntPaintType, Type", "int mainSlice<ByteSlice>", "void vmessageLoc, BytePtr, Slice<Object>", "boolean isValidManglingint", "int getAlignmentAlignDeclaration, Scope", "int arrayObjectHashDArray<RootObject>", "boolean numCmpbyte, int, intInteger", "boolean exceptionOrCantInterpretExpression", "ByteSlice lookForSourceFileByteSlice", "void showCtfeExprExpression, int", "void emplaceExpObject, Loc _param_1, Expression _param_2AddrExpLocExpression", "void removeBlankLineMacroOutBuffer, IntRef, IntRef", "boolean isErrorRootObject", "void emitMemberCommentsScopeDsymbol, OutBuffer, Scope", "UnionExp ctfeCatLoc, Type, Expression, Expression", "void escapeDdocStringOutBuffer, int", "void deprecationLoc, BytePtr", "void messageLoc, BytePtr", "Parameter isFunctionParameterDArray<Dsymbol>, BytePtr, int", "short parseModulePatternDepthBytePtr", "void MODtoDecoBufferOutBuffer, byte", "UnionExp ModLoc, Type, Expression, Expression", "void emplaceExpObject, Loc _param_1, Object _param_2, int _param_3StringExpLocObjectInteger", "void emplaceExpObject, Loc _param_1, StructLiteralExp _param_2, Type _param_3ClassReferenceExpLocStructLiteralExpType", "Expression eval_tanLoc, FuncDeclaration, DArray<Expression>", "int skippastURLOutBuffer, int", "boolean isZeroSecondbyte", "Expression eval_copysignLoc, FuncDeclaration, DArray<Expression>", "Expression eval_log2Loc, FuncDeclaration, DArray<Expression>", "double creallcomplex_t", "void warningSupplementalLoc, BytePtr", "int deduceTypeRootObject, Scope, Type, DArray<TemplateParameter>, DArray<RootObject>, IntPtr, int, boolean", "Tuple isTupleRootObject", "Expression eval_truncLoc, FuncDeclaration, DArray<Expression>", "UnionExp DivLoc, Type, Expression, Expression", "void expandTemplateMixinCommentsTemplateMixin, OutBuffer, Scope", "Expression eval_sqrtLoc, FuncDeclaration, DArray<Expression>", "boolean lambdaCheckForNestedRefExpression, Scope", "void emplaceExpObject, Loc _param_1, complex_t _param_2, Type _param_3ComplexExpLoccomplex_tType", "void dsymbolSemanticDsymbol, Scope", "void cantExpUnionExp", "boolean pointToSameMemoryBlockExpression, Expression", "long getStorageClassPrefixAttributesASTBaseASTBase", "UnionExp ComType, Expression", "ByteSlice initializerMsgtable", "int specificCmpbyte, int", "void builtinDeinitialize", "boolean isDigitSecondbyte", "Scope skipNonQualScopesScope", "UnionExp MulLoc, Type, Expression, Expression", "int utfStrideBytePtr", "void verrorPrintLoc, int, BytePtr, BytePtr, Slice<Object>, BytePtr, BytePtr", "int ctfeCmpLoc, byte, Expression, Expression", "boolean isTrueBoolExpression", "void builtin_init", "Parameter isParameterRootObject", "void errorSupplementalLoc, BytePtr", "long resolveArrayLengthExpression", "Expression evaluateDtorInterState, Expression", "int foreachDsymbolDArray<Dsymbol>, Function1<Dsymbol,Integer>", "Expression interpret_lengthUnionExp, InterState, Expression", "Parameter isFunctionParameterDsymbol, BytePtr, int", "void emitProtectionOutBuffer, Import", "TemplateParameter isTemplateParameterRootObject", "boolean arrayObjectMatchDArray<RootObject>, DArray<RootObject>", "void emplaceExpObject, Loc _param_1, Type _param_2, Expression _param_3, DArray<Expression> _param_4ArrayLiteralExpLocTypeExpressionDArray<Expression>", "boolean reliesOnTemplateParametersExpression, Slice<TemplateParameter>", "int endAllMarkdownQuotesOutBuffer, int, IntRef", "void emplaceExpObject, Loc _param_1, Expression _param_2, FuncDeclaration _param_3, boolean _param_4DelegateExpLocExpressionFuncDeclarationBoolean", "boolean definitelyValueParameterExpression", "void emplaceExpObject, Loc _param_1, boolean _param_2, Type _param_3IntegerExpLocBooleanType", "boolean reliesOnTidentType, DArray<TemplateParameter>, int", "Expression eval_yl2xLoc, FuncDeclaration, DArray<Expression>", "void errorLoc, BytePtr", "boolean utf_isValidDcharint", "void fatal", "Expression evaluateIfBuiltinUnionExp, InterState, Loc, FuncDeclaration, DArray<Expression>, Expression", "UnionExp pointerDifferenceLoc, Type, Expression, Expression", "UnionExp NegType, Expression", "boolean isidcharbyte", "int utf_codeLengthWcharint", "Expression getValueRef<Dsymbol>", "Function3<Loc,FuncDeclaration,DArray<Expression>,Expression> builtin_lookupBytePtr", "BytePtr linkToCharsint", "Expression interpretStatement, InterState", "int isConstExpression", "Expression getExpressionRootObject", "void emitProtectionOutBuffer, Prot", "Expression ctfeIndexLoc, Type, Expression, long", "int utf_codeLengthint, int", "UnionExp SliceType, Expression, Expression, Expression", "void functionResolveMatchAccumulator, Dsymbol, Loc, Scope, DArray<RootObject>, Type, DArray<Expression>, Ptr<BytePtr>", "int intSignedCmpbyte, long, long", "int ctfeIdentityLoc, byte, Expression, Expression", "Expression ctfeInterpretForPragmaMsgExpression", "void emplaceExpObject, Loc _param_1, long _param_2, Type _param_3IntegerExpLocLongType", "boolean isUniAlphaint", "BytePtr skipwhitespaceBytePtr", "UnionExp Cmpbyte, Loc, Type, Expression, Expression", "Dsymbol mostVisibleOverloadDsymbol, Module", "UnionExp OrLoc, Type, Expression, Expression", "void emplaceExpObject, Loc _param_1, Declaration _param_2, int _param_3SymOffExpLocDeclarationInteger", "int sliceCmpStringWithArrayStringExp, ArrayLiteralExp, int, int, int", "boolean hasPackageAccessModule, Dsymbol", "CtorDeclaration generateCopyCtorDeclarationStructDeclaration, long, long", "void errorBytePtr, int, int, BytePtr", "void add_builtinBytePtr, Function3<Loc,FuncDeclaration,DArray<Expression>,Expression>", "UnionExp PtrType, Expression", "void utf_encodeWcharCharPtr, int", "boolean findConditionDArray<Identifier>, Identifier", "int ctfeRawCmpLoc, Expression, Expression, boolean", "UnionExp ShlLoc, Type, Expression, Expression", "void highlightTextScope, DArray<Dsymbol>, Loc, OutBuffer, int", "UnionExp voidInitLiteralType, VarDeclaration", "void gendocfileModule", "boolean isIdTailBytePtr", "UnionExp ShrLoc, Type, Expression, Expression", "void emplaceExpObject, Loc _param_1, Type _param_2, Expression _param_3ArrayLiteralExpLocTypeExpression", "int setMangleOverrideDsymbol, ByteSlice", "Dsymbol getDsymbolRootObject", "Expression eval_log10Loc, FuncDeclaration, DArray<Expression>", "Expression eval_expLoc, FuncDeclaration, DArray<Expression>", "Expression getAggregateFromPointerExpression, Ptr<Long>", "void emplaceExpObject, Loc _param_1, Expression _param_2, Expression _param_3IndexExpLocExpressionExpression", "Expression eval_fmaxLoc, FuncDeclaration, DArray<Expression>", "boolean isArrayExpression", "UnionExp CastLoc, Type, Type, Expression", "UnionExp IndexType, Expression, Expression", "void emitAnchorOutBuffer, Dsymbol, Scope, boolean", "void removeAnyAtxHeadingSuffixOutBuffer, int", "DArray<Expression> copyElementsExpression, Expression", "void assignInPlaceExpression, Expression", "TemplateDeclaration getEponymousParentDsymbol", "void utf_encodeint, Object, int", "boolean issinglecharbyte", "ByteSlice replaceCharByteSlice, byte, ByteSlice", "int getCodeIndentBytePtr", "boolean isIdentifierDArray<Dsymbol>, BytePtr, int", "BytePtr utf_decodeCharBytePtr, int, IntRef, IntRef", "void vwarningLoc, BytePtr, Slice<Object>", "boolean needToCopyLiteralExpression", "int sliceCmpStringWithStringStringExp, StringExp, int, int, int", "boolean isCtfeComparableExpression", "ByteSlice memdupByteSlice", "void mangleToBufferTemplateInstance, OutBuffer", "ByteSlice lexBytePtr, ByteSlice", "boolean isPointerType", "Expression findKeyInAALoc, AssocArrayLiteralExp, Expression", "int endTableOutBuffer, int, Ref<IntSlice>", "Expression scrubReturnValueLoc, Expression", "Type rawTypeMergeType, Type", "void emplaceExpObject, Loc _param_1, Expression _param_2, Type _param_3VectorExpLocExpressionType", "boolean buildCopyCtorStructDeclaration, Scope", "boolean reliesOnTemplateParametersType, Slice<TemplateParameter>", "int utf_codeLengthCharint", "void highlightCode3Scope, OutBuffer, BytePtr, BytePtr", "BytePtr getMessageDeprecatedDeclaration", "int endAllListsAndQuotesOutBuffer, IntRef, Ref<Slice<MarkdownList>>, IntRef, IntRef", "ByteSlice toLowercaseByteSlice", "Expression interpretFunctionUnionExp, FuncDeclaration, InterState, DArray<Expression>, Expression", "Expression interpret_valuesUnionExp, InterState, Expression, Type", "Expression eval_roundLoc, FuncDeclaration, DArray<Expression>", "void emplaceExpObject, Loc _param_1, Expression _param_2, Expression _param_3, Expression _param_4SliceExpLocExpressionExpressionExpression", "boolean modifyFieldVarLoc, Scope, VarDeclaration, Expression", "void deprecationSupplementalLoc, BytePtr", "Expression eval_ldexpLoc, FuncDeclaration, DArray<Expression>", "int extractArgNByteSlice, Ref<ByteSlice>, int", "UnionExp UshrLoc, Type, Expression, Expression", "Expression interpret_keysUnionExp, InterState, Expression, Type", "UnionExp Identitybyte, Loc, Type, Expression, Expression", "void vwarningSupplementalLoc, BytePtr, Slice<Object>", "BytePtr modToCharsint", "boolean checkSymbolAccessScope, Dsymbol", "Expression toDelegateExpression, Type, Scope", "UnionExp PowLoc, Type, Expression, Expression", "int isattyint", "Expression scrubCacheValueExpression", "int findFieldIndexByNameStructDeclaration, VarDeclaration", "boolean replaceMarkdownThematicBreakOutBuffer, IntRef, int, Loc", "RootObject objectSyntaxCopyRootObject", "int ctfeEqualLoc, byte, Expression, Expression", "void emplaceExpObject, Loc _param_1, Object _param_2, DArray<Expression> _param_3ArrayLiteralExpLocObjectDArray<Expression>", "void emplaceExpObject, Loc _param_1, Declaration _param_2, long _param_3SymOffExpLocDeclarationLong", "FuncDeclaration buildPostBlitStructDeclaration, Scope", "int skipCharsOutBuffer, int, ByteSlice", "Statement generateCopyCtorBodyStructDeclaration", "void sliceAssignStringFromArrayLiteralStringExp, ArrayLiteralExp, int", "int expressionHashExpression", "boolean ensureStaticLinkToDsymbol, Dsymbol", "DArray<Expression> copyLiteralArrayDArray<Expression>, Expression", "int templateParameterLookupType, DArray<TemplateParameter>", "boolean symbolIsVisibleDsymbol, Dsymbol", "boolean c_isalnumint", "void tyToDecoBufferOutBuffer, int", "void emplaceExpObject, Loc _param_1, StructDeclaration _param_2, DArray<Expression> _param_3StructLiteralExpLocStructDeclarationDArray<Expression>", "void ObjectNotFoundIdentifier", "boolean isCVariadicParameterDArray<Dsymbol>, ByteSlice", "void mangleToFuncSignatureOutBuffer, FuncDeclaration", "void colorHighlightCodeOutBuffer", "boolean symbolIsVisibleScope, Dsymbol", "void emplaceExpObject, Loc _param_1, TypeSArray _param_2, DArray<Expression> _param_3ArrayLiteralExpLocTypeSArrayDArray<Expression>", "void warningLoc, BytePtr", "UnionExp BoolType, Expression", "StringExp createBlockDuplicatedStringLiteralUnionExp, Loc, Type, int, int, byte", "void colorSyntaxHighlightOutBuffer", "Expression paintTypeOntoLiteralType, Expression", "void endMarkdownHeadingOutBuffer, int, IntRef, Loc, IntRef", "int endRowAndTableOutBuffer, int, int, Loc, Ref<Slice<MarkdownDelimiter>>, Ref<IntSlice>", "boolean isoctalbyte", "void unSpeculativeScope, RootObject", "Expression eval_fminLoc, FuncDeclaration, DArray<Expression>", "boolean arrayObjectIsErrorDArray<RootObject>", "long getStorageClassPrefixAttributesASTCodegenASTCodegen", "boolean isSpecialEnumIdentIdentifier", "int skiptoidentOutBuffer, int", "int deduceTypeHelperType, Ptr<Type>, Type", "boolean mergeFieldInitRef<Short>, short", "void foreachDsymbolDArray<Dsymbol>, Function1<Dsymbol,Void>", "Expression interpretUnionExp, Expression, InterState, int", "UnionExp AddLoc, Type, Expression, Expression", "Expression isExpressionRootObject", "void emplaceExpObject, Loc _param_1, Expression _param_2, IntegerExp _param_3, Expression _param_4SliceExpLocExpressionIntegerExpExpression", "int parseTableDelimiterRowOutBuffer, int, boolean, Ref<IntSlice>", "int skippastidentOutBuffer, int", "UnionExp XorLoc, Type, Expression, Expression", "int realCmpbyte, double, double", "boolean isCVariadicArgByteSlice", "boolean isCtfeValueValidExpression", "UnionExp MinLoc, Type, Expression, Expression", "Expression eval_bsrLoc, FuncDeclaration, DArray<Expression>", "void semanticTypeInfoScope, Type", "void highlightCodeScope, Dsymbol, OutBuffer, int", "Expression eval_logLoc, FuncDeclaration, DArray<Expression>", "Expression eval_cosLoc, FuncDeclaration, DArray<Expression>", "boolean allowsContractWithoutBodyFuncDeclaration", "double cimaglcomplex_t", "int replaceTableRowOutBuffer, int, int, Loc, Ref<Slice<MarkdownDelimiter>>, IntSlice, boolean", "void verrorLoc, BytePtr, Slice<Object>, BytePtr, BytePtr, BytePtr", "UnionExp AndLoc, Type, Expression, Expression", "boolean _isZeroInitExpression", "boolean checkAccessLoc, Scope, Package", "Expression eval_ceilLoc, FuncDeclaration, DArray<Expression>", "boolean isCtfeReferenceValidExpression", "boolean checkFrameAccessLoc, Scope, AggregateDeclaration, int", "Expression ctfeInterpretExpression", "int ctfeCmpArraysLoc, Expression, Expression, long", "boolean isTypeInfo_ClassType", "byte deduceWildHelperType, Ptr<Type>, Type", "boolean isIndentWSBytePtr", "Expression evaluatePostblitInterState, Expression", "void verrorSupplementalLoc, BytePtr, Slice<Object>", "boolean checkAccessLoc, Scope, Expression, Declaration", "FuncDeclaration search_toStringStructDeclaration", "Expression eval_sinLoc, FuncDeclaration, DArray<Expression>", "UnionExp Equalbyte, Loc, Type, Expression, Expression", "void emplaceExpObject, Loc _param_1, Expression _param_2, TypeVector _param_3VectorExpLocExpressionTypeVector", "int replaceMarkdownEmphasisOutBuffer, Loc, Ref<Slice<MarkdownDelimiter>>, int", "void emplaceExpObject, Loc _param_1, Object _param_2, int _param_3, byte _param_4StringExpLocObjectIntegerByte", "ByteSlice generateSlice<Msgtable>, Function1<Msgtable,ByteSlice>", "void emplaceExpObject, Loc _param_1, DArray<Expression> _param_2TupleExpLocDArray<Expression>", "void processFileByteSlice, ByteSlice, BytePtr_lispy", "Expression eval_popcntLoc, FuncDeclaration, DArray<Expression>", "Expression eval_bsfLoc, FuncDeclaration, DArray<Expression>", "void setValueWithoutCheckingVarDeclaration, Expression", "void mangleToBufferType, OutBuffer", "int isBuiltinFuncDeclaration", "Expression paintFloatIntUnionExp, Expression, Type", "void sliceAssignStringFromStringStringExp, StringExp, int", "Expression paintTypeOntoLiteralUnionExp, Type, Expression", "boolean symbolIsVisibleModule, Dsymbol", "void ctfeCompileFuncDeclaration", "Expression eval_fabsLoc, FuncDeclaration, DArray<Expression>", "void printCtfePerformanceStats", "void highlightCodeScope, DArray<Dsymbol>, OutBuffer, int", "ByteSlice getFilenameDArray<Identifier>, Identifier", "Expression interpretExpression, InterState, int", "Expression getValueExpression", "void messageBytePtr", "Expression eval_isnanLoc, FuncDeclaration, DArray<Expression>", "Expression ctfeCastUnionExp, Loc, Type, Type, Expression", "UnionExp NotType, Expression", "void escapeStrayParenthesisLoc, OutBuffer, int, boolean", "void lambdaSetParentExpression, FuncDeclaration", "boolean isIdStartBytePtr", "int intUnsignedCmpbyte, long, long", "void emplaceExpObject, Loc _param_1, int _param_2, Type _param_3IntegerExpLocIntegerType", "UnionExp pointerArithmeticLoc, byte, Type, Expression, Expression", "void emitProtectionOutBuffer, Declaration", "int templateIdentifierLookupIdentifier, DArray<TemplateParameter>", "ByteSlice lispyBytePtr, ByteSlice", "boolean walkPostorderExpression, StoppableVisitor", "TypeFunction isTypeFunctionDsymbol", "void printDepsConditionalScope, DVCondition, ByteSlice", "Expression expTypeType, Expression", "Expression resolveAliasThisScope, Expression, boolean", "int detectAtxHeadingLevelOutBuffer, int", "Type isTypeRootObject", "Expression eval_builtinLoc, FuncDeclaration, DArray<Expression>", "boolean c_isxdigitint", "BytePtr utf_decodeWcharCharPtr, int, IntRef, IntRef", "Expression interpretUnionExp, Statement, InterState", "ByteSlice deinitializerMsgtable", "Expression eval_unimpLoc, FuncDeclaration, DArray<Expression>", "void utf_encodeCharBytePtr, int", "void semantic3OnDependenciesModule", "UnionExp copyLiteralExpression", "UnionExp paintTypeOntoLiteralCopyType, Expression", "Expression interpret_aaApplyUnionExp, InterState, Expression, Expression", "void emitCommentDsymbol, OutBuffer, Scope", "void emplaceExpObject, Loc _param_1, VarExp _param_2, Type _param_3AddrExpLocVarExpType", "ByteSlice skipwhitespaceByteSlice", "void vdeprecationSupplementalLoc, BytePtr, Slice<Object>", "void highlightCode2Scope, DArray<Dsymbol>, OutBuffer, int", "FuncDeclaration funcptrOfExpression", "void emplaceExpObject, Loc _param_1, DArray<Expression> _param_2, DArray<Expression> _param_3AssocArrayLiteralExpLocDArray<Expression>DArray<Expression>", "void parseModulePatternBytePtr, MatcherNode, short", "void mangleToBufferExpression, OutBuffer", "boolean matchRootObject, RootObject", "Expression eval_exp2Loc, FuncDeclaration, DArray<Expression>", "int getMarkdownIndentOutBuffer, int, int", "int startTableOutBuffer, int, int, Loc, boolean, Ref<Slice<MarkdownDelimiter>>, Ref<IntSlice>", "boolean isKeywordBytePtr, int", "UnionExp CatType, Expression, Expression", "Expression eval_isfiniteLoc, FuncDeclaration, DArray<Expression>", "int comparePointersbyte, Expression, long, Expression, long", "boolean isDittoBytePtr", "void emplaceExpObject, Loc _param_1, Type _param_2NullExpLocType", "boolean isAssocArrayType", "boolean isSafePointerCastType, Type", "boolean numCmpbyte, double, doubleDouble", "void mangleToBufferDsymbol, OutBuffer", "void aliasSemanticAliasDeclaration, Scope", "Parameter isEponymousFunctionParameterDArray<Dsymbol>, BytePtr, int", "void emplaceExpObject, Loc _param_1, Type _param_2, DArray<Expression> _param_3ArrayLiteralExpLocTypeDArray<Expression>", "Expression assignAssocArrayElementLoc, AssocArrayLiteralExp, Expression, Expression", "void emplaceExpObject, Loc _param_1, IndexExp _param_2, Type _param_3AddrExpLocIndexExpType", "ByteSlice identifierMsgtable", "boolean ishexbyte", "void processFileByteSlice, ByteSlice, BytePtr_lex", "Expression eval_bswapLoc, FuncDeclaration, DArray<Expression>", "void vdeprecationLoc, BytePtr, Slice<Object>, BytePtr, BytePtr", "void setValueVarDeclaration, Expression", "void halt", "BytePtr mangleExactFuncDeclaration", "void emplaceExpObject, int _param_1IntegerExpInteger", "Expression eval_expm1Loc, FuncDeclaration, DArray<Expression>", "Dsymbol isDsymbolRootObject", "boolean isReservedNameByteSlice", "boolean hasProtectedAccessScope, Dsymbol", "void writeHighlightsConsole, OutBuffer", "boolean numCmpbyte, long, longLong", "Expression interpret_dupUnionExp, InterState, Expression", "Dsymbol getEponymousMemberTemplateDeclaration", "Expression eval_powLoc, FuncDeclaration, DArray<Expression>", "boolean hasValueVarDeclaration", "void templateInstanceSemanticTemplateInstance, Scope, DArray<Expression>", "Type getTypeRootObject", "Expression foreachApplyUtfUnionExp, InterState, Expression, Expression, boolean", "boolean includeImportedModuleCheckModuleComponentRange", "Expression eval_fmaLoc, FuncDeclaration, DArray<Expression>", "void sliceAssignArrayLiteralFromStringArrayLiteralExp, StringExp, int", "boolean writeMixinByteSlice, Loc", "void toDocBufferDsymbol, OutBuffer, Scope", "void emplaceExpObject, Loc _param_1, SliceExp _param_2, Type _param_3AddrExpLocSliceExpType"]] signature: void emplaceExpObject, Loc _param_1, Expression _param_2AddrExpLocExpression
    ...
    // from template emplaceExp!(StructLiteralExpLocStructDeclarationDArray<Expression>)
    // removed duplicate function, [["Expression eval_yl2xp1Loc, FuncDeclaration, DArray<Expression>", "int skipPastIdentWithDotsOutBuffer, int", "boolean emitAnchorNameOutBuffer, Dsymbol, Scope, boolean", "TemplateParameter isTemplateParameterDArray<Dsymbol>, BytePtr, int", "void emplaceExpObject, Loc _param_1, double _param_2, Type _param_3RealExpLocDoubleType", "TypeAArray toBuiltinAATypeType", "Expression eval_isinfinityLoc, FuncDeclaration, DArray<Expression>", "boolean mergeCallSuperRef<Short>, short", "Expression eval_floorLoc, FuncDeclaration, DArray<Expression>", "UnionExp changeArrayLiteralLengthLoc, TypeArray, Expression, int, int", "ArrayLiteralExp createBlockDuplicatedArrayLiteralUnionExp, Loc, Type, Expression, int", "BytePtr stripLeadingNewlinesBytePtr", "void emplaceExpObject, byte _param_1CTFEExpByte", "void createMatchNodes", "UnionExp ArrayLengthType, Expression", "boolean checkAccessAggregateDeclaration, Loc, Scope, Dsymbol", "Expression resolveSliceExpression, UnionExp", "Expression getValueVarDeclaration", "boolean hasPackageAccessScope, Dsymbol", "void emplaceExpObject, Loc _param_1, Expression _param_2, Type _param_3AddrExpLocExpressionType", "boolean isFloatIntPaintType, Type", "int mainSlice<ByteSlice>", "void vmessageLoc, BytePtr, Slice<Object>", "boolean isValidManglingint", "int getAlignmentAlignDeclaration, Scope", "int arrayObjectHashDArray<RootObject>", "boolean numCmpbyte, int, intInteger", "boolean exceptionOrCantInterpretExpression", "ByteSlice lookForSourceFileByteSlice", "void showCtfeExprExpression, int", "void emplaceExpObject, Loc _param_1, Expression _param_2AddrExpLocExpression", "void removeBlankLineMacroOutBuffer, IntRef, IntRef", "boolean isErrorRootObject", "void emitMemberCommentsScopeDsymbol, OutBuffer, Scope", "UnionExp ctfeCatLoc, Type, Expression, Expression", "void escapeDdocStringOutBuffer, int", "void deprecationLoc, BytePtr", "void messageLoc, BytePtr", "Parameter isFunctionParameterDArray<Dsymbol>, BytePtr, int", "short parseModulePatternDepthBytePtr", "void MODtoDecoBufferOutBuffer, byte", "UnionExp ModLoc, Type, Expression, Expression", "void emplaceExpObject, Loc _param_1, Object _param_2, int _param_3StringExpLocObjectInteger", "void emplaceExpObject, Loc _param_1, StructLiteralExp _param_2, Type _param_3ClassReferenceExpLocStructLiteralExpType", "Expression eval_tanLoc, FuncDeclaration, DArray<Expression>", "int skippastURLOutBuffer, int", "boolean isZeroSecondbyte", "Expression eval_copysignLoc, FuncDeclaration, DArray<Expression>", "Expression eval_log2Loc, FuncDeclaration, DArray<Expression>", "double creallcomplex_t", "void warningSupplementalLoc, BytePtr", "int deduceTypeRootObject, Scope, Type, DArray<TemplateParameter>, DArray<RootObject>, IntPtr, int, boolean", "Tuple isTupleRootObject", "Expression eval_truncLoc, FuncDeclaration, DArray<Expression>", "UnionExp DivLoc, Type, Expression, Expression", "void expandTemplateMixinCommentsTemplateMixin, OutBuffer, Scope", "Expression eval_sqrtLoc, FuncDeclaration, DArray<Expression>", "boolean lambdaCheckForNestedRefExpression, Scope", "void emplaceExpObject, Loc _param_1, complex_t _param_2, Type _param_3ComplexExpLoccomplex_tType", "void dsymbolSemanticDsymbol, Scope", "void cantExpUnionExp", "boolean pointToSameMemoryBlockExpression, Expression", "long getStorageClassPrefixAttributesASTBaseASTBase", "UnionExp ComType, Expression", "ByteSlice initializerMsgtable", "int specificCmpbyte, int", "void builtinDeinitialize", "boolean isDigitSecondbyte", "Scope skipNonQualScopesScope", "UnionExp MulLoc, Type, Expression, Expression", "int utfStrideBytePtr", "void verrorPrintLoc, int, BytePtr, BytePtr, Slice<Object>, BytePtr, BytePtr", "int ctfeCmpLoc, byte, Expression, Expression", "boolean isTrueBoolExpression", "void builtin_init", "Parameter isParameterRootObject", "void errorSupplementalLoc, BytePtr", "long resolveArrayLengthExpression", "Expression evaluateDtorInterState, Expression", "int foreachDsymbolDArray<Dsymbol>, Function1<Dsymbol,Integer>", "Expression interpret_lengthUnionExp, InterState, Expression", "Parameter isFunctionParameterDsymbol, BytePtr, int", "void emitProtectionOutBuffer, Import", "TemplateParameter isTemplateParameterRootObject", "boolean arrayObjectMatchDArray<RootObject>, DArray<RootObject>", "void emplaceExpObject, Loc _param_1, Type _param_2, Expression _param_3, DArray<Expression> _param_4ArrayLiteralExpLocTypeExpressionDArray<Expression>", "boolean reliesOnTemplateParametersExpression, Slice<TemplateParameter>", "int endAllMarkdownQuotesOutBuffer, int, IntRef", "void emplaceExpObject, Loc _param_1, Expression _param_2, FuncDeclaration _param_3, boolean _param_4DelegateExpLocExpressionFuncDeclarationBoolean", "boolean definitelyValueParameterExpression", "void emplaceExpObject, Loc _param_1, boolean _param_2, Type _param_3IntegerExpLocBooleanType", "boolean reliesOnTidentType, DArray<TemplateParameter>, int", "Expression eval_yl2xLoc, FuncDeclaration, DArray<Expression>", "void errorLoc, BytePtr", "boolean utf_isValidDcharint", "void fatal", "Expression evaluateIfBuiltinUnionExp, InterState, Loc, FuncDeclaration, DArray<Expression>, Expression", "UnionExp pointerDifferenceLoc, Type, Expression, Expression", "UnionExp NegType, Expression", "boolean isidcharbyte", "int utf_codeLengthWcharint", "Expression getValueRef<Dsymbol>", "Function3<Loc,FuncDeclaration,DArray<Expression>,Expression> builtin_lookupBytePtr", "BytePtr linkToCharsint", "Expression interpretStatement, InterState", "int isConstExpression", "Expression getExpressionRootObject", "void emitProtectionOutBuffer, Prot", "Expression ctfeIndexLoc, Type, Expression, long", "int utf_codeLengthint, int", "UnionExp SliceType, Expression, Expression, Expression", "void functionResolveMatchAccumulator, Dsymbol, Loc, Scope, DArray<RootObject>, Type, DArray<Expression>, Ptr<BytePtr>", "int intSignedCmpbyte, long, long", "int ctfeIdentityLoc, byte, Expression, Expression", "Expression ctfeInterpretForPragmaMsgExpression", "void emplaceExpObject, Loc _param_1, long _param_2, Type _param_3IntegerExpLocLongType", "boolean isUniAlphaint", "BytePtr skipwhitespaceBytePtr", "UnionExp Cmpbyte, Loc, Type, Expression, Expression", "Dsymbol mostVisibleOverloadDsymbol, Module", "UnionExp OrLoc, Type, Expression, Expression", "void emplaceExpObject, Loc _param_1, Declaration _param_2, int _param_3SymOffExpLocDeclarationInteger", "int sliceCmpStringWithArrayStringExp, ArrayLiteralExp, int, int, int", "boolean hasPackageAccessModule, Dsymbol", "CtorDeclaration generateCopyCtorDeclarationStructDeclaration, long, long", "void errorBytePtr, int, int, BytePtr", "void add_builtinBytePtr, Function3<Loc,FuncDeclaration,DArray<Expression>,Expression>", "UnionExp PtrType, Expression", "void utf_encodeWcharCharPtr, int", "boolean findConditionDArray<Identifier>, Identifier", "int ctfeRawCmpLoc, Expression, Expression, boolean", "UnionExp ShlLoc, Type, Expression, Expression", "void highlightTextScope, DArray<Dsymbol>, Loc, OutBuffer, int", "UnionExp voidInitLiteralType, VarDeclaration", "void gendocfileModule", "boolean isIdTailBytePtr", "UnionExp ShrLoc, Type, Expression, Expression", "void emplaceExpObject, Loc _param_1, Type _param_2, Expression _param_3ArrayLiteralExpLocTypeExpression", "int setMangleOverrideDsymbol, ByteSlice", "Dsymbol getDsymbolRootObject", "Expression eval_log10Loc, FuncDeclaration, DArray<Expression>", "Expression eval_expLoc, FuncDeclaration, DArray<Expression>", "Expression getAggregateFromPointerExpression, Ptr<Long>", "void emplaceExpObject, Loc _param_1, Expression _param_2, Expression _param_3IndexExpLocExpressionExpression", "Expression eval_fmaxLoc, FuncDeclaration, DArray<Expression>", "boolean isArrayExpression", "UnionExp CastLoc, Type, Type, Expression", "UnionExp IndexType, Expression, Expression", "void emitAnchorOutBuffer, Dsymbol, Scope, boolean", "void removeAnyAtxHeadingSuffixOutBuffer, int", "DArray<Expression> copyElementsExpression, Expression", "void assignInPlaceExpression, Expression", "TemplateDeclaration getEponymousParentDsymbol", "void utf_encodeint, Object, int", "boolean issinglecharbyte", "ByteSlice replaceCharByteSlice, byte, ByteSlice", "int getCodeIndentBytePtr", "boolean isIdentifierDArray<Dsymbol>, BytePtr, int", "BytePtr utf_decodeCharBytePtr, int, IntRef, IntRef", "void vwarningLoc, BytePtr, Slice<Object>", "boolean needToCopyLiteralExpression", "int sliceCmpStringWithStringStringExp, StringExp, int, int, int", "boolean isCtfeComparableExpression", "ByteSlice memdupByteSlice", "void mangleToBufferTemplateInstance, OutBuffer", "ByteSlice lexBytePtr, ByteSlice", "boolean isPointerType", "Expression findKeyInAALoc, AssocArrayLiteralExp, Expression", "int endTableOutBuffer, int, Ref<IntSlice>", "Expression scrubReturnValueLoc, Expression", "Type rawTypeMergeType, Type", "void emplaceExpObject, Loc _param_1, Expression _param_2, Type _param_3VectorExpLocExpressionType", "boolean buildCopyCtorStructDeclaration, Scope", "boolean reliesOnTemplateParametersType, Slice<TemplateParameter>", "int utf_codeLengthCharint", "void highlightCode3Scope, OutBuffer, BytePtr, BytePtr", "BytePtr getMessageDeprecatedDeclaration", "int endAllListsAndQuotesOutBuffer, IntRef, Ref<Slice<MarkdownList>>, IntRef, IntRef", "ByteSlice toLowercaseByteSlice", "Expression interpretFunctionUnionExp, FuncDeclaration, InterState, DArray<Expression>, Expression", "Expression interpret_valuesUnionExp, InterState, Expression, Type", "Expression eval_roundLoc, FuncDeclaration, DArray<Expression>", "void emplaceExpObject, Loc _param_1, Expression _param_2, Expression _param_3, Expression _param_4SliceExpLocExpressionExpressionExpression", "boolean modifyFieldVarLoc, Scope, VarDeclaration, Expression", "void deprecationSupplementalLoc, BytePtr", "Expression eval_ldexpLoc, FuncDeclaration, DArray<Expression>", "int extractArgNByteSlice, Ref<ByteSlice>, int", "UnionExp UshrLoc, Type, Expression, Expression", "Expression interpret_keysUnionExp, InterState, Expression, Type", "UnionExp Identitybyte, Loc, Type, Expression, Expression", "void vwarningSupplementalLoc, BytePtr, Slice<Object>", "BytePtr modToCharsint", "boolean checkSymbolAccessScope, Dsymbol", "Expression toDelegateExpression, Type, Scope", "UnionExp PowLoc, Type, Expression, Expression", "int isattyint", "Expression scrubCacheValueExpression", "int findFieldIndexByNameStructDeclaration, VarDeclaration", "boolean replaceMarkdownThematicBreakOutBuffer, IntRef, int, Loc", "RootObject objectSyntaxCopyRootObject", "int ctfeEqualLoc, byte, Expression, Expression", "void emplaceExpObject, Loc _param_1, Object _param_2, DArray<Expression> _param_3ArrayLiteralExpLocObjectDArray<Expression>", "void emplaceExpObject, Loc _param_1, Declaration _param_2, long _param_3SymOffExpLocDeclarationLong", "FuncDeclaration buildPostBlitStructDeclaration, Scope", "int skipCharsOutBuffer, int, ByteSlice", "Statement generateCopyCtorBodyStructDeclaration", "void sliceAssignStringFromArrayLiteralStringExp, ArrayLiteralExp, int", "int expressionHashExpression", "boolean ensureStaticLinkToDsymbol, Dsymbol", "DArray<Expression> copyLiteralArrayDArray<Expression>, Expression", "int templateParameterLookupType, DArray<TemplateParameter>", "boolean symbolIsVisibleDsymbol, Dsymbol", "boolean c_isalnumint", "void tyToDecoBufferOutBuffer, int", "void emplaceExpObject, Loc _param_1, StructDeclaration _param_2, DArray<Expression> _param_3StructLiteralExpLocStructDeclarationDArray<Expression>", "void ObjectNotFoundIdentifier", "boolean isCVariadicParameterDArray<Dsymbol>, ByteSlice", "void mangleToFuncSignatureOutBuffer, FuncDeclaration", "void colorHighlightCodeOutBuffer", "boolean symbolIsVisibleScope, Dsymbol", "void emplaceExpObject, Loc _param_1, TypeSArray _param_2, DArray<Expression> _param_3ArrayLiteralExpLocTypeSArrayDArray<Expression>", "void warningLoc, BytePtr", "UnionExp BoolType, Expression", "StringExp createBlockDuplicatedStringLiteralUnionExp, Loc, Type, int, int, byte", "void colorSyntaxHighlightOutBuffer", "Expression paintTypeOntoLiteralType, Expression", "void endMarkdownHeadingOutBuffer, int, IntRef, Loc, IntRef", "int endRowAndTableOutBuffer, int, int, Loc, Ref<Slice<MarkdownDelimiter>>, Ref<IntSlice>", "boolean isoctalbyte", "void unSpeculativeScope, RootObject", "Expression eval_fminLoc, FuncDeclaration, DArray<Expression>", "boolean arrayObjectIsErrorDArray<RootObject>", "long getStorageClassPrefixAttributesASTCodegenASTCodegen", "boolean isSpecialEnumIdentIdentifier", "int skiptoidentOutBuffer, int", "int deduceTypeHelperType, Ptr<Type>, Type", "boolean mergeFieldInitRef<Short>, short", "void emplaceExpObject, VarDeclaration _param_1VoidInitExpVarDeclaration", "void foreachDsymbolDArray<Dsymbol>, Function1<Dsymbol,Void>", "Expression interpretUnionExp, Expression, InterState, int", "UnionExp AddLoc, Type, Expression, Expression", "Expression isExpressionRootObject", "void emplaceExpObject, Loc _param_1, Expression _param_2, IntegerExp _param_3, Expression _param_4SliceExpLocExpressionIntegerExpExpression", "int parseTableDelimiterRowOutBuffer, int, boolean, Ref<IntSlice>", "int skippastidentOutBuffer, int", "UnionExp XorLoc, Type, Expression, Expression", "int realCmpbyte, double, double", "boolean isCVariadicArgByteSlice", "boolean isCtfeValueValidExpression", "UnionExp MinLoc, Type, Expression, Expression", "Expression eval_bsrLoc, FuncDeclaration, DArray<Expression>", "void semanticTypeInfoScope, Type", "void highlightCodeScope, Dsymbol, OutBuffer, int", "Expression eval_logLoc, FuncDeclaration, DArray<Expression>", "Expression eval_cosLoc, FuncDeclaration, DArray<Expression>", "boolean allowsContractWithoutBodyFuncDeclaration", "double cimaglcomplex_t", "int replaceTableRowOutBuffer, int, int, Loc, Ref<Slice<MarkdownDelimiter>>, IntSlice, boolean", "void verrorLoc, BytePtr, Slice<Object>, BytePtr, BytePtr, BytePtr", "UnionExp AndLoc, Type, Expression, Expression", "boolean _isZeroInitExpression", "boolean checkAccessLoc, Scope, Package", "Expression eval_ceilLoc, FuncDeclaration, DArray<Expression>", "boolean isCtfeReferenceValidExpression", "boolean checkFrameAccessLoc, Scope, AggregateDeclaration, int", "Expression ctfeInterpretExpression", "int ctfeCmpArraysLoc, Expression, Expression, long", "boolean isTypeInfo_ClassType", "byte deduceWildHelperType, Ptr<Type>, Type", "boolean isIndentWSBytePtr", "Expression evaluatePostblitInterState, Expression", "void verrorSupplementalLoc, BytePtr, Slice<Object>", "boolean checkAccessLoc, Scope, Expression, Declaration", "FuncDeclaration search_toStringStructDeclaration", "Expression eval_sinLoc, FuncDeclaration, DArray<Expression>", "UnionExp Equalbyte, Loc, Type, Expression, Expression", "void emplaceExpObject, Loc _param_1, Expression _param_2, TypeVector _param_3VectorExpLocExpressionTypeVector", "int replaceMarkdownEmphasisOutBuffer, Loc, Ref<Slice<MarkdownDelimiter>>, int", "void emplaceExpObject, Loc _param_1, Object _param_2, int _param_3, byte _param_4StringExpLocObjectIntegerByte", "ByteSlice generateSlice<Msgtable>, Function1<Msgtable,ByteSlice>", "void emplaceExpObject, Loc _param_1, DArray<Expression> _param_2TupleExpLocDArray<Expression>", "void processFileByteSlice, ByteSlice, BytePtr_lispy", "Expression eval_popcntLoc, FuncDeclaration, DArray<Expression>", "Expression eval_bsfLoc, FuncDeclaration, DArray<Expression>", "void setValueWithoutCheckingVarDeclaration, Expression", "void mangleToBufferType, OutBuffer", "int isBuiltinFuncDeclaration", "Expression paintFloatIntUnionExp, Expression, Type", "void sliceAssignStringFromStringStringExp, StringExp, int", "Expression paintTypeOntoLiteralUnionExp, Type, Expression", "boolean symbolIsVisibleModule, Dsymbol", "void ctfeCompileFuncDeclaration", "Expression eval_fabsLoc, FuncDeclaration, DArray<Expression>", "void printCtfePerformanceStats", "void highlightCodeScope, DArray<Dsymbol>, OutBuffer, int", "ByteSlice getFilenameDArray<Identifier>, Identifier", "Expression interpretExpression, InterState, int", "Expression getValueExpression", "void messageBytePtr", "Expression eval_isnanLoc, FuncDeclaration, DArray<Expression>", "Expression ctfeCastUnionExp, Loc, Type, Type, Expression", "UnionExp NotType, Expression", "void escapeStrayParenthesisLoc, OutBuffer, int, boolean", "void lambdaSetParentExpression, FuncDeclaration", "boolean isIdStartBytePtr", "int intUnsignedCmpbyte, long, long", "void emplaceExpObject, Loc _param_1, int _param_2, Type _param_3IntegerExpLocIntegerType", "UnionExp pointerArithmeticLoc, byte, Type, Expression, Expression", "void emitProtectionOutBuffer, Declaration", "int templateIdentifierLookupIdentifier, DArray<TemplateParameter>", "ByteSlice lispyBytePtr, ByteSlice", "boolean walkPostorderExpression, StoppableVisitor", "TypeFunction isTypeFunctionDsymbol", "void printDepsConditionalScope, DVCondition, ByteSlice", "Expression expTypeType, Expression", "Expression resolveAliasThisScope, Expression, boolean", "int detectAtxHeadingLevelOutBuffer, int", "Type isTypeRootObject", "Expression eval_builtinLoc, FuncDeclaration, DArray<Expression>", "boolean c_isxdigitint", "BytePtr utf_decodeWcharCharPtr, int, IntRef, IntRef", "Expression interpretUnionExp, Statement, InterState", "ByteSlice deinitializerMsgtable", "Expression eval_unimpLoc, FuncDeclaration, DArray<Expression>", "void utf_encodeCharBytePtr, int", "void semantic3OnDependenciesModule", "UnionExp copyLiteralExpression", "UnionExp paintTypeOntoLiteralCopyType, Expression", "Expression interpret_aaApplyUnionExp, InterState, Expression, Expression", "void emitCommentDsymbol, OutBuffer, Scope", "void emplaceExpObject, Loc _param_1, VarExp _param_2, Type _param_3AddrExpLocVarExpType", "ByteSlice skipwhitespaceByteSlice", "void vdeprecationSupplementalLoc, BytePtr, Slice<Object>", "void highlightCode2Scope, DArray<Dsymbol>, OutBuffer, int", "FuncDeclaration funcptrOfExpression", "void emplaceExpObject, Loc _param_1, DArray<Expression> _param_2, DArray<Expression> _param_3AssocArrayLiteralExpLocDArray<Expression>DArray<Expression>", "void parseModulePatternBytePtr, MatcherNode, short", "void mangleToBufferExpression, OutBuffer", "boolean matchRootObject, RootObject", "Expression eval_exp2Loc, FuncDeclaration, DArray<Expression>", "int getMarkdownIndentOutBuffer, int, int", "int startTableOutBuffer, int, int, Loc, boolean, Ref<Slice<MarkdownDelimiter>>, Ref<IntSlice>", "boolean isKeywordBytePtr, int", "UnionExp CatType, Expression, Expression", "Expression eval_isfiniteLoc, FuncDeclaration, DArray<Expression>", "int comparePointersbyte, Expression, long, Expression, long", "boolean isDittoBytePtr", "void emplaceExpObject, Loc _param_1, Type _param_2NullExpLocType", "boolean isAssocArrayType", "boolean isSafePointerCastType, Type", "boolean numCmpbyte, double, doubleDouble", "void mangleToBufferDsymbol, OutBuffer", "void aliasSemanticAliasDeclaration, Scope", "Parameter isEponymousFunctionParameterDArray<Dsymbol>, BytePtr, int", "void emplaceExpObject, Loc _param_1, Type _param_2, DArray<Expression> _param_3ArrayLiteralExpLocTypeDArray<Expression>", "Expression assignAssocArrayElementLoc, AssocArrayLiteralExp, Expression, Expression", "void emplaceExpObject, Loc _param_1, IndexExp _param_2, Type _param_3AddrExpLocIndexExpType", "ByteSlice identifierMsgtable", "boolean ishexbyte", "void processFileByteSlice, ByteSlice, BytePtr_lex", "Expression eval_bswapLoc, FuncDeclaration, DArray<Expression>", "void vdeprecationLoc, BytePtr, Slice<Object>, BytePtr, BytePtr", "void setValueVarDeclaration, Expression", "void halt", "BytePtr mangleExactFuncDeclaration", "void emplaceExpObject, int _param_1IntegerExpInteger", "Expression eval_expm1Loc, FuncDeclaration, DArray<Expression>", "Dsymbol isDsymbolRootObject", "boolean isReservedNameByteSlice", "boolean hasProtectedAccessScope, Dsymbol", "void writeHighlightsConsole, OutBuffer", "boolean numCmpbyte, long, longLong", "Expression interpret_dupUnionExp, InterState, Expression", "Dsymbol getEponymousMemberTemplateDeclaration", "Expression eval_powLoc, FuncDeclaration, DArray<Expression>", "boolean hasValueVarDeclaration", "void templateInstanceSemanticTemplateInstance, Scope, DArray<Expression>", "Type getTypeRootObject", "Expression foreachApplyUtfUnionExp, InterState, Expression, Expression, boolean", "boolean includeImportedModuleCheckModuleComponentRange", "Expression eval_fmaLoc, FuncDeclaration, DArray<Expression>", "void sliceAssignArrayLiteralFromStringArrayLiteralExp, StringExp, int", "boolean writeMixinByteSlice, Loc", "void toDocBufferDsymbol, OutBuffer, Scope", "void emplaceExpObject, Loc _param_1, SliceExp _param_2, Type _param_3AddrExpLocSliceExpType"]] signature: void emplaceExpObject, Loc _param_1, StructDeclaration _param_2, DArray<Expression> _param_3StructLiteralExpLocStructDeclarationDArray<Expression>
    ...
    // from template emplaceExp!(IntegerExpLocLongType)
    // removed duplicate function, [["Expression eval_yl2xp1Loc, FuncDeclaration, DArray<Expression>", "int skipPastIdentWithDotsOutBuffer, int", "boolean emitAnchorNameOutBuffer, Dsymbol, Scope, boolean", "TemplateParameter isTemplateParameterDArray<Dsymbol>, BytePtr, int", "void emplaceExpObject, Loc _param_1, double _param_2, Type _param_3RealExpLocDoubleType", "TypeAArray toBuiltinAATypeType", "Expression eval_isinfinityLoc, FuncDeclaration, DArray<Expression>", "boolean mergeCallSuperRef<Short>, short", "Expression eval_floorLoc, FuncDeclaration, DArray<Expression>", "UnionExp changeArrayLiteralLengthLoc, TypeArray, Expression, int, int", "ArrayLiteralExp createBlockDuplicatedArrayLiteralUnionExp, Loc, Type, Expression, int", "BytePtr stripLeadingNewlinesBytePtr", "void emplaceExpObject, byte _param_1CTFEExpByte", "void createMatchNodes", "UnionExp ArrayLengthType, Expression", "boolean checkAccessAggregateDeclaration, Loc, Scope, Dsymbol", "Expression resolveSliceExpression, UnionExp", "Expression getValueVarDeclaration", "boolean hasPackageAccessScope, Dsymbol", "void emplaceExpObject, Loc _param_1, Expression _param_2, Type _param_3AddrExpLocExpressionType", "boolean isFloatIntPaintType, Type", "int mainSlice<ByteSlice>", "void vmessageLoc, BytePtr, Slice<Object>", "boolean isValidManglingint", "int getAlignmentAlignDeclaration, Scope", "int arrayObjectHashDArray<RootObject>", "boolean numCmpbyte, int, intInteger", "boolean exceptionOrCantInterpretExpression", "ByteSlice lookForSourceFileByteSlice", "void showCtfeExprExpression, int", "void emplaceExpObject, Loc _param_1, Expression _param_2AddrExpLocExpression", "void removeBlankLineMacroOutBuffer, IntRef, IntRef", "boolean isErrorRootObject", "void emitMemberCommentsScopeDsymbol, OutBuffer, Scope", "UnionExp ctfeCatLoc, Type, Expression, Expression", "void escapeDdocStringOutBuffer, int", "void deprecationLoc, BytePtr", "void messageLoc, BytePtr", "Parameter isFunctionParameterDArray<Dsymbol>, BytePtr, int", "short parseModulePatternDepthBytePtr", "void MODtoDecoBufferOutBuffer, byte", "UnionExp ModLoc, Type, Expression, Expression", "void emplaceExpObject, Loc _param_1, Object _param_2, int _param_3StringExpLocObjectInteger", "void emplaceExpObject, Loc _param_1, StructLiteralExp _param_2, Type _param_3ClassReferenceExpLocStructLiteralExpType", "Expression eval_tanLoc, FuncDeclaration, DArray<Expression>", "int skippastURLOutBuffer, int", "boolean isZeroSecondbyte", "Expression eval_copysignLoc, FuncDeclaration, DArray<Expression>", "Expression eval_log2Loc, FuncDeclaration, DArray<Expression>", "double creallcomplex_t", "void warningSupplementalLoc, BytePtr", "int deduceTypeRootObject, Scope, Type, DArray<TemplateParameter>, DArray<RootObject>, IntPtr, int, boolean", "Tuple isTupleRootObject", "Expression eval_truncLoc, FuncDeclaration, DArray<Expression>", "UnionExp DivLoc, Type, Expression, Expression", "void expandTemplateMixinCommentsTemplateMixin, OutBuffer, Scope", "Expression eval_sqrtLoc, FuncDeclaration, DArray<Expression>", "boolean lambdaCheckForNestedRefExpression, Scope", "void emplaceExpObject, Loc _param_1, complex_t _param_2, Type _param_3ComplexExpLoccomplex_tType", "void dsymbolSemanticDsymbol, Scope", "void cantExpUnionExp", "boolean pointToSameMemoryBlockExpression, Expression", "long getStorageClassPrefixAttributesASTBaseASTBase", "UnionExp ComType, Expression", "ByteSlice initializerMsgtable", "int specificCmpbyte, int", "void builtinDeinitialize", "boolean isDigitSecondbyte", "Scope skipNonQualScopesScope", "UnionExp MulLoc, Type, Expression, Expression", "int utfStrideBytePtr", "void verrorPrintLoc, int, BytePtr, BytePtr, Slice<Object>, BytePtr, BytePtr", "int ctfeCmpLoc, byte, Expression, Expression", "boolean isTrueBoolExpression", "void builtin_init", "Parameter isParameterRootObject", "void errorSupplementalLoc, BytePtr", "long resolveArrayLengthExpression", "Expression evaluateDtorInterState, Expression", "int foreachDsymbolDArray<Dsymbol>, Function1<Dsymbol,Integer>", "void emplaceExpObject, ErrorExp", "Expression interpret_lengthUnionExp, InterState, Expression", "Parameter isFunctionParameterDsymbol, BytePtr, int", "void emitProtectionOutBuffer, Import", "TemplateParameter isTemplateParameterRootObject", "boolean arrayObjectMatchDArray<RootObject>, DArray<RootObject>", "void emplaceExpObject, Loc _param_1, Type _param_2, Expression _param_3, DArray<Expression> _param_4ArrayLiteralExpLocTypeExpressionDArray<Expression>", "boolean reliesOnTemplateParametersExpression, Slice<TemplateParameter>", "int endAllMarkdownQuotesOutBuffer, int, IntRef", "void emplaceExpObject, Loc _param_1, Expression _param_2, FuncDeclaration _param_3, boolean _param_4DelegateExpLocExpressionFuncDeclarationBoolean", "boolean definitelyValueParameterExpression", "void emplaceExpObject, Loc _param_1, boolean _param_2, Type _param_3IntegerExpLocBooleanType", "boolean reliesOnTidentType, DArray<TemplateParameter>, int", "Expression eval_yl2xLoc, FuncDeclaration, DArray<Expression>", "void errorLoc, BytePtr", "boolean utf_isValidDcharint", "void fatal", "Expression evaluateIfBuiltinUnionExp, InterState, Loc, FuncDeclaration, DArray<Expression>, Expression", "UnionExp pointerDifferenceLoc, Type, Expression, Expression", "UnionExp NegType, Expression", "boolean isidcharbyte", "int utf_codeLengthWcharint", "Expression getValueRef<Dsymbol>", "Function3<Loc,FuncDeclaration,DArray<Expression>,Expression> builtin_lookupBytePtr", "BytePtr linkToCharsint", "Expression interpretStatement, InterState", "int isConstExpression", "Expression getExpressionRootObject", "void emitProtectionOutBuffer, Prot", "Expression ctfeIndexLoc, Type, Expression, long", "int utf_codeLengthint, int", "UnionExp SliceType, Expression, Expression, Expression", "void functionResolveMatchAccumulator, Dsymbol, Loc, Scope, DArray<RootObject>, Type, DArray<Expression>, Ptr<BytePtr>", "int intSignedCmpbyte, long, long", "int ctfeIdentityLoc, byte, Expression, Expression", "Expression ctfeInterpretForPragmaMsgExpression", "void emplaceExpObject, Loc _param_1, long _param_2, Type _param_3IntegerExpLocLongType", "boolean isUniAlphaint", "BytePtr skipwhitespaceBytePtr", "UnionExp Cmpbyte, Loc, Type, Expression, Expression", "Dsymbol mostVisibleOverloadDsymbol, Module", "UnionExp OrLoc, Type, Expression, Expression", "void emplaceExpObject, Loc _param_1, Declaration _param_2, int _param_3SymOffExpLocDeclarationInteger", "int sliceCmpStringWithArrayStringExp, ArrayLiteralExp, int, int, int", "boolean hasPackageAccessModule, Dsymbol", "CtorDeclaration generateCopyCtorDeclarationStructDeclaration, long, long", "void errorBytePtr, int, int, BytePtr", "void add_builtinBytePtr, Function3<Loc,FuncDeclaration,DArray<Expression>,Expression>", "UnionExp PtrType, Expression", "void utf_encodeWcharCharPtr, int", "boolean findConditionDArray<Identifier>, Identifier", "int ctfeRawCmpLoc, Expression, Expression, boolean", "UnionExp ShlLoc, Type, Expression, Expression", "void highlightTextScope, DArray<Dsymbol>, Loc, OutBuffer, int", "UnionExp voidInitLiteralType, VarDeclaration", "void gendocfileModule", "boolean isIdTailBytePtr", "UnionExp ShrLoc, Type, Expression, Expression", "void emplaceExpObject, Loc _param_1, Type _param_2, Expression _param_3ArrayLiteralExpLocTypeExpression", "int setMangleOverrideDsymbol, ByteSlice", "Dsymbol getDsymbolRootObject", "Expression eval_log10Loc, FuncDeclaration, DArray<Expression>", "Expression eval_expLoc, FuncDeclaration, DArray<Expression>", "Expression getAggregateFromPointerExpression, Ptr<Long>", "void emplaceExpObject, Loc _param_1, Expression _param_2, Expression _param_3IndexExpLocExpressionExpression", "Expression eval_fmaxLoc, FuncDeclaration, DArray<Expression>", "boolean isArrayExpression", "UnionExp CastLoc, Type, Type, Expression", "UnionExp IndexType, Expression, Expression", "void emitAnchorOutBuffer, Dsymbol, Scope, boolean", "void removeAnyAtxHeadingSuffixOutBuffer, int", "DArray<Expression> copyElementsExpression, Expression", "void assignInPlaceExpression, Expression", "TemplateDeclaration getEponymousParentDsymbol", "void utf_encodeint, Object, int", "boolean issinglecharbyte", "ByteSlice replaceCharByteSlice, byte, ByteSlice", "int getCodeIndentBytePtr", "boolean isIdentifierDArray<Dsymbol>, BytePtr, int", "BytePtr utf_decodeCharBytePtr, int, IntRef, IntRef", "void vwarningLoc, BytePtr, Slice<Object>", "boolean needToCopyLiteralExpression", "int sliceCmpStringWithStringStringExp, StringExp, int, int, int", "boolean isCtfeComparableExpression", "ByteSlice memdupByteSlice", "void mangleToBufferTemplateInstance, OutBuffer", "ByteSlice lexBytePtr, ByteSlice", "boolean isPointerType", "Expression findKeyInAALoc, AssocArrayLiteralExp, Expression", "int endTableOutBuffer, int, Ref<IntSlice>", "Expression scrubReturnValueLoc, Expression", "Type rawTypeMergeType, Type", "void emplaceExpObject, Loc _param_1, Expression _param_2, Type _param_3VectorExpLocExpressionType", "boolean buildCopyCtorStructDeclaration, Scope", "boolean reliesOnTemplateParametersType, Slice<TemplateParameter>", "int utf_codeLengthCharint", "void highlightCode3Scope, OutBuffer, BytePtr, BytePtr", "BytePtr getMessageDeprecatedDeclaration", "int endAllListsAndQuotesOutBuffer, IntRef, Ref<Slice<MarkdownList>>, IntRef, IntRef", "ByteSlice toLowercaseByteSlice", "Expression interpretFunctionUnionExp, FuncDeclaration, InterState, DArray<Expression>, Expression", "Expression interpret_valuesUnionExp, InterState, Expression, Type", "Expression eval_roundLoc, FuncDeclaration, DArray<Expression>", "void emplaceExpObject, Loc _param_1, Expression _param_2, Expression _param_3, Expression _param_4SliceExpLocExpressionExpressionExpression", "boolean modifyFieldVarLoc, Scope, VarDeclaration, Expression", "void deprecationSupplementalLoc, BytePtr", "Expression eval_ldexpLoc, FuncDeclaration, DArray<Expression>", "int extractArgNByteSlice, Ref<ByteSlice>, int", "UnionExp UshrLoc, Type, Expression, Expression", "Expression interpret_keysUnionExp, InterState, Expression, Type", "UnionExp Identitybyte, Loc, Type, Expression, Expression", "void vwarningSupplementalLoc, BytePtr, Slice<Object>", "BytePtr modToCharsint", "boolean checkSymbolAccessScope, Dsymbol", "Expression toDelegateExpression, Type, Scope", "UnionExp PowLoc, Type, Expression, Expression", "int isattyint", "Expression scrubCacheValueExpression", "int findFieldIndexByNameStructDeclaration, VarDeclaration", "boolean replaceMarkdownThematicBreakOutBuffer, IntRef, int, Loc", "RootObject objectSyntaxCopyRootObject", "int ctfeEqualLoc, byte, Expression, Expression", "void emplaceExpObject, Loc _param_1, Object _param_2, DArray<Expression> _param_3ArrayLiteralExpLocObjectDArray<Expression>", "void emplaceExpObject, Loc _param_1, Declaration _param_2, long _param_3SymOffExpLocDeclarationLong", "FuncDeclaration buildPostBlitStructDeclaration, Scope", "int skipCharsOutBuffer, int, ByteSlice", "Statement generateCopyCtorBodyStructDeclaration", "void emplaceExpObject, Loc _param_1, Expression _param_2, IntegerExp _param_3IndexExpLocExpressionIntegerExp", "void sliceAssignStringFromArrayLiteralStringExp, ArrayLiteralExp, int", "int expressionHashExpression", "boolean ensureStaticLinkToDsymbol, Dsymbol", "void emplaceExpObject, Loc _param_1, StructDeclaration _param_2, DArray<Expression> _param_3, Type _param_4StructLiteralExpLocStructDeclarationDArray<Expression>Type", "DArray<Expression> copyLiteralArrayDArray<Expression>, Expression", "int templateParameterLookupType, DArray<TemplateParameter>", "boolean symbolIsVisibleDsymbol, Dsymbol", "boolean c_isalnumint", "void tyToDecoBufferOutBuffer, int", "void emplaceExpObject, Loc _param_1, StructDeclaration _param_2, DArray<Expression> _param_3StructLiteralExpLocStructDeclarationDArray<Expression>", "void ObjectNotFoundIdentifier", "boolean isCVariadicParameterDArray<Dsymbol>, ByteSlice", "void mangleToFuncSignatureOutBuffer, FuncDeclaration", "void colorHighlightCodeOutBuffer", "boolean symbolIsVisibleScope, Dsymbol", "void emplaceExpObject, Loc _param_1, TypeSArray _param_2, DArray<Expression> _param_3ArrayLiteralExpLocTypeSArrayDArray<Expression>", "void warningLoc, BytePtr", "UnionExp BoolType, Expression", "StringExp createBlockDuplicatedStringLiteralUnionExp, Loc, Type, int, int, byte", "void colorSyntaxHighlightOutBuffer", "Expression paintTypeOntoLiteralType, Expression", "void endMarkdownHeadingOutBuffer, int, IntRef, Loc, IntRef", "int endRowAndTableOutBuffer, int, int, Loc, Ref<Slice<MarkdownDelimiter>>, Ref<IntSlice>", "boolean isoctalbyte", "void unSpeculativeScope, RootObject", "Expression eval_fminLoc, FuncDeclaration, DArray<Expression>", "boolean arrayObjectIsErrorDArray<RootObject>", "long getStorageClassPrefixAttributesASTCodegenASTCodegen", "boolean isSpecialEnumIdentIdentifier", "int skiptoidentOutBuffer, int", "int deduceTypeHelperType, Ptr<Type>, Type", "boolean mergeFieldInitRef<Short>, short", "void emplaceExpObject, VarDeclaration _param_1VoidInitExpVarDeclaration", "void foreachDsymbolDArray<Dsymbol>, Function1<Dsymbol,Void>", "Expression interpretUnionExp, Expression, InterState, int", "UnionExp AddLoc, Type, Expression, Expression", "Expression isExpressionRootObject", "void emplaceExpObject, Loc _param_1, Expression _param_2, IntegerExp _param_3, Expression _param_4SliceExpLocExpressionIntegerExpExpression", "int parseTableDelimiterRowOutBuffer, int, boolean, Ref<IntSlice>", "int skippastidentOutBuffer, int", "UnionExp XorLoc, Type, Expression, Expression", "int realCmpbyte, double, double", "boolean isCVariadicArgByteSlice", "boolean isCtfeValueValidExpression", "UnionExp MinLoc, Type, Expression, Expression", "Expression eval_bsrLoc, FuncDeclaration, DArray<Expression>", "void semanticTypeInfoScope, Type", "void highlightCodeScope, Dsymbol, OutBuffer, int", "Expression eval_logLoc, FuncDeclaration, DArray<Expression>", "Expression eval_cosLoc, FuncDeclaration, DArray<Expression>", "boolean allowsContractWithoutBodyFuncDeclaration", "double cimaglcomplex_t", "int replaceTableRowOutBuffer, int, int, Loc, Ref<Slice<MarkdownDelimiter>>, IntSlice, boolean", "void verrorLoc, BytePtr, Slice<Object>, BytePtr, BytePtr, BytePtr", "UnionExp AndLoc, Type, Expression, Expression", "boolean _isZeroInitExpression", "boolean checkAccessLoc, Scope, Package", "Expression eval_ceilLoc, FuncDeclaration, DArray<Expression>", "boolean isCtfeReferenceValidExpression", "boolean checkFrameAccessLoc, Scope, AggregateDeclaration, int", "Expression ctfeInterpretExpression", "int ctfeCmpArraysLoc, Expression, Expression, long", "boolean isTypeInfo_ClassType", "byte deduceWildHelperType, Ptr<Type>, Type", "boolean isIndentWSBytePtr", "Expression evaluatePostblitInterState, Expression", "void verrorSupplementalLoc, BytePtr, Slice<Object>", "boolean checkAccessLoc, Scope, Expression, Declaration", "FuncDeclaration search_toStringStructDeclaration", "Expression eval_sinLoc, FuncDeclaration, DArray<Expression>", "UnionExp Equalbyte, Loc, Type, Expression, Expression", "void emplaceExpObject, Loc _param_1, Expression _param_2, TypeVector _param_3VectorExpLocExpressionTypeVector", "int replaceMarkdownEmphasisOutBuffer, Loc, Ref<Slice<MarkdownDelimiter>>, int", "void emplaceExpObject, Loc _param_1, Object _param_2, int _param_3, byte _param_4StringExpLocObjectIntegerByte", "ByteSlice generateSlice<Msgtable>, Function1<Msgtable,ByteSlice>", "void emplaceExpObject, Loc _param_1, DArray<Expression> _param_2TupleExpLocDArray<Expression>", "void processFileByteSlice, ByteSlice, BytePtr_lispy", "Expression eval_popcntLoc, FuncDeclaration, DArray<Expression>", "Expression eval_bsfLoc, FuncDeclaration, DArray<Expression>", "void setValueWithoutCheckingVarDeclaration, Expression", "void mangleToBufferType, OutBuffer", "int isBuiltinFuncDeclaration", "Expression paintFloatIntUnionExp, Expression, Type", "void sliceAssignStringFromStringStringExp, StringExp, int", "Expression paintTypeOntoLiteralUnionExp, Type, Expression", "boolean symbolIsVisibleModule, Dsymbol", "void ctfeCompileFuncDeclaration", "Expression eval_fabsLoc, FuncDeclaration, DArray<Expression>", "void printCtfePerformanceStats", "void highlightCodeScope, DArray<Dsymbol>, OutBuffer, int", "ByteSlice getFilenameDArray<Identifier>, Identifier", "Expression interpretExpression, InterState, int", "Expression getValueExpression", "void messageBytePtr", "Expression eval_isnanLoc, FuncDeclaration, DArray<Expression>", "Expression ctfeCastUnionExp, Loc, Type, Type, Expression", "UnionExp NotType, Expression", "void escapeStrayParenthesisLoc, OutBuffer, int, boolean", "void lambdaSetParentExpression, FuncDeclaration", "boolean isIdStartBytePtr", "int intUnsignedCmpbyte, long, long", "void emplaceExpObject, Loc _param_1, int _param_2, Type _param_3IntegerExpLocIntegerType", "UnionExp pointerArithmeticLoc, byte, Type, Expression, Expression", "void emitProtectionOutBuffer, Declaration", "int templateIdentifierLookupIdentifier, DArray<TemplateParameter>", "ByteSlice lispyBytePtr, ByteSlice", "boolean walkPostorderExpression, StoppableVisitor", "TypeFunction isTypeFunctionDsymbol", "void printDepsConditionalScope, DVCondition, ByteSlice", "Expression expTypeType, Expression", "Expression resolveAliasThisScope, Expression, boolean", "int detectAtxHeadingLevelOutBuffer, int", "Type isTypeRootObject", "Expression eval_builtinLoc, FuncDeclaration, DArray<Expression>", "boolean c_isxdigitint", "BytePtr utf_decodeWcharCharPtr, int, IntRef, IntRef", "Expression interpretUnionExp, Statement, InterState", "ByteSlice deinitializerMsgtable", "Expression eval_unimpLoc, FuncDeclaration, DArray<Expression>", "void utf_encodeCharBytePtr, int", "void semantic3OnDependenciesModule", "UnionExp copyLiteralExpression", "UnionExp paintTypeOntoLiteralCopyType, Expression", "Expression interpret_aaApplyUnionExp, InterState, Expression, Expression", "void emitCommentDsymbol, OutBuffer, Scope", "void emplaceExpObject, Loc _param_1, VarExp _param_2, Type _param_3AddrExpLocVarExpType", "ByteSlice skipwhitespaceByteSlice", "void vdeprecationSupplementalLoc, BytePtr, Slice<Object>", "void highlightCode2Scope, DArray<Dsymbol>, OutBuffer, int", "FuncDeclaration funcptrOfExpression", "void emplaceExpObject, Loc _param_1, DArray<Expression> _param_2, DArray<Expression> _param_3AssocArrayLiteralExpLocDArray<Expression>DArray<Expression>", "void parseModulePatternBytePtr, MatcherNode, short", "void mangleToBufferExpression, OutBuffer", "boolean matchRootObject, RootObject", "Expression eval_exp2Loc, FuncDeclaration, DArray<Expression>", "int getMarkdownIndentOutBuffer, int, int", "int startTableOutBuffer, int, int, Loc, boolean, Ref<Slice<MarkdownDelimiter>>, Ref<IntSlice>", "boolean isKeywordBytePtr, int", "UnionExp CatType, Expression, Expression", "Expression eval_isfiniteLoc, FuncDeclaration, DArray<Expression>", "int comparePointersbyte, Expression, long, Expression, long", "boolean isDittoBytePtr", "void emplaceExpObject, Loc _param_1, Type _param_2NullExpLocType", "boolean isAssocArrayType", "boolean isSafePointerCastType, Type", "boolean numCmpbyte, double, doubleDouble", "void mangleToBufferDsymbol, OutBuffer", "void aliasSemanticAliasDeclaration, Scope", "Parameter isEponymousFunctionParameterDArray<Dsymbol>, BytePtr, int", "void emplaceExpObject, Loc _param_1, Type _param_2, DArray<Expression> _param_3ArrayLiteralExpLocTypeDArray<Expression>", "Expression assignAssocArrayElementLoc, AssocArrayLiteralExp, Expression, Expression", "void emplaceExpObject, Loc _param_1, IndexExp _param_2, Type _param_3AddrExpLocIndexExpType", "ByteSlice identifierMsgtable", "boolean ishexbyte", "void processFileByteSlice, ByteSlice, BytePtr_lex", "Expression eval_bswapLoc, FuncDeclaration, DArray<Expression>", "void vdeprecationLoc, BytePtr, Slice<Object>, BytePtr, BytePtr", "void setValueVarDeclaration, Expression", "void halt", "BytePtr mangleExactFuncDeclaration", "void emplaceExpObject, int _param_1IntegerExpInteger", "Expression eval_expm1Loc, FuncDeclaration, DArray<Expression>", "Dsymbol isDsymbolRootObject", "boolean isReservedNameByteSlice", "boolean hasProtectedAccessScope, Dsymbol", "void writeHighlightsConsole, OutBuffer", "boolean numCmpbyte, long, longLong", "Expression interpret_dupUnionExp, InterState, Expression", "Dsymbol getEponymousMemberTemplateDeclaration", "Expression eval_powLoc, FuncDeclaration, DArray<Expression>", "boolean hasValueVarDeclaration", "void templateInstanceSemanticTemplateInstance, Scope, DArray<Expression>", "Type getTypeRootObject", "Expression foreachApplyUtfUnionExp, InterState, Expression, Expression, boolean", "void emplaceExpObject, Loc _param_1, BytePtr _param_2StringExpLocBytePtr", "boolean includeImportedModuleCheckModuleComponentRange", "Expression eval_fmaLoc, FuncDeclaration, DArray<Expression>", "void sliceAssignArrayLiteralFromStringArrayLiteralExp, StringExp, int", "boolean writeMixinByteSlice, Loc", "void toDocBufferDsymbol, OutBuffer, Scope", "void emplaceExpObject, Loc _param_1, SliceExp _param_2, Type _param_3AddrExpLocSliceExpType"]] signature: void emplaceExpObject, Loc _param_1, long _param_2, Type _param_3IntegerExpLocLongType

    // from template emplaceExp!(RealExpLocDoubleType)
    // removed duplicate function, [["Expression eval_yl2xp1Loc, FuncDeclaration, DArray<Expression>", "int skipPastIdentWithDotsOutBuffer, int", "boolean emitAnchorNameOutBuffer, Dsymbol, Scope, boolean", "TemplateParameter isTemplateParameterDArray<Dsymbol>, BytePtr, int", "void emplaceExpObject, Loc _param_1, double _param_2, Type _param_3RealExpLocDoubleType", "TypeAArray toBuiltinAATypeType", "Expression eval_isinfinityLoc, FuncDeclaration, DArray<Expression>", "boolean mergeCallSuperRef<Short>, short", "Expression eval_floorLoc, FuncDeclaration, DArray<Expression>", "UnionExp changeArrayLiteralLengthLoc, TypeArray, Expression, int, int", "ArrayLiteralExp createBlockDuplicatedArrayLiteralUnionExp, Loc, Type, Expression, int", "BytePtr stripLeadingNewlinesBytePtr", "void emplaceExpObject, byte _param_1CTFEExpByte", "void createMatchNodes", "UnionExp ArrayLengthType, Expression", "boolean checkAccessAggregateDeclaration, Loc, Scope, Dsymbol", "Expression resolveSliceExpression, UnionExp", "Expression getValueVarDeclaration", "boolean hasPackageAccessScope, Dsymbol", "void emplaceExpObject, Loc _param_1, Expression _param_2, Type _param_3AddrExpLocExpressionType", "boolean isFloatIntPaintType, Type", "int mainSlice<ByteSlice>", "void vmessageLoc, BytePtr, Slice<Object>", "boolean isValidManglingint", "int getAlignmentAlignDeclaration, Scope", "int arrayObjectHashDArray<RootObject>", "boolean numCmpbyte, int, intInteger", "boolean exceptionOrCantInterpretExpression", "ByteSlice lookForSourceFileByteSlice", "void showCtfeExprExpression, int", "void emplaceExpObject, Loc _param_1, Expression _param_2AddrExpLocExpression", "void removeBlankLineMacroOutBuffer, IntRef, IntRef", "boolean isErrorRootObject", "void emitMemberCommentsScopeDsymbol, OutBuffer, Scope", "UnionExp ctfeCatLoc, Type, Expression, Expression", "void escapeDdocStringOutBuffer, int", "void deprecationLoc, BytePtr", "void messageLoc, BytePtr", "Parameter isFunctionParameterDArray<Dsymbol>, BytePtr, int", "short parseModulePatternDepthBytePtr", "void MODtoDecoBufferOutBuffer, byte", "UnionExp ModLoc, Type, Expression, Expression", "void emplaceExpObject, Loc _param_1, Object _param_2, int _param_3StringExpLocObjectInteger", "void emplaceExpObject, Loc _param_1, StructLiteralExp _param_2, Type _param_3ClassReferenceExpLocStructLiteralExpType", "Expression eval_tanLoc, FuncDeclaration, DArray<Expression>", "int skippastURLOutBuffer, int", "boolean isZeroSecondbyte", "Expression eval_copysignLoc, FuncDeclaration, DArray<Expression>", "Expression eval_log2Loc, FuncDeclaration, DArray<Expression>", "double creallcomplex_t", "void warningSupplementalLoc, BytePtr", "int deduceTypeRootObject, Scope, Type, DArray<TemplateParameter>, DArray<RootObject>, IntPtr, int, boolean", "Tuple isTupleRootObject", "Expression eval_truncLoc, FuncDeclaration, DArray<Expression>", "UnionExp DivLoc, Type, Expression, Expression", "void expandTemplateMixinCommentsTemplateMixin, OutBuffer, Scope", "Expression eval_sqrtLoc, FuncDeclaration, DArray<Expression>", "boolean lambdaCheckForNestedRefExpression, Scope", "void emplaceExpObject, Loc _param_1, complex_t _param_2, Type _param_3ComplexExpLoccomplex_tType", "void dsymbolSemanticDsymbol, Scope", "void cantExpUnionExp", "boolean pointToSameMemoryBlockExpression, Expression", "long getStorageClassPrefixAttributesASTBaseASTBase", "UnionExp ComType, Expression", "ByteSlice initializerMsgtable", "int specificCmpbyte, int", "void builtinDeinitialize", "boolean isDigitSecondbyte", "Scope skipNonQualScopesScope", "UnionExp MulLoc, Type, Expression, Expression", "int utfStrideBytePtr", "void verrorPrintLoc, int, BytePtr, BytePtr, Slice<Object>, BytePtr, BytePtr", "int ctfeCmpLoc, byte, Expression, Expression", "boolean isTrueBoolExpression", "void builtin_init", "Parameter isParameterRootObject", "void errorSupplementalLoc, BytePtr", "long resolveArrayLengthExpression", "Expression evaluateDtorInterState, Expression", "int foreachDsymbolDArray<Dsymbol>, Function1<Dsymbol,Integer>", "void emplaceExpObject, ErrorExp", "Expression interpret_lengthUnionExp, InterState, Expression", "Parameter isFunctionParameterDsymbol, BytePtr, int", "void emitProtectionOutBuffer, Import", "TemplateParameter isTemplateParameterRootObject", "boolean arrayObjectMatchDArray<RootObject>, DArray<RootObject>", "void emplaceExpObject, Loc _param_1, Type _param_2, Expression _param_3, DArray<Expression> _param_4ArrayLiteralExpLocTypeExpressionDArray<Expression>", "boolean reliesOnTemplateParametersExpression, Slice<TemplateParameter>", "int endAllMarkdownQuotesOutBuffer, int, IntRef", "void emplaceExpObject, Loc _param_1, Expression _param_2, FuncDeclaration _param_3, boolean _param_4DelegateExpLocExpressionFuncDeclarationBoolean", "boolean definitelyValueParameterExpression", "void emplaceExpObject, Loc _param_1, boolean _param_2, Type _param_3IntegerExpLocBooleanType", "boolean reliesOnTidentType, DArray<TemplateParameter>, int", "Expression eval_yl2xLoc, FuncDeclaration, DArray<Expression>", "void errorLoc, BytePtr", "boolean utf_isValidDcharint", "void fatal", "Expression evaluateIfBuiltinUnionExp, InterState, Loc, FuncDeclaration, DArray<Expression>, Expression", "UnionExp pointerDifferenceLoc, Type, Expression, Expression", "UnionExp NegType, Expression", "boolean isidcharbyte", "int utf_codeLengthWcharint", "Expression getValueRef<Dsymbol>", "Function3<Loc,FuncDeclaration,DArray<Expression>,Expression> builtin_lookupBytePtr", "BytePtr linkToCharsint", "Expression interpretStatement, InterState", "int isConstExpression", "Expression getExpressionRootObject", "void emitProtectionOutBuffer, Prot", "Expression ctfeIndexLoc, Type, Expression, long", "int utf_codeLengthint, int", "UnionExp SliceType, Expression, Expression, Expression", "void functionResolveMatchAccumulator, Dsymbol, Loc, Scope, DArray<RootObject>, Type, DArray<Expression>, Ptr<BytePtr>", "int intSignedCmpbyte, long, long", "int ctfeIdentityLoc, byte, Expression, Expression", "Expression ctfeInterpretForPragmaMsgExpression", "void emplaceExpObject, Loc _param_1, long _param_2, Type _param_3IntegerExpLocLongType", "boolean isUniAlphaint", "BytePtr skipwhitespaceBytePtr", "UnionExp Cmpbyte, Loc, Type, Expression, Expression", "Dsymbol mostVisibleOverloadDsymbol, Module", "UnionExp OrLoc, Type, Expression, Expression", "void emplaceExpObject, Loc _param_1, Declaration _param_2, int _param_3SymOffExpLocDeclarationInteger", "int sliceCmpStringWithArrayStringExp, ArrayLiteralExp, int, int, int", "boolean hasPackageAccessModule, Dsymbol", "CtorDeclaration generateCopyCtorDeclarationStructDeclaration, long, long", "void errorBytePtr, int, int, BytePtr", "void add_builtinBytePtr, Function3<Loc,FuncDeclaration,DArray<Expression>,Expression>", "UnionExp PtrType, Expression", "void utf_encodeWcharCharPtr, int", "boolean findConditionDArray<Identifier>, Identifier", "int ctfeRawCmpLoc, Expression, Expression, boolean", "UnionExp ShlLoc, Type, Expression, Expression", "void highlightTextScope, DArray<Dsymbol>, Loc, OutBuffer, int", "UnionExp voidInitLiteralType, VarDeclaration", "void gendocfileModule", "boolean isIdTailBytePtr", "UnionExp ShrLoc, Type, Expression, Expression", "void emplaceExpObject, Loc _param_1, Type _param_2, Expression _param_3ArrayLiteralExpLocTypeExpression", "int setMangleOverrideDsymbol, ByteSlice", "Dsymbol getDsymbolRootObject", "Expression eval_log10Loc, FuncDeclaration, DArray<Expression>", "Expression eval_expLoc, FuncDeclaration, DArray<Expression>", "Expression getAggregateFromPointerExpression, Ptr<Long>", "void emplaceExpObject, Loc _param_1, Expression _param_2, Expression _param_3IndexExpLocExpressionExpression", "Expression eval_fmaxLoc, FuncDeclaration, DArray<Expression>", "boolean isArrayExpression", "UnionExp CastLoc, Type, Type, Expression", "UnionExp IndexType, Expression, Expression", "void emitAnchorOutBuffer, Dsymbol, Scope, boolean", "void removeAnyAtxHeadingSuffixOutBuffer, int", "DArray<Expression> copyElementsExpression, Expression", "void assignInPlaceExpression, Expression", "TemplateDeclaration getEponymousParentDsymbol", "void utf_encodeint, Object, int", "boolean issinglecharbyte", "ByteSlice replaceCharByteSlice, byte, ByteSlice", "int getCodeIndentBytePtr", "boolean isIdentifierDArray<Dsymbol>, BytePtr, int", "BytePtr utf_decodeCharBytePtr, int, IntRef, IntRef", "void vwarningLoc, BytePtr, Slice<Object>", "boolean needToCopyLiteralExpression", "int sliceCmpStringWithStringStringExp, StringExp, int, int, int", "boolean isCtfeComparableExpression", "ByteSlice memdupByteSlice", "void mangleToBufferTemplateInstance, OutBuffer", "ByteSlice lexBytePtr, ByteSlice", "boolean isPointerType", "Expression findKeyInAALoc, AssocArrayLiteralExp, Expression", "int endTableOutBuffer, int, Ref<IntSlice>", "Expression scrubReturnValueLoc, Expression", "Type rawTypeMergeType, Type", "void emplaceExpObject, Loc _param_1, Expression _param_2, Type _param_3VectorExpLocExpressionType", "boolean buildCopyCtorStructDeclaration, Scope", "boolean reliesOnTemplateParametersType, Slice<TemplateParameter>", "int utf_codeLengthCharint", "void highlightCode3Scope, OutBuffer, BytePtr, BytePtr", "BytePtr getMessageDeprecatedDeclaration", "int endAllListsAndQuotesOutBuffer, IntRef, Ref<Slice<MarkdownList>>, IntRef, IntRef", "ByteSlice toLowercaseByteSlice", "Expression interpretFunctionUnionExp, FuncDeclaration, InterState, DArray<Expression>, Expression", "Expression interpret_valuesUnionExp, InterState, Expression, Type", "Expression eval_roundLoc, FuncDeclaration, DArray<Expression>", "void emplaceExpObject, Loc _param_1, Expression _param_2, Expression _param_3, Expression _param_4SliceExpLocExpressionExpressionExpression", "boolean modifyFieldVarLoc, Scope, VarDeclaration, Expression", "void deprecationSupplementalLoc, BytePtr", "Expression eval_ldexpLoc, FuncDeclaration, DArray<Expression>", "int extractArgNByteSlice, Ref<ByteSlice>, int", "UnionExp UshrLoc, Type, Expression, Expression", "Expression interpret_keysUnionExp, InterState, Expression, Type", "UnionExp Identitybyte, Loc, Type, Expression, Expression", "void vwarningSupplementalLoc, BytePtr, Slice<Object>", "BytePtr modToCharsint", "boolean checkSymbolAccessScope, Dsymbol", "Expression toDelegateExpression, Type, Scope", "UnionExp PowLoc, Type, Expression, Expression", "int isattyint", "Expression scrubCacheValueExpression", "int findFieldIndexByNameStructDeclaration, VarDeclaration", "boolean replaceMarkdownThematicBreakOutBuffer, IntRef, int, Loc", "RootObject objectSyntaxCopyRootObject", "int ctfeEqualLoc, byte, Expression, Expression", "void emplaceExpObject, Loc _param_1, Object _param_2, DArray<Expression> _param_3ArrayLiteralExpLocObjectDArray<Expression>", "void emplaceExpObject, Loc _param_1, Declaration _param_2, long _param_3SymOffExpLocDeclarationLong", "FuncDeclaration buildPostBlitStructDeclaration, Scope", "int skipCharsOutBuffer, int, ByteSlice", "Statement generateCopyCtorBodyStructDeclaration", "void emplaceExpObject, Loc _param_1, Expression _param_2, IntegerExp _param_3IndexExpLocExpressionIntegerExp", "void sliceAssignStringFromArrayLiteralStringExp, ArrayLiteralExp, int", "int expressionHashExpression", "boolean ensureStaticLinkToDsymbol, Dsymbol", "void emplaceExpObject, Loc _param_1, StructDeclaration _param_2, DArray<Expression> _param_3, Type _param_4StructLiteralExpLocStructDeclarationDArray<Expression>Type", "DArray<Expression> copyLiteralArrayDArray<Expression>, Expression", "int templateParameterLookupType, DArray<TemplateParameter>", "boolean symbolIsVisibleDsymbol, Dsymbol", "boolean c_isalnumint", "void tyToDecoBufferOutBuffer, int", "void emplaceExpObject, Loc _param_1, StructDeclaration _param_2, DArray<Expression> _param_3StructLiteralExpLocStructDeclarationDArray<Expression>", "void ObjectNotFoundIdentifier", "boolean isCVariadicParameterDArray<Dsymbol>, ByteSlice", "void mangleToFuncSignatureOutBuffer, FuncDeclaration", "void colorHighlightCodeOutBuffer", "boolean symbolIsVisibleScope, Dsymbol", "void emplaceExpObject, Loc _param_1, TypeSArray _param_2, DArray<Expression> _param_3ArrayLiteralExpLocTypeSArrayDArray<Expression>", "void warningLoc, BytePtr", "UnionExp BoolType, Expression", "StringExp createBlockDuplicatedStringLiteralUnionExp, Loc, Type, int, int, byte", "void colorSyntaxHighlightOutBuffer", "Expression paintTypeOntoLiteralType, Expression", "void endMarkdownHeadingOutBuffer, int, IntRef, Loc, IntRef", "int endRowAndTableOutBuffer, int, int, Loc, Ref<Slice<MarkdownDelimiter>>, Ref<IntSlice>", "boolean isoctalbyte", "void unSpeculativeScope, RootObject", "Expression eval_fminLoc, FuncDeclaration, DArray<Expression>", "boolean arrayObjectIsErrorDArray<RootObject>", "long getStorageClassPrefixAttributesASTCodegenASTCodegen", "boolean isSpecialEnumIdentIdentifier", "int skiptoidentOutBuffer, int", "int deduceTypeHelperType, Ptr<Type>, Type", "boolean mergeFieldInitRef<Short>, short", "void emplaceExpObject, VarDeclaration _param_1VoidInitExpVarDeclaration", "void foreachDsymbolDArray<Dsymbol>, Function1<Dsymbol,Void>", "Expression interpretUnionExp, Expression, InterState, int", "UnionExp AddLoc, Type, Expression, Expression", "Expression isExpressionRootObject", "void emplaceExpObject, Loc _param_1, Expression _param_2, IntegerExp _param_3, Expression _param_4SliceExpLocExpressionIntegerExpExpression", "int parseTableDelimiterRowOutBuffer, int, boolean, Ref<IntSlice>", "int skippastidentOutBuffer, int", "UnionExp XorLoc, Type, Expression, Expression", "int realCmpbyte, double, double", "boolean isCVariadicArgByteSlice", "boolean isCtfeValueValidExpression", "UnionExp MinLoc, Type, Expression, Expression", "Expression eval_bsrLoc, FuncDeclaration, DArray<Expression>", "void semanticTypeInfoScope, Type", "void highlightCodeScope, Dsymbol, OutBuffer, int", "Expression eval_logLoc, FuncDeclaration, DArray<Expression>", "Expression eval_cosLoc, FuncDeclaration, DArray<Expression>", "boolean allowsContractWithoutBodyFuncDeclaration", "double cimaglcomplex_t", "int replaceTableRowOutBuffer, int, int, Loc, Ref<Slice<MarkdownDelimiter>>, IntSlice, boolean", "void verrorLoc, BytePtr, Slice<Object>, BytePtr, BytePtr, BytePtr", "UnionExp AndLoc, Type, Expression, Expression", "boolean _isZeroInitExpression", "boolean checkAccessLoc, Scope, Package", "Expression eval_ceilLoc, FuncDeclaration, DArray<Expression>", "boolean isCtfeReferenceValidExpression", "boolean checkFrameAccessLoc, Scope, AggregateDeclaration, int", "Expression ctfeInterpretExpression", "int ctfeCmpArraysLoc, Expression, Expression, long", "boolean isTypeInfo_ClassType", "byte deduceWildHelperType, Ptr<Type>, Type", "boolean isIndentWSBytePtr", "Expression evaluatePostblitInterState, Expression", "void verrorSupplementalLoc, BytePtr, Slice<Object>", "boolean checkAccessLoc, Scope, Expression, Declaration", "FuncDeclaration search_toStringStructDeclaration", "Expression eval_sinLoc, FuncDeclaration, DArray<Expression>", "UnionExp Equalbyte, Loc, Type, Expression, Expression", "void emplaceExpObject, Loc _param_1, Expression _param_2, TypeVector _param_3VectorExpLocExpressionTypeVector", "int replaceMarkdownEmphasisOutBuffer, Loc, Ref<Slice<MarkdownDelimiter>>, int", "void emplaceExpObject, Loc _param_1, Object _param_2, int _param_3, byte _param_4StringExpLocObjectIntegerByte", "ByteSlice generateSlice<Msgtable>, Function1<Msgtable,ByteSlice>", "void emplaceExpObject, Loc _param_1, DArray<Expression> _param_2TupleExpLocDArray<Expression>", "void processFileByteSlice, ByteSlice, BytePtr_lispy", "Expression eval_popcntLoc, FuncDeclaration, DArray<Expression>", "Expression eval_bsfLoc, FuncDeclaration, DArray<Expression>", "void setValueWithoutCheckingVarDeclaration, Expression", "void mangleToBufferType, OutBuffer", "int isBuiltinFuncDeclaration", "Expression paintFloatIntUnionExp, Expression, Type", "void sliceAssignStringFromStringStringExp, StringExp, int", "Expression paintTypeOntoLiteralUnionExp, Type, Expression", "boolean symbolIsVisibleModule, Dsymbol", "void ctfeCompileFuncDeclaration", "Expression eval_fabsLoc, FuncDeclaration, DArray<Expression>", "void printCtfePerformanceStats", "void highlightCodeScope, DArray<Dsymbol>, OutBuffer, int", "ByteSlice getFilenameDArray<Identifier>, Identifier", "Expression interpretExpression, InterState, int", "Expression getValueExpression", "void messageBytePtr", "Expression eval_isnanLoc, FuncDeclaration, DArray<Expression>", "Expression ctfeCastUnionExp, Loc, Type, Type, Expression", "UnionExp NotType, Expression", "void escapeStrayParenthesisLoc, OutBuffer, int, boolean", "void lambdaSetParentExpression, FuncDeclaration", "boolean isIdStartBytePtr", "int intUnsignedCmpbyte, long, long", "void emplaceExpObject, Loc _param_1, int _param_2, Type _param_3IntegerExpLocIntegerType", "UnionExp pointerArithmeticLoc, byte, Type, Expression, Expression", "void emitProtectionOutBuffer, Declaration", "int templateIdentifierLookupIdentifier, DArray<TemplateParameter>", "ByteSlice lispyBytePtr, ByteSlice", "boolean walkPostorderExpression, StoppableVisitor", "TypeFunction isTypeFunctionDsymbol", "void printDepsConditionalScope, DVCondition, ByteSlice", "Expression expTypeType, Expression", "Expression resolveAliasThisScope, Expression, boolean", "int detectAtxHeadingLevelOutBuffer, int", "Type isTypeRootObject", "Expression eval_builtinLoc, FuncDeclaration, DArray<Expression>", "boolean c_isxdigitint", "BytePtr utf_decodeWcharCharPtr, int, IntRef, IntRef", "Expression interpretUnionExp, Statement, InterState", "ByteSlice deinitializerMsgtable", "Expression eval_unimpLoc, FuncDeclaration, DArray<Expression>", "void utf_encodeCharBytePtr, int", "void semantic3OnDependenciesModule", "UnionExp copyLiteralExpression", "UnionExp paintTypeOntoLiteralCopyType, Expression", "Expression interpret_aaApplyUnionExp, InterState, Expression, Expression", "void emitCommentDsymbol, OutBuffer, Scope", "void emplaceExpObject, Loc _param_1, VarExp _param_2, Type _param_3AddrExpLocVarExpType", "ByteSlice skipwhitespaceByteSlice", "void vdeprecationSupplementalLoc, BytePtr, Slice<Object>", "void highlightCode2Scope, DArray<Dsymbol>, OutBuffer, int", "FuncDeclaration funcptrOfExpression", "void emplaceExpObject, Loc _param_1, DArray<Expression> _param_2, DArray<Expression> _param_3AssocArrayLiteralExpLocDArray<Expression>DArray<Expression>", "void parseModulePatternBytePtr, MatcherNode, short", "void mangleToBufferExpression, OutBuffer", "boolean matchRootObject, RootObject", "Expression eval_exp2Loc, FuncDeclaration, DArray<Expression>", "int getMarkdownIndentOutBuffer, int, int", "int startTableOutBuffer, int, int, Loc, boolean, Ref<Slice<MarkdownDelimiter>>, Ref<IntSlice>", "boolean isKeywordBytePtr, int", "UnionExp CatType, Expression, Expression", "Expression eval_isfiniteLoc, FuncDeclaration, DArray<Expression>", "int comparePointersbyte, Expression, long, Expression, long", "boolean isDittoBytePtr", "void emplaceExpObject, Loc _param_1, Type _param_2NullExpLocType", "boolean isAssocArrayType", "boolean isSafePointerCastType, Type", "boolean numCmpbyte, double, doubleDouble", "void mangleToBufferDsymbol, OutBuffer", "void aliasSemanticAliasDeclaration, Scope", "Parameter isEponymousFunctionParameterDArray<Dsymbol>, BytePtr, int", "void emplaceExpObject, Loc _param_1, Type _param_2, DArray<Expression> _param_3ArrayLiteralExpLocTypeDArray<Expression>", "Expression assignAssocArrayElementLoc, AssocArrayLiteralExp, Expression, Expression", "void emplaceExpObject, Loc _param_1, IndexExp _param_2, Type _param_3AddrExpLocIndexExpType", "ByteSlice identifierMsgtable", "boolean ishexbyte", "void processFileByteSlice, ByteSlice, BytePtr_lex", "Expression eval_bswapLoc, FuncDeclaration, DArray<Expression>", "void vdeprecationLoc, BytePtr, Slice<Object>, BytePtr, BytePtr", "void setValueVarDeclaration, Expression", "void halt", "BytePtr mangleExactFuncDeclaration", "void emplaceExpObject, int _param_1IntegerExpInteger", "Expression eval_expm1Loc, FuncDeclaration, DArray<Expression>", "Dsymbol isDsymbolRootObject", "boolean isReservedNameByteSlice", "boolean hasProtectedAccessScope, Dsymbol", "void writeHighlightsConsole, OutBuffer", "boolean numCmpbyte, long, longLong", "Expression interpret_dupUnionExp, InterState, Expression", "Dsymbol getEponymousMemberTemplateDeclaration", "Expression eval_powLoc, FuncDeclaration, DArray<Expression>", "boolean hasValueVarDeclaration", "void templateInstanceSemanticTemplateInstance, Scope, DArray<Expression>", "Type getTypeRootObject", "Expression foreachApplyUtfUnionExp, InterState, Expression, Expression, boolean", "void emplaceExpObject, Loc _param_1, BytePtr _param_2StringExpLocBytePtr", "boolean includeImportedModuleCheckModuleComponentRange", "Expression eval_fmaLoc, FuncDeclaration, DArray<Expression>", "void sliceAssignArrayLiteralFromStringArrayLiteralExp, StringExp, int", "boolean writeMixinByteSlice, Loc", "void toDocBufferDsymbol, OutBuffer, Scope", "void emplaceExpObject, Loc _param_1, SliceExp _param_2, Type _param_3AddrExpLocSliceExpType"]] signature: void emplaceExpObject, Loc _param_1, double _param_2, Type _param_3RealExpLocDoubleType
    ...
    // from template emplaceExp!(StringExpLocObjectInteger)
    // removed duplicate function, [["Expression eval_yl2xp1Loc, FuncDeclaration, DArray<Expression>", "int skipPastIdentWithDotsOutBuffer, int", "boolean emitAnchorNameOutBuffer, Dsymbol, Scope, boolean", "TemplateParameter isTemplateParameterDArray<Dsymbol>, BytePtr, int", "void emplaceExpObject, Loc _param_1, double _param_2, Type _param_3RealExpLocDoubleType", "TypeAArray toBuiltinAATypeType", "Expression eval_isinfinityLoc, FuncDeclaration, DArray<Expression>", "boolean mergeCallSuperRef<Short>, short", "Expression eval_floorLoc, FuncDeclaration, DArray<Expression>", "UnionExp changeArrayLiteralLengthLoc, TypeArray, Expression, int, int", "ArrayLiteralExp createBlockDuplicatedArrayLiteralUnionExp, Loc, Type, Expression, int", "BytePtr stripLeadingNewlinesBytePtr", "void emplaceExpObject, byte _param_1CTFEExpByte", "void createMatchNodes", "UnionExp ArrayLengthType, Expression", "boolean checkAccessAggregateDeclaration, Loc, Scope, Dsymbol", "Expression resolveSliceExpression, UnionExp", "Expression getValueVarDeclaration", "boolean hasPackageAccessScope, Dsymbol", "void emplaceExpObject, Loc _param_1, Expression _param_2, Type _param_3AddrExpLocExpressionType", "boolean isFloatIntPaintType, Type", "int mainSlice<ByteSlice>", "void vmessageLoc, BytePtr, Slice<Object>", "boolean isValidManglingint", "int getAlignmentAlignDeclaration, Scope", "int arrayObjectHashDArray<RootObject>", "boolean numCmpbyte, int, intInteger", "boolean exceptionOrCantInterpretExpression", "ByteSlice lookForSourceFileByteSlice", "void showCtfeExprExpression, int", "void emplaceExpObject, Loc _param_1, Expression _param_2AddrExpLocExpression", "void removeBlankLineMacroOutBuffer, IntRef, IntRef", "boolean isErrorRootObject", "void emitMemberCommentsScopeDsymbol, OutBuffer, Scope", "UnionExp ctfeCatLoc, Type, Expression, Expression", "void escapeDdocStringOutBuffer, int", "void deprecationLoc, BytePtr", "void messageLoc, BytePtr", "Parameter isFunctionParameterDArray<Dsymbol>, BytePtr, int", "short parseModulePatternDepthBytePtr", "void MODtoDecoBufferOutBuffer, byte", "UnionExp ModLoc, Type, Expression, Expression", "void emplaceExpObject, Loc _param_1, Object _param_2, int _param_3StringExpLocObjectInteger", "void emplaceExpObject, Loc _param_1, StructLiteralExp _param_2, Type _param_3ClassReferenceExpLocStructLiteralExpType", "Expression eval_tanLoc, FuncDeclaration, DArray<Expression>", "int skippastURLOutBuffer, int", "boolean isZeroSecondbyte", "Expression eval_copysignLoc, FuncDeclaration, DArray<Expression>", "Expression eval_log2Loc, FuncDeclaration, DArray<Expression>", "double creallcomplex_t", "void warningSupplementalLoc, BytePtr", "int deduceTypeRootObject, Scope, Type, DArray<TemplateParameter>, DArray<RootObject>, IntPtr, int, boolean", "Tuple isTupleRootObject", "Expression eval_truncLoc, FuncDeclaration, DArray<Expression>", "UnionExp DivLoc, Type, Expression, Expression", "void expandTemplateMixinCommentsTemplateMixin, OutBuffer, Scope", "Expression eval_sqrtLoc, FuncDeclaration, DArray<Expression>", "boolean lambdaCheckForNestedRefExpression, Scope", "void emplaceExpObject, Loc _param_1, complex_t _param_2, Type _param_3ComplexExpLoccomplex_tType", "void dsymbolSemanticDsymbol, Scope", "void cantExpUnionExp", "boolean pointToSameMemoryBlockExpression, Expression", "long getStorageClassPrefixAttributesASTBaseASTBase", "UnionExp ComType, Expression", "ByteSlice initializerMsgtable", "int specificCmpbyte, int", "void builtinDeinitialize", "boolean isDigitSecondbyte", "Scope skipNonQualScopesScope", "UnionExp MulLoc, Type, Expression, Expression", "int utfStrideBytePtr", "void verrorPrintLoc, int, BytePtr, BytePtr, Slice<Object>, BytePtr, BytePtr", "int ctfeCmpLoc, byte, Expression, Expression", "boolean isTrueBoolExpression", "void builtin_init", "Parameter isParameterRootObject", "void errorSupplementalLoc, BytePtr", "long resolveArrayLengthExpression", "Expression evaluateDtorInterState, Expression", "int foreachDsymbolDArray<Dsymbol>, Function1<Dsymbol,Integer>", "void emplaceExpObject, ErrorExp", "Expression interpret_lengthUnionExp, InterState, Expression", "Parameter isFunctionParameterDsymbol, BytePtr, int", "void emitProtectionOutBuffer, Import", "TemplateParameter isTemplateParameterRootObject", "boolean arrayObjectMatchDArray<RootObject>, DArray<RootObject>", "void emplaceExpObject, Loc _param_1, Type _param_2, Expression _param_3, DArray<Expression> _param_4ArrayLiteralExpLocTypeExpressionDArray<Expression>", "boolean reliesOnTemplateParametersExpression, Slice<TemplateParameter>", "int endAllMarkdownQuotesOutBuffer, int, IntRef", "void emplaceExpObject, Loc _param_1, Expression _param_2, FuncDeclaration _param_3, boolean _param_4DelegateExpLocExpressionFuncDeclarationBoolean", "boolean definitelyValueParameterExpression", "void emplaceExpObject, Loc _param_1, boolean _param_2, Type _param_3IntegerExpLocBooleanType", "boolean reliesOnTidentType, DArray<TemplateParameter>, int", "Expression eval_yl2xLoc, FuncDeclaration, DArray<Expression>", "void errorLoc, BytePtr", "boolean utf_isValidDcharint", "void fatal", "Expression evaluateIfBuiltinUnionExp, InterState, Loc, FuncDeclaration, DArray<Expression>, Expression", "UnionExp pointerDifferenceLoc, Type, Expression, Expression", "UnionExp NegType, Expression", "boolean isidcharbyte", "int utf_codeLengthWcharint", "Expression getValueRef<Dsymbol>", "Function3<Loc,FuncDeclaration,DArray<Expression>,Expression> builtin_lookupBytePtr", "BytePtr linkToCharsint", "Expression interpretStatement, InterState", "int isConstExpression", "Expression getExpressionRootObject", "void emitProtectionOutBuffer, Prot", "Expression ctfeIndexLoc, Type, Expression, long", "int utf_codeLengthint, int", "UnionExp SliceType, Expression, Expression, Expression", "void functionResolveMatchAccumulator, Dsymbol, Loc, Scope, DArray<RootObject>, Type, DArray<Expression>, Ptr<BytePtr>", "int intSignedCmpbyte, long, long", "int ctfeIdentityLoc, byte, Expression, Expression", "Expression ctfeInterpretForPragmaMsgExpression", "void emplaceExpObject, Loc _param_1, long _param_2, Type _param_3IntegerExpLocLongType", "boolean isUniAlphaint", "BytePtr skipwhitespaceBytePtr", "UnionExp Cmpbyte, Loc, Type, Expression, Expression", "Dsymbol mostVisibleOverloadDsymbol, Module", "UnionExp OrLoc, Type, Expression, Expression", "void emplaceExpObject, Loc _param_1, Declaration _param_2, int _param_3SymOffExpLocDeclarationInteger", "int sliceCmpStringWithArrayStringExp, ArrayLiteralExp, int, int, int", "boolean hasPackageAccessModule, Dsymbol", "CtorDeclaration generateCopyCtorDeclarationStructDeclaration, long, long", "void errorBytePtr, int, int, BytePtr", "void add_builtinBytePtr, Function3<Loc,FuncDeclaration,DArray<Expression>,Expression>", "UnionExp PtrType, Expression", "void utf_encodeWcharCharPtr, int", "boolean findConditionDArray<Identifier>, Identifier", "int ctfeRawCmpLoc, Expression, Expression, boolean", "UnionExp ShlLoc, Type, Expression, Expression", "void highlightTextScope, DArray<Dsymbol>, Loc, OutBuffer, int", "UnionExp voidInitLiteralType, VarDeclaration", "void gendocfileModule", "boolean isIdTailBytePtr", "UnionExp ShrLoc, Type, Expression, Expression", "void emplaceExpObject, Loc _param_1, Type _param_2, Expression _param_3ArrayLiteralExpLocTypeExpression", "int setMangleOverrideDsymbol, ByteSlice", "Dsymbol getDsymbolRootObject", "Expression eval_log10Loc, FuncDeclaration, DArray<Expression>", "Expression eval_expLoc, FuncDeclaration, DArray<Expression>", "Expression getAggregateFromPointerExpression, Ptr<Long>", "void emplaceExpObject, Loc _param_1, Expression _param_2, Expression _param_3IndexExpLocExpressionExpression", "Expression eval_fmaxLoc, FuncDeclaration, DArray<Expression>", "boolean isArrayExpression", "UnionExp CastLoc, Type, Type, Expression", "UnionExp IndexType, Expression, Expression", "void emitAnchorOutBuffer, Dsymbol, Scope, boolean", "void removeAnyAtxHeadingSuffixOutBuffer, int", "DArray<Expression> copyElementsExpression, Expression", "void assignInPlaceExpression, Expression", "TemplateDeclaration getEponymousParentDsymbol", "void utf_encodeint, Object, int", "boolean issinglecharbyte", "ByteSlice replaceCharByteSlice, byte, ByteSlice", "void emplaceExpObject, Loc _param_1, BytePtr _param_2, int _param_3StringExpLocBytePtrInteger", "int getCodeIndentBytePtr", "boolean isIdentifierDArray<Dsymbol>, BytePtr, int", "BytePtr utf_decodeCharBytePtr, int, IntRef, IntRef", "void vwarningLoc, BytePtr, Slice<Object>", "boolean needToCopyLiteralExpression", "int sliceCmpStringWithStringStringExp, StringExp, int, int, int", "boolean isCtfeComparableExpression", "ByteSlice memdupByteSlice", "void mangleToBufferTemplateInstance, OutBuffer", "ByteSlice lexBytePtr, ByteSlice", "boolean isPointerType", "Expression findKeyInAALoc, AssocArrayLiteralExp, Expression", "int endTableOutBuffer, int, Ref<IntSlice>", "Expression scrubReturnValueLoc, Expression", "Type rawTypeMergeType, Type", "void emplaceExpObject, Loc _param_1, Expression _param_2, Type _param_3VectorExpLocExpressionType", "boolean buildCopyCtorStructDeclaration, Scope", "boolean reliesOnTemplateParametersType, Slice<TemplateParameter>", "int utf_codeLengthCharint", "void highlightCode3Scope, OutBuffer, BytePtr, BytePtr", "BytePtr getMessageDeprecatedDeclaration", "int endAllListsAndQuotesOutBuffer, IntRef, Ref<Slice<MarkdownList>>, IntRef, IntRef", "ByteSlice toLowercaseByteSlice", "Expression interpretFunctionUnionExp, FuncDeclaration, InterState, DArray<Expression>, Expression", "Expression interpret_valuesUnionExp, InterState, Expression, Type", "Expression eval_roundLoc, FuncDeclaration, DArray<Expression>", "void emplaceExpObject, Loc _param_1, Expression _param_2, Expression _param_3, Expression _param_4SliceExpLocExpressionExpressionExpression", "boolean modifyFieldVarLoc, Scope, VarDeclaration, Expression", "void deprecationSupplementalLoc, BytePtr", "Expression eval_ldexpLoc, FuncDeclaration, DArray<Expression>", "int extractArgNByteSlice, Ref<ByteSlice>, int", "UnionExp UshrLoc, Type, Expression, Expression", "Expression interpret_keysUnionExp, InterState, Expression, Type", "UnionExp Identitybyte, Loc, Type, Expression, Expression", "void vwarningSupplementalLoc, BytePtr, Slice<Object>", "BytePtr modToCharsint", "boolean checkSymbolAccessScope, Dsymbol", "Expression toDelegateExpression, Type, Scope", "UnionExp PowLoc, Type, Expression, Expression", "int isattyint", "Expression scrubCacheValueExpression", "int findFieldIndexByNameStructDeclaration, VarDeclaration", "boolean replaceMarkdownThematicBreakOutBuffer, IntRef, int, Loc", "RootObject objectSyntaxCopyRootObject", "int ctfeEqualLoc, byte, Expression, Expression", "void emplaceExpObject, Loc _param_1, Object _param_2, DArray<Expression> _param_3ArrayLiteralExpLocObjectDArray<Expression>", "void emplaceExpObject, Loc _param_1, Declaration _param_2, long _param_3SymOffExpLocDeclarationLong", "FuncDeclaration buildPostBlitStructDeclaration, Scope", "int skipCharsOutBuffer, int, ByteSlice", "Statement generateCopyCtorBodyStructDeclaration", "void emplaceExpObject, Loc _param_1, Expression _param_2, IntegerExp _param_3IndexExpLocExpressionIntegerExp", "void sliceAssignStringFromArrayLiteralStringExp, ArrayLiteralExp, int", "int expressionHashExpression", "boolean ensureStaticLinkToDsymbol, Dsymbol", "void emplaceExpObject, Loc _param_1, StructDeclaration _param_2, DArray<Expression> _param_3, Type _param_4StructLiteralExpLocStructDeclarationDArray<Expression>Type", "DArray<Expression> copyLiteralArrayDArray<Expression>, Expression", "int templateParameterLookupType, DArray<TemplateParameter>", "boolean symbolIsVisibleDsymbol, Dsymbol", "boolean c_isalnumint", "void tyToDecoBufferOutBuffer, int", "void emplaceExpObject, Loc _param_1, StructDeclaration _param_2, DArray<Expression> _param_3StructLiteralExpLocStructDeclarationDArray<Expression>", "void ObjectNotFoundIdentifier", "boolean isCVariadicParameterDArray<Dsymbol>, ByteSlice", "void mangleToFuncSignatureOutBuffer, FuncDeclaration", "void colorHighlightCodeOutBuffer", "boolean symbolIsVisibleScope, Dsymbol", "void emplaceExpObject, Loc _param_1, TypeSArray _param_2, DArray<Expression> _param_3ArrayLiteralExpLocTypeSArrayDArray<Expression>", "void warningLoc, BytePtr", "UnionExp BoolType, Expression", "StringExp createBlockDuplicatedStringLiteralUnionExp, Loc, Type, int, int, byte", "void colorSyntaxHighlightOutBuffer", "Expression paintTypeOntoLiteralType, Expression", "void endMarkdownHeadingOutBuffer, int, IntRef, Loc, IntRef", "int endRowAndTableOutBuffer, int, int, Loc, Ref<Slice<MarkdownDelimiter>>, Ref<IntSlice>", "boolean isoctalbyte", "void unSpeculativeScope, RootObject", "Expression eval_fminLoc, FuncDeclaration, DArray<Expression>", "boolean arrayObjectIsErrorDArray<RootObject>", "long getStorageClassPrefixAttributesASTCodegenASTCodegen", "boolean isSpecialEnumIdentIdentifier", "int skiptoidentOutBuffer, int", "int deduceTypeHelperType, Ptr<Type>, Type", "boolean mergeFieldInitRef<Short>, short", "void emplaceExpObject, VarDeclaration _param_1VoidInitExpVarDeclaration", "void foreachDsymbolDArray<Dsymbol>, Function1<Dsymbol,Void>", "Expression interpretUnionExp, Expression, InterState, int", "UnionExp AddLoc, Type, Expression, Expression", "Expression isExpressionRootObject", "void emplaceExpObject, Loc _param_1, Expression _param_2, IntegerExp _param_3, Expression _param_4SliceExpLocExpressionIntegerExpExpression", "int parseTableDelimiterRowOutBuffer, int, boolean, Ref<IntSlice>", "int skippastidentOutBuffer, int", "UnionExp XorLoc, Type, Expression, Expression", "int realCmpbyte, double, double", "boolean isCVariadicArgByteSlice", "boolean isCtfeValueValidExpression", "UnionExp MinLoc, Type, Expression, Expression", "Expression eval_bsrLoc, FuncDeclaration, DArray<Expression>", "void semanticTypeInfoScope, Type", "void highlightCodeScope, Dsymbol, OutBuffer, int", "Expression eval_logLoc, FuncDeclaration, DArray<Expression>", "Expression eval_cosLoc, FuncDeclaration, DArray<Expression>", "boolean allowsContractWithoutBodyFuncDeclaration", "double cimaglcomplex_t", "int replaceTableRowOutBuffer, int, int, Loc, Ref<Slice<MarkdownDelimiter>>, IntSlice, boolean", "void verrorLoc, BytePtr, Slice<Object>, BytePtr, BytePtr, BytePtr", "UnionExp AndLoc, Type, Expression, Expression", "boolean _isZeroInitExpression", "boolean checkAccessLoc, Scope, Package", "Expression eval_ceilLoc, FuncDeclaration, DArray<Expression>", "boolean isCtfeReferenceValidExpression", "boolean checkFrameAccessLoc, Scope, AggregateDeclaration, int", "Expression ctfeInterpretExpression", "int ctfeCmpArraysLoc, Expression, Expression, long", "boolean isTypeInfo_ClassType", "byte deduceWildHelperType, Ptr<Type>, Type", "boolean isIndentWSBytePtr", "Expression evaluatePostblitInterState, Expression", "void verrorSupplementalLoc, BytePtr, Slice<Object>", "boolean checkAccessLoc, Scope, Expression, Declaration", "FuncDeclaration search_toStringStructDeclaration", "Expression eval_sinLoc, FuncDeclaration, DArray<Expression>", "UnionExp Equalbyte, Loc, Type, Expression, Expression", "void emplaceExpObject, Loc _param_1, Expression _param_2, TypeVector _param_3VectorExpLocExpressionTypeVector", "int replaceMarkdownEmphasisOutBuffer, Loc, Ref<Slice<MarkdownDelimiter>>, int", "void emplaceExpObject, Loc _param_1, Object _param_2, int _param_3, byte _param_4StringExpLocObjectIntegerByte", "ByteSlice generateSlice<Msgtable>, Function1<Msgtable,ByteSlice>", "void emplaceExpObject, Loc _param_1, DArray<Expression> _param_2TupleExpLocDArray<Expression>", "void processFileByteSlice, ByteSlice, BytePtr_lispy", "Expression eval_popcntLoc, FuncDeclaration, DArray<Expression>", "Expression eval_bsfLoc, FuncDeclaration, DArray<Expression>", "void setValueWithoutCheckingVarDeclaration, Expression", "void mangleToBufferType, OutBuffer", "int isBuiltinFuncDeclaration", "Expression paintFloatIntUnionExp, Expression, Type", "void sliceAssignStringFromStringStringExp, StringExp, int", "Expression paintTypeOntoLiteralUnionExp, Type, Expression", "boolean symbolIsVisibleModule, Dsymbol", "void ctfeCompileFuncDeclaration", "Expression eval_fabsLoc, FuncDeclaration, DArray<Expression>", "void printCtfePerformanceStats", "void highlightCodeScope, DArray<Dsymbol>, OutBuffer, int", "ByteSlice getFilenameDArray<Identifier>, Identifier", "Expression interpretExpression, InterState, int", "Expression getValueExpression", "void messageBytePtr", "Expression eval_isnanLoc, FuncDeclaration, DArray<Expression>", "Expression ctfeCastUnionExp, Loc, Type, Type, Expression", "UnionExp NotType, Expression", "void escapeStrayParenthesisLoc, OutBuffer, int, boolean", "void lambdaSetParentExpression, FuncDeclaration", "boolean isIdStartBytePtr", "int intUnsignedCmpbyte, long, long", "void emplaceExpObject, Loc _param_1, int _param_2, Type _param_3IntegerExpLocIntegerType", "UnionExp pointerArithmeticLoc, byte, Type, Expression, Expression", "void emitProtectionOutBuffer, Declaration", "int templateIdentifierLookupIdentifier, DArray<TemplateParameter>", "ByteSlice lispyBytePtr, ByteSlice", "boolean walkPostorderExpression, StoppableVisitor", "TypeFunction isTypeFunctionDsymbol", "void printDepsConditionalScope, DVCondition, ByteSlice", "Expression expTypeType, Expression", "Expression resolveAliasThisScope, Expression, boolean", "int detectAtxHeadingLevelOutBuffer, int", "Type isTypeRootObject", "Expression eval_builtinLoc, FuncDeclaration, DArray<Expression>", "boolean c_isxdigitint", "BytePtr utf_decodeWcharCharPtr, int, IntRef, IntRef", "Expression interpretUnionExp, Statement, InterState", "ByteSlice deinitializerMsgtable", "Expression eval_unimpLoc, FuncDeclaration, DArray<Expression>", "void utf_encodeCharBytePtr, int", "void semantic3OnDependenciesModule", "UnionExp copyLiteralExpression", "UnionExp paintTypeOntoLiteralCopyType, Expression", "Expression interpret_aaApplyUnionExp, InterState, Expression, Expression", "void emitCommentDsymbol, OutBuffer, Scope", "void emplaceExpObject, Loc _param_1, VarExp _param_2, Type _param_3AddrExpLocVarExpType", "ByteSlice skipwhitespaceByteSlice", "void vdeprecationSupplementalLoc, BytePtr, Slice<Object>", "void highlightCode2Scope, DArray<Dsymbol>, OutBuffer, int", "FuncDeclaration funcptrOfExpression", "void emplaceExpObject, Loc _param_1, DArray<Expression> _param_2, DArray<Expression> _param_3AssocArrayLiteralExpLocDArray<Expression>DArray<Expression>", "void parseModulePatternBytePtr, MatcherNode, short", "void mangleToBufferExpression, OutBuffer", "boolean matchRootObject, RootObject", "Expression eval_exp2Loc, FuncDeclaration, DArray<Expression>", "int getMarkdownIndentOutBuffer, int, int", "int startTableOutBuffer, int, int, Loc, boolean, Ref<Slice<MarkdownDelimiter>>, Ref<IntSlice>", "boolean isKeywordBytePtr, int", "UnionExp CatType, Expression, Expression", "Expression eval_isfiniteLoc, FuncDeclaration, DArray<Expression>", "int comparePointersbyte, Expression, long, Expression, long", "boolean isDittoBytePtr", "void emplaceExpObject, Loc _param_1, Type _param_2NullExpLocType", "boolean isAssocArrayType", "boolean isSafePointerCastType, Type", "boolean numCmpbyte, double, doubleDouble", "void mangleToBufferDsymbol, OutBuffer", "void aliasSemanticAliasDeclaration, Scope", "Parameter isEponymousFunctionParameterDArray<Dsymbol>, BytePtr, int", "void emplaceExpObject, Loc _param_1, Type _param_2, DArray<Expression> _param_3ArrayLiteralExpLocTypeDArray<Expression>", "Expression assignAssocArrayElementLoc, AssocArrayLiteralExp, Expression, Expression", "void emplaceExpObject, Loc _param_1, IndexExp _param_2, Type _param_3AddrExpLocIndexExpType", "ByteSlice identifierMsgtable", "boolean ishexbyte", "void processFileByteSlice, ByteSlice, BytePtr_lex", "Expression eval_bswapLoc, FuncDeclaration, DArray<Expression>", "void vdeprecationLoc, BytePtr, Slice<Object>, BytePtr, BytePtr", "void setValueVarDeclaration, Expression", "void halt", "BytePtr mangleExactFuncDeclaration", "void emplaceExpObject, int _param_1IntegerExpInteger", "Expression eval_expm1Loc, FuncDeclaration, DArray<Expression>", "Dsymbol isDsymbolRootObject", "boolean isReservedNameByteSlice", "boolean hasProtectedAccessScope, Dsymbol", "void writeHighlightsConsole, OutBuffer", "boolean numCmpbyte, long, longLong", "Expression interpret_dupUnionExp, InterState, Expression", "Dsymbol getEponymousMemberTemplateDeclaration", "Expression eval_powLoc, FuncDeclaration, DArray<Expression>", "boolean hasValueVarDeclaration", "void templateInstanceSemanticTemplateInstance, Scope, DArray<Expression>", "Type getTypeRootObject", "Expression foreachApplyUtfUnionExp, InterState, Expression, Expression, boolean", "void emplaceExpObject, Loc _param_1, BytePtr _param_2StringExpLocBytePtr", "boolean includeImportedModuleCheckModuleComponentRange", "Expression eval_fmaLoc, FuncDeclaration, DArray<Expression>", "void sliceAssignArrayLiteralFromStringArrayLiteralExp, StringExp, int", "boolean writeMixinByteSlice, Loc", "void toDocBufferDsymbol, OutBuffer, Scope", "void emplaceExpObject, Loc _param_1, SliceExp _param_2, Type _param_3AddrExpLocSliceExpType"]] signature: void emplaceExpObject, Loc _param_1, Object _param_2, int _param_3StringExpLocObjectInteger

    // from template emplaceExp!(IntegerExpLocIntegerType)
    // removed duplicate function, [["Expression eval_yl2xp1Loc, FuncDeclaration, DArray<Expression>", "int skipPastIdentWithDotsOutBuffer, int", "boolean emitAnchorNameOutBuffer, Dsymbol, Scope, boolean", "TemplateParameter isTemplateParameterDArray<Dsymbol>, BytePtr, int", "void emplaceExpObject, Loc _param_1, double _param_2, Type _param_3RealExpLocDoubleType", "TypeAArray toBuiltinAATypeType", "Expression eval_isinfinityLoc, FuncDeclaration, DArray<Expression>", "boolean mergeCallSuperRef<Short>, short", "Expression eval_floorLoc, FuncDeclaration, DArray<Expression>", "UnionExp changeArrayLiteralLengthLoc, TypeArray, Expression, int, int", "ArrayLiteralExp createBlockDuplicatedArrayLiteralUnionExp, Loc, Type, Expression, int", "BytePtr stripLeadingNewlinesBytePtr", "void emplaceExpObject, byte _param_1CTFEExpByte", "void createMatchNodes", "UnionExp ArrayLengthType, Expression", "boolean checkAccessAggregateDeclaration, Loc, Scope, Dsymbol", "Expression resolveSliceExpression, UnionExp", "Expression getValueVarDeclaration", "boolean hasPackageAccessScope, Dsymbol", "void emplaceExpObject, Loc _param_1, Expression _param_2, Type _param_3AddrExpLocExpressionType", "boolean isFloatIntPaintType, Type", "int mainSlice<ByteSlice>", "void vmessageLoc, BytePtr, Slice<Object>", "boolean isValidManglingint", "int getAlignmentAlignDeclaration, Scope", "int arrayObjectHashDArray<RootObject>", "boolean numCmpbyte, int, intInteger", "boolean exceptionOrCantInterpretExpression", "ByteSlice lookForSourceFileByteSlice", "void showCtfeExprExpression, int", "void emplaceExpObject, Loc _param_1, Expression _param_2AddrExpLocExpression", "void removeBlankLineMacroOutBuffer, IntRef, IntRef", "boolean isErrorRootObject", "void emitMemberCommentsScopeDsymbol, OutBuffer, Scope", "UnionExp ctfeCatLoc, Type, Expression, Expression", "void escapeDdocStringOutBuffer, int", "void deprecationLoc, BytePtr", "void messageLoc, BytePtr", "Parameter isFunctionParameterDArray<Dsymbol>, BytePtr, int", "short parseModulePatternDepthBytePtr", "void MODtoDecoBufferOutBuffer, byte", "UnionExp ModLoc, Type, Expression, Expression", "void emplaceExpObject, Loc _param_1, Object _param_2, int _param_3StringExpLocObjectInteger", "void emplaceExpObject, Loc _param_1, StructLiteralExp _param_2, Type _param_3ClassReferenceExpLocStructLiteralExpType", "Expression eval_tanLoc, FuncDeclaration, DArray<Expression>", "int skippastURLOutBuffer, int", "boolean isZeroSecondbyte", "Expression eval_copysignLoc, FuncDeclaration, DArray<Expression>", "Expression eval_log2Loc, FuncDeclaration, DArray<Expression>", "double creallcomplex_t", "void warningSupplementalLoc, BytePtr", "int deduceTypeRootObject, Scope, Type, DArray<TemplateParameter>, DArray<RootObject>, IntPtr, int, boolean", "Tuple isTupleRootObject", "Expression eval_truncLoc, FuncDeclaration, DArray<Expression>", "UnionExp DivLoc, Type, Expression, Expression", "void expandTemplateMixinCommentsTemplateMixin, OutBuffer, Scope", "Expression eval_sqrtLoc, FuncDeclaration, DArray<Expression>", "boolean lambdaCheckForNestedRefExpression, Scope", "void emplaceExpObject, Loc _param_1, complex_t _param_2, Type _param_3ComplexExpLoccomplex_tType", "void dsymbolSemanticDsymbol, Scope", "void cantExpUnionExp", "boolean pointToSameMemoryBlockExpression, Expression", "long getStorageClassPrefixAttributesASTBaseASTBase", "UnionExp ComType, Expression", "ByteSlice initializerMsgtable", "int specificCmpbyte, int", "void builtinDeinitialize", "boolean isDigitSecondbyte", "Scope skipNonQualScopesScope", "UnionExp MulLoc, Type, Expression, Expression", "int utfStrideBytePtr", "void verrorPrintLoc, int, BytePtr, BytePtr, Slice<Object>, BytePtr, BytePtr", "int ctfeCmpLoc, byte, Expression, Expression", "boolean isTrueBoolExpression", "void builtin_init", "Parameter isParameterRootObject", "void errorSupplementalLoc, BytePtr", "long resolveArrayLengthExpression", "Expression evaluateDtorInterState, Expression", "int foreachDsymbolDArray<Dsymbol>, Function1<Dsymbol,Integer>", "void emplaceExpObject, ErrorExp", "Expression interpret_lengthUnionExp, InterState, Expression", "Parameter isFunctionParameterDsymbol, BytePtr, int", "void emitProtectionOutBuffer, Import", "TemplateParameter isTemplateParameterRootObject", "boolean arrayObjectMatchDArray<RootObject>, DArray<RootObject>", "void emplaceExpObject, Loc _param_1, Type _param_2, Expression _param_3, DArray<Expression> _param_4ArrayLiteralExpLocTypeExpressionDArray<Expression>", "boolean reliesOnTemplateParametersExpression, Slice<TemplateParameter>", "int endAllMarkdownQuotesOutBuffer, int, IntRef", "void emplaceExpObject, Loc _param_1, Expression _param_2, FuncDeclaration _param_3, boolean _param_4DelegateExpLocExpressionFuncDeclarationBoolean", "boolean definitelyValueParameterExpression", "void emplaceExpObject, Loc _param_1, boolean _param_2, Type _param_3IntegerExpLocBooleanType", "boolean reliesOnTidentType, DArray<TemplateParameter>, int", "Expression eval_yl2xLoc, FuncDeclaration, DArray<Expression>", "void errorLoc, BytePtr", "boolean utf_isValidDcharint", "void fatal", "Expression evaluateIfBuiltinUnionExp, InterState, Loc, FuncDeclaration, DArray<Expression>, Expression", "UnionExp pointerDifferenceLoc, Type, Expression, Expression", "UnionExp NegType, Expression", "boolean isidcharbyte", "int utf_codeLengthWcharint", "Expression getValueRef<Dsymbol>", "Function3<Loc,FuncDeclaration,DArray<Expression>,Expression> builtin_lookupBytePtr", "BytePtr linkToCharsint", "Expression interpretStatement, InterState", "int isConstExpression", "Expression getExpressionRootObject", "void emitProtectionOutBuffer, Prot", "Expression ctfeIndexLoc, Type, Expression, long", "int utf_codeLengthint, int", "UnionExp SliceType, Expression, Expression, Expression", "void functionResolveMatchAccumulator, Dsymbol, Loc, Scope, DArray<RootObject>, Type, DArray<Expression>, Ptr<BytePtr>", "int intSignedCmpbyte, long, long", "int ctfeIdentityLoc, byte, Expression, Expression", "Expression ctfeInterpretForPragmaMsgExpression", "void emplaceExpObject, Loc _param_1, long _param_2, Type _param_3IntegerExpLocLongType", "boolean isUniAlphaint", "BytePtr skipwhitespaceBytePtr", "UnionExp Cmpbyte, Loc, Type, Expression, Expression", "Dsymbol mostVisibleOverloadDsymbol, Module", "UnionExp OrLoc, Type, Expression, Expression", "void emplaceExpObject, Loc _param_1, Declaration _param_2, int _param_3SymOffExpLocDeclarationInteger", "int sliceCmpStringWithArrayStringExp, ArrayLiteralExp, int, int, int", "boolean hasPackageAccessModule, Dsymbol", "CtorDeclaration generateCopyCtorDeclarationStructDeclaration, long, long", "void errorBytePtr, int, int, BytePtr", "void add_builtinBytePtr, Function3<Loc,FuncDeclaration,DArray<Expression>,Expression>", "UnionExp PtrType, Expression", "void utf_encodeWcharCharPtr, int", "boolean findConditionDArray<Identifier>, Identifier", "int ctfeRawCmpLoc, Expression, Expression, boolean", "UnionExp ShlLoc, Type, Expression, Expression", "void highlightTextScope, DArray<Dsymbol>, Loc, OutBuffer, int", "UnionExp voidInitLiteralType, VarDeclaration", "void gendocfileModule", "boolean isIdTailBytePtr", "UnionExp ShrLoc, Type, Expression, Expression", "void emplaceExpObject, Loc _param_1, Type _param_2, Expression _param_3ArrayLiteralExpLocTypeExpression", "int setMangleOverrideDsymbol, ByteSlice", "Dsymbol getDsymbolRootObject", "Expression eval_log10Loc, FuncDeclaration, DArray<Expression>", "Expression eval_expLoc, FuncDeclaration, DArray<Expression>", "Expression getAggregateFromPointerExpression, Ptr<Long>", "void emplaceExpObject, Loc _param_1, Expression _param_2, Expression _param_3IndexExpLocExpressionExpression", "Expression eval_fmaxLoc, FuncDeclaration, DArray<Expression>", "boolean isArrayExpression", "UnionExp CastLoc, Type, Type, Expression", "UnionExp IndexType, Expression, Expression", "void emitAnchorOutBuffer, Dsymbol, Scope, boolean", "void removeAnyAtxHeadingSuffixOutBuffer, int", "DArray<Expression> copyElementsExpression, Expression", "void assignInPlaceExpression, Expression", "TemplateDeclaration getEponymousParentDsymbol", "void utf_encodeint, Object, int", "boolean issinglecharbyte", "ByteSlice replaceCharByteSlice, byte, ByteSlice", "void emplaceExpObject, Loc _param_1, BytePtr _param_2, int _param_3StringExpLocBytePtrInteger", "int getCodeIndentBytePtr", "boolean isIdentifierDArray<Dsymbol>, BytePtr, int", "BytePtr utf_decodeCharBytePtr, int, IntRef, IntRef", "void vwarningLoc, BytePtr, Slice<Object>", "boolean needToCopyLiteralExpression", "int sliceCmpStringWithStringStringExp, StringExp, int, int, int", "boolean isCtfeComparableExpression", "ByteSlice memdupByteSlice", "void mangleToBufferTemplateInstance, OutBuffer", "ByteSlice lexBytePtr, ByteSlice", "boolean isPointerType", "Expression findKeyInAALoc, AssocArrayLiteralExp, Expression", "int endTableOutBuffer, int, Ref<IntSlice>", "Expression scrubReturnValueLoc, Expression", "Type rawTypeMergeType, Type", "void emplaceExpObject, Loc _param_1, Expression _param_2, Type _param_3VectorExpLocExpressionType", "boolean buildCopyCtorStructDeclaration, Scope", "boolean reliesOnTemplateParametersType, Slice<TemplateParameter>", "int utf_codeLengthCharint", "void highlightCode3Scope, OutBuffer, BytePtr, BytePtr", "BytePtr getMessageDeprecatedDeclaration", "int endAllListsAndQuotesOutBuffer, IntRef, Ref<Slice<MarkdownList>>, IntRef, IntRef", "ByteSlice toLowercaseByteSlice", "Expression interpretFunctionUnionExp, FuncDeclaration, InterState, DArray<Expression>, Expression", "Expression interpret_valuesUnionExp, InterState, Expression, Type", "Expression eval_roundLoc, FuncDeclaration, DArray<Expression>", "void emplaceExpObject, Loc _param_1, Expression _param_2, Expression _param_3, Expression _param_4SliceExpLocExpressionExpressionExpression", "boolean modifyFieldVarLoc, Scope, VarDeclaration, Expression", "void deprecationSupplementalLoc, BytePtr", "Expression eval_ldexpLoc, FuncDeclaration, DArray<Expression>", "int extractArgNByteSlice, Ref<ByteSlice>, int", "UnionExp UshrLoc, Type, Expression, Expression", "Expression interpret_keysUnionExp, InterState, Expression, Type", "UnionExp Identitybyte, Loc, Type, Expression, Expression", "void vwarningSupplementalLoc, BytePtr, Slice<Object>", "BytePtr modToCharsint", "boolean checkSymbolAccessScope, Dsymbol", "Expression toDelegateExpression, Type, Scope", "UnionExp PowLoc, Type, Expression, Expression", "int isattyint", "Expression scrubCacheValueExpression", "int findFieldIndexByNameStructDeclaration, VarDeclaration", "boolean replaceMarkdownThematicBreakOutBuffer, IntRef, int, Loc", "RootObject objectSyntaxCopyRootObject", "int ctfeEqualLoc, byte, Expression, Expression", "void emplaceExpObject, Loc _param_1, Object _param_2, DArray<Expression> _param_3ArrayLiteralExpLocObjectDArray<Expression>", "void emplaceExpObject, Loc _param_1, Declaration _param_2, long _param_3SymOffExpLocDeclarationLong", "FuncDeclaration buildPostBlitStructDeclaration, Scope", "int skipCharsOutBuffer, int, ByteSlice", "Statement generateCopyCtorBodyStructDeclaration", "void emplaceExpObject, Loc _param_1, Expression _param_2, IntegerExp _param_3IndexExpLocExpressionIntegerExp", "void sliceAssignStringFromArrayLiteralStringExp, ArrayLiteralExp, int", "int expressionHashExpression", "boolean ensureStaticLinkToDsymbol, Dsymbol", "void emplaceExpObject, Loc _param_1, StructDeclaration _param_2, DArray<Expression> _param_3, Type _param_4StructLiteralExpLocStructDeclarationDArray<Expression>Type", "DArray<Expression> copyLiteralArrayDArray<Expression>, Expression", "int templateParameterLookupType, DArray<TemplateParameter>", "boolean symbolIsVisibleDsymbol, Dsymbol", "boolean c_isalnumint", "void tyToDecoBufferOutBuffer, int", "void emplaceExpObject, Loc _param_1, StructDeclaration _param_2, DArray<Expression> _param_3StructLiteralExpLocStructDeclarationDArray<Expression>", "void ObjectNotFoundIdentifier", "boolean isCVariadicParameterDArray<Dsymbol>, ByteSlice", "void mangleToFuncSignatureOutBuffer, FuncDeclaration", "void colorHighlightCodeOutBuffer", "boolean symbolIsVisibleScope, Dsymbol", "void emplaceExpObject, Loc _param_1, TypeSArray _param_2, DArray<Expression> _param_3ArrayLiteralExpLocTypeSArrayDArray<Expression>", "void warningLoc, BytePtr", "UnionExp BoolType, Expression", "StringExp createBlockDuplicatedStringLiteralUnionExp, Loc, Type, int, int, byte", "void colorSyntaxHighlightOutBuffer", "Expression paintTypeOntoLiteralType, Expression", "void endMarkdownHeadingOutBuffer, int, IntRef, Loc, IntRef", "int endRowAndTableOutBuffer, int, int, Loc, Ref<Slice<MarkdownDelimiter>>, Ref<IntSlice>", "boolean isoctalbyte", "void unSpeculativeScope, RootObject", "Expression eval_fminLoc, FuncDeclaration, DArray<Expression>", "boolean arrayObjectIsErrorDArray<RootObject>", "long getStorageClassPrefixAttributesASTCodegenASTCodegen", "boolean isSpecialEnumIdentIdentifier", "int skiptoidentOutBuffer, int", "int deduceTypeHelperType, Ptr<Type>, Type", "boolean mergeFieldInitRef<Short>, short", "void emplaceExpObject, VarDeclaration _param_1VoidInitExpVarDeclaration", "void foreachDsymbolDArray<Dsymbol>, Function1<Dsymbol,Void>", "Expression interpretUnionExp, Expression, InterState, int", "UnionExp AddLoc, Type, Expression, Expression", "Expression isExpressionRootObject", "void emplaceExpObject, Loc _param_1, Expression _param_2, IntegerExp _param_3, Expression _param_4SliceExpLocExpressionIntegerExpExpression", "int parseTableDelimiterRowOutBuffer, int, boolean, Ref<IntSlice>", "int skippastidentOutBuffer, int", "UnionExp XorLoc, Type, Expression, Expression", "int realCmpbyte, double, double", "boolean isCVariadicArgByteSlice", "boolean isCtfeValueValidExpression", "UnionExp MinLoc, Type, Expression, Expression", "Expression eval_bsrLoc, FuncDeclaration, DArray<Expression>", "void semanticTypeInfoScope, Type", "void highlightCodeScope, Dsymbol, OutBuffer, int", "Expression eval_logLoc, FuncDeclaration, DArray<Expression>", "Expression eval_cosLoc, FuncDeclaration, DArray<Expression>", "boolean allowsContractWithoutBodyFuncDeclaration", "double cimaglcomplex_t", "int replaceTableRowOutBuffer, int, int, Loc, Ref<Slice<MarkdownDelimiter>>, IntSlice, boolean", "void verrorLoc, BytePtr, Slice<Object>, BytePtr, BytePtr, BytePtr", "UnionExp AndLoc, Type, Expression, Expression", "boolean _isZeroInitExpression", "boolean checkAccessLoc, Scope, Package", "Expression eval_ceilLoc, FuncDeclaration, DArray<Expression>", "boolean isCtfeReferenceValidExpression", "boolean checkFrameAccessLoc, Scope, AggregateDeclaration, int", "Expression ctfeInterpretExpression", "int ctfeCmpArraysLoc, Expression, Expression, long", "boolean isTypeInfo_ClassType", "byte deduceWildHelperType, Ptr<Type>, Type", "boolean isIndentWSBytePtr", "Expression evaluatePostblitInterState, Expression", "void verrorSupplementalLoc, BytePtr, Slice<Object>", "boolean checkAccessLoc, Scope, Expression, Declaration", "FuncDeclaration search_toStringStructDeclaration", "Expression eval_sinLoc, FuncDeclaration, DArray<Expression>", "UnionExp Equalbyte, Loc, Type, Expression, Expression", "void emplaceExpObject, Loc _param_1, Expression _param_2, TypeVector _param_3VectorExpLocExpressionTypeVector", "int replaceMarkdownEmphasisOutBuffer, Loc, Ref<Slice<MarkdownDelimiter>>, int", "void emplaceExpObject, Loc _param_1, Object _param_2, int _param_3, byte _param_4StringExpLocObjectIntegerByte", "ByteSlice generateSlice<Msgtable>, Function1<Msgtable,ByteSlice>", "void emplaceExpObject, Loc _param_1, DArray<Expression> _param_2TupleExpLocDArray<Expression>", "void processFileByteSlice, ByteSlice, BytePtr_lispy", "Expression eval_popcntLoc, FuncDeclaration, DArray<Expression>", "Expression eval_bsfLoc, FuncDeclaration, DArray<Expression>", "void setValueWithoutCheckingVarDeclaration, Expression", "void mangleToBufferType, OutBuffer", "int isBuiltinFuncDeclaration", "Expression paintFloatIntUnionExp, Expression, Type", "void sliceAssignStringFromStringStringExp, StringExp, int", "Expression paintTypeOntoLiteralUnionExp, Type, Expression", "boolean symbolIsVisibleModule, Dsymbol", "void ctfeCompileFuncDeclaration", "Expression eval_fabsLoc, FuncDeclaration, DArray<Expression>", "void printCtfePerformanceStats", "void highlightCodeScope, DArray<Dsymbol>, OutBuffer, int", "ByteSlice getFilenameDArray<Identifier>, Identifier", "Expression interpretExpression, InterState, int", "Expression getValueExpression", "void messageBytePtr", "Expression eval_isnanLoc, FuncDeclaration, DArray<Expression>", "Expression ctfeCastUnionExp, Loc, Type, Type, Expression", "UnionExp NotType, Expression", "void escapeStrayParenthesisLoc, OutBuffer, int, boolean", "void lambdaSetParentExpression, FuncDeclaration", "boolean isIdStartBytePtr", "int intUnsignedCmpbyte, long, long", "void emplaceExpObject, Loc _param_1, int _param_2, Type _param_3IntegerExpLocIntegerType", "UnionExp pointerArithmeticLoc, byte, Type, Expression, Expression", "void emitProtectionOutBuffer, Declaration", "int templateIdentifierLookupIdentifier, DArray<TemplateParameter>", "ByteSlice lispyBytePtr, ByteSlice", "boolean walkPostorderExpression, StoppableVisitor", "TypeFunction isTypeFunctionDsymbol", "void printDepsConditionalScope, DVCondition, ByteSlice", "Expression expTypeType, Expression", "Expression resolveAliasThisScope, Expression, boolean", "int detectAtxHeadingLevelOutBuffer, int", "Type isTypeRootObject", "Expression eval_builtinLoc, FuncDeclaration, DArray<Expression>", "boolean c_isxdigitint", "BytePtr utf_decodeWcharCharPtr, int, IntRef, IntRef", "Expression interpretUnionExp, Statement, InterState", "ByteSlice deinitializerMsgtable", "Expression eval_unimpLoc, FuncDeclaration, DArray<Expression>", "void utf_encodeCharBytePtr, int", "void semantic3OnDependenciesModule", "UnionExp copyLiteralExpression", "UnionExp paintTypeOntoLiteralCopyType, Expression", "Expression interpret_aaApplyUnionExp, InterState, Expression, Expression", "void emitCommentDsymbol, OutBuffer, Scope", "void emplaceExpObject, Loc _param_1, VarExp _param_2, Type _param_3AddrExpLocVarExpType", "ByteSlice skipwhitespaceByteSlice", "void vdeprecationSupplementalLoc, BytePtr, Slice<Object>", "void highlightCode2Scope, DArray<Dsymbol>, OutBuffer, int", "FuncDeclaration funcptrOfExpression", "void emplaceExpObject, Loc _param_1, DArray<Expression> _param_2, DArray<Expression> _param_3AssocArrayLiteralExpLocDArray<Expression>DArray<Expression>", "void parseModulePatternBytePtr, MatcherNode, short", "void mangleToBufferExpression, OutBuffer", "boolean matchRootObject, RootObject", "Expression eval_exp2Loc, FuncDeclaration, DArray<Expression>", "int getMarkdownIndentOutBuffer, int, int", "int startTableOutBuffer, int, int, Loc, boolean, Ref<Slice<MarkdownDelimiter>>, Ref<IntSlice>", "boolean isKeywordBytePtr, int", "UnionExp CatType, Expression, Expression", "Expression eval_isfiniteLoc, FuncDeclaration, DArray<Expression>", "int comparePointersbyte, Expression, long, Expression, long", "boolean isDittoBytePtr", "void emplaceExpObject, Loc _param_1, Type _param_2NullExpLocType", "boolean isAssocArrayType", "boolean isSafePointerCastType, Type", "boolean numCmpbyte, double, doubleDouble", "void mangleToBufferDsymbol, OutBuffer", "void aliasSemanticAliasDeclaration, Scope", "Parameter isEponymousFunctionParameterDArray<Dsymbol>, BytePtr, int", "void emplaceExpObject, Loc _param_1, Type _param_2, DArray<Expression> _param_3ArrayLiteralExpLocTypeDArray<Expression>", "Expression assignAssocArrayElementLoc, AssocArrayLiteralExp, Expression, Expression", "void emplaceExpObject, Loc _param_1, IndexExp _param_2, Type _param_3AddrExpLocIndexExpType", "ByteSlice identifierMsgtable", "boolean ishexbyte", "void processFileByteSlice, ByteSlice, BytePtr_lex", "Expression eval_bswapLoc, FuncDeclaration, DArray<Expression>", "void vdeprecationLoc, BytePtr, Slice<Object>, BytePtr, BytePtr", "void setValueVarDeclaration, Expression", "void halt", "BytePtr mangleExactFuncDeclaration", "void emplaceExpObject, int _param_1IntegerExpInteger", "Expression eval_expm1Loc, FuncDeclaration, DArray<Expression>", "Dsymbol isDsymbolRootObject", "boolean isReservedNameByteSlice", "boolean hasProtectedAccessScope, Dsymbol", "void writeHighlightsConsole, OutBuffer", "boolean numCmpbyte, long, longLong", "Expression interpret_dupUnionExp, InterState, Expression", "Dsymbol getEponymousMemberTemplateDeclaration", "Expression eval_powLoc, FuncDeclaration, DArray<Expression>", "boolean hasValueVarDeclaration", "void templateInstanceSemanticTemplateInstance, Scope, DArray<Expression>", "Type getTypeRootObject", "Expression foreachApplyUtfUnionExp, InterState, Expression, Expression, boolean", "void emplaceExpObject, Loc _param_1, BytePtr _param_2StringExpLocBytePtr", "boolean includeImportedModuleCheckModuleComponentRange", "Expression eval_fmaLoc, FuncDeclaration, DArray<Expression>", "void sliceAssignArrayLiteralFromStringArrayLiteralExp, StringExp, int", "boolean writeMixinByteSlice, Loc", "void toDocBufferDsymbol, OutBuffer, Scope", "void emplaceExpObject, Loc _param_1, SliceExp _param_2, Type _param_3AddrExpLocSliceExpType"]] signature: void emplaceExpObject, Loc _param_1, int _param_2, Type _param_3IntegerExpLocIntegerType
    ...
    // from template emplaceExp!(IntegerExpLocIntegerType)
    // removed duplicate function, [["Expression eval_yl2xp1Loc, FuncDeclaration, DArray<Expression>", "int skipPastIdentWithDotsOutBuffer, int", "boolean emitAnchorNameOutBuffer, Dsymbol, Scope, boolean", "TemplateParameter isTemplateParameterDArray<Dsymbol>, BytePtr, int", "void emplaceExpObject, Loc _param_1, double _param_2, Type _param_3RealExpLocDoubleType", "TypeAArray toBuiltinAATypeType", "Expression eval_isinfinityLoc, FuncDeclaration, DArray<Expression>", "boolean mergeCallSuperRef<Short>, short", "Expression eval_floorLoc, FuncDeclaration, DArray<Expression>", "UnionExp changeArrayLiteralLengthLoc, TypeArray, Expression, int, int", "ArrayLiteralExp createBlockDuplicatedArrayLiteralUnionExp, Loc, Type, Expression, int", "BytePtr stripLeadingNewlinesBytePtr", "void emplaceExpObject, byte _param_1CTFEExpByte", "void createMatchNodes", "UnionExp ArrayLengthType, Expression", "boolean checkAccessAggregateDeclaration, Loc, Scope, Dsymbol", "Expression resolveSliceExpression, UnionExp", "Expression getValueVarDeclaration", "boolean hasPackageAccessScope, Dsymbol", "void emplaceExpObject, Loc _param_1, Expression _param_2, Type _param_3AddrExpLocExpressionType", "boolean isFloatIntPaintType, Type", "int mainSlice<ByteSlice>", "void vmessageLoc, BytePtr, Slice<Object>", "boolean isValidManglingint", "int getAlignmentAlignDeclaration, Scope", "int arrayObjectHashDArray<RootObject>", "boolean numCmpbyte, int, intInteger", "boolean exceptionOrCantInterpretExpression", "ByteSlice lookForSourceFileByteSlice", "void showCtfeExprExpression, int", "void emplaceExpObject, Loc _param_1, Expression _param_2AddrExpLocExpression", "void removeBlankLineMacroOutBuffer, IntRef, IntRef", "boolean isErrorRootObject", "void emitMemberCommentsScopeDsymbol, OutBuffer, Scope", "UnionExp ctfeCatLoc, Type, Expression, Expression", "void escapeDdocStringOutBuffer, int", "void deprecationLoc, BytePtr", "void messageLoc, BytePtr", "Parameter isFunctionParameterDArray<Dsymbol>, BytePtr, int", "short parseModulePatternDepthBytePtr", "void MODtoDecoBufferOutBuffer, byte", "UnionExp ModLoc, Type, Expression, Expression", "void emplaceExpObject, Loc _param_1, Object _param_2, int _param_3StringExpLocObjectInteger", "void emplaceExpObject, Loc _param_1, StructLiteralExp _param_2, Type _param_3ClassReferenceExpLocStructLiteralExpType", "Expression eval_tanLoc, FuncDeclaration, DArray<Expression>", "int skippastURLOutBuffer, int", "boolean isZeroSecondbyte", "Expression eval_copysignLoc, FuncDeclaration, DArray<Expression>", "Expression eval_log2Loc, FuncDeclaration, DArray<Expression>", "double creallcomplex_t", "void warningSupplementalLoc, BytePtr", "int deduceTypeRootObject, Scope, Type, DArray<TemplateParameter>, DArray<RootObject>, IntPtr, int, boolean", "Tuple isTupleRootObject", "Expression eval_truncLoc, FuncDeclaration, DArray<Expression>", "UnionExp DivLoc, Type, Expression, Expression", "void expandTemplateMixinCommentsTemplateMixin, OutBuffer, Scope", "Expression eval_sqrtLoc, FuncDeclaration, DArray<Expression>", "boolean lambdaCheckForNestedRefExpression, Scope", "void emplaceExpObject, Loc _param_1, complex_t _param_2, Type _param_3ComplexExpLoccomplex_tType", "void dsymbolSemanticDsymbol, Scope", "void cantExpUnionExp", "boolean pointToSameMemoryBlockExpression, Expression", "long getStorageClassPrefixAttributesASTBaseASTBase", "UnionExp ComType, Expression", "ByteSlice initializerMsgtable", "int specificCmpbyte, int", "void builtinDeinitialize", "boolean isDigitSecondbyte", "Scope skipNonQualScopesScope", "UnionExp MulLoc, Type, Expression, Expression", "int utfStrideBytePtr", "void verrorPrintLoc, int, BytePtr, BytePtr, Slice<Object>, BytePtr, BytePtr", "int ctfeCmpLoc, byte, Expression, Expression", "boolean isTrueBoolExpression", "void builtin_init", "Parameter isParameterRootObject", "void errorSupplementalLoc, BytePtr", "long resolveArrayLengthExpression", "Expression evaluateDtorInterState, Expression", "int foreachDsymbolDArray<Dsymbol>, Function1<Dsymbol,Integer>", "void emplaceExpObject, ErrorExp", "Expression interpret_lengthUnionExp, InterState, Expression", "Parameter isFunctionParameterDsymbol, BytePtr, int", "void emitProtectionOutBuffer, Import", "TemplateParameter isTemplateParameterRootObject", "boolean arrayObjectMatchDArray<RootObject>, DArray<RootObject>", "void emplaceExpObject, Loc _param_1, Type _param_2, Expression _param_3, DArray<Expression> _param_4ArrayLiteralExpLocTypeExpressionDArray<Expression>", "boolean reliesOnTemplateParametersExpression, Slice<TemplateParameter>", "int endAllMarkdownQuotesOutBuffer, int, IntRef", "void emplaceExpObject, Loc _param_1, Expression _param_2, FuncDeclaration _param_3, boolean _param_4DelegateExpLocExpressionFuncDeclarationBoolean", "boolean definitelyValueParameterExpression", "void emplaceExpObject, Loc _param_1, boolean _param_2, Type _param_3IntegerExpLocBooleanType", "boolean reliesOnTidentType, DArray<TemplateParameter>, int", "Expression eval_yl2xLoc, FuncDeclaration, DArray<Expression>", "void errorLoc, BytePtr", "boolean utf_isValidDcharint", "void fatal", "Expression evaluateIfBuiltinUnionExp, InterState, Loc, FuncDeclaration, DArray<Expression>, Expression", "UnionExp pointerDifferenceLoc, Type, Expression, Expression", "UnionExp NegType, Expression", "boolean isidcharbyte", "int utf_codeLengthWcharint", "Expression getValueRef<Dsymbol>", "Function3<Loc,FuncDeclaration,DArray<Expression>,Expression> builtin_lookupBytePtr", "BytePtr linkToCharsint", "Expression interpretStatement, InterState", "int isConstExpression", "Expression getExpressionRootObject", "void emitProtectionOutBuffer, Prot", "Expression ctfeIndexLoc, Type, Expression, long", "int utf_codeLengthint, int", "UnionExp SliceType, Expression, Expression, Expression", "void functionResolveMatchAccumulator, Dsymbol, Loc, Scope, DArray<RootObject>, Type, DArray<Expression>, Ptr<BytePtr>", "int intSignedCmpbyte, long, long", "int ctfeIdentityLoc, byte, Expression, Expression", "Expression ctfeInterpretForPragmaMsgExpression", "void emplaceExpObject, Loc _param_1, long _param_2, Type _param_3IntegerExpLocLongType", "boolean isUniAlphaint", "BytePtr skipwhitespaceBytePtr", "UnionExp Cmpbyte, Loc, Type, Expression, Expression", "Dsymbol mostVisibleOverloadDsymbol, Module", "UnionExp OrLoc, Type, Expression, Expression", "void emplaceExpObject, Loc _param_1, Declaration _param_2, int _param_3SymOffExpLocDeclarationInteger", "int sliceCmpStringWithArrayStringExp, ArrayLiteralExp, int, int, int", "boolean hasPackageAccessModule, Dsymbol", "CtorDeclaration generateCopyCtorDeclarationStructDeclaration, long, long", "void errorBytePtr, int, int, BytePtr", "void add_builtinBytePtr, Function3<Loc,FuncDeclaration,DArray<Expression>,Expression>", "UnionExp PtrType, Expression", "void utf_encodeWcharCharPtr, int", "boolean findConditionDArray<Identifier>, Identifier", "int ctfeRawCmpLoc, Expression, Expression, boolean", "UnionExp ShlLoc, Type, Expression, Expression", "void highlightTextScope, DArray<Dsymbol>, Loc, OutBuffer, int", "UnionExp voidInitLiteralType, VarDeclaration", "void gendocfileModule", "boolean isIdTailBytePtr", "UnionExp ShrLoc, Type, Expression, Expression", "void emplaceExpObject, Loc _param_1, Type _param_2, Expression _param_3ArrayLiteralExpLocTypeExpression", "int setMangleOverrideDsymbol, ByteSlice", "Dsymbol getDsymbolRootObject", "Expression eval_log10Loc, FuncDeclaration, DArray<Expression>", "Expression eval_expLoc, FuncDeclaration, DArray<Expression>", "Expression getAggregateFromPointerExpression, Ptr<Long>", "void emplaceExpObject, Loc _param_1, Expression _param_2, Expression _param_3IndexExpLocExpressionExpression", "Expression eval_fmaxLoc, FuncDeclaration, DArray<Expression>", "boolean isArrayExpression", "UnionExp CastLoc, Type, Type, Expression", "UnionExp IndexType, Expression, Expression", "void emitAnchorOutBuffer, Dsymbol, Scope, boolean", "void removeAnyAtxHeadingSuffixOutBuffer, int", "DArray<Expression> copyElementsExpression, Expression", "void assignInPlaceExpression, Expression", "TemplateDeclaration getEponymousParentDsymbol", "void utf_encodeint, Object, int", "boolean issinglecharbyte", "ByteSlice replaceCharByteSlice, byte, ByteSlice", "void emplaceExpObject, Loc _param_1, BytePtr _param_2, int _param_3StringExpLocBytePtrInteger", "int getCodeIndentBytePtr", "boolean isIdentifierDArray<Dsymbol>, BytePtr, int", "BytePtr utf_decodeCharBytePtr, int, IntRef, IntRef", "void vwarningLoc, BytePtr, Slice<Object>", "boolean needToCopyLiteralExpression", "int sliceCmpStringWithStringStringExp, StringExp, int, int, int", "boolean isCtfeComparableExpression", "ByteSlice memdupByteSlice", "void mangleToBufferTemplateInstance, OutBuffer", "ByteSlice lexBytePtr, ByteSlice", "boolean isPointerType", "Expression findKeyInAALoc, AssocArrayLiteralExp, Expression", "int endTableOutBuffer, int, Ref<IntSlice>", "Expression scrubReturnValueLoc, Expression", "Type rawTypeMergeType, Type", "void emplaceExpObject, Loc _param_1, Expression _param_2, Type _param_3VectorExpLocExpressionType", "boolean buildCopyCtorStructDeclaration, Scope", "boolean reliesOnTemplateParametersType, Slice<TemplateParameter>", "int utf_codeLengthCharint", "void highlightCode3Scope, OutBuffer, BytePtr, BytePtr", "BytePtr getMessageDeprecatedDeclaration", "int endAllListsAndQuotesOutBuffer, IntRef, Ref<Slice<MarkdownList>>, IntRef, IntRef", "ByteSlice toLowercaseByteSlice", "Expression interpretFunctionUnionExp, FuncDeclaration, InterState, DArray<Expression>, Expression", "Expression interpret_valuesUnionExp, InterState, Expression, Type", "Expression eval_roundLoc, FuncDeclaration, DArray<Expression>", "void emplaceExpObject, Loc _param_1, Expression _param_2, Expression _param_3, Expression _param_4SliceExpLocExpressionExpressionExpression", "boolean modifyFieldVarLoc, Scope, VarDeclaration, Expression", "void emplaceExpObject, Loc _param_1, Expression _param_2, FuncDeclaration _param_3, boolean _param_4DotVarExpLocExpressionFuncDeclarationBoolean", "void deprecationSupplementalLoc, BytePtr", "Expression eval_ldexpLoc, FuncDeclaration, DArray<Expression>", "int extractArgNByteSlice, Ref<ByteSlice>, int", "UnionExp UshrLoc, Type, Expression, Expression", "Expression interpret_keysUnionExp, InterState, Expression, Type", "UnionExp Identitybyte, Loc, Type, Expression, Expression", "void vwarningSupplementalLoc, BytePtr, Slice<Object>", "BytePtr modToCharsint", "boolean checkSymbolAccessScope, Dsymbol", "Expression toDelegateExpression, Type, Scope", "UnionExp PowLoc, Type, Expression, Expression", "int isattyint", "Expression scrubCacheValueExpression", "int findFieldIndexByNameStructDeclaration, VarDeclaration", "boolean replaceMarkdownThematicBreakOutBuffer, IntRef, int, Loc", "RootObject objectSyntaxCopyRootObject", "int ctfeEqualLoc, byte, Expression, Expression", "void emplaceExpObject, Loc _param_1, Object _param_2, DArray<Expression> _param_3ArrayLiteralExpLocObjectDArray<Expression>", "void emplaceExpObject, Loc _param_1, Declaration _param_2, long _param_3SymOffExpLocDeclarationLong", "FuncDeclaration buildPostBlitStructDeclaration, Scope", "int skipCharsOutBuffer, int, ByteSlice", "Statement generateCopyCtorBodyStructDeclaration", "void emplaceExpObject, Loc _param_1, Expression _param_2, IntegerExp _param_3IndexExpLocExpressionIntegerExp", "void sliceAssignStringFromArrayLiteralStringExp, ArrayLiteralExp, int", "void emplaceExpObject, Loc _param_1, Declaration _param_2VarExpLocDeclaration", "int expressionHashExpression", "boolean ensureStaticLinkToDsymbol, Dsymbol", "void emplaceExpObject, Loc _param_1, StructDeclaration _param_2, DArray<Expression> _param_3, Type _param_4StructLiteralExpLocStructDeclarationDArray<Expression>Type", "DArray<Expression> copyLiteralArrayDArray<Expression>, Expression", "int templateParameterLookupType, DArray<TemplateParameter>", "boolean symbolIsVisibleDsymbol, Dsymbol", "boolean c_isalnumint", "void tyToDecoBufferOutBuffer, int", "void emplaceExpObject, Loc _param_1, StructDeclaration _param_2, DArray<Expression> _param_3StructLiteralExpLocStructDeclarationDArray<Expression>", "void ObjectNotFoundIdentifier", "boolean isCVariadicParameterDArray<Dsymbol>, ByteSlice", "void mangleToFuncSignatureOutBuffer, FuncDeclaration", "void colorHighlightCodeOutBuffer", "boolean symbolIsVisibleScope, Dsymbol", "void emplaceExpObject, Loc _param_1, TypeSArray _param_2, DArray<Expression> _param_3ArrayLiteralExpLocTypeSArrayDArray<Expression>", "void warningLoc, BytePtr", "UnionExp BoolType, Expression", "StringExp createBlockDuplicatedStringLiteralUnionExp, Loc, Type, int, int, byte", "void colorSyntaxHighlightOutBuffer", "Expression paintTypeOntoLiteralType, Expression", "void endMarkdownHeadingOutBuffer, int, IntRef, Loc, IntRef", "int endRowAndTableOutBuffer, int, int, Loc, Ref<Slice<MarkdownDelimiter>>, Ref<IntSlice>", "boolean isoctalbyte", "void unSpeculativeScope, RootObject", "Expression eval_fminLoc, FuncDeclaration, DArray<Expression>", "boolean arrayObjectIsErrorDArray<RootObject>", "long getStorageClassPrefixAttributesASTCodegenASTCodegen", "boolean isSpecialEnumIdentIdentifier", "int skiptoidentOutBuffer, int", "int deduceTypeHelperType, Ptr<Type>, Type", "boolean mergeFieldInitRef<Short>, short", "void emplaceExpObject, VarDeclaration _param_1VoidInitExpVarDeclaration", "void foreachDsymbolDArray<Dsymbol>, Function1<Dsymbol,Void>", "Expression interpretUnionExp, Expression, InterState, int", "UnionExp AddLoc, Type, Expression, Expression", "Expression isExpressionRootObject", "void emplaceExpObject, Loc _param_1, Expression _param_2, IntegerExp _param_3, Expression _param_4SliceExpLocExpressionIntegerExpExpression", "int parseTableDelimiterRowOutBuffer, int, boolean, Ref<IntSlice>", "int skippastidentOutBuffer, int", "UnionExp XorLoc, Type, Expression, Expression", "int realCmpbyte, double, double", "boolean isCVariadicArgByteSlice", "boolean isCtfeValueValidExpression", "UnionExp MinLoc, Type, Expression, Expression", "Expression eval_bsrLoc, FuncDeclaration, DArray<Expression>", "void semanticTypeInfoScope, Type", "void highlightCodeScope, Dsymbol, OutBuffer, int", "Expression eval_logLoc, FuncDeclaration, DArray<Expression>", "Expression eval_cosLoc, FuncDeclaration, DArray<Expression>", "boolean allowsContractWithoutBodyFuncDeclaration", "double cimaglcomplex_t", "int replaceTableRowOutBuffer, int, int, Loc, Ref<Slice<MarkdownDelimiter>>, IntSlice, boolean", "void verrorLoc, BytePtr, Slice<Object>, BytePtr, BytePtr, BytePtr", "UnionExp AndLoc, Type, Expression, Expression", "boolean _isZeroInitExpression", "boolean checkAccessLoc, Scope, Package", "Expression eval_ceilLoc, FuncDeclaration, DArray<Expression>", "boolean isCtfeReferenceValidExpression", "boolean checkFrameAccessLoc, Scope, AggregateDeclaration, int", "Expression ctfeInterpretExpression", "int ctfeCmpArraysLoc, Expression, Expression, long", "boolean isTypeInfo_ClassType", "byte deduceWildHelperType, Ptr<Type>, Type", "boolean isIndentWSBytePtr", "Expression evaluatePostblitInterState, Expression", "void verrorSupplementalLoc, BytePtr, Slice<Object>", "boolean checkAccessLoc, Scope, Expression, Declaration", "FuncDeclaration search_toStringStructDeclaration", "Expression eval_sinLoc, FuncDeclaration, DArray<Expression>", "UnionExp Equalbyte, Loc, Type, Expression, Expression", "void emplaceExpObject, Loc _param_1, Expression _param_2, TypeVector _param_3VectorExpLocExpressionTypeVector", "int replaceMarkdownEmphasisOutBuffer, Loc, Ref<Slice<MarkdownDelimiter>>, int", "void emplaceExpObject, Loc _param_1, Expression _param_2, IntegerExp _param_3, IntegerExp _param_4SliceExpLocExpressionIntegerExpIntegerExp", "void emplaceExpObject, Loc _param_1, Object _param_2, int _param_3, byte _param_4StringExpLocObjectIntegerByte", "ByteSlice generateSlice<Msgtable>, Function1<Msgtable,ByteSlice>", "void emplaceExpObject, Loc _param_1, DArray<Expression> _param_2TupleExpLocDArray<Expression>", "void processFileByteSlice, ByteSlice, BytePtr_lispy", "Expression eval_popcntLoc, FuncDeclaration, DArray<Expression>", "Expression eval_bsfLoc, FuncDeclaration, DArray<Expression>", "void setValueWithoutCheckingVarDeclaration, Expression", "void mangleToBufferType, OutBuffer", "int isBuiltinFuncDeclaration", "Expression paintFloatIntUnionExp, Expression, Type", "void sliceAssignStringFromStringStringExp, StringExp, int", "Expression paintTypeOntoLiteralUnionExp, Type, Expression", "boolean symbolIsVisibleModule, Dsymbol", "void ctfeCompileFuncDeclaration", "Expression eval_fabsLoc, FuncDeclaration, DArray<Expression>", "void printCtfePerformanceStats", "void highlightCodeScope, DArray<Dsymbol>, OutBuffer, int", "ByteSlice getFilenameDArray<Identifier>, Identifier", "Expression interpretExpression, InterState, int", "Expression getValueExpression", "void messageBytePtr", "Expression eval_isnanLoc, FuncDeclaration, DArray<Expression>", "Expression ctfeCastUnionExp, Loc, Type, Type, Expression", "UnionExp NotType, Expression", "void escapeStrayParenthesisLoc, OutBuffer, int, boolean", "void lambdaSetParentExpression, FuncDeclaration", "boolean isIdStartBytePtr", "int intUnsignedCmpbyte, long, long", "void emplaceExpObject, Loc _param_1, int _param_2, Type _param_3IntegerExpLocIntegerType", "UnionExp pointerArithmeticLoc, byte, Type, Expression, Expression", "void emitProtectionOutBuffer, Declaration", "int templateIdentifierLookupIdentifier, DArray<TemplateParameter>", "ByteSlice lispyBytePtr, ByteSlice", "boolean walkPostorderExpression, StoppableVisitor", "TypeFunction isTypeFunctionDsymbol", "void printDepsConditionalScope, DVCondition, ByteSlice", "Expression expTypeType, Expression", "Expression resolveAliasThisScope, Expression, boolean", "int detectAtxHeadingLevelOutBuffer, int", "Type isTypeRootObject", "Expression eval_builtinLoc, FuncDeclaration, DArray<Expression>", "boolean c_isxdigitint", "BytePtr utf_decodeWcharCharPtr, int, IntRef, IntRef", "Expression interpretUnionExp, Statement, InterState", "ByteSlice deinitializerMsgtable", "Expression eval_unimpLoc, FuncDeclaration, DArray<Expression>", "void utf_encodeCharBytePtr, int", "void semantic3OnDependenciesModule", "UnionExp copyLiteralExpression", "UnionExp paintTypeOntoLiteralCopyType, Expression", "Expression interpret_aaApplyUnionExp, InterState, Expression, Expression", "void emitCommentDsymbol, OutBuffer, Scope", "void emplaceExpObject, Loc _param_1, VarExp _param_2, Type _param_3AddrExpLocVarExpType", "ByteSlice skipwhitespaceByteSlice", "void vdeprecationSupplementalLoc, BytePtr, Slice<Object>", "void highlightCode2Scope, DArray<Dsymbol>, OutBuffer, int", "FuncDeclaration funcptrOfExpression", "void emplaceExpObject, Loc _param_1, DArray<Expression> _param_2, DArray<Expression> _param_3AssocArrayLiteralExpLocDArray<Expression>DArray<Expression>", "void parseModulePatternBytePtr, MatcherNode, short", "void mangleToBufferExpression, OutBuffer", "boolean matchRootObject, RootObject", "Expression eval_exp2Loc, FuncDeclaration, DArray<Expression>", "int getMarkdownIndentOutBuffer, int, int", "int startTableOutBuffer, int, int, Loc, boolean, Ref<Slice<MarkdownDelimiter>>, Ref<IntSlice>", "boolean isKeywordBytePtr, int", "UnionExp CatType, Expression, Expression", "Expression eval_isfiniteLoc, FuncDeclaration, DArray<Expression>", "int comparePointersbyte, Expression, long, Expression, long", "boolean isDittoBytePtr", "void emplaceExpObject, Loc _param_1, Type _param_2NullExpLocType", "boolean isAssocArrayType", "boolean isSafePointerCastType, Type", "boolean numCmpbyte, double, doubleDouble", "void mangleToBufferDsymbol, OutBuffer", "void aliasSemanticAliasDeclaration, Scope", "Parameter isEponymousFunctionParameterDArray<Dsymbol>, BytePtr, int", "void emplaceExpObject, Loc _param_1, Type _param_2, DArray<Expression> _param_3ArrayLiteralExpLocTypeDArray<Expression>", "Expression assignAssocArrayElementLoc, AssocArrayLiteralExp, Expression, Expression", "void emplaceExpObject, Loc _param_1, IndexExp _param_2, Type _param_3AddrExpLocIndexExpType", "ByteSlice identifierMsgtable", "boolean ishexbyte", "void processFileByteSlice, ByteSlice, BytePtr_lex", "Expression eval_bswapLoc, FuncDeclaration, DArray<Expression>", "void vdeprecationLoc, BytePtr, Slice<Object>, BytePtr, BytePtr", "void setValueVarDeclaration, Expression", "void halt", "BytePtr mangleExactFuncDeclaration", "void emplaceExpObject, int _param_1IntegerExpInteger", "Expression eval_expm1Loc, FuncDeclaration, DArray<Expression>", "Dsymbol isDsymbolRootObject", "boolean isReservedNameByteSlice", "boolean hasProtectedAccessScope, Dsymbol", "void writeHighlightsConsole, OutBuffer", "boolean numCmpbyte, long, longLong", "Expression interpret_dupUnionExp, InterState, Expression", "Dsymbol getEponymousMemberTemplateDeclaration", "Expression eval_powLoc, FuncDeclaration, DArray<Expression>", "boolean hasValueVarDeclaration", "void templateInstanceSemanticTemplateInstance, Scope, DArray<Expression>", "Type getTypeRootObject", "Expression foreachApplyUtfUnionExp, InterState, Expression, Expression, boolean", "void emplaceExpObject, Loc _param_1, BytePtr _param_2StringExpLocBytePtr", "boolean includeImportedModuleCheckModuleComponentRange", "Expression eval_fmaLoc, FuncDeclaration, DArray<Expression>", "void sliceAssignArrayLiteralFromStringArrayLiteralExp, StringExp, int", "boolean writeMixinByteSlice, Loc", "void toDocBufferDsymbol, OutBuffer, Scope", "void emplaceExpObject, Loc _param_1, SliceExp _param_2, Type _param_3AddrExpLocSliceExpType"]] signature: void emplaceExpObject, Loc _param_1, int _param_2, Type _param_3IntegerExpLocIntegerType
    ...
    // from template emplaceExp!(ComplexExpLoccomplex_tType)
    // removed duplicate function, [["Expression eval_yl2xp1Loc, FuncDeclaration, DArray<Expression>", "int skipPastIdentWithDotsOutBuffer, int", "boolean emitAnchorNameOutBuffer, Dsymbol, Scope, boolean", "TemplateParameter isTemplateParameterDArray<Dsymbol>, BytePtr, int", "void emplaceExpObject, Loc _param_1, double _param_2, Type _param_3RealExpLocDoubleType", "TypeAArray toBuiltinAATypeType", "Expression eval_isinfinityLoc, FuncDeclaration, DArray<Expression>", "boolean mergeCallSuperRef<Short>, short", "Expression eval_floorLoc, FuncDeclaration, DArray<Expression>", "UnionExp changeArrayLiteralLengthLoc, TypeArray, Expression, int, int", "ArrayLiteralExp createBlockDuplicatedArrayLiteralUnionExp, Loc, Type, Expression, int", "BytePtr stripLeadingNewlinesBytePtr", "void emplaceExpObject, byte _param_1CTFEExpByte", "void createMatchNodes", "UnionExp ArrayLengthType, Expression", "boolean checkAccessAggregateDeclaration, Loc, Scope, Dsymbol", "Expression resolveSliceExpression, UnionExp", "Expression getValueVarDeclaration", "boolean hasPackageAccessScope, Dsymbol", "void emplaceExpObject, Loc _param_1, Expression _param_2, Type _param_3AddrExpLocExpressionType", "boolean isFloatIntPaintType, Type", "int mainSlice<ByteSlice>", "void vmessageLoc, BytePtr, Slice<Object>", "boolean isValidManglingint", "int getAlignmentAlignDeclaration, Scope", "int arrayObjectHashDArray<RootObject>", "boolean numCmpbyte, int, intInteger", "boolean exceptionOrCantInterpretExpression", "ByteSlice lookForSourceFileByteSlice", "void showCtfeExprExpression, int", "void emplaceExpObject, Loc _param_1, Expression _param_2AddrExpLocExpression", "void removeBlankLineMacroOutBuffer, IntRef, IntRef", "boolean isErrorRootObject", "void emitMemberCommentsScopeDsymbol, OutBuffer, Scope", "UnionExp ctfeCatLoc, Type, Expression, Expression", "void escapeDdocStringOutBuffer, int", "void deprecationLoc, BytePtr", "void messageLoc, BytePtr", "Parameter isFunctionParameterDArray<Dsymbol>, BytePtr, int", "short parseModulePatternDepthBytePtr", "void MODtoDecoBufferOutBuffer, byte", "UnionExp ModLoc, Type, Expression, Expression", "void emplaceExpObject, Loc _param_1, Object _param_2, int _param_3StringExpLocObjectInteger", "void emplaceExpObject, Loc _param_1, StructLiteralExp _param_2, Type _param_3ClassReferenceExpLocStructLiteralExpType", "Expression eval_tanLoc, FuncDeclaration, DArray<Expression>", "int skippastURLOutBuffer, int", "boolean isZeroSecondbyte", "Expression eval_copysignLoc, FuncDeclaration, DArray<Expression>", "Expression eval_log2Loc, FuncDeclaration, DArray<Expression>", "double creallcomplex_t", "void warningSupplementalLoc, BytePtr", "int deduceTypeRootObject, Scope, Type, DArray<TemplateParameter>, DArray<RootObject>, IntPtr, int, boolean", "Tuple isTupleRootObject", "Expression eval_truncLoc, FuncDeclaration, DArray<Expression>", "UnionExp DivLoc, Type, Expression, Expression", "void expandTemplateMixinCommentsTemplateMixin, OutBuffer, Scope", "Expression eval_sqrtLoc, FuncDeclaration, DArray<Expression>", "boolean lambdaCheckForNestedRefExpression, Scope", "void emplaceExpObject, Loc _param_1, complex_t _param_2, Type _param_3ComplexExpLoccomplex_tType", "void dsymbolSemanticDsymbol, Scope", "void cantExpUnionExp", "boolean pointToSameMemoryBlockExpression, Expression", "long getStorageClassPrefixAttributesASTBaseASTBase", "UnionExp ComType, Expression", "ByteSlice initializerMsgtable", "int specificCmpbyte, int", "void builtinDeinitialize", "boolean isDigitSecondbyte", "Scope skipNonQualScopesScope", "UnionExp MulLoc, Type, Expression, Expression", "int utfStrideBytePtr", "void verrorPrintLoc, int, BytePtr, BytePtr, Slice<Object>, BytePtr, BytePtr", "int ctfeCmpLoc, byte, Expression, Expression", "boolean isTrueBoolExpression", "void builtin_init", "Parameter isParameterRootObject", "void errorSupplementalLoc, BytePtr", "long resolveArrayLengthExpression", "Expression evaluateDtorInterState, Expression", "int foreachDsymbolDArray<Dsymbol>, Function1<Dsymbol,Integer>", "void emplaceExpObject, ErrorExp", "Expression interpret_lengthUnionExp, InterState, Expression", "Parameter isFunctionParameterDsymbol, BytePtr, int", "void emitProtectionOutBuffer, Import", "TemplateParameter isTemplateParameterRootObject", "boolean arrayObjectMatchDArray<RootObject>, DArray<RootObject>", "void emplaceExpObject, Loc _param_1, Type _param_2, Expression _param_3, DArray<Expression> _param_4ArrayLiteralExpLocTypeExpressionDArray<Expression>", "boolean reliesOnTemplateParametersExpression, Slice<TemplateParameter>", "int endAllMarkdownQuotesOutBuffer, int, IntRef", "void emplaceExpObject, Loc _param_1, Expression _param_2, FuncDeclaration _param_3, boolean _param_4DelegateExpLocExpressionFuncDeclarationBoolean", "boolean definitelyValueParameterExpression", "void emplaceExpObject, Loc _param_1, boolean _param_2, Type _param_3IntegerExpLocBooleanType", "boolean reliesOnTidentType, DArray<TemplateParameter>, int", "Expression eval_yl2xLoc, FuncDeclaration, DArray<Expression>", "void errorLoc, BytePtr", "boolean utf_isValidDcharint", "void fatal", "Expression evaluateIfBuiltinUnionExp, InterState, Loc, FuncDeclaration, DArray<Expression>, Expression", "UnionExp pointerDifferenceLoc, Type, Expression, Expression", "UnionExp NegType, Expression", "boolean isidcharbyte", "int utf_codeLengthWcharint", "Expression getValueRef<Dsymbol>", "Function3<Loc,FuncDeclaration,DArray<Expression>,Expression> builtin_lookupBytePtr", "BytePtr linkToCharsint", "Expression interpretStatement, InterState", "int isConstExpression", "Expression getExpressionRootObject", "void emitProtectionOutBuffer, Prot", "Expression ctfeIndexLoc, Type, Expression, long", "int utf_codeLengthint, int", "UnionExp SliceType, Expression, Expression, Expression", "void functionResolveMatchAccumulator, Dsymbol, Loc, Scope, DArray<RootObject>, Type, DArray<Expression>, Ptr<BytePtr>", "int intSignedCmpbyte, long, long", "int ctfeIdentityLoc, byte, Expression, Expression", "Expression ctfeInterpretForPragmaMsgExpression", "void emplaceExpObject, Loc _param_1, long _param_2, Type _param_3IntegerExpLocLongType", "boolean isUniAlphaint", "BytePtr skipwhitespaceBytePtr", "UnionExp Cmpbyte, Loc, Type, Expression, Expression", "Dsymbol mostVisibleOverloadDsymbol, Module", "UnionExp OrLoc, Type, Expression, Expression", "void emplaceExpObject, Loc _param_1, Declaration _param_2, int _param_3SymOffExpLocDeclarationInteger", "int sliceCmpStringWithArrayStringExp, ArrayLiteralExp, int, int, int", "boolean hasPackageAccessModule, Dsymbol", "CtorDeclaration generateCopyCtorDeclarationStructDeclaration, long, long", "void errorBytePtr, int, int, BytePtr", "void add_builtinBytePtr, Function3<Loc,FuncDeclaration,DArray<Expression>,Expression>", "UnionExp PtrType, Expression", "void utf_encodeWcharCharPtr, int", "boolean findConditionDArray<Identifier>, Identifier", "int ctfeRawCmpLoc, Expression, Expression, boolean", "UnionExp ShlLoc, Type, Expression, Expression", "void highlightTextScope, DArray<Dsymbol>, Loc, OutBuffer, int", "UnionExp voidInitLiteralType, VarDeclaration", "void gendocfileModule", "boolean isIdTailBytePtr", "UnionExp ShrLoc, Type, Expression, Expression", "void emplaceExpObject, Loc _param_1, Type _param_2, Expression _param_3ArrayLiteralExpLocTypeExpression", "int setMangleOverrideDsymbol, ByteSlice", "Dsymbol getDsymbolRootObject", "Expression eval_log10Loc, FuncDeclaration, DArray<Expression>", "Expression eval_expLoc, FuncDeclaration, DArray<Expression>", "Expression getAggregateFromPointerExpression, Ptr<Long>", "void emplaceExpObject, Loc _param_1, Expression _param_2, Expression _param_3IndexExpLocExpressionExpression", "Expression eval_fmaxLoc, FuncDeclaration, DArray<Expression>", "boolean isArrayExpression", "UnionExp CastLoc, Type, Type, Expression", "UnionExp IndexType, Expression, Expression", "void emitAnchorOutBuffer, Dsymbol, Scope, boolean", "void removeAnyAtxHeadingSuffixOutBuffer, int", "DArray<Expression> copyElementsExpression, Expression", "void assignInPlaceExpression, Expression", "TemplateDeclaration getEponymousParentDsymbol", "void utf_encodeint, Object, int", "boolean issinglecharbyte", "ByteSlice replaceCharByteSlice, byte, ByteSlice", "void emplaceExpObject, Loc _param_1, BytePtr _param_2, int _param_3StringExpLocBytePtrInteger", "int getCodeIndentBytePtr", "boolean isIdentifierDArray<Dsymbol>, BytePtr, int", "BytePtr utf_decodeCharBytePtr, int, IntRef, IntRef", "void vwarningLoc, BytePtr, Slice<Object>", "boolean needToCopyLiteralExpression", "int sliceCmpStringWithStringStringExp, StringExp, int, int, int", "boolean isCtfeComparableExpression", "ByteSlice memdupByteSlice", "void mangleToBufferTemplateInstance, OutBuffer", "ByteSlice lexBytePtr, ByteSlice", "boolean isPointerType", "Expression findKeyInAALoc, AssocArrayLiteralExp, Expression", "int endTableOutBuffer, int, Ref<IntSlice>", "Expression scrubReturnValueLoc, Expression", "Type rawTypeMergeType, Type", "void emplaceExpObject, Loc _param_1, Expression _param_2, Type _param_3VectorExpLocExpressionType", "boolean buildCopyCtorStructDeclaration, Scope", "boolean reliesOnTemplateParametersType, Slice<TemplateParameter>", "int utf_codeLengthCharint", "void highlightCode3Scope, OutBuffer, BytePtr, BytePtr", "void emplaceExpObject, Loc _param_1, SliceExp _param_2AddrExpLocSliceExp", "BytePtr getMessageDeprecatedDeclaration", "int endAllListsAndQuotesOutBuffer, IntRef, Ref<Slice<MarkdownList>>, IntRef, IntRef", "ByteSlice toLowercaseByteSlice", "Expression interpretFunctionUnionExp, FuncDeclaration, InterState, DArray<Expression>, Expression", "Expression interpret_valuesUnionExp, InterState, Expression, Type", "Expression eval_roundLoc, FuncDeclaration, DArray<Expression>", "void emplaceExpObject, Loc _param_1, Expression _param_2, Expression _param_3, Expression _param_4SliceExpLocExpressionExpressionExpression", "boolean modifyFieldVarLoc, Scope, VarDeclaration, Expression", "void emplaceExpObject, Loc _param_1, Expression _param_2, FuncDeclaration _param_3, boolean _param_4DotVarExpLocExpressionFuncDeclarationBoolean", "void deprecationSupplementalLoc, BytePtr", "Expression eval_ldexpLoc, FuncDeclaration, DArray<Expression>", "int extractArgNByteSlice, Ref<ByteSlice>, int", "UnionExp UshrLoc, Type, Expression, Expression", "Expression interpret_keysUnionExp, InterState, Expression, Type", "UnionExp Identitybyte, Loc, Type, Expression, Expression", "void vwarningSupplementalLoc, BytePtr, Slice<Object>", "BytePtr modToCharsint", "boolean checkSymbolAccessScope, Dsymbol", "Expression toDelegateExpression, Type, Scope", "UnionExp PowLoc, Type, Expression, Expression", "int isattyint", "Expression scrubCacheValueExpression", "int findFieldIndexByNameStructDeclaration, VarDeclaration", "boolean replaceMarkdownThematicBreakOutBuffer, IntRef, int, Loc", "RootObject objectSyntaxCopyRootObject", "int ctfeEqualLoc, byte, Expression, Expression", "void emplaceExpObject, Loc _param_1, Object _param_2, DArray<Expression> _param_3ArrayLiteralExpLocObjectDArray<Expression>", "void emplaceExpObject, Loc _param_1, Declaration _param_2, long _param_3SymOffExpLocDeclarationLong", "FuncDeclaration buildPostBlitStructDeclaration, Scope", "int skipCharsOutBuffer, int, ByteSlice", "Statement generateCopyCtorBodyStructDeclaration", "void emplaceExpObject, Loc _param_1, Expression _param_2, IntegerExp _param_3IndexExpLocExpressionIntegerExp", "void sliceAssignStringFromArrayLiteralStringExp, ArrayLiteralExp, int", "void emplaceExpObject, Loc _param_1, Declaration _param_2VarExpLocDeclaration", "int expressionHashExpression", "boolean ensureStaticLinkToDsymbol, Dsymbol", "void emplaceExpObject, Loc _param_1, StructDeclaration _param_2, DArray<Expression> _param_3, Type _param_4StructLiteralExpLocStructDeclarationDArray<Expression>Type", "DArray<Expression> copyLiteralArrayDArray<Expression>, Expression", "int templateParameterLookupType, DArray<TemplateParameter>", "boolean symbolIsVisibleDsymbol, Dsymbol", "boolean c_isalnumint", "void tyToDecoBufferOutBuffer, int", "void emplaceExpObject, Loc _param_1, StructDeclaration _param_2, DArray<Expression> _param_3StructLiteralExpLocStructDeclarationDArray<Expression>", "void ObjectNotFoundIdentifier", "boolean isCVariadicParameterDArray<Dsymbol>, ByteSlice", "void mangleToFuncSignatureOutBuffer, FuncDeclaration", "void colorHighlightCodeOutBuffer", "boolean symbolIsVisibleScope, Dsymbol", "void emplaceExpObject, Loc _param_1, TypeSArray _param_2, DArray<Expression> _param_3ArrayLiteralExpLocTypeSArrayDArray<Expression>", "void warningLoc, BytePtr", "UnionExp BoolType, Expression", "StringExp createBlockDuplicatedStringLiteralUnionExp, Loc, Type, int, int, byte", "void colorSyntaxHighlightOutBuffer", "Expression paintTypeOntoLiteralType, Expression", "void endMarkdownHeadingOutBuffer, int, IntRef, Loc, IntRef", "int endRowAndTableOutBuffer, int, int, Loc, Ref<Slice<MarkdownDelimiter>>, Ref<IntSlice>", "boolean isoctalbyte", "void unSpeculativeScope, RootObject", "Expression eval_fminLoc, FuncDeclaration, DArray<Expression>", "boolean arrayObjectIsErrorDArray<RootObject>", "long getStorageClassPrefixAttributesASTCodegenASTCodegen", "boolean isSpecialEnumIdentIdentifier", "int skiptoidentOutBuffer, int", "int deduceTypeHelperType, Ptr<Type>, Type", "boolean mergeFieldInitRef<Short>, short", "void emplaceExpObject, VarDeclaration _param_1VoidInitExpVarDeclaration", "void foreachDsymbolDArray<Dsymbol>, Function1<Dsymbol,Void>", "Expression interpretUnionExp, Expression, InterState, int", "UnionExp AddLoc, Type, Expression, Expression", "Expression isExpressionRootObject", "void emplaceExpObject, Loc _param_1, Expression _param_2, IntegerExp _param_3, Expression _param_4SliceExpLocExpressionIntegerExpExpression", "int parseTableDelimiterRowOutBuffer, int, boolean, Ref<IntSlice>", "int skippastidentOutBuffer, int", "UnionExp XorLoc, Type, Expression, Expression", "int realCmpbyte, double, double", "boolean isCVariadicArgByteSlice", "boolean isCtfeValueValidExpression", "UnionExp MinLoc, Type, Expression, Expression", "Expression eval_bsrLoc, FuncDeclaration, DArray<Expression>", "void semanticTypeInfoScope, Type", "void highlightCodeScope, Dsymbol, OutBuffer, int", "Expression eval_logLoc, FuncDeclaration, DArray<Expression>", "Expression eval_cosLoc, FuncDeclaration, DArray<Expression>", "boolean allowsContractWithoutBodyFuncDeclaration", "double cimaglcomplex_t", "int replaceTableRowOutBuffer, int, int, Loc, Ref<Slice<MarkdownDelimiter>>, IntSlice, boolean", "void verrorLoc, BytePtr, Slice<Object>, BytePtr, BytePtr, BytePtr", "UnionExp AndLoc, Type, Expression, Expression", "boolean _isZeroInitExpression", "boolean checkAccessLoc, Scope, Package", "Expression eval_ceilLoc, FuncDeclaration, DArray<Expression>", "boolean isCtfeReferenceValidExpression", "boolean checkFrameAccessLoc, Scope, AggregateDeclaration, int", "Expression ctfeInterpretExpression", "int ctfeCmpArraysLoc, Expression, Expression, long", "boolean isTypeInfo_ClassType", "byte deduceWildHelperType, Ptr<Type>, Type", "boolean isIndentWSBytePtr", "Expression evaluatePostblitInterState, Expression", "void verrorSupplementalLoc, BytePtr, Slice<Object>", "boolean checkAccessLoc, Scope, Expression, Declaration", "FuncDeclaration search_toStringStructDeclaration", "Expression eval_sinLoc, FuncDeclaration, DArray<Expression>", "UnionExp Equalbyte, Loc, Type, Expression, Expression", "void emplaceExpObject, Loc _param_1, Expression _param_2, TypeVector _param_3VectorExpLocExpressionTypeVector", "int replaceMarkdownEmphasisOutBuffer, Loc, Ref<Slice<MarkdownDelimiter>>, int", "void emplaceExpObject, Loc _param_1, Expression _param_2, IntegerExp _param_3, IntegerExp _param_4SliceExpLocExpressionIntegerExpIntegerExp", "void emplaceExpObject, Loc _param_1, Object _param_2, int _param_3, byte _param_4StringExpLocObjectIntegerByte", "ByteSlice generateSlice<Msgtable>, Function1<Msgtable,ByteSlice>", "void emplaceExpObject, Loc _param_1, DArray<Expression> _param_2TupleExpLocDArray<Expression>", "void processFileByteSlice, ByteSlice, BytePtr_lispy", "Expression eval_popcntLoc, FuncDeclaration, DArray<Expression>", "Expression eval_bsfLoc, FuncDeclaration, DArray<Expression>", "void setValueWithoutCheckingVarDeclaration, Expression", "void mangleToBufferType, OutBuffer", "int isBuiltinFuncDeclaration", "Expression paintFloatIntUnionExp, Expression, Type", "void sliceAssignStringFromStringStringExp, StringExp, int", "Expression paintTypeOntoLiteralUnionExp, Type, Expression", "boolean symbolIsVisibleModule, Dsymbol", "void ctfeCompileFuncDeclaration", "Expression eval_fabsLoc, FuncDeclaration, DArray<Expression>", "void printCtfePerformanceStats", "void highlightCodeScope, DArray<Dsymbol>, OutBuffer, int", "ByteSlice getFilenameDArray<Identifier>, Identifier", "Expression interpretExpression, InterState, int", "Expression getValueExpression", "void messageBytePtr", "Expression eval_isnanLoc, FuncDeclaration, DArray<Expression>", "Expression ctfeCastUnionExp, Loc, Type, Type, Expression", "UnionExp NotType, Expression", "void escapeStrayParenthesisLoc, OutBuffer, int, boolean", "void lambdaSetParentExpression, FuncDeclaration", "boolean isIdStartBytePtr", "int intUnsignedCmpbyte, long, long", "void emplaceExpObject, Loc _param_1, int _param_2, Type _param_3IntegerExpLocIntegerType", "UnionExp pointerArithmeticLoc, byte, Type, Expression, Expression", "void emitProtectionOutBuffer, Declaration", "int templateIdentifierLookupIdentifier, DArray<TemplateParameter>", "ByteSlice lispyBytePtr, ByteSlice", "boolean walkPostorderExpression, StoppableVisitor", "TypeFunction isTypeFunctionDsymbol", "void printDepsConditionalScope, DVCondition, ByteSlice", "Expression expTypeType, Expression", "Expression resolveAliasThisScope, Expression, boolean", "int detectAtxHeadingLevelOutBuffer, int", "Type isTypeRootObject", "Expression eval_builtinLoc, FuncDeclaration, DArray<Expression>", "boolean c_isxdigitint", "BytePtr utf_decodeWcharCharPtr, int, IntRef, IntRef", "Expression interpretUnionExp, Statement, InterState", "ByteSlice deinitializerMsgtable", "Expression eval_unimpLoc, FuncDeclaration, DArray<Expression>", "void utf_encodeCharBytePtr, int", "void semantic3OnDependenciesModule", "UnionExp copyLiteralExpression", "UnionExp paintTypeOntoLiteralCopyType, Expression", "Expression interpret_aaApplyUnionExp, InterState, Expression, Expression", "void emitCommentDsymbol, OutBuffer, Scope", "void emplaceExpObject, Loc _param_1, VarExp _param_2, Type _param_3AddrExpLocVarExpType", "ByteSlice skipwhitespaceByteSlice", "void vdeprecationSupplementalLoc, BytePtr, Slice<Object>", "void highlightCode2Scope, DArray<Dsymbol>, OutBuffer, int", "FuncDeclaration funcptrOfExpression", "void emplaceExpObject, Loc _param_1, DArray<Expression> _param_2, DArray<Expression> _param_3AssocArrayLiteralExpLocDArray<Expression>DArray<Expression>", "void parseModulePatternBytePtr, MatcherNode, short", "void mangleToBufferExpression, OutBuffer", "boolean matchRootObject, RootObject", "Expression eval_exp2Loc, FuncDeclaration, DArray<Expression>", "int getMarkdownIndentOutBuffer, int, int", "int startTableOutBuffer, int, int, Loc, boolean, Ref<Slice<MarkdownDelimiter>>, Ref<IntSlice>", "boolean isKeywordBytePtr, int", "UnionExp CatType, Expression, Expression", "Expression eval_isfiniteLoc, FuncDeclaration, DArray<Expression>", "int comparePointersbyte, Expression, long, Expression, long", "boolean isDittoBytePtr", "void emplaceExpObject, Loc _param_1, Type _param_2NullExpLocType", "boolean isAssocArrayType", "boolean isSafePointerCastType, Type", "boolean numCmpbyte, double, doubleDouble", "void mangleToBufferDsymbol, OutBuffer", "void aliasSemanticAliasDeclaration, Scope", "Parameter isEponymousFunctionParameterDArray<Dsymbol>, BytePtr, int", "void emplaceExpObject, Loc _param_1, Type _param_2, DArray<Expression> _param_3ArrayLiteralExpLocTypeDArray<Expression>", "Expression assignAssocArrayElementLoc, AssocArrayLiteralExp, Expression, Expression", "void emplaceExpObject, Loc _param_1, IndexExp _param_2, Type _param_3AddrExpLocIndexExpType", "ByteSlice identifierMsgtable", "boolean ishexbyte", "void processFileByteSlice, ByteSlice, BytePtr_lex", "Expression eval_bswapLoc, FuncDeclaration, DArray<Expression>", "void vdeprecationLoc, BytePtr, Slice<Object>, BytePtr, BytePtr", "void setValueVarDeclaration, Expression", "void halt", "BytePtr mangleExactFuncDeclaration", "void emplaceExpObject, int _param_1IntegerExpInteger", "Expression eval_expm1Loc, FuncDeclaration, DArray<Expression>", "Dsymbol isDsymbolRootObject", "boolean isReservedNameByteSlice", "boolean hasProtectedAccessScope, Dsymbol", "void writeHighlightsConsole, OutBuffer", "boolean numCmpbyte, long, longLong", "Expression interpret_dupUnionExp, InterState, Expression", "Dsymbol getEponymousMemberTemplateDeclaration", "Expression eval_powLoc, FuncDeclaration, DArray<Expression>", "boolean hasValueVarDeclaration", "void templateInstanceSemanticTemplateInstance, Scope, DArray<Expression>", "Type getTypeRootObject", "Expression foreachApplyUtfUnionExp, InterState, Expression, Expression, boolean", "void emplaceExpObject, Loc _param_1, BytePtr _param_2StringExpLocBytePtr", "boolean includeImportedModuleCheckModuleComponentRange", "Expression eval_fmaLoc, FuncDeclaration, DArray<Expression>", "void sliceAssignArrayLiteralFromStringArrayLiteralExp, StringExp, int", "boolean writeMixinByteSlice, Loc", "void toDocBufferDsymbol, OutBuffer, Scope", "void emplaceExpObject, Loc _param_1, SliceExp _param_2, Type _param_3AddrExpLocSliceExpType"]] signature: void emplaceExpObject, Loc _param_1, complex_t _param_2, Type _param_3ComplexExpLoccomplex_tType
    ...
    // from template emplaceExp!(ArrayLiteralExpLocTypeDArray<Expression>)
    // removed duplicate function, [["Expression eval_yl2xp1Loc, FuncDeclaration, DArray<Expression>", "int skipPastIdentWithDotsOutBuffer, int", "boolean emitAnchorNameOutBuffer, Dsymbol, Scope, boolean", "TemplateParameter isTemplateParameterDArray<Dsymbol>, BytePtr, int", "void emplaceExpObject, Loc _param_1, double _param_2, Type _param_3RealExpLocDoubleType", "TypeAArray toBuiltinAATypeType", "Expression eval_isinfinityLoc, FuncDeclaration, DArray<Expression>", "boolean mergeCallSuperRef<Short>, short", "Expression eval_floorLoc, FuncDeclaration, DArray<Expression>", "UnionExp changeArrayLiteralLengthLoc, TypeArray, Expression, int, int", "ArrayLiteralExp createBlockDuplicatedArrayLiteralUnionExp, Loc, Type, Expression, int", "BytePtr stripLeadingNewlinesBytePtr", "void emplaceExpObject, byte _param_1CTFEExpByte", "void createMatchNodes", "UnionExp ArrayLengthType, Expression", "boolean checkAccessAggregateDeclaration, Loc, Scope, Dsymbol", "Expression resolveSliceExpression, UnionExp", "Expression getValueVarDeclaration", "boolean hasPackageAccessScope, Dsymbol", "void emplaceExpObject, Loc _param_1, Expression _param_2, Type _param_3AddrExpLocExpressionType", "boolean isFloatIntPaintType, Type", "int mainSlice<ByteSlice>", "void vmessageLoc, BytePtr, Slice<Object>", "boolean isValidManglingint", "int getAlignmentAlignDeclaration, Scope", "int arrayObjectHashDArray<RootObject>", "boolean numCmpbyte, int, intInteger", "boolean exceptionOrCantInterpretExpression", "ByteSlice lookForSourceFileByteSlice", "void showCtfeExprExpression, int", "void emplaceExpObject, Loc _param_1, Expression _param_2AddrExpLocExpression", "void removeBlankLineMacroOutBuffer, IntRef, IntRef", "boolean isErrorRootObject", "void emitMemberCommentsScopeDsymbol, OutBuffer, Scope", "UnionExp ctfeCatLoc, Type, Expression, Expression", "void escapeDdocStringOutBuffer, int", "void deprecationLoc, BytePtr", "void messageLoc, BytePtr", "Parameter isFunctionParameterDArray<Dsymbol>, BytePtr, int", "short parseModulePatternDepthBytePtr", "void MODtoDecoBufferOutBuffer, byte", "UnionExp ModLoc, Type, Expression, Expression", "void emplaceExpObject, Loc _param_1, Object _param_2, int _param_3StringExpLocObjectInteger", "void emplaceExpObject, Loc _param_1, StructLiteralExp _param_2, Type _param_3ClassReferenceExpLocStructLiteralExpType", "Expression eval_tanLoc, FuncDeclaration, DArray<Expression>", "int skippastURLOutBuffer, int", "boolean isZeroSecondbyte", "Expression eval_copysignLoc, FuncDeclaration, DArray<Expression>", "Expression eval_log2Loc, FuncDeclaration, DArray<Expression>", "double creallcomplex_t", "void warningSupplementalLoc, BytePtr", "int deduceTypeRootObject, Scope, Type, DArray<TemplateParameter>, DArray<RootObject>, IntPtr, int, boolean", "Tuple isTupleRootObject", "Expression eval_truncLoc, FuncDeclaration, DArray<Expression>", "UnionExp DivLoc, Type, Expression, Expression", "void expandTemplateMixinCommentsTemplateMixin, OutBuffer, Scope", "Expression eval_sqrtLoc, FuncDeclaration, DArray<Expression>", "boolean lambdaCheckForNestedRefExpression, Scope", "void emplaceExpObject, Loc _param_1, complex_t _param_2, Type _param_3ComplexExpLoccomplex_tType", "void dsymbolSemanticDsymbol, Scope", "void cantExpUnionExp", "boolean pointToSameMemoryBlockExpression, Expression", "long getStorageClassPrefixAttributesASTBaseASTBase", "UnionExp ComType, Expression", "ByteSlice initializerMsgtable", "int specificCmpbyte, int", "void builtinDeinitialize", "boolean isDigitSecondbyte", "Scope skipNonQualScopesScope", "UnionExp MulLoc, Type, Expression, Expression", "int utfStrideBytePtr", "void verrorPrintLoc, int, BytePtr, BytePtr, Slice<Object>, BytePtr, BytePtr", "int ctfeCmpLoc, byte, Expression, Expression", "boolean isTrueBoolExpression", "void builtin_init", "Parameter isParameterRootObject", "void errorSupplementalLoc, BytePtr", "long resolveArrayLengthExpression", "Expression evaluateDtorInterState, Expression", "int foreachDsymbolDArray<Dsymbol>, Function1<Dsymbol,Integer>", "void emplaceExpObject, ErrorExp", "Expression interpret_lengthUnionExp, InterState, Expression", "Parameter isFunctionParameterDsymbol, BytePtr, int", "void emitProtectionOutBuffer, Import", "TemplateParameter isTemplateParameterRootObject", "boolean arrayObjectMatchDArray<RootObject>, DArray<RootObject>", "void emplaceExpObject, Loc _param_1, Type _param_2, Expression _param_3, DArray<Expression> _param_4ArrayLiteralExpLocTypeExpressionDArray<Expression>", "boolean reliesOnTemplateParametersExpression, Slice<TemplateParameter>", "int endAllMarkdownQuotesOutBuffer, int, IntRef", "void emplaceExpObject, Loc _param_1, Expression _param_2, FuncDeclaration _param_3, boolean _param_4DelegateExpLocExpressionFuncDeclarationBoolean", "boolean definitelyValueParameterExpression", "void emplaceExpObject, Loc _param_1, boolean _param_2, Type _param_3IntegerExpLocBooleanType", "boolean reliesOnTidentType, DArray<TemplateParameter>, int", "Expression eval_yl2xLoc, FuncDeclaration, DArray<Expression>", "void errorLoc, BytePtr", "boolean utf_isValidDcharint", "void fatal", "Expression evaluateIfBuiltinUnionExp, InterState, Loc, FuncDeclaration, DArray<Expression>, Expression", "UnionExp pointerDifferenceLoc, Type, Expression, Expression", "UnionExp NegType, Expression", "boolean isidcharbyte", "int utf_codeLengthWcharint", "Expression getValueRef<Dsymbol>", "Function3<Loc,FuncDeclaration,DArray<Expression>,Expression> builtin_lookupBytePtr", "BytePtr linkToCharsint", "Expression interpretStatement, InterState", "int isConstExpression", "Expression getExpressionRootObject", "void emitProtectionOutBuffer, Prot", "Expression ctfeIndexLoc, Type, Expression, long", "int utf_codeLengthint, int", "UnionExp SliceType, Expression, Expression, Expression", "void functionResolveMatchAccumulator, Dsymbol, Loc, Scope, DArray<RootObject>, Type, DArray<Expression>, Ptr<BytePtr>", "int intSignedCmpbyte, long, long", "int ctfeIdentityLoc, byte, Expression, Expression", "Expression ctfeInterpretForPragmaMsgExpression", "void emplaceExpObject, Loc _param_1, long _param_2, Type _param_3IntegerExpLocLongType", "boolean isUniAlphaint", "BytePtr skipwhitespaceBytePtr", "UnionExp Cmpbyte, Loc, Type, Expression, Expression", "Dsymbol mostVisibleOverloadDsymbol, Module", "UnionExp OrLoc, Type, Expression, Expression", "void emplaceExpObject, Loc _param_1, Declaration _param_2, int _param_3SymOffExpLocDeclarationInteger", "int sliceCmpStringWithArrayStringExp, ArrayLiteralExp, int, int, int", "boolean hasPackageAccessModule, Dsymbol", "CtorDeclaration generateCopyCtorDeclarationStructDeclaration, long, long", "void errorBytePtr, int, int, BytePtr", "void add_builtinBytePtr, Function3<Loc,FuncDeclaration,DArray<Expression>,Expression>", "UnionExp PtrType, Expression", "void utf_encodeWcharCharPtr, int", "boolean findConditionDArray<Identifier>, Identifier", "int ctfeRawCmpLoc, Expression, Expression, boolean", "UnionExp ShlLoc, Type, Expression, Expression", "void highlightTextScope, DArray<Dsymbol>, Loc, OutBuffer, int", "UnionExp voidInitLiteralType, VarDeclaration", "void gendocfileModule", "boolean isIdTailBytePtr", "UnionExp ShrLoc, Type, Expression, Expression", "void emplaceExpObject, Loc _param_1, Type _param_2, Expression _param_3ArrayLiteralExpLocTypeExpression", "int setMangleOverrideDsymbol, ByteSlice", "Dsymbol getDsymbolRootObject", "Expression eval_log10Loc, FuncDeclaration, DArray<Expression>", "Expression eval_expLoc, FuncDeclaration, DArray<Expression>", "Expression getAggregateFromPointerExpression, Ptr<Long>", "void emplaceExpObject, Loc _param_1, Expression _param_2, Expression _param_3IndexExpLocExpressionExpression", "Expression eval_fmaxLoc, FuncDeclaration, DArray<Expression>", "boolean isArrayExpression", "UnionExp CastLoc, Type, Type, Expression", "UnionExp IndexType, Expression, Expression", "void emitAnchorOutBuffer, Dsymbol, Scope, boolean", "void removeAnyAtxHeadingSuffixOutBuffer, int", "DArray<Expression> copyElementsExpression, Expression", "void assignInPlaceExpression, Expression", "TemplateDeclaration getEponymousParentDsymbol", "void utf_encodeint, Object, int", "boolean issinglecharbyte", "ByteSlice replaceCharByteSlice, byte, ByteSlice", "void emplaceExpObject, Loc _param_1, BytePtr _param_2, int _param_3StringExpLocBytePtrInteger", "int getCodeIndentBytePtr", "boolean isIdentifierDArray<Dsymbol>, BytePtr, int", "BytePtr utf_decodeCharBytePtr, int, IntRef, IntRef", "void vwarningLoc, BytePtr, Slice<Object>", "boolean needToCopyLiteralExpression", "int sliceCmpStringWithStringStringExp, StringExp, int, int, int", "boolean isCtfeComparableExpression", "ByteSlice memdupByteSlice", "void mangleToBufferTemplateInstance, OutBuffer", "ByteSlice lexBytePtr, ByteSlice", "boolean isPointerType", "Expression findKeyInAALoc, AssocArrayLiteralExp, Expression", "int endTableOutBuffer, int, Ref<IntSlice>", "Expression scrubReturnValueLoc, Expression", "Type rawTypeMergeType, Type", "void emplaceExpObject, Loc _param_1, Expression _param_2, Type _param_3VectorExpLocExpressionType", "boolean buildCopyCtorStructDeclaration, Scope", "boolean reliesOnTemplateParametersType, Slice<TemplateParameter>", "int utf_codeLengthCharint", "void highlightCode3Scope, OutBuffer, BytePtr, BytePtr", "void emplaceExpObject, Loc _param_1, SliceExp _param_2AddrExpLocSliceExp", "BytePtr getMessageDeprecatedDeclaration", "int endAllListsAndQuotesOutBuffer, IntRef, Ref<Slice<MarkdownList>>, IntRef, IntRef", "ByteSlice toLowercaseByteSlice", "Expression interpretFunctionUnionExp, FuncDeclaration, InterState, DArray<Expression>, Expression", "Expression interpret_valuesUnionExp, InterState, Expression, Type", "Expression eval_roundLoc, FuncDeclaration, DArray<Expression>", "void emplaceExpObject, Loc _param_1, Expression _param_2, Expression _param_3, Expression _param_4SliceExpLocExpressionExpressionExpression", "boolean modifyFieldVarLoc, Scope, VarDeclaration, Expression", "void emplaceExpObject, Loc _param_1, Expression _param_2, FuncDeclaration _param_3, boolean _param_4DotVarExpLocExpressionFuncDeclarationBoolean", "void deprecationSupplementalLoc, BytePtr", "Expression eval_ldexpLoc, FuncDeclaration, DArray<Expression>", "int extractArgNByteSlice, Ref<ByteSlice>, int", "UnionExp UshrLoc, Type, Expression, Expression", "Expression interpret_keysUnionExp, InterState, Expression, Type", "UnionExp Identitybyte, Loc, Type, Expression, Expression", "void vwarningSupplementalLoc, BytePtr, Slice<Object>", "BytePtr modToCharsint", "boolean checkSymbolAccessScope, Dsymbol", "Expression toDelegateExpression, Type, Scope", "UnionExp PowLoc, Type, Expression, Expression", "int isattyint", "Expression scrubCacheValueExpression", "int findFieldIndexByNameStructDeclaration, VarDeclaration", "boolean replaceMarkdownThematicBreakOutBuffer, IntRef, int, Loc", "RootObject objectSyntaxCopyRootObject", "int ctfeEqualLoc, byte, Expression, Expression", "void emplaceExpObject, Loc _param_1, Object _param_2, DArray<Expression> _param_3ArrayLiteralExpLocObjectDArray<Expression>", "void emplaceExpObject, Loc _param_1, Declaration _param_2, long _param_3SymOffExpLocDeclarationLong", "FuncDeclaration buildPostBlitStructDeclaration, Scope", "int skipCharsOutBuffer, int, ByteSlice", "Statement generateCopyCtorBodyStructDeclaration", "void emplaceExpObject, Loc _param_1, Expression _param_2, IntegerExp _param_3IndexExpLocExpressionIntegerExp", "void sliceAssignStringFromArrayLiteralStringExp, ArrayLiteralExp, int", "void emplaceExpObject, Loc _param_1, Declaration _param_2VarExpLocDeclaration", "int expressionHashExpression", "boolean ensureStaticLinkToDsymbol, Dsymbol", "void emplaceExpObject, Loc _param_1, StructDeclaration _param_2, DArray<Expression> _param_3, Type _param_4StructLiteralExpLocStructDeclarationDArray<Expression>Type", "DArray<Expression> copyLiteralArrayDArray<Expression>, Expression", "int templateParameterLookupType, DArray<TemplateParameter>", "boolean symbolIsVisibleDsymbol, Dsymbol", "boolean c_isalnumint", "void tyToDecoBufferOutBuffer, int", "void emplaceExpObject, Loc _param_1, StructDeclaration _param_2, DArray<Expression> _param_3StructLiteralExpLocStructDeclarationDArray<Expression>", "void ObjectNotFoundIdentifier", "boolean isCVariadicParameterDArray<Dsymbol>, ByteSlice", "void mangleToFuncSignatureOutBuffer, FuncDeclaration", "void colorHighlightCodeOutBuffer", "boolean symbolIsVisibleScope, Dsymbol", "void emplaceExpObject, Loc _param_1, TypeSArray _param_2, DArray<Expression> _param_3ArrayLiteralExpLocTypeSArrayDArray<Expression>", "void warningLoc, BytePtr", "UnionExp BoolType, Expression", "StringExp createBlockDuplicatedStringLiteralUnionExp, Loc, Type, int, int, byte", "void colorSyntaxHighlightOutBuffer", "Expression paintTypeOntoLiteralType, Expression", "void endMarkdownHeadingOutBuffer, int, IntRef, Loc, IntRef", "int endRowAndTableOutBuffer, int, int, Loc, Ref<Slice<MarkdownDelimiter>>, Ref<IntSlice>", "boolean isoctalbyte", "void unSpeculativeScope, RootObject", "Expression eval_fminLoc, FuncDeclaration, DArray<Expression>", "boolean arrayObjectIsErrorDArray<RootObject>", "long getStorageClassPrefixAttributesASTCodegenASTCodegen", "boolean isSpecialEnumIdentIdentifier", "int skiptoidentOutBuffer, int", "int deduceTypeHelperType, Ptr<Type>, Type", "boolean mergeFieldInitRef<Short>, short", "void emplaceExpObject, VarDeclaration _param_1VoidInitExpVarDeclaration", "void foreachDsymbolDArray<Dsymbol>, Function1<Dsymbol,Void>", "Expression interpretUnionExp, Expression, InterState, int", "UnionExp AddLoc, Type, Expression, Expression", "Expression isExpressionRootObject", "void emplaceExpObject, Loc _param_1, Expression _param_2, IntegerExp _param_3, Expression _param_4SliceExpLocExpressionIntegerExpExpression", "int parseTableDelimiterRowOutBuffer, int, boolean, Ref<IntSlice>", "int skippastidentOutBuffer, int", "UnionExp XorLoc, Type, Expression, Expression", "int realCmpbyte, double, double", "boolean isCVariadicArgByteSlice", "boolean isCtfeValueValidExpression", "UnionExp MinLoc, Type, Expression, Expression", "Expression eval_bsrLoc, FuncDeclaration, DArray<Expression>", "void semanticTypeInfoScope, Type", "void highlightCodeScope, Dsymbol, OutBuffer, int", "Expression eval_logLoc, FuncDeclaration, DArray<Expression>", "Expression eval_cosLoc, FuncDeclaration, DArray<Expression>", "boolean allowsContractWithoutBodyFuncDeclaration", "double cimaglcomplex_t", "int replaceTableRowOutBuffer, int, int, Loc, Ref<Slice<MarkdownDelimiter>>, IntSlice, boolean", "void verrorLoc, BytePtr, Slice<Object>, BytePtr, BytePtr, BytePtr", "UnionExp AndLoc, Type, Expression, Expression", "boolean _isZeroInitExpression", "boolean checkAccessLoc, Scope, Package", "Expression eval_ceilLoc, FuncDeclaration, DArray<Expression>", "boolean isCtfeReferenceValidExpression", "boolean checkFrameAccessLoc, Scope, AggregateDeclaration, int", "Expression ctfeInterpretExpression", "int ctfeCmpArraysLoc, Expression, Expression, long", "boolean isTypeInfo_ClassType", "byte deduceWildHelperType, Ptr<Type>, Type", "boolean isIndentWSBytePtr", "Expression evaluatePostblitInterState, Expression", "void verrorSupplementalLoc, BytePtr, Slice<Object>", "boolean checkAccessLoc, Scope, Expression, Declaration", "FuncDeclaration search_toStringStructDeclaration", "Expression eval_sinLoc, FuncDeclaration, DArray<Expression>", "UnionExp Equalbyte, Loc, Type, Expression, Expression", "void emplaceExpObject, Loc _param_1, Expression _param_2, TypeVector _param_3VectorExpLocExpressionTypeVector", "int replaceMarkdownEmphasisOutBuffer, Loc, Ref<Slice<MarkdownDelimiter>>, int", "void emplaceExpObject, Loc _param_1, Expression _param_2, IntegerExp _param_3, IntegerExp _param_4SliceExpLocExpressionIntegerExpIntegerExp", "void emplaceExpObject, Loc _param_1, Object _param_2, int _param_3, byte _param_4StringExpLocObjectIntegerByte", "ByteSlice generateSlice<Msgtable>, Function1<Msgtable,ByteSlice>", "void emplaceExpObject, Loc _param_1, DArray<Expression> _param_2TupleExpLocDArray<Expression>", "void processFileByteSlice, ByteSlice, BytePtr_lispy", "Expression eval_popcntLoc, FuncDeclaration, DArray<Expression>", "Expression eval_bsfLoc, FuncDeclaration, DArray<Expression>", "void setValueWithoutCheckingVarDeclaration, Expression", "void mangleToBufferType, OutBuffer", "int isBuiltinFuncDeclaration", "Expression paintFloatIntUnionExp, Expression, Type", "void sliceAssignStringFromStringStringExp, StringExp, int", "Expression paintTypeOntoLiteralUnionExp, Type, Expression", "boolean symbolIsVisibleModule, Dsymbol", "void ctfeCompileFuncDeclaration", "Expression eval_fabsLoc, FuncDeclaration, DArray<Expression>", "void printCtfePerformanceStats", "void highlightCodeScope, DArray<Dsymbol>, OutBuffer, int", "ByteSlice getFilenameDArray<Identifier>, Identifier", "Expression interpretExpression, InterState, int", "Expression getValueExpression", "void messageBytePtr", "Expression eval_isnanLoc, FuncDeclaration, DArray<Expression>", "Expression ctfeCastUnionExp, Loc, Type, Type, Expression", "UnionExp NotType, Expression", "void escapeStrayParenthesisLoc, OutBuffer, int, boolean", "void lambdaSetParentExpression, FuncDeclaration", "boolean isIdStartBytePtr", "int intUnsignedCmpbyte, long, long", "void emplaceExpObject, Loc _param_1, int _param_2, Type _param_3IntegerExpLocIntegerType", "UnionExp pointerArithmeticLoc, byte, Type, Expression, Expression", "void emitProtectionOutBuffer, Declaration", "int templateIdentifierLookupIdentifier, DArray<TemplateParameter>", "ByteSlice lispyBytePtr, ByteSlice", "boolean walkPostorderExpression, StoppableVisitor", "TypeFunction isTypeFunctionDsymbol", "void emplaceExpObject, Loc _param_1, Expression _param_2, Declaration _param_3, boolean _param_4DotVarExpLocExpressionDeclarationBoolean", "void printDepsConditionalScope, DVCondition, ByteSlice", "Expression expTypeType, Expression", "Expression resolveAliasThisScope, Expression, boolean", "int detectAtxHeadingLevelOutBuffer, int", "Type isTypeRootObject", "Expression eval_builtinLoc, FuncDeclaration, DArray<Expression>", "boolean c_isxdigitint", "BytePtr utf_decodeWcharCharPtr, int, IntRef, IntRef", "Expression interpretUnionExp, Statement, InterState", "ByteSlice deinitializerMsgtable", "Expression eval_unimpLoc, FuncDeclaration, DArray<Expression>", "void utf_encodeCharBytePtr, int", "void semantic3OnDependenciesModule", "UnionExp copyLiteralExpression", "UnionExp paintTypeOntoLiteralCopyType, Expression", "Expression interpret_aaApplyUnionExp, InterState, Expression, Expression", "void emitCommentDsymbol, OutBuffer, Scope", "void emplaceExpObject, Loc _param_1, VarExp _param_2, Type _param_3AddrExpLocVarExpType", "ByteSlice skipwhitespaceByteSlice", "void vdeprecationSupplementalLoc, BytePtr, Slice<Object>", "void highlightCode2Scope, DArray<Dsymbol>, OutBuffer, int", "FuncDeclaration funcptrOfExpression", "void emplaceExpObject, Loc _param_1, DArray<Expression> _param_2, DArray<Expression> _param_3AssocArrayLiteralExpLocDArray<Expression>DArray<Expression>", "void parseModulePatternBytePtr, MatcherNode, short", "void mangleToBufferExpression, OutBuffer", "boolean matchRootObject, RootObject", "Expression eval_exp2Loc, FuncDeclaration, DArray<Expression>", "int getMarkdownIndentOutBuffer, int, int", "int startTableOutBuffer, int, int, Loc, boolean, Ref<Slice<MarkdownDelimiter>>, Ref<IntSlice>", "boolean isKeywordBytePtr, int", "UnionExp CatType, Expression, Expression", "Expression eval_isfiniteLoc, FuncDeclaration, DArray<Expression>", "int comparePointersbyte, Expression, long, Expression, long", "boolean isDittoBytePtr", "void emplaceExpObject, Loc _param_1, Type _param_2NullExpLocType", "boolean isAssocArrayType", "boolean isSafePointerCastType, Type", "boolean numCmpbyte, double, doubleDouble", "void mangleToBufferDsymbol, OutBuffer", "void aliasSemanticAliasDeclaration, Scope", "Parameter isEponymousFunctionParameterDArray<Dsymbol>, BytePtr, int", "void emplaceExpObject, Loc _param_1, Type _param_2, DArray<Expression> _param_3ArrayLiteralExpLocTypeDArray<Expression>", "Expression assignAssocArrayElementLoc, AssocArrayLiteralExp, Expression, Expression", "void emplaceExpObject, Loc _param_1, IndexExp _param_2, Type _param_3AddrExpLocIndexExpType", "ByteSlice identifierMsgtable", "boolean ishexbyte", "void processFileByteSlice, ByteSlice, BytePtr_lex", "Expression eval_bswapLoc, FuncDeclaration, DArray<Expression>", "void vdeprecationLoc, BytePtr, Slice<Object>, BytePtr, BytePtr", "void setValueVarDeclaration, Expression", "void halt", "BytePtr mangleExactFuncDeclaration", "void emplaceExpObject, int _param_1IntegerExpInteger", "Expression eval_expm1Loc, FuncDeclaration, DArray<Expression>", "Dsymbol isDsymbolRootObject", "boolean isReservedNameByteSlice", "boolean hasProtectedAccessScope, Dsymbol", "void writeHighlightsConsole, OutBuffer", "boolean numCmpbyte, long, longLong", "Expression interpret_dupUnionExp, InterState, Expression", "Dsymbol getEponymousMemberTemplateDeclaration", "Expression eval_powLoc, FuncDeclaration, DArray<Expression>", "boolean hasValueVarDeclaration", "void templateInstanceSemanticTemplateInstance, Scope, DArray<Expression>", "Type getTypeRootObject", "Expression foreachApplyUtfUnionExp, InterState, Expression, Expression, boolean", "void emplaceExpObject, Loc _param_1, BytePtr _param_2StringExpLocBytePtr", "boolean includeImportedModuleCheckModuleComponentRange", "Expression eval_fmaLoc, FuncDeclaration, DArray<Expression>", "void sliceAssignArrayLiteralFromStringArrayLiteralExp, StringExp, int", "boolean writeMixinByteSlice, Loc", "void toDocBufferDsymbol, OutBuffer, Scope", "void emplaceExpObject, Loc _param_1, SliceExp _param_2, Type _param_3AddrExpLocSliceExpType"]] signature: void emplaceExpObject, Loc _param_1, Type _param_2, DArray<Expression> _param_3ArrayLiteralExpLocTypeDArray<Expression>
    ...
    // from template emplaceExp!(StringExpLocBytePtrInteger)
    // removed duplicate function, [["Expression eval_yl2xp1Loc, FuncDeclaration, DArray<Expression>", "int skipPastIdentWithDotsOutBuffer, int", "boolean emitAnchorNameOutBuffer, Dsymbol, Scope, boolean", "TemplateParameter isTemplateParameterDArray<Dsymbol>, BytePtr, int", "void emplaceExpObject, Loc _param_1, double _param_2, Type _param_3RealExpLocDoubleType", "TypeAArray toBuiltinAATypeType", "Expression eval_isinfinityLoc, FuncDeclaration, DArray<Expression>", "boolean mergeCallSuperRef<Short>, short", "Expression eval_floorLoc, FuncDeclaration, DArray<Expression>", "UnionExp changeArrayLiteralLengthLoc, TypeArray, Expression, int, int", "ArrayLiteralExp createBlockDuplicatedArrayLiteralUnionExp, Loc, Type, Expression, int", "BytePtr stripLeadingNewlinesBytePtr", "void emplaceExpObject, byte _param_1CTFEExpByte", "void createMatchNodes", "UnionExp ArrayLengthType, Expression", "boolean checkAccessAggregateDeclaration, Loc, Scope, Dsymbol", "Expression resolveSliceExpression, UnionExp", "Expression getValueVarDeclaration", "boolean hasPackageAccessScope, Dsymbol", "void emplaceExpObject, Loc _param_1, Expression _param_2, Type _param_3AddrExpLocExpressionType", "boolean isFloatIntPaintType, Type", "int mainSlice<ByteSlice>", "void vmessageLoc, BytePtr, Slice<Object>", "boolean isValidManglingint", "int getAlignmentAlignDeclaration, Scope", "int arrayObjectHashDArray<RootObject>", "boolean numCmpbyte, int, intInteger", "boolean exceptionOrCantInterpretExpression", "ByteSlice lookForSourceFileByteSlice", "void showCtfeExprExpression, int", "void emplaceExpObject, Loc _param_1, Expression _param_2AddrExpLocExpression", "void removeBlankLineMacroOutBuffer, IntRef, IntRef", "boolean isErrorRootObject", "void emitMemberCommentsScopeDsymbol, OutBuffer, Scope", "UnionExp ctfeCatLoc, Type, Expression, Expression", "void escapeDdocStringOutBuffer, int", "void deprecationLoc, BytePtr", "void messageLoc, BytePtr", "Parameter isFunctionParameterDArray<Dsymbol>, BytePtr, int", "short parseModulePatternDepthBytePtr", "void MODtoDecoBufferOutBuffer, byte", "UnionExp ModLoc, Type, Expression, Expression", "void emplaceExpObject, Loc _param_1, Object _param_2, int _param_3StringExpLocObjectInteger", "void emplaceExpObject, Loc _param_1, StructLiteralExp _param_2, Type _param_3ClassReferenceExpLocStructLiteralExpType", "void emplaceExpObject, Loc _param_1, Type _param_2TypeidExpLocType", "Expression eval_tanLoc, FuncDeclaration, DArray<Expression>", "int skippastURLOutBuffer, int", "boolean isZeroSecondbyte", "Expression eval_copysignLoc, FuncDeclaration, DArray<Expression>", "Expression eval_log2Loc, FuncDeclaration, DArray<Expression>", "double creallcomplex_t", "void warningSupplementalLoc, BytePtr", "int deduceTypeRootObject, Scope, Type, DArray<TemplateParameter>, DArray<RootObject>, IntPtr, int, boolean", "Tuple isTupleRootObject", "Expression eval_truncLoc, FuncDeclaration, DArray<Expression>", "UnionExp DivLoc, Type, Expression, Expression", "void expandTemplateMixinCommentsTemplateMixin, OutBuffer, Scope", "Expression eval_sqrtLoc, FuncDeclaration, DArray<Expression>", "boolean lambdaCheckForNestedRefExpression, Scope", "void emplaceExpObject, Loc _param_1, complex_t _param_2, Type _param_3ComplexExpLoccomplex_tType", "void dsymbolSemanticDsymbol, Scope", "void cantExpUnionExp", "boolean pointToSameMemoryBlockExpression, Expression", "long getStorageClassPrefixAttributesASTBaseASTBase", "UnionExp ComType, Expression", "ByteSlice initializerMsgtable", "int specificCmpbyte, int", "void builtinDeinitialize", "boolean isDigitSecondbyte", "Scope skipNonQualScopesScope", "UnionExp MulLoc, Type, Expression, Expression", "int utfStrideBytePtr", "void verrorPrintLoc, int, BytePtr, BytePtr, Slice<Object>, BytePtr, BytePtr", "int ctfeCmpLoc, byte, Expression, Expression", "boolean isTrueBoolExpression", "void builtin_init", "Parameter isParameterRootObject", "void errorSupplementalLoc, BytePtr", "long resolveArrayLengthExpression", "Expression evaluateDtorInterState, Expression", "int foreachDsymbolDArray<Dsymbol>, Function1<Dsymbol,Integer>", "void emplaceExpObject, ErrorExp", "Expression interpret_lengthUnionExp, InterState, Expression", "Parameter isFunctionParameterDsymbol, BytePtr, int", "void emitProtectionOutBuffer, Import", "TemplateParameter isTemplateParameterRootObject", "boolean arrayObjectMatchDArray<RootObject>, DArray<RootObject>", "void emplaceExpObject, Loc _param_1, Type _param_2, Expression _param_3, DArray<Expression> _param_4ArrayLiteralExpLocTypeExpressionDArray<Expression>", "boolean reliesOnTemplateParametersExpression, Slice<TemplateParameter>", "int endAllMarkdownQuotesOutBuffer, int, IntRef", "void emplaceExpObject, Loc _param_1, Expression _param_2, FuncDeclaration _param_3, boolean _param_4DelegateExpLocExpressionFuncDeclarationBoolean", "boolean definitelyValueParameterExpression", "void emplaceExpObject, Loc _param_1, boolean _param_2, Type _param_3IntegerExpLocBooleanType", "boolean reliesOnTidentType, DArray<TemplateParameter>, int", "Expression eval_yl2xLoc, FuncDeclaration, DArray<Expression>", "void errorLoc, BytePtr", "boolean utf_isValidDcharint", "void fatal", "Expression evaluateIfBuiltinUnionExp, InterState, Loc, FuncDeclaration, DArray<Expression>, Expression", "UnionExp pointerDifferenceLoc, Type, Expression, Expression", "UnionExp NegType, Expression", "boolean isidcharbyte", "int utf_codeLengthWcharint", "Expression getValueRef<Dsymbol>", "Function3<Loc,FuncDeclaration,DArray<Expression>,Expression> builtin_lookupBytePtr", "BytePtr linkToCharsint", "Expression interpretStatement, InterState", "int isConstExpression", "Expression getExpressionRootObject", "void emitProtectionOutBuffer, Prot", "Expression ctfeIndexLoc, Type, Expression, long", "int utf_codeLengthint, int", "UnionExp SliceType, Expression, Expression, Expression", "void functionResolveMatchAccumulator, Dsymbol, Loc, Scope, DArray<RootObject>, Type, DArray<Expression>, Ptr<BytePtr>", "int intSignedCmpbyte, long, long", "int ctfeIdentityLoc, byte, Expression, Expression", "Expression ctfeInterpretForPragmaMsgExpression", "void emplaceExpObject, Loc _param_1, long _param_2, Type _param_3IntegerExpLocLongType", "boolean isUniAlphaint", "BytePtr skipwhitespaceBytePtr", "UnionExp Cmpbyte, Loc, Type, Expression, Expression", "Dsymbol mostVisibleOverloadDsymbol, Module", "UnionExp OrLoc, Type, Expression, Expression", "void emplaceExpObject, Loc _param_1, Declaration _param_2, int _param_3SymOffExpLocDeclarationInteger", "int sliceCmpStringWithArrayStringExp, ArrayLiteralExp, int, int, int", "boolean hasPackageAccessModule, Dsymbol", "CtorDeclaration generateCopyCtorDeclarationStructDeclaration, long, long", "void errorBytePtr, int, int, BytePtr", "void add_builtinBytePtr, Function3<Loc,FuncDeclaration,DArray<Expression>,Expression>", "UnionExp PtrType, Expression", "void utf_encodeWcharCharPtr, int", "boolean findConditionDArray<Identifier>, Identifier", "int ctfeRawCmpLoc, Expression, Expression, boolean", "UnionExp ShlLoc, Type, Expression, Expression", "void highlightTextScope, DArray<Dsymbol>, Loc, OutBuffer, int", "UnionExp voidInitLiteralType, VarDeclaration", "void gendocfileModule", "boolean isIdTailBytePtr", "UnionExp ShrLoc, Type, Expression, Expression", "void emplaceExpObject, Loc _param_1, Type _param_2, Expression _param_3ArrayLiteralExpLocTypeExpression", "int setMangleOverrideDsymbol, ByteSlice", "Dsymbol getDsymbolRootObject", "Expression eval_log10Loc, FuncDeclaration, DArray<Expression>", "Expression eval_expLoc, FuncDeclaration, DArray<Expression>", "Expression getAggregateFromPointerExpression, Ptr<Long>", "void emplaceExpObject, Loc _param_1, Expression _param_2, Expression _param_3IndexExpLocExpressionExpression", "Expression eval_fmaxLoc, FuncDeclaration, DArray<Expression>", "boolean isArrayExpression", "UnionExp CastLoc, Type, Type, Expression", "UnionExp IndexType, Expression, Expression", "void emitAnchorOutBuffer, Dsymbol, Scope, boolean", "void removeAnyAtxHeadingSuffixOutBuffer, int", "DArray<Expression> copyElementsExpression, Expression", "void assignInPlaceExpression, Expression", "TemplateDeclaration getEponymousParentDsymbol", "void utf_encodeint, Object, int", "boolean issinglecharbyte", "ByteSlice replaceCharByteSlice, byte, ByteSlice", "void emplaceExpObject, Loc _param_1, BytePtr _param_2, int _param_3StringExpLocBytePtrInteger", "int getCodeIndentBytePtr", "boolean isIdentifierDArray<Dsymbol>, BytePtr, int", "BytePtr utf_decodeCharBytePtr, int, IntRef, IntRef", "void vwarningLoc, BytePtr, Slice<Object>", "boolean needToCopyLiteralExpression", "int sliceCmpStringWithStringStringExp, StringExp, int, int, int", "boolean isCtfeComparableExpression", "ByteSlice memdupByteSlice", "void mangleToBufferTemplateInstance, OutBuffer", "ByteSlice lexBytePtr, ByteSlice", "boolean isPointerType", "Expression findKeyInAALoc, AssocArrayLiteralExp, Expression", "int endTableOutBuffer, int, Ref<IntSlice>", "Expression scrubReturnValueLoc, Expression", "Type rawTypeMergeType, Type", "void emplaceExpObject, Loc _param_1, Expression _param_2, Type _param_3VectorExpLocExpressionType", "boolean buildCopyCtorStructDeclaration, Scope", "boolean reliesOnTemplateParametersType, Slice<TemplateParameter>", "int utf_codeLengthCharint", "void highlightCode3Scope, OutBuffer, BytePtr, BytePtr", "void emplaceExpObject, Loc _param_1, SliceExp _param_2AddrExpLocSliceExp", "BytePtr getMessageDeprecatedDeclaration", "int endAllListsAndQuotesOutBuffer, IntRef, Ref<Slice<MarkdownList>>, IntRef, IntRef", "ByteSlice toLowercaseByteSlice", "Expression interpretFunctionUnionExp, FuncDeclaration, InterState, DArray<Expression>, Expression", "Expression interpret_valuesUnionExp, InterState, Expression, Type", "Expression eval_roundLoc, FuncDeclaration, DArray<Expression>", "void emplaceExpObject, Loc _param_1, Expression _param_2, Expression _param_3, Expression _param_4SliceExpLocExpressionExpressionExpression", "boolean modifyFieldVarLoc, Scope, VarDeclaration, Expression", "void emplaceExpObject, Loc _param_1, Expression _param_2, FuncDeclaration _param_3, boolean _param_4DotVarExpLocExpressionFuncDeclarationBoolean", "void deprecationSupplementalLoc, BytePtr", "Expression eval_ldexpLoc, FuncDeclaration, DArray<Expression>", "int extractArgNByteSlice, Ref<ByteSlice>, int", "UnionExp UshrLoc, Type, Expression, Expression", "Expression interpret_keysUnionExp, InterState, Expression, Type", "UnionExp Identitybyte, Loc, Type, Expression, Expression", "void vwarningSupplementalLoc, BytePtr, Slice<Object>", "BytePtr modToCharsint", "boolean checkSymbolAccessScope, Dsymbol", "Expression toDelegateExpression, Type, Scope", "UnionExp PowLoc, Type, Expression, Expression", "int isattyint", "Expression scrubCacheValueExpression", "int findFieldIndexByNameStructDeclaration, VarDeclaration", "boolean replaceMarkdownThematicBreakOutBuffer, IntRef, int, Loc", "RootObject objectSyntaxCopyRootObject", "int ctfeEqualLoc, byte, Expression, Expression", "void emplaceExpObject, Loc _param_1, Object _param_2, DArray<Expression> _param_3ArrayLiteralExpLocObjectDArray<Expression>", "void emplaceExpObject, Loc _param_1, Declaration _param_2, long _param_3SymOffExpLocDeclarationLong", "FuncDeclaration buildPostBlitStructDeclaration, Scope", "int skipCharsOutBuffer, int, ByteSlice", "Statement generateCopyCtorBodyStructDeclaration", "void emplaceExpObject, Loc _param_1, Expression _param_2, IntegerExp _param_3IndexExpLocExpressionIntegerExp", "void sliceAssignStringFromArrayLiteralStringExp, ArrayLiteralExp, int", "void emplaceExpObject, Loc _param_1, Declaration _param_2VarExpLocDeclaration", "int expressionHashExpression", "boolean ensureStaticLinkToDsymbol, Dsymbol", "void emplaceExpObject, Loc _param_1, StructDeclaration _param_2, DArray<Expression> _param_3, Type _param_4StructLiteralExpLocStructDeclarationDArray<Expression>Type", "DArray<Expression> copyLiteralArrayDArray<Expression>, Expression", "int templateParameterLookupType, DArray<TemplateParameter>", "boolean symbolIsVisibleDsymbol, Dsymbol", "boolean c_isalnumint", "void tyToDecoBufferOutBuffer, int", "void emplaceExpObject, Loc _param_1, StructDeclaration _param_2, DArray<Expression> _param_3StructLiteralExpLocStructDeclarationDArray<Expression>", "void ObjectNotFoundIdentifier", "boolean isCVariadicParameterDArray<Dsymbol>, ByteSlice", "void mangleToFuncSignatureOutBuffer, FuncDeclaration", "void colorHighlightCodeOutBuffer", "boolean symbolIsVisibleScope, Dsymbol", "void emplaceExpObject, Loc _param_1, TypeSArray _param_2, DArray<Expression> _param_3ArrayLiteralExpLocTypeSArrayDArray<Expression>", "void warningLoc, BytePtr", "UnionExp BoolType, Expression", "StringExp createBlockDuplicatedStringLiteralUnionExp, Loc, Type, int, int, byte", "void colorSyntaxHighlightOutBuffer", "Expression paintTypeOntoLiteralType, Expression", "void endMarkdownHeadingOutBuffer, int, IntRef, Loc, IntRef", "int endRowAndTableOutBuffer, int, int, Loc, Ref<Slice<MarkdownDelimiter>>, Ref<IntSlice>", "boolean isoctalbyte", "void unSpeculativeScope, RootObject", "Expression eval_fminLoc, FuncDeclaration, DArray<Expression>", "boolean arrayObjectIsErrorDArray<RootObject>", "long getStorageClassPrefixAttributesASTCodegenASTCodegen", "boolean isSpecialEnumIdentIdentifier", "int skiptoidentOutBuffer, int", "int deduceTypeHelperType, Ptr<Type>, Type", "boolean mergeFieldInitRef<Short>, short", "void emplaceExpObject, VarDeclaration _param_1VoidInitExpVarDeclaration", "void foreachDsymbolDArray<Dsymbol>, Function1<Dsymbol,Void>", "Expression interpretUnionExp, Expression, InterState, int", "UnionExp AddLoc, Type, Expression, Expression", "Expression isExpressionRootObject", "void emplaceExpObject, Loc _param_1, Expression _param_2, IntegerExp _param_3, Expression _param_4SliceExpLocExpressionIntegerExpExpression", "int parseTableDelimiterRowOutBuffer, int, boolean, Ref<IntSlice>", "int skippastidentOutBuffer, int", "UnionExp XorLoc, Type, Expression, Expression", "int realCmpbyte, double, double", "boolean isCVariadicArgByteSlice", "boolean isCtfeValueValidExpression", "UnionExp MinLoc, Type, Expression, Expression", "Expression eval_bsrLoc, FuncDeclaration, DArray<Expression>", "void semanticTypeInfoScope, Type", "void highlightCodeScope, Dsymbol, OutBuffer, int", "Expression eval_logLoc, FuncDeclaration, DArray<Expression>", "Expression eval_cosLoc, FuncDeclaration, DArray<Expression>", "boolean allowsContractWithoutBodyFuncDeclaration", "double cimaglcomplex_t", "int replaceTableRowOutBuffer, int, int, Loc, Ref<Slice<MarkdownDelimiter>>, IntSlice, boolean", "void verrorLoc, BytePtr, Slice<Object>, BytePtr, BytePtr, BytePtr", "UnionExp AndLoc, Type, Expression, Expression", "boolean _isZeroInitExpression", "boolean checkAccessLoc, Scope, Package", "Expression eval_ceilLoc, FuncDeclaration, DArray<Expression>", "boolean isCtfeReferenceValidExpression", "boolean checkFrameAccessLoc, Scope, AggregateDeclaration, int", "Expression ctfeInterpretExpression", "int ctfeCmpArraysLoc, Expression, Expression, long", "boolean isTypeInfo_ClassType", "byte deduceWildHelperType, Ptr<Type>, Type", "boolean isIndentWSBytePtr", "Expression evaluatePostblitInterState, Expression", "void verrorSupplementalLoc, BytePtr, Slice<Object>", "boolean checkAccessLoc, Scope, Expression, Declaration", "FuncDeclaration search_toStringStructDeclaration", "Expression eval_sinLoc, FuncDeclaration, DArray<Expression>", "UnionExp Equalbyte, Loc, Type, Expression, Expression", "void emplaceExpObject, Loc _param_1, Expression _param_2, TypeVector _param_3VectorExpLocExpressionTypeVector", "int replaceMarkdownEmphasisOutBuffer, Loc, Ref<Slice<MarkdownDelimiter>>, int", "void emplaceExpObject, Loc _param_1, Expression _param_2, IntegerExp _param_3, IntegerExp _param_4SliceExpLocExpressionIntegerExpIntegerExp", "void emplaceExpObject, Loc _param_1, Object _param_2, int _param_3, byte _param_4StringExpLocObjectIntegerByte", "ByteSlice generateSlice<Msgtable>, Function1<Msgtable,ByteSlice>", "void emplaceExpObject, Loc _param_1, DArray<Expression> _param_2TupleExpLocDArray<Expression>", "void processFileByteSlice, ByteSlice, BytePtr_lispy", "Expression eval_popcntLoc, FuncDeclaration, DArray<Expression>", "Expression eval_bsfLoc, FuncDeclaration, DArray<Expression>", "void setValueWithoutCheckingVarDeclaration, Expression", "void mangleToBufferType, OutBuffer", "int isBuiltinFuncDeclaration", "Expression paintFloatIntUnionExp, Expression, Type", "void sliceAssignStringFromStringStringExp, StringExp, int", "Expression paintTypeOntoLiteralUnionExp, Type, Expression", "boolean symbolIsVisibleModule, Dsymbol", "void ctfeCompileFuncDeclaration", "Expression eval_fabsLoc, FuncDeclaration, DArray<Expression>", "void printCtfePerformanceStats", "void highlightCodeScope, DArray<Dsymbol>, OutBuffer, int", "ByteSlice getFilenameDArray<Identifier>, Identifier", "Expression interpretExpression, InterState, int", "Expression getValueExpression", "void messageBytePtr", "Expression eval_isnanLoc, FuncDeclaration, DArray<Expression>", "Expression ctfeCastUnionExp, Loc, Type, Type, Expression", "UnionExp NotType, Expression", "void escapeStrayParenthesisLoc, OutBuffer, int, boolean", "void lambdaSetParentExpression, FuncDeclaration", "boolean isIdStartBytePtr", "int intUnsignedCmpbyte, long, long", "void emplaceExpObject, Loc _param_1, int _param_2, Type _param_3IntegerExpLocIntegerType", "UnionExp pointerArithmeticLoc, byte, Type, Expression, Expression", "void emitProtectionOutBuffer, Declaration", "int templateIdentifierLookupIdentifier, DArray<TemplateParameter>", "ByteSlice lispyBytePtr, ByteSlice", "boolean walkPostorderExpression, StoppableVisitor", "TypeFunction isTypeFunctionDsymbol", "void emplaceExpObject, Loc _param_1, Expression _param_2, Declaration _param_3, boolean _param_4DotVarExpLocExpressionDeclarationBoolean", "void printDepsConditionalScope, DVCondition, ByteSlice", "Expression expTypeType, Expression", "Expression resolveAliasThisScope, Expression, boolean", "int detectAtxHeadingLevelOutBuffer, int", "Type isTypeRootObject", "Expression eval_builtinLoc, FuncDeclaration, DArray<Expression>", "boolean c_isxdigitint", "BytePtr utf_decodeWcharCharPtr, int, IntRef, IntRef", "Expression interpretUnionExp, Statement, InterState", "ByteSlice deinitializerMsgtable", "Expression eval_unimpLoc, FuncDeclaration, DArray<Expression>", "void utf_encodeCharBytePtr, int", "void semantic3OnDependenciesModule", "UnionExp copyLiteralExpression", "UnionExp paintTypeOntoLiteralCopyType, Expression", "Expression interpret_aaApplyUnionExp, InterState, Expression, Expression", "void emitCommentDsymbol, OutBuffer, Scope", "void emplaceExpObject, Loc _param_1, VarExp _param_2, Type _param_3AddrExpLocVarExpType", "ByteSlice skipwhitespaceByteSlice", "void vdeprecationSupplementalLoc, BytePtr, Slice<Object>", "void highlightCode2Scope, DArray<Dsymbol>, OutBuffer, int", "FuncDeclaration funcptrOfExpression", "void emplaceExpObject, Loc _param_1, DArray<Expression> _param_2, DArray<Expression> _param_3AssocArrayLiteralExpLocDArray<Expression>DArray<Expression>", "void parseModulePatternBytePtr, MatcherNode, short", "void mangleToBufferExpression, OutBuffer", "boolean matchRootObject, RootObject", "Expression eval_exp2Loc, FuncDeclaration, DArray<Expression>", "int getMarkdownIndentOutBuffer, int, int", "int startTableOutBuffer, int, int, Loc, boolean, Ref<Slice<MarkdownDelimiter>>, Ref<IntSlice>", "boolean isKeywordBytePtr, int", "UnionExp CatType, Expression, Expression", "Expression eval_isfiniteLoc, FuncDeclaration, DArray<Expression>", "int comparePointersbyte, Expression, long, Expression, long", "boolean isDittoBytePtr", "void emplaceExpObject, Loc _param_1, Type _param_2NullExpLocType", "boolean isAssocArrayType", "boolean isSafePointerCastType, Type", "boolean numCmpbyte, double, doubleDouble", "void mangleToBufferDsymbol, OutBuffer", "void aliasSemanticAliasDeclaration, Scope", "Parameter isEponymousFunctionParameterDArray<Dsymbol>, BytePtr, int", "void emplaceExpObject, Loc _param_1, Type _param_2, DArray<Expression> _param_3ArrayLiteralExpLocTypeDArray<Expression>", "Expression assignAssocArrayElementLoc, AssocArrayLiteralExp, Expression, Expression", "void emplaceExpObject, Loc _param_1, IndexExp _param_2, Type _param_3AddrExpLocIndexExpType", "ByteSlice identifierMsgtable", "boolean ishexbyte", "void processFileByteSlice, ByteSlice, BytePtr_lex", "Expression eval_bswapLoc, FuncDeclaration, DArray<Expression>", "void vdeprecationLoc, BytePtr, Slice<Object>, BytePtr, BytePtr", "void setValueVarDeclaration, Expression", "void halt", "BytePtr mangleExactFuncDeclaration", "void emplaceExpObject, int _param_1IntegerExpInteger", "Expression eval_expm1Loc, FuncDeclaration, DArray<Expression>", "Dsymbol isDsymbolRootObject", "boolean isReservedNameByteSlice", "boolean hasProtectedAccessScope, Dsymbol", "void writeHighlightsConsole, OutBuffer", "boolean numCmpbyte, long, longLong", "Expression interpret_dupUnionExp, InterState, Expression", "Dsymbol getEponymousMemberTemplateDeclaration", "Expression eval_powLoc, FuncDeclaration, DArray<Expression>", "boolean hasValueVarDeclaration", "void templateInstanceSemanticTemplateInstance, Scope, DArray<Expression>", "Type getTypeRootObject", "Expression foreachApplyUtfUnionExp, InterState, Expression, Expression, boolean", "void emplaceExpObject, Loc _param_1, BytePtr _param_2StringExpLocBytePtr", "boolean includeImportedModuleCheckModuleComponentRange", "Expression eval_fmaLoc, FuncDeclaration, DArray<Expression>", "void sliceAssignArrayLiteralFromStringArrayLiteralExp, StringExp, int", "boolean writeMixinByteSlice, Loc", "void toDocBufferDsymbol, OutBuffer, Scope", "void emplaceExpObject, Loc _param_1, SliceExp _param_2, Type _param_3AddrExpLocSliceExpType"]] signature: void emplaceExpObject, Loc _param_1, BytePtr _param_2, int _param_3StringExpLocBytePtrInteger
    ...
    // from template emplaceExp!(IntegerExpLocIntegerType)
    // removed duplicate function, [["Expression eval_yl2xp1Loc, FuncDeclaration, DArray<Expression>", "int skipPastIdentWithDotsOutBuffer, int", "boolean emitAnchorNameOutBuffer, Dsymbol, Scope, boolean", "TemplateParameter isTemplateParameterDArray<Dsymbol>, BytePtr, int", "void emplaceExpObject, Loc _param_1, double _param_2, Type _param_3RealExpLocDoubleType", "TypeAArray toBuiltinAATypeType", "Expression eval_isinfinityLoc, FuncDeclaration, DArray<Expression>", "boolean mergeCallSuperRef<Short>, short", "Expression eval_floorLoc, FuncDeclaration, DArray<Expression>", "UnionExp changeArrayLiteralLengthLoc, TypeArray, Expression, int, int", "ArrayLiteralExp createBlockDuplicatedArrayLiteralUnionExp, Loc, Type, Expression, int", "BytePtr stripLeadingNewlinesBytePtr", "void emplaceExpObject, byte _param_1CTFEExpByte", "void createMatchNodes", "UnionExp ArrayLengthType, Expression", "boolean checkAccessAggregateDeclaration, Loc, Scope, Dsymbol", "Expression resolveSliceExpression, UnionExp", "Expression getValueVarDeclaration", "boolean hasPackageAccessScope, Dsymbol", "void emplaceExpObject, Loc _param_1, Expression _param_2, Type _param_3AddrExpLocExpressionType", "boolean isFloatIntPaintType, Type", "int mainSlice<ByteSlice>", "void vmessageLoc, BytePtr, Slice<Object>", "boolean isValidManglingint", "int getAlignmentAlignDeclaration, Scope", "int arrayObjectHashDArray<RootObject>", "boolean numCmpbyte, int, intInteger", "boolean exceptionOrCantInterpretExpression", "ByteSlice lookForSourceFileByteSlice", "void showCtfeExprExpression, int", "void emplaceExpObject, Loc _param_1, Expression _param_2AddrExpLocExpression", "void removeBlankLineMacroOutBuffer, IntRef, IntRef", "boolean isErrorRootObject", "void emitMemberCommentsScopeDsymbol, OutBuffer, Scope", "UnionExp ctfeCatLoc, Type, Expression, Expression", "void escapeDdocStringOutBuffer, int", "void deprecationLoc, BytePtr", "void messageLoc, BytePtr", "Parameter isFunctionParameterDArray<Dsymbol>, BytePtr, int", "short parseModulePatternDepthBytePtr", "void MODtoDecoBufferOutBuffer, byte", "UnionExp ModLoc, Type, Expression, Expression", "void emplaceExpObject, Loc _param_1, Object _param_2, int _param_3StringExpLocObjectInteger", "void emplaceExpObject, Loc _param_1, StructLiteralExp _param_2, Type _param_3ClassReferenceExpLocStructLiteralExpType", "void emplaceExpObject, Loc _param_1, Type _param_2TypeidExpLocType", "Expression eval_tanLoc, FuncDeclaration, DArray<Expression>", "int skippastURLOutBuffer, int", "boolean isZeroSecondbyte", "Expression eval_copysignLoc, FuncDeclaration, DArray<Expression>", "Expression eval_log2Loc, FuncDeclaration, DArray<Expression>", "double creallcomplex_t", "void warningSupplementalLoc, BytePtr", "int deduceTypeRootObject, Scope, Type, DArray<TemplateParameter>, DArray<RootObject>, IntPtr, int, boolean", "Tuple isTupleRootObject", "Expression eval_truncLoc, FuncDeclaration, DArray<Expression>", "UnionExp DivLoc, Type, Expression, Expression", "void expandTemplateMixinCommentsTemplateMixin, OutBuffer, Scope", "Expression eval_sqrtLoc, FuncDeclaration, DArray<Expression>", "boolean lambdaCheckForNestedRefExpression, Scope", "void emplaceExpObject, Loc _param_1, complex_t _param_2, Type _param_3ComplexExpLoccomplex_tType", "void dsymbolSemanticDsymbol, Scope", "void cantExpUnionExp", "boolean pointToSameMemoryBlockExpression, Expression", "long getStorageClassPrefixAttributesASTBaseASTBase", "UnionExp ComType, Expression", "ByteSlice initializerMsgtable", "int specificCmpbyte, int", "void builtinDeinitialize", "boolean isDigitSecondbyte", "Scope skipNonQualScopesScope", "UnionExp MulLoc, Type, Expression, Expression", "int utfStrideBytePtr", "void verrorPrintLoc, int, BytePtr, BytePtr, Slice<Object>, BytePtr, BytePtr", "int ctfeCmpLoc, byte, Expression, Expression", "boolean isTrueBoolExpression", "void builtin_init", "Parameter isParameterRootObject", "void errorSupplementalLoc, BytePtr", "long resolveArrayLengthExpression", "Expression evaluateDtorInterState, Expression", "int foreachDsymbolDArray<Dsymbol>, Function1<Dsymbol,Integer>", "void emplaceExpObject, ErrorExp", "Expression interpret_lengthUnionExp, InterState, Expression", "Parameter isFunctionParameterDsymbol, BytePtr, int", "void emitProtectionOutBuffer, Import", "TemplateParameter isTemplateParameterRootObject", "boolean arrayObjectMatchDArray<RootObject>, DArray<RootObject>", "void emplaceExpObject, Loc _param_1, Type _param_2, Expression _param_3, DArray<Expression> _param_4ArrayLiteralExpLocTypeExpressionDArray<Expression>", "boolean reliesOnTemplateParametersExpression, Slice<TemplateParameter>", "int endAllMarkdownQuotesOutBuffer, int, IntRef", "void emplaceExpObject, Loc _param_1, Expression _param_2, VarDeclaration _param_3DotVarExpLocExpressionVarDeclaration", "void emplaceExpObject, Loc _param_1, Expression _param_2, FuncDeclaration _param_3, boolean _param_4DelegateExpLocExpressionFuncDeclarationBoolean", "boolean definitelyValueParameterExpression", "void emplaceExpObject, Loc _param_1, boolean _param_2, Type _param_3IntegerExpLocBooleanType", "boolean reliesOnTidentType, DArray<TemplateParameter>, int", "Expression eval_yl2xLoc, FuncDeclaration, DArray<Expression>", "void errorLoc, BytePtr", "boolean utf_isValidDcharint", "void fatal", "Expression evaluateIfBuiltinUnionExp, InterState, Loc, FuncDeclaration, DArray<Expression>, Expression", "UnionExp pointerDifferenceLoc, Type, Expression, Expression", "UnionExp NegType, Expression", "boolean isidcharbyte", "int utf_codeLengthWcharint", "Expression getValueRef<Dsymbol>", "Function3<Loc,FuncDeclaration,DArray<Expression>,Expression> builtin_lookupBytePtr", "BytePtr linkToCharsint", "Expression interpretStatement, InterState", "int isConstExpression", "Expression getExpressionRootObject", "void emitProtectionOutBuffer, Prot", "Expression ctfeIndexLoc, Type, Expression, long", "int utf_codeLengthint, int", "UnionExp SliceType, Expression, Expression, Expression", "void functionResolveMatchAccumulator, Dsymbol, Loc, Scope, DArray<RootObject>, Type, DArray<Expression>, Ptr<BytePtr>", "int intSignedCmpbyte, long, long", "int ctfeIdentityLoc, byte, Expression, Expression", "Expression ctfeInterpretForPragmaMsgExpression", "void emplaceExpObject, Loc _param_1, long _param_2, Type _param_3IntegerExpLocLongType", "boolean isUniAlphaint", "BytePtr skipwhitespaceBytePtr", "UnionExp Cmpbyte, Loc, Type, Expression, Expression", "Dsymbol mostVisibleOverloadDsymbol, Module", "UnionExp OrLoc, Type, Expression, Expression", "void emplaceExpObject, Loc _param_1, Declaration _param_2, int _param_3SymOffExpLocDeclarationInteger", "int sliceCmpStringWithArrayStringExp, ArrayLiteralExp, int, int, int", "boolean hasPackageAccessModule, Dsymbol", "CtorDeclaration generateCopyCtorDeclarationStructDeclaration, long, long", "void errorBytePtr, int, int, BytePtr", "void add_builtinBytePtr, Function3<Loc,FuncDeclaration,DArray<Expression>,Expression>", "UnionExp PtrType, Expression", "void utf_encodeWcharCharPtr, int", "boolean findConditionDArray<Identifier>, Identifier", "int ctfeRawCmpLoc, Expression, Expression, boolean", "UnionExp ShlLoc, Type, Expression, Expression", "void highlightTextScope, DArray<Dsymbol>, Loc, OutBuffer, int", "UnionExp voidInitLiteralType, VarDeclaration", "void gendocfileModule", "boolean isIdTailBytePtr", "UnionExp ShrLoc, Type, Expression, Expression", "void emplaceExpObject, Loc _param_1, Type _param_2, Expression _param_3ArrayLiteralExpLocTypeExpression", "int setMangleOverrideDsymbol, ByteSlice", "Dsymbol getDsymbolRootObject", "Expression eval_log10Loc, FuncDeclaration, DArray<Expression>", "Expression eval_expLoc, FuncDeclaration, DArray<Expression>", "Expression getAggregateFromPointerExpression, Ptr<Long>", "void emplaceExpObject, Loc _param_1, Expression _param_2, Expression _param_3IndexExpLocExpressionExpression", "Expression eval_fmaxLoc, FuncDeclaration, DArray<Expression>", "boolean isArrayExpression", "UnionExp CastLoc, Type, Type, Expression", "UnionExp IndexType, Expression, Expression", "void emitAnchorOutBuffer, Dsymbol, Scope, boolean", "void removeAnyAtxHeadingSuffixOutBuffer, int", "DArray<Expression> copyElementsExpression, Expression", "void assignInPlaceExpression, Expression", "TemplateDeclaration getEponymousParentDsymbol", "void utf_encodeint, Object, int", "boolean issinglecharbyte", "ByteSlice replaceCharByteSlice, byte, ByteSlice", "void emplaceExpObject, Loc _param_1, BytePtr _param_2, int _param_3StringExpLocBytePtrInteger", "int getCodeIndentBytePtr", "boolean isIdentifierDArray<Dsymbol>, BytePtr, int", "BytePtr utf_decodeCharBytePtr, int, IntRef, IntRef", "void vwarningLoc, BytePtr, Slice<Object>", "boolean needToCopyLiteralExpression", "int sliceCmpStringWithStringStringExp, StringExp, int, int, int", "boolean isCtfeComparableExpression", "ByteSlice memdupByteSlice", "void mangleToBufferTemplateInstance, OutBuffer", "ByteSlice lexBytePtr, ByteSlice", "boolean isPointerType", "Expression findKeyInAALoc, AssocArrayLiteralExp, Expression", "int endTableOutBuffer, int, Ref<IntSlice>", "Expression scrubReturnValueLoc, Expression", "Type rawTypeMergeType, Type", "void emplaceExpObject, Loc _param_1, Expression _param_2, Type _param_3VectorExpLocExpressionType", "boolean buildCopyCtorStructDeclaration, Scope", "boolean reliesOnTemplateParametersType, Slice<TemplateParameter>", "int utf_codeLengthCharint", "void highlightCode3Scope, OutBuffer, BytePtr, BytePtr", "void emplaceExpObject, Loc _param_1, SliceExp _param_2AddrExpLocSliceExp", "BytePtr getMessageDeprecatedDeclaration", "int endAllListsAndQuotesOutBuffer, IntRef, Ref<Slice<MarkdownList>>, IntRef, IntRef", "ByteSlice toLowercaseByteSlice", "Expression interpretFunctionUnionExp, FuncDeclaration, InterState, DArray<Expression>, Expression", "Expression interpret_valuesUnionExp, InterState, Expression, Type", "Expression eval_roundLoc, FuncDeclaration, DArray<Expression>", "void emplaceExpObject, Loc _param_1, Expression _param_2, Expression _param_3, Expression _param_4SliceExpLocExpressionExpressionExpression", "boolean modifyFieldVarLoc, Scope, VarDeclaration, Expression", "void emplaceExpObject, Loc _param_1, Expression _param_2, FuncDeclaration _param_3, boolean _param_4DotVarExpLocExpressionFuncDeclarationBoolean", "void deprecationSupplementalLoc, BytePtr", "Expression eval_ldexpLoc, FuncDeclaration, DArray<Expression>", "int extractArgNByteSlice, Ref<ByteSlice>, int", "UnionExp UshrLoc, Type, Expression, Expression", "Expression interpret_keysUnionExp, InterState, Expression, Type", "UnionExp Identitybyte, Loc, Type, Expression, Expression", "void vwarningSupplementalLoc, BytePtr, Slice<Object>", "BytePtr modToCharsint", "boolean checkSymbolAccessScope, Dsymbol", "Expression toDelegateExpression, Type, Scope", "UnionExp PowLoc, Type, Expression, Expression", "int isattyint", "Expression scrubCacheValueExpression", "int findFieldIndexByNameStructDeclaration, VarDeclaration", "boolean replaceMarkdownThematicBreakOutBuffer, IntRef, int, Loc", "RootObject objectSyntaxCopyRootObject", "int ctfeEqualLoc, byte, Expression, Expression", "void emplaceExpObject, Loc _param_1, Object _param_2, DArray<Expression> _param_3ArrayLiteralExpLocObjectDArray<Expression>", "void emplaceExpObject, Loc _param_1, Declaration _param_2, long _param_3SymOffExpLocDeclarationLong", "FuncDeclaration buildPostBlitStructDeclaration, Scope", "int skipCharsOutBuffer, int, ByteSlice", "Statement generateCopyCtorBodyStructDeclaration", "void emplaceExpObject, Loc _param_1, Expression _param_2, IntegerExp _param_3IndexExpLocExpressionIntegerExp", "void sliceAssignStringFromArrayLiteralStringExp, ArrayLiteralExp, int", "void emplaceExpObject, Loc _param_1, Declaration _param_2VarExpLocDeclaration", "int expressionHashExpression", "boolean ensureStaticLinkToDsymbol, Dsymbol", "void emplaceExpObject, Loc _param_1, StructDeclaration _param_2, DArray<Expression> _param_3, Type _param_4StructLiteralExpLocStructDeclarationDArray<Expression>Type", "DArray<Expression> copyLiteralArrayDArray<Expression>, Expression", "void emplaceExpObject, Loc _param_1, TypeArray _param_2, DArray<Expression> _param_3ArrayLiteralExpLocTypeArrayDArray<Expression>", "int templateParameterLookupType, DArray<TemplateParameter>", "boolean symbolIsVisibleDsymbol, Dsymbol", "boolean c_isalnumint", "void tyToDecoBufferOutBuffer, int", "void emplaceExpObject, Loc _param_1, StructDeclaration _param_2, DArray<Expression> _param_3StructLiteralExpLocStructDeclarationDArray<Expression>", "void ObjectNotFoundIdentifier", "boolean isCVariadicParameterDArray<Dsymbol>, ByteSlice", "void mangleToFuncSignatureOutBuffer, FuncDeclaration", "void colorHighlightCodeOutBuffer", "boolean symbolIsVisibleScope, Dsymbol", "void emplaceExpObject, Loc _param_1, TypeSArray _param_2, DArray<Expression> _param_3ArrayLiteralExpLocTypeSArrayDArray<Expression>", "void warningLoc, BytePtr", "UnionExp BoolType, Expression", "StringExp createBlockDuplicatedStringLiteralUnionExp, Loc, Type, int, int, byte", "void colorSyntaxHighlightOutBuffer", "Expression paintTypeOntoLiteralType, Expression", "void endMarkdownHeadingOutBuffer, int, IntRef, Loc, IntRef", "int endRowAndTableOutBuffer, int, int, Loc, Ref<Slice<MarkdownDelimiter>>, Ref<IntSlice>", "boolean isoctalbyte", "void unSpeculativeScope, RootObject", "Expression eval_fminLoc, FuncDeclaration, DArray<Expression>", "boolean arrayObjectIsErrorDArray<RootObject>", "long getStorageClassPrefixAttributesASTCodegenASTCodegen", "boolean isSpecialEnumIdentIdentifier", "int skiptoidentOutBuffer, int", "int deduceTypeHelperType, Ptr<Type>, Type", "boolean mergeFieldInitRef<Short>, short", "void emplaceExpObject, VarDeclaration _param_1VoidInitExpVarDeclaration", "void foreachDsymbolDArray<Dsymbol>, Function1<Dsymbol,Void>", "Expression interpretUnionExp, Expression, InterState, int", "UnionExp AddLoc, Type, Expression, Expression", "Expression isExpressionRootObject", "void emplaceExpObject, Loc _param_1, Expression _param_2, IntegerExp _param_3, Expression _param_4SliceExpLocExpressionIntegerExpExpression", "int parseTableDelimiterRowOutBuffer, int, boolean, Ref<IntSlice>", "int skippastidentOutBuffer, int", "UnionExp XorLoc, Type, Expression, Expression", "int realCmpbyte, double, double", "boolean isCVariadicArgByteSlice", "boolean isCtfeValueValidExpression", "UnionExp MinLoc, Type, Expression, Expression", "Expression eval_bsrLoc, FuncDeclaration, DArray<Expression>", "void semanticTypeInfoScope, Type", "void highlightCodeScope, Dsymbol, OutBuffer, int", "Expression eval_logLoc, FuncDeclaration, DArray<Expression>", "Expression eval_cosLoc, FuncDeclaration, DArray<Expression>", "boolean allowsContractWithoutBodyFuncDeclaration", "double cimaglcomplex_t", "int replaceTableRowOutBuffer, int, int, Loc, Ref<Slice<MarkdownDelimiter>>, IntSlice, boolean", "void verrorLoc, BytePtr, Slice<Object>, BytePtr, BytePtr, BytePtr", "UnionExp AndLoc, Type, Expression, Expression", "boolean _isZeroInitExpression", "boolean checkAccessLoc, Scope, Package", "Expression eval_ceilLoc, FuncDeclaration, DArray<Expression>", "boolean isCtfeReferenceValidExpression", "boolean checkFrameAccessLoc, Scope, AggregateDeclaration, int", "Expression ctfeInterpretExpression", "int ctfeCmpArraysLoc, Expression, Expression, long", "boolean isTypeInfo_ClassType", "byte deduceWildHelperType, Ptr<Type>, Type", "boolean isIndentWSBytePtr", "Expression evaluatePostblitInterState, Expression", "void verrorSupplementalLoc, BytePtr, Slice<Object>", "boolean checkAccessLoc, Scope, Expression, Declaration", "FuncDeclaration search_toStringStructDeclaration", "Expression eval_sinLoc, FuncDeclaration, DArray<Expression>", "UnionExp Equalbyte, Loc, Type, Expression, Expression", "void emplaceExpObject, Loc _param_1, Expression _param_2, TypeVector _param_3VectorExpLocExpressionTypeVector", "int replaceMarkdownEmphasisOutBuffer, Loc, Ref<Slice<MarkdownDelimiter>>, int", "void emplaceExpObject, Loc _param_1, Expression _param_2, IntegerExp _param_3, IntegerExp _param_4SliceExpLocExpressionIntegerExpIntegerExp", "void emplaceExpObject, Loc _param_1, Object _param_2, int _param_3, byte _param_4StringExpLocObjectIntegerByte", "ByteSlice generateSlice<Msgtable>, Function1<Msgtable,ByteSlice>", "void emplaceExpObject, Loc _param_1, DArray<Expression> _param_2TupleExpLocDArray<Expression>", "void processFileByteSlice, ByteSlice, BytePtr_lispy", "Expression eval_popcntLoc, FuncDeclaration, DArray<Expression>", "Expression eval_bsfLoc, FuncDeclaration, DArray<Expression>", "void setValueWithoutCheckingVarDeclaration, Expression", "void mangleToBufferType, OutBuffer", "int isBuiltinFuncDeclaration", "Expression paintFloatIntUnionExp, Expression, Type", "void sliceAssignStringFromStringStringExp, StringExp, int", "Expression paintTypeOntoLiteralUnionExp, Type, Expression", "boolean symbolIsVisibleModule, Dsymbol", "void ctfeCompileFuncDeclaration", "Expression eval_fabsLoc, FuncDeclaration, DArray<Expression>", "void printCtfePerformanceStats", "void highlightCodeScope, DArray<Dsymbol>, OutBuffer, int", "ByteSlice getFilenameDArray<Identifier>, Identifier", "Expression interpretExpression, InterState, int", "Expression getValueExpression", "void messageBytePtr", "Expression eval_isnanLoc, FuncDeclaration, DArray<Expression>", "Expression ctfeCastUnionExp, Loc, Type, Type, Expression", "UnionExp NotType, Expression", "void escapeStrayParenthesisLoc, OutBuffer, int, boolean", "void lambdaSetParentExpression, FuncDeclaration", "boolean isIdStartBytePtr", "int intUnsignedCmpbyte, long, long", "void emplaceExpObject, Loc _param_1, int _param_2, Type _param_3IntegerExpLocIntegerType", "UnionExp pointerArithmeticLoc, byte, Type, Expression, Expression", "void emitProtectionOutBuffer, Declaration", "int templateIdentifierLookupIdentifier, DArray<TemplateParameter>", "ByteSlice lispyBytePtr, ByteSlice", "boolean walkPostorderExpression, StoppableVisitor", "TypeFunction isTypeFunctionDsymbol", "void emplaceExpObject, Loc _param_1, Expression _param_2, Declaration _param_3, boolean _param_4DotVarExpLocExpressionDeclarationBoolean", "void printDepsConditionalScope, DVCondition, ByteSlice", "Expression expTypeType, Expression", "Expression resolveAliasThisScope, Expression, boolean", "int detectAtxHeadingLevelOutBuffer, int", "Type isTypeRootObject", "Expression eval_builtinLoc, FuncDeclaration, DArray<Expression>", "boolean c_isxdigitint", "BytePtr utf_decodeWcharCharPtr, int, IntRef, IntRef", "Expression interpretUnionExp, Statement, InterState", "ByteSlice deinitializerMsgtable", "Expression eval_unimpLoc, FuncDeclaration, DArray<Expression>", "void utf_encodeCharBytePtr, int", "void semantic3OnDependenciesModule", "UnionExp copyLiteralExpression", "UnionExp paintTypeOntoLiteralCopyType, Expression", "Expression interpret_aaApplyUnionExp, InterState, Expression, Expression", "void emitCommentDsymbol, OutBuffer, Scope", "void emplaceExpObject, Loc _param_1, VarExp _param_2, Type _param_3AddrExpLocVarExpType", "ByteSlice skipwhitespaceByteSlice", "void vdeprecationSupplementalLoc, BytePtr, Slice<Object>", "void highlightCode2Scope, DArray<Dsymbol>, OutBuffer, int", "FuncDeclaration funcptrOfExpression", "void emplaceExpObject, Loc _param_1, DArray<Expression> _param_2, DArray<Expression> _param_3AssocArrayLiteralExpLocDArray<Expression>DArray<Expression>", "void parseModulePatternBytePtr, MatcherNode, short", "void mangleToBufferExpression, OutBuffer", "boolean matchRootObject, RootObject", "Expression eval_exp2Loc, FuncDeclaration, DArray<Expression>", "int getMarkdownIndentOutBuffer, int, int", "int startTableOutBuffer, int, int, Loc, boolean, Ref<Slice<MarkdownDelimiter>>, Ref<IntSlice>", "boolean isKeywordBytePtr, int", "UnionExp CatType, Expression, Expression", "Expression eval_isfiniteLoc, FuncDeclaration, DArray<Expression>", "int comparePointersbyte, Expression, long, Expression, long", "boolean isDittoBytePtr", "void emplaceExpObject, Loc _param_1, Type _param_2NullExpLocType", "boolean isAssocArrayType", "boolean isSafePointerCastType, Type", "boolean numCmpbyte, double, doubleDouble", "void mangleToBufferDsymbol, OutBuffer", "void aliasSemanticAliasDeclaration, Scope", "Parameter isEponymousFunctionParameterDArray<Dsymbol>, BytePtr, int", "void emplaceExpObject, Loc _param_1, Type _param_2, DArray<Expression> _param_3ArrayLiteralExpLocTypeDArray<Expression>", "Expression assignAssocArrayElementLoc, AssocArrayLiteralExp, Expression, Expression", "void emplaceExpObject, Loc _param_1, IndexExp _param_2, Type _param_3AddrExpLocIndexExpType", "ByteSlice identifierMsgtable", "boolean ishexbyte", "void processFileByteSlice, ByteSlice, BytePtr_lex", "Expression eval_bswapLoc, FuncDeclaration, DArray<Expression>", "void vdeprecationLoc, BytePtr, Slice<Object>, BytePtr, BytePtr", "void setValueVarDeclaration, Expression", "void halt", "BytePtr mangleExactFuncDeclaration", "void emplaceExpObject, int _param_1IntegerExpInteger", "Expression eval_expm1Loc, FuncDeclaration, DArray<Expression>", "Dsymbol isDsymbolRootObject", "boolean isReservedNameByteSlice", "boolean hasProtectedAccessScope, Dsymbol", "void writeHighlightsConsole, OutBuffer", "boolean numCmpbyte, long, longLong", "Expression interpret_dupUnionExp, InterState, Expression", "Dsymbol getEponymousMemberTemplateDeclaration", "Expression eval_powLoc, FuncDeclaration, DArray<Expression>", "boolean hasValueVarDeclaration", "void templateInstanceSemanticTemplateInstance, Scope, DArray<Expression>", "Type getTypeRootObject", "Expression foreachApplyUtfUnionExp, InterState, Expression, Expression, boolean", "void emplaceExpObject, Loc _param_1, BytePtr _param_2StringExpLocBytePtr", "boolean includeImportedModuleCheckModuleComponentRange", "Expression eval_fmaLoc, FuncDeclaration, DArray<Expression>", "void sliceAssignArrayLiteralFromStringArrayLiteralExp, StringExp, int", "boolean writeMixinByteSlice, Loc", "void toDocBufferDsymbol, OutBuffer, Scope", "void emplaceExpObject, Loc _param_1, SliceExp _param_2, Type _param_3AddrExpLocSliceExpType"]] signature: void emplaceExpObject, Loc _param_1, int _param_2, Type _param_3IntegerExpLocIntegerType
            ...
            for (; u < (exps).length;u++){
                Expression exp = (exps).get(u);
                {
                    ...
                    if (td != null)
                    {
                        (exps).remove(u);
                        {
                            Slice<RootObject> __r1235 = (td.objects).opSlice().copy();
                            int __key1234 = 0;
                            for (; __key1234 < __r1235.getLength();__key1234 += 1) {
                                RootObject o = __r1235.get(__key1234);
                                int i = __key1234;
    ...
    public static abstract class Expression extends ASTNode
    {
        ...
        public static DArray<Expression> arraySyntaxCopy(DArray<Expression> exps) {
            ...
            if (exps != null)
            {
                ...
                {
                    Slice<Expression> __r1237 = (exps).opSlice().copy();
                    int __key1236 = 0;
                    for (; __key1236 < __r1237.getLength();__key1236 += 1) {
                        Expression e = __r1237.get(__key1236);
                        int i = __key1236;
        ...
        public  boolean checkPurity(Scope sc, VarDeclaration v) {
            ...
            else
            {
                ...
                {
                    Dsymbol s = (sc).func;
                    for (; (!(err) && s != null);s = toParentP(s, vparent)){
    ...
    public static class IntegerExp extends Expression
    {
        ...
        // from template literal!(_-1)
        public static IntegerExp literal_-1() {
        ...
        // from template literal!(_0)
        public static IntegerExp literal_0() {
            if (!(expression.literaltheConstant != null))
        ...
        // from template literal!(_1)
        public static IntegerExp literal_1() {
            if (!(expression.literaltheConstant != null))
                expression.literaltheConstant = new IntegerExp(1L);
            return expression.literaltheConstant;
        }
    ...
    public static class RealExp extends Expression
    {
        ...
        public  boolean isBool(boolean result) {
            return result ? (boolean)this.value : !((boolean)this.value);
        }
        ...
        public  int numberOfCodeUnits(int tynto) {
            ...
            switch ((this.sz & 0xFF))
            {
                ...
                case 4:
                    {
                        int __key1238 = 0;
                        int __limit1239 = this.len;
                        for (; __key1238 < __limit1239;__key1238 += 1) {
                            int u_2 = __key1238;
        ...
        public  int charAt(long i) {
            ...
            switch ((this.sz & 0xFF))
            {
                case 1:
                    ...
                    break;
                case 2:
                    value = (int)(toPtr<Short>(this.string)).get((int)i);
                    break;
                case 4:
    ...
    public static class TupleExp extends Expression
    {
        ...
        public  TupleExp(Loc loc, TupleDeclaration tup) {
            ...
            {
                Slice<RootObject> __r1244 = (tup.objects).opSlice().copy();
                int __key1245 = 0;
                for (; __key1245 < __r1244.getLength();__key1245 += 1) {
                    RootObject o = __r1244.get(__key1245);
                    {
                ...
                if (e != null)
                    {
                        ...
                        if (te != null)
                        {
                            ...
                            if (((this.e0 != null && !(this.e0.equals(te.e0))) || (!(this.e0 != null) && te.e0 != null)))
                                return false;
                            {
                                Slice<Expression> __r1247 = (this.exps).opSlice().copy();
                                int __key1246 = 0;
                                for (; __key1246 < __r1247.getLength();__key1246 += 1) {
                                    Expression e1 = __r1247.get(__key1246);
                                    int i = __key1246;
        ...
        public  boolean equals(RootObject o) {
                ...
                return false;
            {
                ...
                if (ae != null)
                {
                    ...
                    {
                        Slice<Expression> __r1249 = (this.elements).opSlice().copy();
                        int __key1248 = 0;
                        for (; __key1248 < __r1249.getLength();__key1248 += 1) {
                            Expression e1 = __r1249.get(__key1248);
                            int i = __key1248;
            ...
            if (((((telem & 0xFF) == ENUMTY.Tchar || (telem & 0xFF) == ENUMTY.Twchar) || (telem & 0xFF) == ENUMTY.Tdchar) || ((telem & 0xFF) == ENUMTY.Tvoid && (this.elements == null || (this.elements).length == 0))))
            {
                ...
                try {
                    if (this.elements != null)
                    {
                        {
                            int __key1250 = 0;
                            int __limit1251 = (this.elements).length;
        ...
        public  boolean equals(RootObject o) {
                ...
                return false;
            {
                ...
                if (ae != null)
                {
                    ...
                    int count = 0;
                    {
                        Slice<Expression> __r1253 = (this.keys).opSlice().copy();
                        int __key1252 = 0;
                        for (; __key1252 < __r1253.getLength();__key1252 += 1) {
                            Expression key = __r1253.get(__key1252);
                            int i = __key1252;
                            {
                                Slice<Expression> __r1255 = (ae.keys).opSlice().copy();
                                int __key1254 = 0;
                                for (; __key1254 < __r1255.getLength();__key1254 += 1) {
                                    Expression akey = __r1255.get(__key1254);
                                    int j = __key1254;
                                    if (key.equals(akey))
                                    {
    ...
    public static class StructLiteralExp extends Expression
    {
                ...
                return false;
            {
                ...
                if (se != null)
                {
                    ...
                    if ((this.elements).length != (se.elements).length)
                        return false;
                    {
                        Slice<Expression> __r1257 = (this.elements).opSlice().copy();
                        int __key1256 = 0;
                        for (; __key1256 < __r1257.getLength();__key1256 += 1) {
                            Expression e1 = __r1257.get(__key1256);
                            int i = __key1256;
            ...
            if (i != -1)
            {
                ...
                if (e != null)
                {
                    ...
                    if ((tsa != null && !pequals(e.type.castMod((byte)0), type.castMod((byte)0))))
                    {
                        ...
                        {
                            Slice<Expression> __r1258 = (z).opSlice().copy();
                            int __key1259 = 0;
                            for (; __key1259 < __r1258.getLength();__key1259 += 1) {
                                Expression q = __r1258.get(__key1259);
                                q = e.copy();
                            }
                        }
        ...
        public  int getFieldIndex(Type type, int offset) {
            ...
            {
                {
                    Slice<VarDeclaration> __r1261 = this.sd.fields.opSlice().copy();
                    int __key1260 = 0;
                    for (; __key1260 < __r1261.getLength();__key1260 += 1) {
                        VarDeclaration v = __r1261.get(__key1260);
                        int i = __key1260;
        ...
        public  Expression addDtorHook(Scope sc) {
            if ((this.sd.dtor != null && (sc).func != null))
            {
                ...
                buf.set(10, (byte)0);
                strcpy(ptr(buf),  new ByteSlice("__sl"));
    ...
    public static class FuncExp extends Expression
    {
        ...
        public  int matchType(Type to, Scope sc, Ptr<FuncExp> presult, int flag) {
            ...
            if (this.td != null)
            {
                ...
                {
                    Slice<TemplateParameter> __r1262 = (this.td.parameters).opSlice().copy();
                    int __key1263 = 0;
                    for (; __key1263 < __r1262.getLength();__key1263 += 1) {
                        TemplateParameter tp = __r1262.get(__key1263);
                        int u = 0;
                        for (; u < dim;u++){
    ...
    public static class IsExp extends Expression
    {
        ...
        public  Expression syntaxCopy() {
            ...
            if (this.parameters != null)
            {
                ...
                {
                    Slice<TemplateParameter> __r1265 = (this.parameters).opSlice().copy();
                    int __key1264 = 0;
                    for (; __key1264 < __r1265.getLength();__key1264 += 1) {
                        TemplateParameter el = __r1265.get(__key1264);
                        int i = __key1264;
                ...
                return false;
            {
                ...
                if (ce != null)
                {
                    if ((this.exps).length != (ce.exps).length)
                        return false;
                    {
                        Slice<Expression> __r1267 = (this.exps).opSlice().copy();
                        int __key1266 = 0;
                        for (; __key1266 < __r1267.getLength();__key1266 += 1) {
                            Expression e1 = __r1267.get(__key1266);
                            int i = __key1266;
            ...
            {
                {
                    ...
                    if (vd != null)
                    {
                        ...
                        {
                            {
                                Slice<VarDeclaration> __r1269 = ad.fields.opSlice().copy();
                                int __key1268 = 0;
                                for (; __key1268 < __r1269.getLength();__key1268 += 1) {
                                    VarDeclaration f = __r1269.get(__key1268);
                                    int i = __key1268;
                                    if (pequals(f, vd))
                                    {
