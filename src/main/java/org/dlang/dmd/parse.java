...
public class parse {
    ...
    public static class ParserASTBase extends Lexer
    {
                            ...
                            switch (__dispatch1 != 0 ? __dispatch1 : (this.token.value & 0xFF))
                            {
                                ...
                                case 208:
                                    ...
                                    L_outer3:
                                                ...
                                                do {
                                                    switch (__dispatch3 != 0 ? __dispatch3 : (this.token.value & 0xFF))
                                                    {
                                                        ...
                                                        case 6:
                                                            ...
                                                            break;
                                                        case 11:
                                                            this.error(loc, new BytePtr("closing `}` of unittest not found before end of file"));
                                        ...
                                        s = new ASTBase.UnitTestDeclaration(loc, this.token.loc, 0L, null);
                                    }
                                    break;
                                case 22:
                                ...
                                case 225:
                                    {
                                        ...
                                        if ((stc) != 0)
                                            /*goto Lstc*/{ __dispatch1 = -3; continue dispatched_1; }
                                        (pAttrs).udas = ASTBase.UserAttributeDeclaration.concat((pAttrs).udas, exps.value);
                                ...
                                case 163:
                                    ...
                                    {
                                        if (e != null)
                                            this.error(new BytePtr("redundant alignment attribute `align(%s)`"), e.toChars());
                                        else
                                ...
                                case 40:
                                    ...
                                    s = new ASTBase.PragmaDeclaration(loc, ident, args, a2);
                                    break;
                                case 173:
                                    this.nextToken();
                                ...
                                __dispatch1 = 0;
                                    {
                                        ...
                                        s = new ASTBase.ConditionalDeclaration(condition, athen, aelse);
                                        break;
                                    }
                                case 9:
                                    this.nextToken();
                            ...
                            switch (__dispatch14 != 0 ? __dispatch14 : (this.token.value & 0xFF))
                            {
                                    ...
                                    if (maybeArray != null)
                                    {
                                        ...
                                        try {
                                            ...
                                            for (; true;){
                                                ...
                                                {
                                                    ASTBase.TypeAArray a = (ASTBase.TypeAArray)t;
                                ...
                                case 3:
                                    ...
                                    else
                                    {
                                        ...
                                        {
                                            maybeArray = new ASTBase.TypeSArray(t, e);
                                            this.inBrackets--;
                                            this.check(TOK.rightBracket);
                                            continue L_outer10;
                                        }
                        ...
                        case 176:
                            ...
                            if ((this.token.value & 0xFF) != 5)
                            {
                                ...
                                if ((this.token.value & 0xFF) == 9)
                                {
                                    ...
                                    this.check(TOK.rightParentheses);
                                    e = new ASTBase.AssertExp(loc, e, msg);
                                    (f.fensures).push(new ASTBase.Ensure(id, new ASTBase.ExpStatement(loc, e)));
                                    requireDo = false;
                                    /*goto L1*/throw Dispatch0.INSTANCE;
                                }
                                this.check(TOK.rightParentheses);
                    ...
                    switch (__dispatch27 != 0 ? __dispatch27 : (this.token.value & 0xFF))
                    {
                        ...
                        __dispatch27 = 0;
                            ...
                            }
                            {
                                ...
                                do {
                                    switch (__dispatch28 != 0 ? __dispatch28 : (this.token.value & 0xFF))
                                    {
                                        case 210:
                                            stc = 2097152L;
                                            /*goto LagainStc*/throw Dispatch.INSTANCE;
                                        case 179:
                                            stc = 256L;
                                            /*goto LagainStc*/throw Dispatch.INSTANCE;
                                        case 171:
                            ...
                            if (condition != null && ifbody != null)
                                s = new ASTBase.IfStatement(loc, param, condition, ifbody, elsebody, this.token.loc);
                            else
                                s = null;
                            break;
                        case 184:
                        ...
                        case 40:
                            ...
                            if ((this.token.value & 0xFF) == 9)
                            {
                                ...
                                _body = this.parseStatement(1, null, null);
                            s = new ASTBase.PragmaStatement(loc, ident, args, _body);
                            break;
                        case 188:
                            isfinal = false;
                            /*goto Lswitch*/{ __dispatch27 = -4; continue dispatched_27; }
                        ...
                        case 189:
                            ...
                            try {
                                ...
                                if (last != null)
                                {
                                    s = new ASTBase.CaseRangeStatement(loc, exp, last, s);
                                }
                                else
                                {
                                    {
                        ...
                        case 196:
                            ...
                            else if ((this.token.value & 0xFF) == 189)
                            {
                                ...
                                if ((this.token.value & 0xFF) != 9)
                                    exp = this.parseExpression();
                                s = new ASTBase.GotoCaseStatement(loc, exp);
                            }
                            else
                            {
                                if ((this.token.value & 0xFF) != 120)
                                ...
                                s = new ASTBase.GotoStatement(loc, ident);
                            }
                        ...
                        case 197:
                            ...
                            for (; (this.token.value & 0xFF) == 198;){
                                ...
                                else
                                {
                                    this.check(TOK.leftParentheses);
                                    id.value = null;
                                    t = this.parseType(ptr(id), null);
                                    this.check(TOK.rightParentheses);
                                }
                                handler = this.parseStatement(0, null, null);
                                c = new ASTBase.Catch(catchloc, t, id.value, handler);
                                if (catches == null)
                            ...
                            {
                                if (catches != null)
                                    s = new ASTBase.TryCatchStatement(loc, _body, catches);
                                if (finalbody != null)
                        ...
                        L_outer15:
                            ...
                            s = new ASTBase.CompoundAsmStatement(loc, statements, stc);
                            this.nextToken();
                            break;
                        case 157:
                            if ((this.peekNext() & 0xFF) == 1)
                                ...
                                for (; (1) != 0;t = this.peek(t)){
                                    {
                                        ...
                                        do {
                                            switch (__dispatch31 != 0 ? __dispatch31 : ((t).value & 0xFF))
                                            {
                                                ...
                                                case 193:
                                                    if (braces == 1)
                                                        /*goto Lexpression*/throw Dispatch.INSTANCE;
                                                    continue L_outer16;
                                                case 5:
                                                    braces++;
                                                    continue L_outer16;
        ...
        public  boolean isDeclaration(Token t, int needId, byte endtok, Ptr<Token> pt) {
            ...
            for (; (1) != 0;){
                if (((t).value & 0xFF) == 171 || ((t).value & 0xFF) == 182 || ((t).value & 0xFF) == 177 || ((t).value & 0xFF) == 224 && ((this.peek(t)).value & 0xFF) != 1)
                {
                    t = this.peek(t);
                    continue;
                }
                                    ...
                                    /*L4:*/
                                        t.value = this.peek(t.value);
                                        {
                                            ...
                                            do {
                                                ...
                                                {
                                                    case 120:
                                                        /*goto L5*/throw Dispatch.INSTANCE;
                                                    case 1:
                    ...
                    for (; (1) != 0;){
                        {
                            ...
                            dispatched_44:
                            do {
                                switch (__dispatch44 != 0 ? __dispatch44 : ((t).value & 0xFF))
                                {
                                    case 171:
                                    case 182:
                                    case 224:
                                    ...
                                    case 225:
                                        ...
                                        if (((t).value & 0xFF) == 120)
                                        {
                                            if ((t).ident.equals(Id.property) || (t).ident.equals(Id.nogc) || (t).ident.equals(Id.safe) || (t).ident.equals(Id.trusted) || (t).ident.equals(Id.system) || (t).ident.equals(Id.disable))
                                                break;
                                            t = this.peek(t);
                                            if (((t).value & 0xFF) == 91)
                                            {
                ...
                do {
                    ...
                    switch (__dispatch45 != 0 ? __dispatch45 : (this.token.value & 0xFF))
                    {
                        ...
                        case 218:
                            ...
                            break;
                        case 221:
                            BytePtr s = pcopy(this.md != null ? (this.md).toChars() : this.mod.toChars());
                            e = new ASTBase.StringExp(loc, s);
                            this.nextToken();
                            break;
                        case 222:
                        ...
                        case 122:
                            ...
                            e = new ASTBase.StringExp(loc, s, len, (byte)postfix);
                            break;
                        case 128:
                            t = ASTBase.Type.tvoid;
                        ...
                        case 63:
                            ...
                            if ((this.token.value & 0xFF) == 1)
                            {
                                ...
                                targ = this.parseType(ptr(ident), null);
                        ...
                        __dispatch45 = 0;
                            {
                                ASTBase.Dsymbol s = this.parseFunctionLiteral();
                                e = new ASTBase.FuncExp(loc, s);
                                break;
                            }
                        default:
            ...
            switch ((this.token.value & 0xFF))
            {
                ...
                case 182:
                    ...
                    else
                    {
                        ...
                        if ((this.token.value & 0xFF) != 1)
                        {
                            this.error(new BytePtr("`(arguments)` expected following `%s`"), t.toChars());
                            return e;
                        }
                        e = new ASTBase.CallExp(loc, e, this.parseArguments());
                    }
