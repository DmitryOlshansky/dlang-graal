...
public class id {
    ...
    public static class Id
    {
        ...
        public static void initialize() {
            ...
            Object.value = Identifier.idPool(new ByteSlice("Object"));
            object.value = Identifier.idPool(new ByteSlice("object"));
            ...
            max.value = Identifier.idPool(new ByteSlice("max"));
            min.value = Identifier.idPool(new ByteSlice("min"));
            This.value = Identifier.idPool(new ByteSlice("this"));
            _super.value = Identifier.idPool(new ByteSlice("super"));
            ctor.value = Identifier.idPool(new ByteSlice("__ctor"));
            dtor.value = Identifier.idPool(new ByteSlice("__dtor"));
            __xdtor.value = Identifier.idPool(new ByteSlice("__xdtor"));
            ...
            postblit.value = Identifier.idPool(new ByteSlice("__postblit"));
            __xpostblit.value = Identifier.idPool(new ByteSlice("__xpostblit"));
            ...
            _init.value = Identifier.idPool(new ByteSlice("init"));
            __sizeof.value = Identifier.idPool(new ByteSlice("sizeof"));
            __xalignof.value = Identifier.idPool(new ByteSlice("alignof"));
            _mangleof.value = Identifier.idPool(new ByteSlice("mangleof"));
            stringof.value = Identifier.idPool(new ByteSlice("stringof"));
            _tupleof.value = Identifier.idPool(new ByteSlice("tupleof"));
            length.value = Identifier.idPool(new ByteSlice("length"));
            remove = Identifier.idPool(new ByteSlice("remove"));
            ptr.value = Identifier.idPool(new ByteSlice("ptr"));
            array.value = Identifier.idPool(new ByteSlice("array"));
            funcptr.value = Identifier.idPool(new ByteSlice("funcptr"));
            dollar = Identifier.idPool(new ByteSlice("__dollar"));
            ctfe.value = Identifier.idPool(new ByteSlice("__ctfe"));
            offset = Identifier.idPool(new ByteSlice("offset"));
            offsetof.value = Identifier.idPool(new ByteSlice("offsetof"));
            ModuleInfo = Identifier.idPool(new ByteSlice("ModuleInfo"));
            ClassInfo = Identifier.idPool(new ByteSlice("ClassInfo"));
            classinfo.value = Identifier.idPool(new ByteSlice("classinfo"));
            typeinfo = Identifier.idPool(new ByteSlice("typeinfo"));
            outer.value = Identifier.idPool(new ByteSlice("outer"));
            Exception.value = Identifier.idPool(new ByteSlice("Exception"));
            RTInfo = Identifier.idPool(new ByteSlice("RTInfo"));
            Throwable.value = Identifier.idPool(new ByteSlice("Throwable"));
            Error = Identifier.idPool(new ByteSlice("Error"));
            withSym.value = Identifier.idPool(new ByteSlice("__withSym"));
            ...
            empty.value = Identifier.idPool(new ByteSlice(""));
            p.value = Identifier.idPool(new ByteSlice("p"));
            q = Identifier.idPool(new ByteSlice("q"));
            __vptr.value = Identifier.idPool(new ByteSlice("__vptr"));
            __monitor.value = Identifier.idPool(new ByteSlice("__monitor"));
            ...
            nan.value = Identifier.idPool(new ByteSlice("nan"));
            infinity.value = Identifier.idPool(new ByteSlice("infinity"));
            dig.value = Identifier.idPool(new ByteSlice("dig"));
            epsilon.value = Identifier.idPool(new ByteSlice("epsilon"));
            mant_dig.value = Identifier.idPool(new ByteSlice("mant_dig"));
            max_10_exp.value = Identifier.idPool(new ByteSlice("max_10_exp"));
            max_exp.value = Identifier.idPool(new ByteSlice("max_exp"));
            min_10_exp.value = Identifier.idPool(new ByteSlice("min_10_exp"));
            min_exp.value = Identifier.idPool(new ByteSlice("min_exp"));
            min_normal.value = Identifier.idPool(new ByteSlice("min_normal"));
            re.value = Identifier.idPool(new ByteSlice("re"));
            im.value = Identifier.idPool(new ByteSlice("im"));
            ...
            uadd.value = Identifier.idPool(new ByteSlice("opPos"));
            neg.value = Identifier.idPool(new ByteSlice("opNeg"));
            com.value = Identifier.idPool(new ByteSlice("opCom"));
            add.value = Identifier.idPool(new ByteSlice("opAdd"));
            add_r.value = Identifier.idPool(new ByteSlice("opAdd_r"));
            sub.value = Identifier.idPool(new ByteSlice("opSub"));
            sub_r.value = Identifier.idPool(new ByteSlice("opSub_r"));
            mul.value = Identifier.idPool(new ByteSlice("opMul"));
            mul_r.value = Identifier.idPool(new ByteSlice("opMul_r"));
            div.value = Identifier.idPool(new ByteSlice("opDiv"));
            div_r.value = Identifier.idPool(new ByteSlice("opDiv_r"));
            mod.value = Identifier.idPool(new ByteSlice("opMod"));
            mod_r.value = Identifier.idPool(new ByteSlice("opMod_r"));
            eq.value = Identifier.idPool(new ByteSlice("opEquals"));
            cmp.value = Identifier.idPool(new ByteSlice("opCmp"));
            iand.value = Identifier.idPool(new ByteSlice("opAnd"));
            iand_r.value = Identifier.idPool(new ByteSlice("opAnd_r"));
            ior.value = Identifier.idPool(new ByteSlice("opOr"));
            ior_r.value = Identifier.idPool(new ByteSlice("opOr_r"));
            ixor.value = Identifier.idPool(new ByteSlice("opXor"));
            ixor_r.value = Identifier.idPool(new ByteSlice("opXor_r"));
            shl.value = Identifier.idPool(new ByteSlice("opShl"));
            shl_r.value = Identifier.idPool(new ByteSlice("opShl_r"));
            shr.value = Identifier.idPool(new ByteSlice("opShr"));
            shr_r.value = Identifier.idPool(new ByteSlice("opShr_r"));
            ushr.value = Identifier.idPool(new ByteSlice("opUShr"));
            ushr_r.value = Identifier.idPool(new ByteSlice("opUShr_r"));
            cat.value = Identifier.idPool(new ByteSlice("opCat"));
            cat_r.value = Identifier.idPool(new ByteSlice("opCat_r"));
            assign.value = Identifier.idPool(new ByteSlice("opAssign"));
            addass.value = Identifier.idPool(new ByteSlice("opAddAssign"));
            subass.value = Identifier.idPool(new ByteSlice("opSubAssign"));
            mulass.value = Identifier.idPool(new ByteSlice("opMulAssign"));
            divass.value = Identifier.idPool(new ByteSlice("opDivAssign"));
            modass.value = Identifier.idPool(new ByteSlice("opModAssign"));
            andass.value = Identifier.idPool(new ByteSlice("opAndAssign"));
            orass.value = Identifier.idPool(new ByteSlice("opOrAssign"));
            xorass.value = Identifier.idPool(new ByteSlice("opXorAssign"));
            shlass.value = Identifier.idPool(new ByteSlice("opShlAssign"));
            shrass.value = Identifier.idPool(new ByteSlice("opShrAssign"));
            ushrass.value = Identifier.idPool(new ByteSlice("opUShrAssign"));
            catass.value = Identifier.idPool(new ByteSlice("opCatAssign"));
            postinc.value = Identifier.idPool(new ByteSlice("opPostInc"));
            postdec.value = Identifier.idPool(new ByteSlice("opPostDec"));
            index.value = Identifier.idPool(new ByteSlice("opIndex"));
            indexass = Identifier.idPool(new ByteSlice("opIndexAssign"));
            slice.value = Identifier.idPool(new ByteSlice("opSlice"));
            sliceass = Identifier.idPool(new ByteSlice("opSliceAssign"));
            call.value = Identifier.idPool(new ByteSlice("opCall"));
            _cast.value = Identifier.idPool(new ByteSlice("opCast"));
            opIn.value = Identifier.idPool(new ByteSlice("opIn"));
            opIn_r.value = Identifier.idPool(new ByteSlice("opIn_r"));
            opStar.value = Identifier.idPool(new ByteSlice("opStar"));
            opDot.value = Identifier.idPool(new ByteSlice("opDot"));
            opDispatch.value = Identifier.idPool(new ByteSlice("opDispatch"));
            opDollar = Identifier.idPool(new ByteSlice("opDollar"));
            opUnary.value = Identifier.idPool(new ByteSlice("opUnary"));
            opIndexUnary.value = Identifier.idPool(new ByteSlice("opIndexUnary"));
            opSliceUnary.value = Identifier.idPool(new ByteSlice("opSliceUnary"));
            opBinary.value = Identifier.idPool(new ByteSlice("opBinary"));
            opBinaryRight.value = Identifier.idPool(new ByteSlice("opBinaryRight"));
            opOpAssign.value = Identifier.idPool(new ByteSlice("opOpAssign"));
            opIndexOpAssign.value = Identifier.idPool(new ByteSlice("opIndexOpAssign"));
            opSliceOpAssign.value = Identifier.idPool(new ByteSlice("opSliceOpAssign"));
            pow.value = Identifier.idPool(new ByteSlice("opPow"));
            pow_r.value = Identifier.idPool(new ByteSlice("opPow_r"));
            powass.value = Identifier.idPool(new ByteSlice("opPowAssign"));
            ...
            aaLen.value = Identifier.idPool(new ByteSlice("_aaLen"));
            ...
            __ArrayEq.value = Identifier.idPool(new ByteSlice("__ArrayEq"));
            ...
            dup.value = Identifier.idPool(new ByteSlice("dup"));
            ...
            parent.value = Identifier.idPool(new ByteSlice("parent"));
            getMember.value = Identifier.idPool(new ByteSlice("getMember"));
            getOverloads.value = Identifier.idPool(new ByteSlice("getOverloads"));
            getVirtualFunctions.value = Identifier.idPool(new ByteSlice("getVirtualFunctions"));
            getVirtualMethods.value = Identifier.idPool(new ByteSlice("getVirtualMethods"));
            classInstanceSize = Identifier.idPool(new ByteSlice("classInstanceSize"));
            allMembers.value = Identifier.idPool(new ByteSlice("allMembers"));
            derivedMembers.value = Identifier.idPool(new ByteSlice("derivedMembers"));
            ...
            getAliasThis.value = Identifier.idPool(new ByteSlice("getAliasThis"));
            getAttributes.value = Identifier.idPool(new ByteSlice("getAttributes"));
            ...
            getUnitTests.value = Identifier.idPool(new ByteSlice("getUnitTests"));
        ...
        public static void deinitialize() {
            ...
            _init.value = null;
            __sizeof.value = null;
            __xalignof.value = null;
            _mangleof.value = null;
            stringof.value = null;
            _tupleof.value = null;
            length.value = null;
            remove = null;
            ...
            epsilon.value = null;
            mant_dig.value = null;
            max_10_exp.value = null;
            max_exp.value = null;
            min_10_exp.value = null;
            min_exp.value = null;
            min_normal.value = null;
            re.value = null;
            im.value = null;
            C = null;
            D = null;
            ...
            opStar.value = null;
            opDot.value = null;
            opDispatch.value = null;
            opDollar = null;
            opUnary.value = null;
            opIndexUnary.value = null;
            opSliceUnary.value = null;
            opBinary.value = null;
            opBinaryRight.value = null;
            opOpAssign.value = null;
            opIndexOpAssign.value = null;
            opSliceOpAssign.value = null;
            pow.value = null;
            pow_r.value = null;
            powass.value = null;
            classNew = null;
            ...
            getProtection = null;
            parent.value = null;
            getMember.value = null;
            getOverloads.value = null;
            getVirtualFunctions.value = null;
            getVirtualMethods.value = null;
            classInstanceSize = null;
            allMembers.value = null;
            derivedMembers.value = null;
            isSame = null;
            compiles = null;
            parameters = null;
            getAliasThis.value = null;
            getAttributes.value = null;
            getFunctionAttributes = null;
            getFunctionVariadicStyle = null;
            getParameterStorageClasses = null;
            getLinkage = null;
            getUnitTests.value = null;
    ...
    public static ByteSlice generate(Slice<Msgtable> msgtable, Function1<Msgtable,ByteSlice> dg) {
        ...
        {
            Slice<Msgtable> __r88 = msgtable.copy();
            int __key87 = 0;
            for (; (__key87 < __r88.getLength());__key87 += 1) {
