...
public class mtype {
    ...
    public static abstract class Type extends ASTNode
    {
        ...
        public  boolean checkAliasThisRec() {
            ...
            if (((tb.ty & 0xFF) == ENUMTY.Tstruct))
                pflag = pcopy((ptr(((TypeStruct)tb).att.value)));
            else if (((tb.ty & 0xFF) == ENUMTY.Tclass))
                pflag = pcopy((ptr(((TypeClass)tb).att.value)));
            else
                return false;
    ...
    public static abstract class TypeNext extends Type implements LinkedNode<Type>
    {
        ...
        public  void checkDeprecated(Loc loc, Ptr<Scope> sc) {
            ...
            if (this.next != null)
                this.next.checkDeprecated(loc, sc);
        }
        ...
        public  int hasWild() {
            ...
            if (((this.ty & 0xFF) == ENUMTY.Tdelegate))
                return this.hasWild();
            return (((((this.mod & 0xFF) & MODFlags.wild) != 0) || (this.next != null) && (this.next.hasWild() != 0)) ? 1 : 0);
        }
        ...
        public  Type makeConst() {
            ...
            if (((this.ty & 0xFF) != ENUMTY.Tfunction) && ((this.next.ty & 0xFF) != ENUMTY.Tfunction) && !this.next.isImmutable())
            {
                if (this.next.isShared())
                {
                    if (this.next.isWild())
                        t.next = this.next.sharedWildConstOf();
                    else
                        t.next = this.next.sharedConstOf();
                }
                else
                {
                    if (this.next.isWild())
                        t.next = this.next.wildConstOf();
                    else
                        t.next = this.next.constOf();
                }
            }
            return t;
        }
        ...
        public  Type makeShared() {
            ...
            if (((this.ty & 0xFF) != ENUMTY.Tfunction) && ((this.next.ty & 0xFF) != ENUMTY.Tfunction) && !this.next.isImmutable())
            {
                if (this.next.isWild())
                {
                    if (this.next.isConst())
                        t.next = this.next.sharedWildConstOf();
                    else
                        t.next = this.next.sharedWildOf();
                }
                else
                {
                    if (this.next.isConst())
        ...
        public  int constConv(Type to) {
            ...
            if (!(((this.ty & 0xFF) == (to.ty & 0xFF)) && MODimplicitConv(this.mod, to.mod)))
                return MATCH.nomatch;
            Type tn = to.nextOf();
            if (!((tn != null) && ((this.next.ty & 0xFF) == (tn.ty & 0xFF))))
                return MATCH.nomatch;
            int m = MATCH.nomatch;
            if (to.isConst())
            {
                m = this.next.constConv(tn);
                if ((m == MATCH.exact))
                    m = MATCH.constant;
            }
            else
            {
                m = this.next.equals(tn) ? MATCH.constant : MATCH.nomatch;
            }
            return m;
        }
        ...
        public  byte deduceWild(Type t, boolean isRef) {
            ...
            {
                wm = this.next.deduceWild(tn, true);
                if (wm == 0)
        ...
        public  void transitive() {
            this.next = this.next.addMod(this.mod);
        }
    ...
    public static abstract class TypeArray extends TypeNext implements LinkedNode<Type>
    {
    ...
    public static class TypeSArray extends TypeArray implements LinkedNode<Type>
    {
        ...
        public  int alignsize() {
            return this.next.alignsize();
        }

        public  boolean isString() {
            byte nty = this.next.toBasetype().ty;
            return ((nty & 0xFF) == ENUMTY.Tchar) || ((nty & 0xFF) == ENUMTY.Twchar) || ((nty & 0xFF) == ENUMTY.Tdchar);
        }

        public  boolean isZeroInit(Loc loc) {
            return this.next.isZeroInit(loc);
        }

        public  int alignment() {
            return this.next.alignment();
        }
        ...
        public  int implicitConvTo(Type to) {
            {
                ...
                if ((ta) != null)
                {
                    if (!MODimplicitConv(this.next.mod, ta.next.mod))
                        return MATCH.nomatch;
                    if (((ta.next.ty & 0xFF) == ENUMTY.Tvoid))
                    {
                        return MATCH.convert;
                    }
                    int m = this.next.constConv(ta.next);
                    if ((m > MATCH.nomatch))
                    {
                        return MATCH.convert;
                    }
            ...
            }
            {
                ...
                if ((tsa) != null)
                {
                    ...
                    if (this.dim.equals(tsa.dim))
                    {
                        int m = this.next.implicitConvTo(tsa.next);
                        if ((m >= MATCH.constant))
                        {
                            if (((this.mod & 0xFF) != (to.mod & 0xFF)))
                                m = MATCH.constant;
        ...
        public  boolean hasPointers() {
            if (((this.next.ty & 0xFF) == ENUMTY.Tvoid))
            {
                ...
                return this.next.hasPointers();
        }

        public  boolean needsDestruction() {
            return this.next.needsDestruction();
        }

        public  boolean needsNested() {
            return this.next.needsNested();
        }
        ...
        public  int implicitConvTo(Type to) {
                ...
                return MATCH.exact;
            {
                ...
                if ((ta) != null)
                {
                    if (!MODimplicitConv(this.next.mod, ta.next.mod))
                        return MATCH.nomatch;
                    if (((this.next.ty & 0xFF) != ENUMTY.Tvoid) && ((ta.next.ty & 0xFF) == ENUMTY.Tvoid))
                    {
                        return MATCH.convert;
                    }
                    int m = this.next.constConv(ta.next);
        ...
        public  int constConv(Type to) {
            {
                ...
                if ((taa) != null)
                {
                    ...
                    int mkey = this.next.constConv(taa.next);
    ...
    public static class TypePointer extends TypeNext implements LinkedNode<Type>
    {
        ...
        public  int implicitConvTo(Type to) {
            if (this.equals(to))
                return MATCH.exact;
            if (((this.next.ty & 0xFF) == ENUMTY.Tfunction))
            {
                {
                    TypePointer tp = to.isTypePointer();
                    if ((tp) != null)
                    {
                        if (((tp.next.ty & 0xFF) == ENUMTY.Tfunction))
                        {
                            if (this.next.equals(tp.next))
                                return MATCH.constant;
                            if ((this.next.covariant(tp.next, null, true) == 1))
                            {
                        ...
                        else if (((tp.next.ty & 0xFF) == ENUMTY.Tvoid))
                        {
                            return MATCH.convert;
                        }
                    }
                ...
                {
                    assert(tp.next != null);
                    if (!MODimplicitConv(this.next.mod, tp.next.mod))
                        return MATCH.nomatch;
                    if (((this.next.ty & 0xFF) != ENUMTY.Tvoid) && ((tp.next.ty & 0xFF) == ENUMTY.Tvoid))
                    {
                        return MATCH.convert;
                    }
                    int m = this.next.constConv(tp.next);
                    if ((m > MATCH.nomatch))
                    {
                        if ((m == MATCH.exact) && ((this.mod & 0xFF) != (to.mod & 0xFF)))
                            m = MATCH.constant;
        ...
        public  int constConv(Type to) {
            if (((this.next.ty & 0xFF) == ENUMTY.Tfunction))
            {
                if ((to.nextOf() != null) && this.next.equals(((TypeNext)to).next))
                    return this.constConv(to);
                else
                    return MATCH.nomatch;
            }
    ...
    public static class TypeFunction extends TypeNext implements LinkedNode<Type>
    {
        ...
        public  void purityLevel() {
            ...
            Function2<Boolean,Type,Integer> purityOfType = new Function2<Boolean,Type,Integer>(){
                public Integer invoke(Boolean isref, Type t) {
                    ...
                    {
                        Ref<Type> tn = ref(t_ref.value.nextOf().toBasetype());
                        if (((tn.value.mod & 0xFF) & MODFlags.immutable_) != 0)
                            return PURE.strong;
                        if (((tn.value.mod & 0xFF) & MODFlags.wildconst) != 0)
                            return PURE.const_;
                    }
                    if (((t_ref.value.mod & 0xFF) & MODFlags.wildconst) != 0)
                        return PURE.const_;
        ...
        public  Type addStorageClass(long stc) {
            ...
            {
                TypeFunction tf = new TypeFunction(t.parameterList, t.next, t.linkage, 0L);
                tf.mod = t.mod;
                tf.fargs = this.fargs;
                tf.purity = t.purity;
        ...
        public  Type substWildTo(int _param_0) {
            ...
            if ((pequals(this.next, tret)) && (params == this.parameterList.parameters))
                return this;
                                ...
                                else
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        if ((argStruct != null) && (pequals(argStruct, prmStruct)) && argStruct.hasCopyCtor)
                                        {
                                            ...
                                            Expression e = new DotIdExp(arg.loc, ve, Id.ctor.value);
    ...
    public static class TypeDelegate extends TypeNext implements LinkedNode<Type>
    {
        ...
        public  Type addStorageClass(long stc) {
            ...
            if ((stc & 524288L) != 0)
            {
                Type n = t.next.addStorageClass(562949953945600L);
                if ((!pequals(n, t.next)))
                {
                    t.next = n;
                    t.deco = pcopy(merge(t).deco);
    ...
    public static class TypeStruct extends Type
    {
        ...
        public  int alignsize() {
            this.sym.size(Loc.initial.value);
        ...
        public  Expression defaultInitLiteral(Loc loc) {
            ...
            if ((this.sym.sizeok != Sizeok.done))
                return new ErrorExp();
            Ptr<DArray<Expression>> structelems = new DArray<Expression>(this.sym.nonHiddenFields());
            int offset = 0;
            {
                int __key1515 = 0;
                int __limit1516 = (structelems.get()).length;
        ...
        public  boolean hasPointers() {
            ...
            if ((this.sym.members != null) && !this.sym.determineFields() && (!pequals(this.sym.type, Type.terror.value)))
    ...
    public static class TypeEnum extends Type
    {
        ...
        public  int implicitConvTo(Type to) {
            ...
            else if (this.sym.getMemtype(Loc.initial.value).implicitConvTo(to) != 0)
                m = MATCH.convert;
            else
                m = MATCH.nomatch;
            return m;
        ...
        public  Type toBasetype() {
            if ((this.sym.members == null) && (this.sym.memtype == null))
                return this;
            Type tb = this.sym.getMemtype(Loc.initial.value).toBasetype();
    ...
    public static class TypeTuple extends Type
    {
        ...
        public  TypeTuple() {
            super((byte)37);
            this.arguments = new DArray<Parameter>();
        }
    ...
    public static class Parameter extends ASTNode
    {
        ...
        public static Ptr<DArray<Parameter>> arraySyntaxCopy(Ptr<DArray<Parameter>> parameters) {
            ...
            if (parameters != null)
            {
                params = new DArray<Parameter>((parameters.get()).length);
                {
                    int i = 0;
                    for (; (i < (params.get()).length);i++) {
        ...
        public static int _foreach(Ptr<DArray<Parameter>> parameters, Function2<Integer,Parameter,Integer> dg, IntPtr pn) {
            ...
            {
                int __key1521 = 0;
                int __limit1522 = (parameters.get()).length;
