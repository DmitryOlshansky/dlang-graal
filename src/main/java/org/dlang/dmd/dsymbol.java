...
public class dsymbol {
    ...
    public static class Dsymbol extends ASTNode
    {
        ...
        public  BytePtr toPrettyChars(boolean QualifyTypes) {
            ...
            Ptr<ByteSlice> compptr = pcopy(toPtr<ByteSlice>(malloc(complength * 8)));
            if (compptr == null)
                Mem.error();
            ...
            BytePtr s = pcopy(toBytePtr(Mem.xmalloc(length)));
    ...
    public static class ScopeDsymbol extends Dsymbol
    {
        ...
        public  void importScope(Dsymbol s, Prot protection) {
            if (!pequals(s, this))
            {
                ...
                this.prots = pcopy((toIntPtr(Mem.xrealloc(this.prots, (this.importedScopes).length * 4))));
