...
public class hdrgen {
    ...
    public static void genhdrfile(Module m) {
        OutBuffer buf = new OutBuffer();
        try {
            buf.doindent = true;
            buf.printf( new ByteSlice("// D import file generated from '%s'"), m.srcfile.toChars());
            buf.writenl();
    ...
    public static void moduleToBuffer(OutBuffer buf, Module m) {
        HdrGenState hgs = new HdrGenState();
        hgs.fullDump = true;
        toCBuffer((Dsymbol)m, buf, hgs);
    }

    public static void moduleToBuffer2(Module m, OutBuffer buf, HdrGenState hgs) {
        if (m.md != null)
        {
        ...
        {
            Slice<Dsymbol> __r1335 = (m.members).opSlice().copy();
            int __key1336 = 0;
            for (; __key1336 < __r1335.getLength();__key1336 += 1) {
                Dsymbol s = __r1335.get(__key1336);
    ...
    public static class StatementPrettyPrintVisitor extends Visitor
    {
        ...
        public  void visit(CompoundStatement s) {
            {
                Slice<Statement> __r1337 = (s.statements).opSlice().copy();
                int __key1338 = 0;
                for (; __key1338 < __r1337.getLength();__key1338 += 1) {
                    Statement sx = __r1337.get(__key1338);
                    if (sx != null)
                        sx.accept(this);
                }
            }
        ...
        public  void visit(CompoundDeclarationStatement s) {
            ...
            {
                Slice<Statement> __r1339 = (s.statements).opSlice().copy();
                int __key1340 = 0;
                for (; __key1340 < __r1339.getLength();__key1340 += 1) {
                    Statement sx = __r1339.get(__key1340);
        ...
        public  void visit(UnrolledLoopStatement s) {
            ...
            (this.buf).level++;
            {
                Slice<Statement> __r1341 = (s.statements).opSlice().copy();
                int __key1342 = 0;
                for (; __key1342 < __r1341.getLength();__key1342 += 1) {
                    Statement sx = __r1341.get(__key1342);
                    if (sx != null)
                        sx.accept(this);
                }
            }
        ...
        public  void foreachWithoutBody(ForeachStatement s) {
            ...
            (this.buf).writestring( new ByteSlice(" ("));
            {
                Slice<Parameter> __r1344 = (s.parameters).opSlice().copy();
                int __key1343 = 0;
                for (; __key1343 < __r1344.getLength();__key1343 += 1) {
                    Parameter p = __r1344.get(__key1343);
                    int i = __key1343;
                    if ((i) != 0)
                        (this.buf).writestring( new ByteSlice(", "));
        ...
        public  void visit(TryCatchStatement s) {
            ...
            {
                Slice<Catch> __r1345 = (s.catches).opSlice().copy();
                int __key1346 = 0;
                for (; __key1346 < __r1345.getLength();__key1346 += 1) {
                    Catch c = __r1345.get(__key1346);
                    this.visit(c);
                }
            }
        }
        ...
        public  void visit(ImportStatement s) {
            {
                Slice<Dsymbol> __r1347 = (s.imports).opSlice().copy();
                int __key1348 = 0;
                for (; __key1348 < __r1347.getLength();__key1348 += 1) {
                    Dsymbol imp = __r1347.get(__key1348);
    ...
    public static class DsymbolPrettyPrintVisitor extends Visitor
    {
        ...
        public  void visit(Import imp) {
            ...
            if (imp.aliasId != null)
            {
                (this.buf).printf( new ByteSlice("%s = "), imp.aliasId.toChars());
            }
            if ((imp.packages != null && ((imp.packages).length) != 0))
            {
                {
                    Slice<Identifier> __r1349 = (imp.packages).opSlice().copy();
                    int __key1350 = 0;
                    for (; __key1350 < __r1349.getLength();__key1350 += 1) {
                        Identifier pid = __r1349.get(__key1350);
                        (this.buf).printf( new ByteSlice("%s."), pid.toChars());
                    }
                }
            }
            ...
            if ((imp.names.length) != 0)
            {
                (this.buf).writestring( new ByteSlice(" : "));
                {
                    Slice<Identifier> __r1352 = imp.names.opSlice().copy();
                    int __key1351 = 0;
                    for (; __key1351 < __r1352.getLength();__key1351 += 1) {
                        Identifier name = __r1352.get(__key1351);
                        int i = __key1351;
                        if ((i) != 0)
                            (this.buf).writestring( new ByteSlice(", "));
                        Identifier _alias = imp.aliases.get(i);
                        if (_alias != null)
                            (this.buf).printf( new ByteSlice("%s = %s"), _alias.toChars(), name.toChars());
                        else
        ...
        public  void visit(AttribDeclaration d) {
            ...
            else
            {
                ...
                (this.buf).level++;
                {
                    Slice<Dsymbol> __r1353 = (d.decl).opSlice().copy();
                    int __key1354 = 0;
                    for (; __key1354 < __r1353.getLength();__key1354 += 1) {
                        Dsymbol de = __r1353.get(__key1354);
                        de.accept(this);
                    }
                }
                (this.buf).level--;
        ...
        public  void visit(AlignDeclaration d) {
            ...
            if (d.ealign != null)
                (this.buf).printf( new ByteSlice("(%s) "), d.ealign.toChars());
            this.visit((AttribDeclaration)d);
        }
        ...
        public  void visit(AnonDeclaration d) {
            ...
            {
                {
                    Slice<Dsymbol> __r1355 = (d.decl).opSlice().copy();
                    int __key1356 = 0;
                    for (; __key1356 < __r1355.getLength();__key1356 += 1) {
                        Dsymbol de = __r1355.get(__key1356);
                        de.accept(this);
                    }
                }
            }
        ...
        public  void visit(ConditionalDeclaration d) {
            ...
            if ((d.decl != null || d.elsedecl != null))
            {
                ...
                {
                    {
                        Slice<Dsymbol> __r1357 = (d.decl).opSlice().copy();
                        int __key1358 = 0;
                        for (; __key1358 < __r1357.getLength();__key1358 += 1) {
                            Dsymbol de = __r1357.get(__key1358);
                            de.accept(this);
                        }
                    }
                }
                ...
                if (d.elsedecl != null)
                {
                    ...
                    (this.buf).level++;
                    {
                        Slice<Dsymbol> __r1359 = (d.elsedecl).opSlice().copy();
                        int __key1360 = 0;
                        for (; __key1360 < __r1359.getLength();__key1360 += 1) {
                            Dsymbol de = __r1359.get(__key1360);
                            de.accept(this);
                        }
                    }
                    (this.buf).level--;
        ...
        public  void visit(StaticForeachDeclaration s) {
            Function1<ForeachStatement,Void> foreachWithoutBody = new Function1<ForeachStatement,Void>(){
                public Void invoke(ForeachStatement s){
                    ...
                    (buf).writestring( new ByteSlice(" ("));
                    {
                        Slice<Parameter> __r1362 = (s.parameters).opSlice().copy();
                        int __key1361 = 0;
                        for (; __key1361 < __r1362.getLength();__key1361 += 1) {
                            Parameter p = __r1362.get(__key1361);
                            int i = __key1361;
                            if ((i) != 0)
                                (buf).writestring( new ByteSlice(", "));
        ...
        public  void visit(TemplateDeclaration d) {
            ...
            if (((this.hgs).hdrgen || (this.hgs).fullDump))
            {
                ...
                (this.buf).level++;
                {
                    Slice<Dsymbol> __r1363 = (d.members).opSlice().copy();
                    int __key1364 = 0;
                    for (; __key1364 < __r1363.getLength();__key1364 += 1) {
                        Dsymbol s = __r1363.get(__key1364);
                        s.accept(this);
                    }
                }
                (this.buf).level--;
            ...
            }
            {
                ...
                if (ad != null)
                {
                    ...
                    if (ad.members != null)
                    {
                        ...
                        (this.buf).level++;
                        {
                            Slice<Dsymbol> __r1365 = (ad.members).opSlice().copy();
                            int __key1366 = 0;
                            for (; __key1366 < __r1365.getLength();__key1366 += 1) {
                                Dsymbol s = __r1365.get(__key1366);
                                s.accept(this);
                            }
                        }
                        (this.buf).level--;
        ...
        public  void visitTemplateParameters(DArray<TemplateParameter> parameters) {
            if ((parameters == null || !(((parameters).length) != 0)))
                return ;
            {
                Slice<TemplateParameter> __r1368 = (parameters).opSlice().copy();
                int __key1367 = 0;
                for (; __key1367 < __r1368.getLength();__key1367 += 1) {
                    TemplateParameter p = __r1368.get(__key1367);
                    int i = __key1367;
                    if ((i) != 0)
                        (this.buf).writestring( new ByteSlice(", "));
        ...
        public  void visit(TemplateMixin tm) {
            ...
            if ((tm.ident != null && memcmp(tm.ident.toChars(),  new ByteSlice("__mixin"), 7) != 0))
            {
                (this.buf).writeByte(32);
        ...
        public  void visit(EnumDeclaration d) {
            ...
            try {
                ...
                (this.buf).level++;
                {
                    Slice<Dsymbol> __r1369 = (d.members).opSlice().copy();
                    int __key1370 = 0;
                    for (; __key1370 < __r1369.getLength();__key1370 += 1) {
                        Dsymbol em = __r1369.get(__key1370);
                        if (!(em != null))
                            continue;
                        em.accept(this);
        ...
        public  void visit(Nspace d) {
            ...
            (this.buf).level++;
            {
                Slice<Dsymbol> __r1371 = (d.members).opSlice().copy();
                int __key1372 = 0;
                for (; __key1372 < __r1371.getLength();__key1372 += 1) {
                    Dsymbol s = __r1371.get(__key1372);
                    s.accept(this);
                }
            }
            (this.buf).level--;
        ...
        public  void visit(StructDeclaration d) {
            ...
            (this.buf).level++;
            {
                Slice<Dsymbol> __r1373 = (d.members).opSlice().copy();
                int __key1374 = 0;
                for (; __key1374 < __r1373.getLength();__key1374 += 1) {
                    Dsymbol s = __r1373.get(__key1374);
                    s.accept(this);
                }
            }
            (this.buf).level--;
        ...
        public  void visit(ClassDeclaration d) {
            ...
            if (d.members != null)
            {
                ...
                (this.buf).level++;
                {
                    Slice<Dsymbol> __r1375 = (d.members).opSlice().copy();
                    int __key1376 = 0;
                    for (; __key1376 < __r1375.getLength();__key1376 += 1) {
                        Dsymbol s = __r1375.get(__key1376);
                        s.accept(this);
                    }
                }
                (this.buf).level--;
        ...
        public  void visitBaseClasses(ClassDeclaration d) {
            ...
            if (!(d.isAnonymous()))
                (this.buf).writestring( new ByteSlice(" : "));
            {
                Slice<BaseClass> __r1378 = (d.baseclasses).opSlice().copy();
                int __key1377 = 0;
                for (; __key1377 < __r1378.getLength();__key1377 += 1) {
                    BaseClass b = __r1378.get(__key1377);
                    int i = __key1377;
                    if ((i) != 0)
                        (this.buf).writestring( new ByteSlice(", "));
        ...
        public  void bodyToBuffer(FuncDeclaration f) {
            ...
            {
                {
                    Slice<Statement> __r1379 = (f.frequires).opSlice().copy();
                    int __key1380 = 0;
                    for (; __key1380 < __r1379.getLength();__key1380 += 1) {
                        Statement frequire = __r1379.get(__key1380);
            ...
            {
                {
                    Slice<Ensure> __r1381 = (f.fensures).opSlice().copy();
                    int __key1382 = 0;
                    for (; __key1382 < __r1381.getLength();__key1382 += 1) {
                        Ensure fensure = __r1381.get(__key1382).copy();
    ...
    public static class ExpressionPrettyPrintVisitor extends Visitor
    {
        ...
        public  void visit(IntegerExp e) {
            ...
            /*L1:*/
                        ...
                        switch (__dispatch1 != 0 ? __dispatch1 : (t.ty & 0xFF))
                        {
                            case 9:
                                ...
                                if ((this.hgs).fullDump)
                                {
                                    ...
                                    {
                                        int __key1383 = 0;
                                        int __limit1384 = (sym.members).length;
                                        for (; __key1383 < __limit1384;__key1383 += 1) {
                                            int i = __key1383;
                                            EnumMember em = (EnumMember)(sym.members).get(i);
                                            if (em.value().toInteger() == v)
                                            {
                                                (this.buf).printf( new ByteSlice("%s.%s"), sym.toChars(), em.ident.toChars());
                                                return ;
                                            }
                                        }
                                    }
                                }
                                (this.buf).printf( new ByteSlice("cast(%s)"), te.sym.toChars());
                                t = te.sym.memtype;
                            ...
                            case 33:
                                if (v > 255L)
                                {
                                    (this.buf).printf( new ByteSlice("'\\U%08x'"), v);
                                    break;
                                }
                            case 31:
                                ...
                                if (v == 39L)
                                    ...
                                    (this.buf).printf( new ByteSlice("'%c'"), (int)v);
                                else
                                    (this.buf).printf( new ByteSlice("'\\x%02x'"), (int)v);
                                if ((this.hgs).ddoc)
                            ...
                            case -1:
                            __dispatch1 = 0;
                                (this.buf).printf( new ByteSlice("%d"), (int)v);
                                break;
                            case 14:
                            ...
                            case 18:
                                __dispatch1 = 0;
                                (this.buf).printf( new ByteSlice("%uu"), (int)v);
                                break;
                            case 19:
                                (this.buf).printf( new ByteSlice("%lldL"), v);
                                break;
                            case 20:
                                __dispatch1 = 0;
                                (this.buf).printf( new ByteSlice("%lluLU"), v);
                                break;
                            case 30:
                ...
                (this.buf).printf( new ByteSlice("0x%llx"), v);
            else
                (this.buf).print(v);
        }
                            ...
                            switch (__dispatch3 != 0 ? __dispatch3 : c)
                            {
                                ...
                                if (c <= 255)
                                {
                                    if ((c <= 127 && (isprint(c)) != 0))
                                        ...
                                        (this.buf).printf( new ByteSlice("\\x%02x"), c);
                                }
                                else if (c <= 65535)
                                    (this.buf).printf( new ByteSlice("\\x%02x\\x%02x"), c & 255, c >> 8);
                                else
                                    (this.buf).printf( new ByteSlice("\\x%02x\\x%02x\\x%02x\\x%02x"), c & 255, c >> 8 & 255, c >> 16 & 255, c >> 24);
                                break;
                            }
                        } while(__dispatch3 != 0);
                    }
        ...
        public  void visit(AssocArrayLiteralExp e) {
            (this.buf).writeByte(91);
            {
                Slice<Expression> __r1386 = (e.keys).opSlice().copy();
                int __key1385 = 0;
                for (; __key1385 < __r1386.getLength();__key1385 += 1) {
                    Expression key = __r1386.get(__key1385);
                    int i = __key1385;
                    if ((i) != 0)
                        (this.buf).writestring( new ByteSlice(", "));
        ...
        public  void visit(SymOffExp e) {
            if ((e.offset) != 0)
                (this.buf).printf( new ByteSlice("(& %s+%u)"), e.var.toChars(), e.offset);
            else if (e.var.isTypeInfoDeclaration() != null)
                (this.buf).writestring(e.var.toChars());
            else
                (this.buf).printf( new ByteSlice("& %s"), e.var.toChars());
        }
        ...
        public  void visit(TraitsExp e) {
            ...
            {
                {
                    Slice<RootObject> __r1387 = (e.args).opSlice().copy();
                    int __key1388 = 0;
                    for (; __key1388 < __r1387.getLength();__key1388 += 1) {
                        RootObject arg = __r1387.get(__key1388);
                        (this.buf).writestring( new ByteSlice(", "));
        ...
        public  void visit(IsExp e) {
            ...
            if ((e.tok2 & 0xFF) != 0)
            {
                (this.buf).printf( new ByteSlice(" %s %s"), Token.toChars(e.tok), Token.toChars(e.tok2));
            }
    ...
    public static void argExpTypesToCBuffer(OutBuffer buf, DArray<Expression> arguments) {
        ...
        HdrGenState hgs = new HdrGenState();
        {
            Slice<Expression> __r1390 = (arguments).opSlice().copy();
            int __key1389 = 0;
            for (; __key1389 < __r1390.getLength();__key1389 += 1) {
                Expression arg = __r1390.get(__key1389);
                int i = __key1389;
                if ((i) != 0)
                    (buf).writestring( new ByteSlice(", "));
    ...
    public static void arrayObjectsToBuffer(OutBuffer buf, DArray<RootObject> objects) {
        ...
        HdrGenState hgs = new HdrGenState();
        {
            Slice<RootObject> __r1392 = (objects).opSlice().copy();
            int __key1391 = 0;
            for (; __key1391 < __r1392.getLength();__key1391 += 1) {
                RootObject o = __r1392.get(__key1391);
                int i = __key1391;
                if ((i) != 0)
                    (buf).writestring( new ByteSlice(", "));
    ...
    public static void parametersToBuffer(ParameterList pl, OutBuffer buf, HdrGenState hgs) {
        ...
        {
            int __key1393 = 0;
            int __limit1394 = pl.length();
            for (; __key1393 < __limit1394;__key1393 += 1) {
                int i = __key1393;
                if ((i) != 0)
                    (buf).writestring( new ByteSlice(", "));
    ...
    public static void parameterToBuffer(Parameter p, OutBuffer buf, HdrGenState hgs) {
        ...
        else if ((((p.type.ty & 0xFF) == ENUMTY.Tident && ((TypeIdentifier)p.type).ident.asString().getLength() > 3) && strncmp(((TypeIdentifier)p.type).ident.toChars(),  new ByteSlice("__T"), 3) == 0))
        {
            (buf).writestring(p.ident.asString());
        }
        else
    ...
    public static void argsToBuffer(DArray<Expression> expressions, OutBuffer buf, HdrGenState hgs, Expression basis) {
        if ((expressions == null || !(((expressions).length) != 0)))
            return ;
        {
            Slice<Expression> __r1396 = (expressions).opSlice().copy();
            int __key1395 = 0;
            for (; __key1395 < __r1396.getLength();__key1395 += 1) {
                Expression el = __r1396.get(__key1395);
                int i = __key1395;
                if ((i) != 0)
                    (buf).writestring( new ByteSlice(", "));
                if (!(el != null))
    ...
    public static void dumpTemplateInstance(TemplateInstance ti, OutBuffer buf, HdrGenState hgs) {
        ...
        {
            {
                Slice<Dsymbol> __r1397 = (ti.members).opSlice().copy();
                int __key1398 = 0;
                for (; __key1398 < __r1397.getLength();__key1398 += 1) {
                    Dsymbol m = __r1397.get(__key1398);
    ...
    public static void tiargsToBuffer(TemplateInstance ti, OutBuffer buf, HdrGenState hgs) {
        ...
        ti.nest++;
        {
            Slice<RootObject> __r1400 = (ti.tiargs).opSlice().copy();
            int __key1399 = 0;
            for (; __key1399 < __r1400.getLength();__key1399 += 1) {
                RootObject arg = __r1400.get(__key1399);
                int i = __key1399;
                if ((i) != 0)
                    (buf).writestring( new ByteSlice(", "));
                ...
                if (e != null)
                {
                    ...
                    if (s != null)
                    {
                        ...
                        if (v != null)
                        {
                            ...
                            {
                                Slice<RootObject> __r1402 = (args).opSlice().copy();
                                int __key1401 = 0;
                                for (; __key1401 < __r1402.getLength();__key1401 += 1) {
                                    RootObject arg = __r1402.get(__key1401);
                                    int i = __key1401;
                                    if ((i) != 0)
                                        (buf).writestring( new ByteSlice(", "));
                                    objectToBuffer(arg, buf, hgs);
    ...
    public static void visitFuncIdentWithPrefix(TypeFunction t, Identifier ident, TemplateDeclaration td, OutBuffer buf, HdrGenState hgs) {
        ...
        if (td != null)
        {
            ...
            {
                Slice<TemplateParameter> __r1404 = (td.origParameters).opSlice().copy();
                int __key1403 = 0;
                for (; __key1403 < __r1404.getLength();__key1403 += 1) {
                    TemplateParameter p = __r1404.get(__key1403);
                    int i = __key1403;
                    if ((i) != 0)
    ...
    public static void initializerToBuffer(Initializer inx, OutBuffer buf, HdrGenState hgs) {
        ...
        Function1<StructInitializer,Void> visitStruct = new Function1<StructInitializer,Void>(){
            public Void invoke(StructInitializer si){
                ...
                {
                    Slice<Identifier> __r1406 = si.field.opSlice().copy();
                    int __key1405 = 0;
                    for (; __key1405 < __r1406.getLength();__key1405 += 1) {
                        Identifier id = __r1406.get(__key1405);
                        int i = __key1405;
                        if ((i) != 0)
                            (buf_ref.value).writestring( new ByteSlice(", "));
                        if (id != null)
        ...
        Function1<ArrayInitializer,Void> visitArray = new Function1<ArrayInitializer,Void>(){
            public Void invoke(ArrayInitializer ai){
                ...
                {
                    Slice<Expression> __r1408 = ai.index.opSlice().copy();
                    int __key1407 = 0;
                    for (; __key1407 < __r1408.getLength();__key1407 += 1) {
                        Expression ex = __r1408.get(__key1407);
                        int i = __key1407;
                        if ((i) != 0)
                            (buf_ref.value).writestring( new ByteSlice(", "));
                        if (ex != null)
    ...
    public static void typeToBufferx(Type t, OutBuffer buf, HdrGenState hgs) {
        ...
        Function1<TypeQualified,Void> visitTypeQualifiedHelper = new Function1<TypeQualified,Void>(){
            public Void invoke(TypeQualified t){
                {
                    Slice<RootObject> __r1409 = t.idents.opSlice().copy();
                    int __key1410 = 0;
                    for (; __key1410 < __r1409.getLength();__key1410 += 1) {
                        RootObject id = __r1409.get(__key1410);
