...
public class transitivevisitor {
    ...
    public static class ParseTimeTransitiveVisitorASTBase extends PermissiveVisitorASTBase
    {
        ...
        public  void visit(ASTBase.CompoundStatement s) {
            {
                Slice<ASTBase.Statement> __r506 = (s.statements).opSlice().copy();
                int __key507 = 0;
                for (; __key507 < __r506.getLength();__key507 += 1) {
                    ASTBase.Statement sx = __r506.get(__key507);
                    if (sx != null)
                        sx.accept(this);
                }
            }
        ...
        public  void visit(ASTBase.CompoundDeclarationStatement s) {
            {
                Slice<ASTBase.Statement> __r512 = (s.statements).opSlice().copy();
                int __key513 = 0;
                for (; __key513 < __r512.getLength();__key513 += 1) {
                    ASTBase.Statement sx = __r512.get(__key513);
        ...
        public  void visit(ASTBase.ForeachStatement s) {
            {
                Slice<ASTBase.Parameter> __r514 = (s.parameters).opSlice().copy();
                int __key515 = 0;
                for (; __key515 < __r514.getLength();__key515 += 1) {
                    ASTBase.Parameter p = __r514.get(__key515);
                    if (p.type != null)
        ...
        public  void visitArgs(DArray<ASTBase.Expression> expressions, ASTBase.Expression basis) {
            if ((expressions == null || !(((expressions).length) != 0)))
                return ;
            {
                Slice<ASTBase.Expression> __r504 = (expressions).opSlice().copy();
                int __key505 = 0;
                for (; __key505 < __r504.getLength();__key505 += 1) {
                    ASTBase.Expression el = __r504.get(__key505);
                    if (!(el != null))
                        el = basis;
                    if (el != null)
                        el.accept(this);
        ...
        public  void visit(ASTBase.TryCatchStatement s) {
            if (s._body != null)
                s._body.accept(this);
            {
                Slice<ASTBase.Catch> __r516 = (s.catches).opSlice().copy();
                int __key517 = 0;
                for (; __key517 < __r516.getLength();__key517 += 1) {
                    ASTBase.Catch c = __r516.get(__key517);
                    this.visit(c);
                }
            }
        }
        ...
        public  void visit(ASTBase.ImportStatement s) {
            {
                Slice<ASTBase.Dsymbol> __r518 = (s.imports).opSlice().copy();
                int __key519 = 0;
                for (; __key519 < __r518.getLength();__key519 += 1) {
                    ASTBase.Dsymbol imp = __r518.get(__key519);
                    imp.accept(this);
                }
            }
        }
        ...
        public  void visitFunctionType(ASTBase.TypeFunction t, ASTBase.TemplateDeclaration td) {
            ...
            {
                {
                    Slice<ASTBase.TemplateParameter> __r508 = (td.origParameters).opSlice().copy();
                    int __key509 = 0;
                    for (; __key509 < __r508.getLength();__key509 += 1) {
                        ASTBase.TemplateParameter p = __r508.get(__key509);
                        p.accept(this);
                    }
                }
            }
        ...
        public  void visitParameters(DArray<ASTBase.Parameter> parameters) {
            if (parameters != null)
            {
                int dim = ASTBase.Parameter.dim(parameters);
                {
                    int __key510 = 0;
                    int __limit511 = dim;
                    for (; __key510 < __limit511;__key510 += 1) {
                        int i = __key510;
        ...
        public  void visitTypeQualified(ASTBase.TypeQualified t) {
            {
                Slice<RootObject> __r520 = t.idents.opSlice().copy();
                int __key521 = 0;
                for (; __key521 < __r520.getLength();__key521 += 1) {
                    RootObject id = __r520.get(__key521);
        ...
        public  void visit(ASTBase.ConditionalDeclaration d) {
            ...
            if (d.elsedecl != null)
            {
                Slice<ASTBase.Dsymbol> __r526 = (d.elsedecl).opSlice().copy();
                int __key527 = 0;
        ...
        public  void visitFuncBody(ASTBase.FuncDeclaration f) {
            ...
            {
                {
                    Slice<ASTBase.Statement> __r528 = (f.frequires).opSlice().copy();
                    int __key529 = 0;
                    for (; __key529 < __r528.getLength();__key529 += 1) {
                        ASTBase.Statement frequire = __r528.get(__key529);
            ...
            {
                {
                    Slice<ASTBase.Ensure> __r530 = (f.fensures).opSlice().copy();
                    int __key531 = 0;
                    for (; __key531 < __r530.getLength();__key531 += 1) {
                        ASTBase.Ensure fensure = __r530.get(__key531).copy();
        ...
        public  void visitBaseClasses(ASTBase.ClassDeclaration d) {
            if ((!(d != null) || !(((d.baseclasses).length) != 0)))
                return ;
            {
                Slice<ASTBase.BaseClass> __r532 = (d.baseclasses).opSlice().copy();
                int __key533 = 0;
                for (; __key533 < __r532.getLength();__key533 += 1) {
                    ASTBase.BaseClass b = __r532.get(__key533);
        ...
        public  boolean visitEponymousMember(ASTBase.TemplateDeclaration d) {
            ...
            }
            {
                ...
                if (ad != null)
                {
                    ...
                    if (ad.members != null)
                    {
                        Slice<ASTBase.Dsymbol> __r536 = (ad.members).opSlice().copy();
                        int __key537 = 0;
        ...
        public  void visitTemplateParameters(DArray<ASTBase.TemplateParameter> parameters) {
            if ((parameters == null || !(((parameters).length) != 0)))
                return ;
            {
                Slice<ASTBase.TemplateParameter> __r534 = (parameters).opSlice().copy();
                int __key535 = 0;
                for (; __key535 < __r534.getLength();__key535 += 1) {
                    ASTBase.TemplateParameter p = __r534.get(__key535);
                    p.accept(this);
                }
            }
        }
                ...
                if (t != null)
                {
                    ...
                    if (e != null)
                    {
                        ...
                        if (v != null)
                        {
                            ...
                            {
                                Slice<RootObject> __r540 = (args).opSlice().copy();
                                int __key541 = 0;
        ...
        public  void visitTiargs(ASTBase.TemplateInstance ti) {
            if (ti.tiargs == null)
                return ;
            {
                Slice<RootObject> __r542 = (ti.tiargs).opSlice().copy();
                int __key543 = 0;
        ...
        public  void visit(ASTBase.EnumDeclaration d) {
                ...
                return ;
            {
                ...
                for (; __key545 < __r544.getLength();__key545 += 1) {
                    ASTBase.Dsymbol em = __r544.get(__key545);
                    if (!(em != null))
                        continue;
                    em.accept(this);
                }
        ...
        public  void visit(ASTBase.StructInitializer si) {
            {
                Slice<Identifier> __r553 = si.field.opSlice().copy();
                int __key552 = 0;
                for (; __key552 < __r553.getLength();__key552 += 1) {
                    Identifier id = __r553.get(__key552);
                    int i = __key552;
                    {
        ...
        public  void visit(ASTBase.ArrayInitializer ai) {
            {
                Slice<ASTBase.Expression> __r555 = ai.index.opSlice().copy();
                int __key554 = 0;
                for (; __key554 < __r555.getLength();__key554 += 1) {
                    ASTBase.Expression ex = __r555.get(__key554);
                    int i = __key554;
                    if (ex != null)
                        ex.accept(this);
                    {
        ...
        public  void visit(ASTBase.AssocArrayLiteralExp e) {
            {
                Slice<ASTBase.Expression> __r557 = (e.keys).opSlice().copy();
                int __key556 = 0;
                for (; __key556 < __r557.getLength();__key556 += 1) {
                    ASTBase.Expression key = __r557.get(__key556);
                    int i = __key556;
                    key.accept(this);
        ...
        public  void visit(ASTBase.TraitsExp e) {
            if (e.args != null)
            {
                Slice<RootObject> __r558 = (e.args).opSlice().copy();
                int __key559 = 0;
                for (; __key559 < __r558.getLength();__key559 += 1) {
                    RootObject arg = __r558.get(__key559);
                    this.visitObject(arg);
                }
            }
        }
        ...
        public  void visit(ASTBase.Module m) {
            {
                Slice<ASTBase.Dsymbol> __r560 = (m.members).opSlice().copy();
                int __key561 = 0;
                for (; __key561 < __r560.getLength();__key561 += 1) {
                    ASTBase.Dsymbol s = __r560.get(__key561);
                    s.accept(this);
                }
            }
        }
