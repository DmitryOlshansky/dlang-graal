...
public class expressionsem {
    ...
    public static boolean expressionsToString(OutBuffer buf, Ptr<Scope> sc, Ptr<DArray<Expression>> exps) {
        ...
        {
            Slice<Expression> __r1350 = (exps.get()).opSlice().copy();
            int __key1351 = 0;
            for (; (__key1351 < __r1350.getLength());__key1351 += 1) {
                Expression ex = __r1350.get(__key1351);
                if (ex == null)
                {
                    continue;
                }
    ...
    public static Expression resolveOpDollar(Ptr<Scope> sc, ArrayExp ae, Ptr<Expression> pe0) {
        ...
        {
            Slice<Expression> __r1353 = (ae.arguments.get()).opSlice().copy();
            int __key1352 = 0;
        L_outer1:
            for (; (__key1352 < __r1353.getLength());__key1352 += 1) {
                Expression e = __r1353.get(__key1352);
                int i = __key1352;
                if ((i == 0))
                {
    ...
    public static Expression resolveOpDollar(Ptr<Scope> sc, ArrayExp ae, IntervalExp ie, Ptr<Expression> pe0) {
        ...
        sc = (sc.get()).push(sym);
        {
            int __key1354 = 0;
            int __limit1355 = 2;
            for (; (__key1354 < __limit1355);__key1354 += 1) {
                int i = __key1354;
    ...
    public static boolean arrayExpressionSemantic(Ptr<DArray<Expression>> exps, Ptr<Scope> sc, boolean preserveErrors) {
        ...
        {
            {
                Slice<Expression> __r1356 = (exps.get()).opSlice().copy();
                int __key1357 = 0;
                for (; (__key1357 < __r1356.getLength());__key1357 += 1) {
                    Expression e = __r1356.get(__key1357);
                    if (e != null)
                    {
            ...
            public Dsymbol invoke(Integer flags) {
                Dsymbol s = null;
                {
                    ...
                    for (; scx != null;scx = (scx.get()).enclosing){
                        ...
                        if ((scx.get()).scopesym.isModule() != null)
                        {
                            flags |= 32;
                        }
                        s = (scx.get()).scopesym.search(loc, ident, flags);
                        if (s != null)
                        {
                        ...
                        s = null;
                        if (((scx.get()).scopesym.isModule() != null) && !(((scx.get()).enclosing != null) && (((scx.get()).enclosing.get()).enclosing == null)))
                        {
                            break;
                        }
                    }
    ...
    public static Expression resolveUFCS(Ptr<Scope> sc, CallExp ce) {
        ...
        {
            ce.arguments = refPtr(new DArray<Expression>());
        }
    ...
    public static Expression resolvePropertiesOnly(Ptr<Scope> sc, Expression e1) {
        ...
        if (((e1.op & 0xFF) == 97))
        {
            ...
            /*Los:*/
                assert(os != null);
                {
                    Slice<Dsymbol> __r1358 = os.a.opSlice().copy();
                    int __key1359 = 0;
                    for (; (__key1359 < __r1358.getLength());__key1359 += 1) {
                        Dsymbol s = __r1358.get(__key1359);
    ...
    public static boolean functionParameters(Loc loc, Ptr<Scope> sc, TypeFunction tf, Expression ethis, Type tthis, Ptr<DArray<Expression>> arguments, FuncDeclaration fd, Ptr<Type> prettype, Ptr<Expression> peprefix) {
        ...
        boolean done = false;
        {
            ...
            int __limit1363 = n;
        L_outer4:
            for (; (__key1362 < __limit1363);__key1362 += 1) {
                int i = __key1362;
                            ...
                            /*L2:*/
                                ...
                                switch ((tb.ty & 0xFF))
                                {
                                    ...
                                    case 0:
                                        ...
                                        {
                                            int __key1364 = 0;
                                            int __limit1365 = (elements.get()).length;
        ...
        if (((wildmatch.value & 0xFF) == MODFlags.mutable) || ((wildmatch.value & 0xFF) == MODFlags.immutable_) && (tf.next.value != null) && (tf.next.value.hasWild() != 0) && tf.isref || (tf.next.value.implicitConvTo(tf.next.value.immutableOf()) == 0))
        {
        ...
        {
            Slice<Expression> __r1369 = (arguments.get()).opSlice(0, nargs).copy();
            int __key1368 = 0;
            for (; (__key1368 < __r1369.getLength());__key1368 += 1) {
                Expression arg = __r1369.get(__key1368);
                int i = __key1368;
                assert(arg != null);
                if ((i < nparams))
                {
    ...
    public static class ExpressionSemanticVisitor extends Visitor
    {
        ...
        public  void visit(NewExp exp) {
            ...
            if (edim != null)
            {
                ...
                {
                    exp.arguments = refPtr(new DArray<Expression>());
            ...
            if (((tb.ty & 0xFF) == ENUMTY.Tclass))
            {
                ...
                if (cd.aggNew != null)
                {
                    ...
                    if (exp.newargs == null)
                    {
                        exp.newargs = refPtr(new DArray<Expression>());
                    }
                ...
                else
                {
                    ...
                    }
                    {
                        ...
                        for (; c != null;c = c.baseClass){
                            {
                                Slice<VarDeclaration> __r1370 = c.fields.opSlice().copy();
                                int __key1371 = 0;
                                for (; (__key1371 < __r1370.getLength());__key1371 += 1) {
                                    VarDeclaration v = __r1370.get(__key1371);
            ...
            else if (((tb.ty & 0xFF) == ENUMTY.Tstruct))
            {
                ...
                else
                {
                    ...
                    {
                        {
                            Slice<Expression> __r1372 = (exp.arguments.get()).opSlice().copy();
                            int __key1373 = 0;
                            for (; (__key1373 < __r1372.getLength());__key1373 += 1) {
                                Expression arg = __r1372.get(__key1373);
        ...
        public  void visit(NewAnonClassExp e) {
            ...
            if (!e.cd.errors && ((this.sc.get()).intypeof != 0) && !(this.sc.get()).parent.value.inNonRoot())
            {
                ...
                if (sds.members == null)
                {
                    sds.members = refPtr(new DArray<Dsymbol>());
                }
            ...
            /*Lagain:*/
                ...
                Function6<Loc,Ptr<Scope>,OverloadSet,Ptr<DArray<RootObject>>,Type,Ptr<DArray<Expression>>,FuncDeclaration> resolveOverloadSet = new Function6<Loc,Ptr<Scope>,OverloadSet,Ptr<DArray<RootObject>>,Type,Ptr<DArray<Expression>>,FuncDeclaration>(){
                    public FuncDeclaration invoke(Loc loc, Ptr<Scope> sc, OverloadSet os, Ptr<DArray<RootObject>> tiargs, Type tthis, Ptr<DArray<Expression>> arguments) {
                        ...
                        {
                            Slice<Dsymbol> __r1374 = os.a.opSlice().copy();
                            int __key1375 = 0;
                            for (; (__key1375 < __r1374.getLength());__key1375 += 1) {
                                Dsymbol s = __r1374.get(__key1375);
                ...
                else if (((exp.e1.value.op & 0xFF) == 124) || ((exp.e1.value.op & 0xFF) == 123))
                {
                    ...
                    else
                    {
                        ...
                        {
                            Slice<FieldInit> __r1376 = (this.sc.get()).ctorflow.fieldinit.copy();
                            int __key1377 = 0;
                            for (; (__key1377 < __r1376.getLength());__key1377 += 1) {
                                FieldInit field = __r1376.get(__key1377).copy();
                                field.csx.value |= 65;
                            }
                        }
                    }
        ...
        public  void visit(DelegateExp e) {
            ...
            if (global.value.params.vsafe && ((e.e1.value.type.value.toBasetype().ty & 0xFF) == ENUMTY.Tstruct))
            {
                {
        ...
        public  void visit(AddrExp exp) {
            ...
            else if (((exp.e1.value.op & 0xFF) == 123) || ((exp.e1.value.op & 0xFF) == 124) && global.value.params.vsafe)
            {
                {
        ...
        public  void visit(UAddExp exp) {
            ...
            fix16997(this.sc, exp);
            if (!target.value.isVectorOpSupported(exp.e1.value.type.value.toBasetype(), exp.op, null))
            {
                this.result = exp.incompatibleTypes();
                return ;
            }
        ...
        public  void visit(NotExp e) {
            ...
            if (!target.value.isVectorOpSupported(e.e1.value.type.value.toBasetype(), e.op, null))
            {
        ...
        public  void visit(PreExp exp) {
            ...
            if (((exp.op & 0xFF) == 103))
            {
                e = new AddAssignExp(exp.loc, exp.e1.value, new IntegerExp(exp.loc, 1L, Type.tint32.value));
            }
            else
            {
                e = new MinAssignExp(exp.loc, exp.e1.value, new IntegerExp(exp.loc, 1L, Type.tint32.value));
            }
            this.result = expressionSemantic(e, this.sc);
        }
