...
public class typesem {
    ...
    public static Type stripDefaultArgs(Type t) {
        Function1<Ptr<DArray<Parameter>>,Ptr<DArray<Parameter>>> stripParams = (parameters) -> {
         {
            Function1<Parameter,Parameter> stripParameter = (p) -> {
             {
            ...
            {
                {
                    ...
                    Ref<Integer> __key1643 = ref(0);
                    for (; (__key1643.value < __r1644.getLength());__key1643.value += 1) {
                        Parameter p = __r1644.get(__key1643.value);
                        int i = __key1643.value;
                        ...
                        if (ps != null)
                        {
                            Ptr<DArray<Parameter>> nparams = refPtr(new DArray<Parameter>((parameters.get()).length));
                            {
                                ...
                                Ref<Integer> __key1645 = ref(0);
                                for (; (__key1645.value < __r1646.getLength());__key1645.value += 1) {
                                    Ref<Parameter> np = ref(__r1646.get(__key1645.value));
                                    int j = __key1645.value;
    ...
    public static Expression typeToExpression(Type t) {
        Function1<TypeSArray,Expression> visitSArray = (t) -> {
         {
            {
        ...
        Function1<TypeAArray,Expression> visitAArray = (t) -> {
         {
            {
                Expression e = typeToExpression(t.next.value);
                if ((e) != null)
        ...
        Function1<TypeIdentifier,Expression> visitIdentifier = (t) -> {
         {
            return typeToExpressionHelper(t, new IdentifierExp(t.loc, t.ident), 0);
        }
        };
        Function1<TypeInstance,Expression> visitInstance = (t) -> {
         {
    ...
    public static Type typeSemantic(Type t, Loc loc, Ptr<Scope> sc) {
        ...
        Function0<Type> error = () -> {
         {
            return Type.terror;
        }
        };
        Function1<Type,Type> visitType = (t) -> {
         {
        ...
        Function1<TypeVector,Type> visitVector = (mtype) -> {
         {
        ...
        Function1<TypeSArray,Type> visitSArray = (mtype) -> {
         {
            Ref<Type> t = ref(null);
            Ref<Expression> e = ref(null);
        ...
        Function1<TypeDArray,Type> visitDArray = (mtype) -> {
         {
            Type tn = typeSemantic(mtype.next.value, loc, sc_ref.value);
            Type tbn = tn.toBasetype();
            switch ((tbn.ty & 0xFF))
        ...
        Function1<TypeAArray,Type> visitAArray = (mtype) -> {
         {
            if (mtype.deco != null)
            {
                return mtype;
        ...
        Function1<TypePointer,Type> visitPointer = (mtype) -> {
         {
            if (mtype.deco != null)
            {
                return mtype;
        ...
        Function1<TypeReference,Type> visitReference = (mtype) -> {
         {
            Type n = typeSemantic(mtype.next.value, loc, sc_ref.value);
            if ((!pequals(n, mtype.next.value)))
            {
        ...
        Function1<TypeFunction,Type> visitFunction = (mtype) -> {
         {
            if (mtype.deco != null)
            {
                return mtype;
        ...
        Function1<TypeDelegate,Type> visitDelegate = (mtype) -> {
         {
            if (mtype.deco != null)
            {
                return mtype;
        ...
        Function1<TypeIdentifier,Type> visitIdentifier = (mtype) -> {
         {
            Ref<Type> t = ref(null);
            Ref<Expression> e = ref(null);
            Ref<Dsymbol> s = ref(null);
        ...
        Function1<TypeInstance,Type> visitInstance = (mtype) -> {
         {
            Ref<Type> t = ref(null);
            Ref<Expression> e = ref(null);
            Ref<Dsymbol> s = ref(null);
        ...
        Function1<TypeTypeof,Type> visitTypeof = (mtype) -> {
         {
            Ref<Expression> e = ref(null);
            Ref<Type> t = ref(null);
            Ref<Dsymbol> s = ref(null);
        ...
        Function1<TypeTraits,Type> visitTraits = (mtype) -> {
         {
        ...
        Function1<TypeReturn,Type> visitReturn = (mtype) -> {
         {
            Ref<Expression> e = ref(null);
            Ref<Type> t = ref(null);
            Ref<Dsymbol> s = ref(null);
        ...
        Function1<TypeStruct,Type> visitStruct = (mtype) -> {
         {
            if (mtype.deco != null)
            {
        ...
        Function1<TypeEnum,Type> visitEnum = (mtype) -> {
         {
            return mtype.deco != null ? mtype : merge(mtype);
        }
        };
        Function1<TypeClass,Type> visitClass = (mtype) -> {
         {
            if (mtype.deco != null)
            {
                if ((sc_ref.value != null) && ((sc_ref.value.get()).cppmangle != CPPMANGLE.def))
        ...
        Function1<TypeTuple,Type> visitTuple = (mtype) -> {
         {
            if (mtype.deco == null)
            {
                mtype.deco = pcopy(merge(mtype).deco);
        ...
        Function1<TypeSlice,Type> visitSlice = (mtype) -> {
         {
            Type tn = typeSemantic(mtype.next.value, loc, sc_ref.value);
            Type tbn = tn.toBasetype();
            ...
            (args.get()).reserve((int)(i2 - i1));
            {
                ...
                Ref<Integer> __key1650 = ref(0);
                for (; (__key1650.value < __r1649.getLength());__key1650.value += 1) {
                    Parameter arg = __r1649.get(__key1650.value);
                    (args.get()).push(arg);
                }
            }
    ...
    public static Expression getProperty(Type t, Loc loc, Identifier ident, int flag) {
        Function1<Type,Expression> visitType = (mt) -> {
         {
            Ref<Expression> e = ref(null);
        ...
        Function1<TypeError,Expression> visitError = (_param_0) -> {
         {
            return new ErrorExp();
        }
        };
        Function1<TypeBasic,Expression> visitBasic = (mt) -> {
         {
            Function1<Long,Expression> integerValue = (i) -> {
             {
                return new IntegerExp(loc, i, mt);
            }
            };
            Function1<Long,Expression> intValue = (i) -> {
             {
                return new IntegerExp(loc, i, Type.tint32);
            }
            };
            Function1<Double,Expression> floatValue = (r) -> {
             {
        ...
        Function1<TypeVector,Expression> visitVector = (mt) -> {
         {
            return visitType.invoke(mt);
        }
        };
        Function1<TypeEnum,Expression> visitEnum = (mt) -> {
         {
            Ref<Expression> e = ref(null);
        ...
        Function1<TypeTuple,Expression> visitTuple = (mt) -> {
         {
            Ref<Expression> e = ref(null);
    ...
    public static void resolve(Type mt, Loc loc, Ptr<Scope> sc, Ptr<Expression> pe, Ptr<Type> pt, Ptr<Dsymbol> ps, boolean intypeid) {
        Ref<Ptr<Scope>> sc_ref = ref(sc);
        Function1<Expression,Void> returnExp = (e) -> {
         {
            pt.set(0, null);
            pe.set(0, e);
            ps.set(0, null);
        ...
        Function1<Type,Void> returnType = (t) -> {
         {
            pt.set(0, t);
            pe.set(0, null);
            ps.set(0, null);
        ...
        Function1<Dsymbol,Void> returnSymbol = (s) -> {
         {
            pt.set(0, null);
            pe.set(0, null);
            ps.set(0, s);
        ...
        Function0<Void> returnError = () -> {
         {
            returnType.invoke(Type.terror);
            return null;
        }
        };
        Function1<Type,Void> visitType = (mt) -> {
         {
        ...
        Function1<TypeSArray,Void> visitSArray = (mt) -> {
         {
        ...
        Function1<TypeDArray,Void> visitDArray = (mt) -> {
         {
            resolve(mt.next.value, loc, sc_ref.value, pe, pt, ps, intypeid);
            if (pe.get() != null)
            {
        ...
        Function1<TypeAArray,Void> visitAArray = (mt) -> {
         {
        ...
        Function1<TypeIdentifier,Void> visitIdentifier = (mt) -> {
         {
            ...
            if ((s.value == null) && ((sc_ref.value.get()).enclosing != null))
            {
                ...
                {
                    Function1<Dsymbol,Void> semanticOnMixin = (member) -> {
                     {
                        {
        ...
        Function1<TypeInstance,Void> visitInstance = (mt) -> {
         {
        ...
        Function1<TypeTypeof,Void> visitTypeof = (mt) -> {
         {
            if ((sc_ref.value == null))
            {
        ...
        Function1<TypeReturn,Void> visitReturn = (mt) -> {
         {
            Ref<Type> t = ref(null);
            {
        ...
        Function1<TypeSlice,Void> visitSlice = (mt) -> {
         {
            resolve(mt.next.value, loc, sc_ref.value, pe, pt, ps, intypeid);
            if (pe.get() != null)
            {
    ...
    public static Expression dotExp(Type mt, Ptr<Scope> sc, Expression e, Identifier ident, int flag) {
        ...
        Function1<TypeArray,Expression> visitArray = (mt) -> {
         {
        ...
        Function1<TypeSArray,Expression> visitSArray = (mt) -> {
         {
            if ((pequals(ident, Id.length)))
            {
        ...
        Function1<TypeDArray,Expression> visitDArray = (mt) -> {
         {
        ...
        Function1<TypeAArray,Expression> visitAArray = (mt) -> {
         {
            if ((pequals(ident, Id.length)))
            {
        ...
        Function1<TypeReference,Expression> visitReference = (mt) -> {
         {
            return dotExp(mt.next.value, sc, e_ref.value, ident, flag);
        }
        };
        Function1<TypeDelegate,Expression> visitDelegate = (mt) -> {
         {
        ...
        Function5<Type,Ptr<Scope>,Expression,Identifier,Integer,Expression> noMember = (mt, sc, e, ident, flag) -> {
         {
            boolean gagError = ((flag & 1) != 0);
            Function1<Expression,Expression> returnExp = (e) -> {
             {
            ...
            {
                error(e.value.loc, new BytePtr("cannot resolve identifier `%s`"), ident.toChars());
            ...
            {
                {
                    ...
                    if ((fd) != null)
                    {
                        e.value = build_overload(e.value.loc, sc, e.value, null, fd);
                        e.value.deprecation(new BytePtr("`opDot` is deprecated. Use `alias this`"));
                        e.value = new DotIdExp(e.value.loc, e.value, ident);
                        return returnExp.invoke(expressionSemantic(e.value, sc));
                    }
                }
                {
                    ...
                    if ((fd) != null)
                    {
                        ...
                        StringExp se = new StringExp(e.value.loc, ident.toChars());
                        Ptr<DArray<RootObject>> tiargs = refPtr(new DArray<RootObject>());
                        (tiargs.get()).push(se);
                        DotTemplateInstanceExp dti = new DotTemplateInstanceExp(e.value.loc, e.value, Id.opDispatch, tiargs);
                        dti.ti.tempdecl = td;
                        int errors = gagError ? global.startGagging() : 0;
                        e.value = semanticY(dti, sc, 0);
                        if (gagError && global.endGagging(errors))
                        {
                            e.value = null;
                        }
                        return returnExp.invoke(e.value);
                    }
                }
                Expression alias_e = resolveAliasThis(sc, e.value, gagError);
                if ((alias_e != null) && (!pequals(alias_e, e.value)))
                {
                    DotIdExp die = new DotIdExp(e.value.loc, alias_e, ident);
                    ...
                    {
                        resolveAliasThis(sc, e.value, false);
                    }
        ...
        Function1<TypeStruct,Expression> visitStruct = (mt) -> {
         {
            Ref<Dsymbol> s = ref(null);
        ...
        Function1<TypeClass,Expression> visitClass = (mt) -> {
         {
            Ref<Dsymbol> s = ref(null);
            assert(((e_ref.value.op & 0xFF) != 97));
    ...
    public static Expression defaultInit(Type mt, Loc loc) {
        ...
        Function1<TypeFunction,Expression> visitFunction = (mt) -> {
         {
