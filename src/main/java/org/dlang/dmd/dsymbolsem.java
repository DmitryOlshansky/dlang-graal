...
public class dsymbolsem {
    ...
    public static class DsymbolSemanticVisitor extends Visitor
    {
            ...
            if (imp.mod != null)
            {
                ...
                if ((imp.aliasId == null) && (imp.names.length.value == 0))
                {
                    ...
                    if (imp.packages.value != null)
                    {
                        ...
                        {
                            Slice<Identifier> __r1146 = (imp.packages.value.get()).opSlice(1, (imp.packages.value.get()).length.value).copy();
                            int __key1147 = 0;
        ...
        public  void visit(Nspace ns) {
            ...
            if (ns.identExp != null)
            {
                ...
                else
                {
                    Nspace parentns = ns;
                    {
                        Slice<Expression> __r1152 = (tup.exps.value.get()).opSlice().copy();
                        int __key1151 = 0;
            ...
            if (ns.members.value != null)
            {
                ...
                {
                    Slice<Dsymbol> __r1155 = (ns.members.value.get()).opSlice().copy();
                    int __key1156 = 0;
            ...
            try {
                ...
                }
                {
                                            ...
                                            __dispatch1 = 0;
                                                ...
                                                else
                                                {
                                                    ...
                                                    if ((cd.classKind.value == ClassKind.cpp) && target.reverseCppOverloads)
                                                    {
                                                        ...
                                                        boolean found = false;
                                                        {
                                                            Slice<Dsymbol> __r1158 = cd.vtbl.value.opSlice().copy();
                                                            int __key1157 = 0;
                    ...
                    /*L2:*/
                        ...
                        {
                            Slice<Ptr<BaseClass>> __r1161 = cd.interfaces.value.copy();
                            int __key1162 = 0;
                            for (; (__key1162 < __r1161.getLength());__key1162 += 1) {
                                Ptr<BaseClass> b = __r1161.get(__key1162);
        ...
        public  void interfaceSemantic(ClassDeclaration cd) {
            ...
            {
                Slice<Ptr<BaseClass>> __r1167 = cd.interfaces.value.copy();
                int __key1168 = 0;
        ...
        public  void visit(ClassDeclaration cldec) {
            ...
            try {
                ...
                try {
                    if ((cldec.baseok < Baseok.done))
                    {
                        ...
                        {
                            Slice<Ptr<BaseClass>> __r1169 = cldec.interfaces.value.copy();
                            int __key1170 = 0;
                            for (; (__key1170 < __r1169.getLength());__key1170 += 1) {
                                Ptr<BaseClass> b = __r1169.get(__key1170);
            ...
            /*Lancestorsdone:*/
                ...
                {
                    {
                        Slice<VarDeclaration> __r1175 = cldec.fields.opSlice().copy();
                        int __key1176 = 0;
        ...
        public  void visit(InterfaceDeclaration idec) {
            ...
            try {
                ...
                try {
                    if ((idec.baseok < Baseok.done))
                    {
                        ...
                        {
                            Slice<Ptr<BaseClass>> __r1177 = idec.interfaces.value.copy();
                            int __key1178 = 0;
                            for (; (__key1178 < __r1177.getLength());__key1178 += 1) {
                                Ptr<BaseClass> b = __r1177.get(__key1178);
                                if ((b.get()).sym.value.isCOMinterface())
                                {
                                    idec.com = true;
                                }
            ...
            /*Lancestorsdone:*/
                ...
                if ((idec.baseok == Baseok.done))
                {
                    ...
                    {
                        Slice<Ptr<BaseClass>> __r1180 = idec.interfaces.value.copy();
                        int __key1179 = 0;
                    L_outer8:
                        for (; (__key1179 < __r1180.getLength());__key1179 += 1) {
                            Ptr<BaseClass> b = __r1180.get(__key1179);
                            int i = __key1179;
                            try {
                                {
                                    int k = 0;
    ...
    public static void templateInstanceSemantic(TemplateInstance tempinst, Ptr<Scope> sc, Ptr<DArray<Expression>> fargs) {
        ...
        try {
            ...
            else if (tempinst.tinst != null)
            {
                ...
                {
                    {
                        Slice<RootObject> __r1182 = tempinst.tdtypes.value.opSlice().copy();
                        int __key1183 = 0;
